...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Pa(){return new zt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function La(){return new zt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ko(),fragmentShader:`
...
`)}function Mp(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ki(i){return i!==""}function Ga(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Va(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Sp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Eo(i){return i.replace(Sp,bp)}const wp=new Map;function bp(i,e){let t=$e[e];if(t===void 0){const n=wp.get(e);if(n!==void 0)t=$e[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Eo(t)}const Ep=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wa(i){return i.replace(Ep,Tp)}function Tp(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Xa(i){let e=`precision ${i.precision} float;
...
`)+`
`+u);const x=g+m+o,v=g+u+a,A=Ba(s,s.VERTEX_SHADER,x),E=Ba(s,s.FRAGMENT_SHADER,v);s.attachShader(y,A),s.attachShader(y,E),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function C(U){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(y).trim(),k=s.getShaderInfoLog(A).trim(),K=s.getShaderInfoLog(E).trim();let re=!0,Z=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(re=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,A,E);else{const le=Ha(s,A,"vertex"),Y=Ha(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Program Info Log: `+W+`
`+le+`
`+Y)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(k===""||K==="")&&(Z=!1);Z&&(U.diagnostics={runnable:re,programLog:W,vertexShader:{log:k,prefix:m},fragmentShader:{log:K,prefix:u}})}s.deleteShader(A),s.deleteShader(E),R=new Xs(s,y),w=Mp(s,y)}let R;this.getUniforms=function(){return R===void 0&&C(this),R};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let S=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=s.getProgramParameter(y,fp)),S},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=dp++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=A,this.fragmentShader=E,this}let Ip=0;class Up{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Np(e),t.set(e,n)),n}}class Np{constructor(e){this.id=Ip++,this.code=e,this.usedTimes=0}}function Fp(i,e,t,n,s,r,o){const a=new Tl,l=new Up,c=new Set,h=[],f=s.logarithmicDepthBuffer,d=s.vertexTextures;let p=s.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function y(w){return c.add(w),w===0?"uv":`uv${w}`}function m(w,S,U,W,k){const K=W.fog,re=k.geometry,Z=w.isMeshStandardMaterial?W.environment:null,le=(w.isMeshStandardMaterial?t:e).get(w.envMap||Z),Y=le&&le.mapping===Ks?le.image.height:null,me=_[w.type];w.precision!==null&&(p=s.getMaxPrecision(w.precision),p!==w.precision&&console.warn("THREE.WebGLProgram.getParameters:",w.precision,"not supported, using",p,"instead."));const be=re.morphAttributes.position||re.morphAttributes.normal||re.morphAttributes.color,Le=be!==void 0?be.length:0;let qe=0;re.morphAttributes.position!==void 0&&(qe=1),re.morphAttributes.normal!==void 0&&(qe=2),re.morphAttributes.color!==void 0&&(qe=3);let nt,ee,ae,Pe;if(me){const it=on[me];nt=it.vertexShader,ee=it.fragmentShader}else nt=w.vertexShader,ee=w.fragmentShader,l.update(w),ae=l.getVertexShaderID(w),Pe=l.getFragmentShaderID(w);const Me=i.getRenderTarget(),I=i.state.buffers.depth.getReversed(),B=k.isInstancedMesh===!0,te=k.isBatchedMesh===!0,ce=!!w.map,J=!!w.matcap,se=!!le,L=!!w.aoMap,Re=!!w.lightMap,$=!!w.bumpMap,fe=!!w.normalMap,_e=!!w.displacementMap,ke=!!w.emissiveMap,ue=!!w.metalnessMap,T=!!w.roughnessMap,M=w.anisotropy>0,z=w.clearcoat>0,X=w.dispersion>0,ne=w.iridescence>0,j=w.sheen>0,Ce=w.transmission>0,de=M&&!!w.anisotropyMap,Ee=z&&!!w.clearcoatMap,Je=z&&!!w.clearcoatNormalMap,oe=z&&!!w.clearcoatRoughnessMap,Te=ne&&!!w.iridescenceMap,Fe=ne&&!!w.iridescenceThicknessMap,ze=j&&!!w.sheenColorMap,Ae=j&&!!w.sheenRoughnessMap,Ke=!!w.specularMap,Ve=!!w.specularColorMap,rt=!!w.specularIntensityMap,N=Ce&&!!w.transmissionMap,ve=Ce&&!!w.thicknessMap,q=!!w.gradientMap,Q=!!w.alphaMap,Se=w.alphaTest>0,ge=!!w.alphaHash,Ge=!!w.extensions;let dt=On;w.toneMapped&&(Me===null||Me.isXRRenderTarget===!0)&&(dt=i.toneMapping);const bt={shaderID:me,shaderType:w.type,shaderName:w.name,vertexShader:nt,fragmentShader:ee,defines:w.defines,customVertexShaderID:ae,customFragmentShaderID:Pe,isRawShaderMaterial:w.isRawShaderMaterial===!0,glslVersion:w.glslVersion,precision:p,batching:te,batchingColor:te&&k._colorsTexture!==null,instancing:B,instancingColor:B&&k.instanceColor!==null,instancingMorph:B&&k.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:Me===null?i.outputColorSpace:Me.isXRRenderTarget===!0?Me.texture.colorSpace:Ii,alphaToCoverage:!!w.alphaToCoverage,map:ce,matcap:J,envMap:se,envMapMode:se&&le.mapping,envMapCubeUVHeight:Y,aoMap:L,lightMap:Re,bumpMap:$,normalMap:fe,displacementMap:d&&_e,emissiveMap:ke,normalMapObjectSpace:fe&&w.normalMapType===Vc,normalMapTangentSpace:fe&&w.normalMapType===Ml,metalnessMap:ue,roughnessMap:T,anisotropy:M,anisotropyMap:de,clearcoat:z,clearcoatMap:Ee,clearcoatNormalMap:Je,clearcoatRoughnessMap:oe,dispersion:X,iridescence:ne,iridescenceMap:Te,iridescenceThicknessMap:Fe,sheen:j,sheenColorMap:ze,sheenRoughnessMap:Ae,specularMap:Ke,specularColorMap:Ve,specularIntensityMap:rt,transmission:Ce,transmissionMap:N,thicknessMap:ve,gradientMap:q,opaque:w.transparent===!1&&w.blending===wi&&w.alphaToCoverage===!1,alphaMap:Q,alphaTest:Se,alphaHash:ge,combine:w.combine,mapUv:ce&&y(w.map.channel),aoMapUv:L&&y(w.aoMap.channel),lightMapUv:Re&&y(w.lightMap.channel),bumpMapUv:$&&y(w.bumpMap.channel),normalMapUv:fe&&y(w.normalMap.channel),displacementMapUv:_e&&y(w.displacementMap.channel),emissiveMapUv:ke&&y(w.emissiveMap.channel),metalnessMapUv:ue&&y(w.metalnessMap.channel),roughnessMapUv:T&&y(w.roughnessMap.channel),anisotropyMapUv:de&&y(w.anisotropyMap.channel),clearcoatMapUv:Ee&&y(w.clearcoatMap.channel),clearcoatNormalMapUv:Je&&y(w.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&y(w.clearcoatRoughnessMap.channel),iridescenceMapUv:Te&&y(w.iridescenceMap.channel),iridescenceThicknessMapUv:Fe&&y(w.iridescenceThicknessMap.channel),sheenColorMapUv:ze&&y(w.sheenColorMap.channel),sheenRoughnessMapUv:Ae&&y(w.sheenRoughnessMap.channel),specularMapUv:Ke&&y(w.specularMap.channel),specularColorMapUv:Ve&&y(w.specularColorMap.channel),specularIntensityMapUv:rt&&y(w.specularIntensityMap.channel),transmissionMapUv:N&&y(w.transmissionMap.channel),thicknessMapUv:ve&&y(w.thicknessMap.channel),alphaMapUv:Q&&y(w.alphaMap.channel),vertexTangents:!!re.attributes.tangent&&(fe||M),vertexColors:w.vertexColors,vertexAlphas:w.vertexColors===!0&&!!re.attributes.color&&re.attributes.color.itemSize===4,pointsUvs:k.isPoints===!0&&!!re.attributes.uv&&(ce||Q),fog:!!K,useFog:w.fog===!0,fogExp2:!!K&&K.isFogExp2,flatShading:w.flatShading===!0,sizeAttenuation:w.sizeAttenuation===!0,logarithmicDepthBuffer:f,reverseDepthBuffer:I,skinning:k.isSkinnedMesh===!0,morphTargets:re.morphAttributes.position!==void 0,morphNormals:re.morphAttributes.normal!==void 0,morphColors:re.morphAttributes.color!==void 0,morphTargetsCount:Le,morphTextureStride:qe,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:w.dithering,shadowMapEnabled:i.shadowMap.enabled&&U.length>0,shadowMapType:i.shadowMap.type,toneMapping:dt,decodeVideoTexture:ce&&w.map.isVideoTexture===!0&&et.getTransfer(w.map.colorSpace)===lt,decodeVideoTextureEmissive:ke&&w.emissiveMap.isVideoTexture===!0&&et.getTransfer(w.emissiveMap.colorSpace)===lt,premultipliedAlpha:w.premultipliedAlpha,doubleSided:w.side===Qe,flipSided:w.side===Bt,useDepthPacking:w.depthPacking>=0,depthPacking:w.depthPacking||0,index0AttributeName:w.index0AttributeName,extensionClipCullDistance:Ge&&w.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ge&&w.extensions.multiDraw===!0||te)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:w.customProgramCacheKey()};return bt.vertexUv1s=c.has(1),bt.vertexUv2s=c.has(2),bt.vertexUv3s=c.has(3),c.clear(),bt}function u(w){const S=[];if(w.shaderID?S.push(w.shaderID):(S.push(w.customVertexShaderID),S.push(w.customFragmentShaderID)),w.defines!==void 0)for(const U in w.defines)S.push(U),S.push(w.defines[U]);return w.isRawShaderMaterial===!1&&(g(S,w),x(S,w),S.push(i.outputColorSpace)),S.push(w.customProgramCacheKey),S.join()}function g(w,S){w.push(S.precision),w.push(S.outputColorSpace),w.push(S.envMapMode),w.push(S.envMapCubeUVHeight),w.push(S.mapUv),w.push(S.alphaMapUv),w.push(S.lightMapUv),w.push(S.aoMapUv),w.push(S.bumpMapUv),w.push(S.normalMapUv),w.push(S.displacementMapUv),w.push(S.emissiveMapUv),w.push(S.metalnessMapUv),w.push(S.roughnessMapUv),w.push(S.anisotropyMapUv),w.push(S.clearcoatMapUv),w.push(S.clearcoatNormalMapUv),w.push(S.clearcoatRoughnessMapUv),w.push(S.iridescenceMapUv),w.push(S.iridescenceThicknessMapUv),w.push(S.sheenColorMapUv),w.push(S.sheenRoughnessMapUv),w.push(S.specularMapUv),w.push(S.specularColorMapUv),w.push(S.specularIntensityMapUv),w.push(S.transmissionMapUv),w.push(S.thicknessMapUv),w.push(S.combine),w.push(S.fogExp2),w.push(S.sizeAttenuation),w.push(S.morphTargetsCount),w.push(S.morphAttributeCount),w.push(S.numDirLights),w.push(S.numPointLights),w.push(S.numSpotLights),w.push(S.numSpotLightMaps),w.push(S.numHemiLights),w.push(S.numRectAreaLights),w.push(S.numDirLightShadows),w.push(S.numPointLightShadows),w.push(S.numSpotLightShadows),w.push(S.numSpotLightShadowsWithMaps),w.push(S.numLightProbes),w.push(S.shadowMapType),w.push(S.toneMapping),w.push(S.numClippingPlanes),w.push(S.numClipIntersection),w.push(S.depthPacking)}function x(w,S){a.disableAll(),S.supportsVertexTextures&&a.enable(0),S.instancing&&a.enable(1),S.instancingColor&&a.enable(2),S.instancingMorph&&a.enable(3),S.matcap&&a.enable(4),S.envMap&&a.enable(5),S.normalMapObjectSpace&&a.enable(6),S.normalMapTangentSpace&&a.enable(7),S.clearcoat&&a.enable(8),S.iridescence&&a.enable(9),S.alphaTest&&a.enable(10),S.vertexColors&&a.enable(11),S.vertexAlphas&&a.enable(12),S.vertexUv1s&&a.enable(13),S.vertexUv2s&&a.enable(14),S.vertexUv3s&&a.enable(15),S.vertexTangents&&a.enable(16),S.anisotropy&&a.enable(17),S.alphaHash&&a.enable(18),S.batching&&a.enable(19),S.dispersion&&a.enable(20),S.batchingColor&&a.enable(21),w.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.reverseDepthBuffer&&a.enable(4),S.skinning&&a.enable(5),S.morphTargets&&a.enable(6),S.morphNormals&&a.enable(7),S.morphColors&&a.enable(8),S.premultipliedAlpha&&a.enable(9),S.shadowMapEnabled&&a.enable(10),S.doubleSided&&a.enable(11),S.flipSided&&a.enable(12),S.useDepthPacking&&a.enable(13),S.dithering&&a.enable(14),S.transmission&&a.enable(15),S.sheen&&a.enable(16),S.opaque&&a.enable(17),S.pointsUvs&&a.enable(18),S.decodeVideoTexture&&a.enable(19),S.decodeVideoTextureEmissive&&a.enable(20),S.alphaToCoverage&&a.enable(21),w.push(a.mask)}function v(w){const S=_[w.type];let U;if(S){const W=on[S];U=Ys.clone(W.uniforms)}else U=w.uniforms;return U}function A(w,S){let U;for(let W=0,k=h.length;W<k;W++){const K=h[W];if(K.cacheKey===S){U=K,++U.usedTimes;break}}return U===void 0&&(U=new Dp(i,S,w,r),h.push(U)),U}function E(w){if(--w.usedTimes===0){const S=h.indexOf(w);h[S]=h[h.length-1],h.pop(),w.destroy()}}function C(w){l.remove(w)}function R(){l.dispose()}return{getParameters:m,getProgramCacheKey:u,getUniforms:v,acquireProgram:A,releaseProgram:E,releaseShaderCache:C,programs:h,dispose:R}}function Op(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,l){i.get(o)[a]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function zp(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function $a(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function qa(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function o(f,d,p,_,y,m){let u=i[e];return u===void 0?(u={id:f.id,object:f,geometry:d,material:p,groupOrder:_,renderOrder:f.renderOrder,z:y,group:m},i[e]=u):(u.id=f.id,u.object=f,u.geometry=d,u.material=p,u.groupOrder=_,u.renderOrder=f.renderOrder,u.z=y,u.group=m),e++,u}function a(f,d,p,_,y,m){const u=o(f,d,p,_,y,m);p.transmission>0?n.push(u):p.transparent===!0?s.push(u):t.push(u)}function l(f,d,p,_,y,m){const u=o(f,d,p,_,y,m);p.transmission>0?n.unshift(u):p.transparent===!0?s.unshift(u):t.unshift(u)}function c(f,d){t.length>1&&t.sort(f||zp),n.length>1&&n.sort(d||$a),s.length>1&&s.sort(d||$a)}function h(){for(let f=e,d=i.length;f<d;f++){const p=i[f];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:a,unshift:l,finish:h,sort:c}}function Bp(){let i=new WeakMap;function e(n,s){const r=i.get(n);let o;return r===void 0?(o=new qa,i.set(n,[o])):s>=r.length?(o=new qa,r.push(o)):o=r[s],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function kp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Be};break;case"SpotLight":t={position:new D,direction:new D,color:new Be,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Be,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Be,groundColor:new Be};break;case"RectAreaLight":t={color:new Be,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function Hp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Gp=0;function Vp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Wp(i){const e=new kp,t=Hp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);const s=new D,r=new pt,o=new pt;function a(c){let h=0,f=0,d=0;for(let w=0;w<9;w++)n.probe[w].set(0,0,0);let p=0,_=0,y=0,m=0,u=0,g=0,x=0,v=0,A=0,E=0,C=0;c.sort(Vp);for(let w=0,S=c.length;w<S;w++){const U=c[w],W=U.color,k=U.intensity,K=U.distance,re=U.shadow&&U.shadow.map?U.shadow.map.texture:null;if(U.isAmbientLight)h+=W.r*k,f+=W.g*k,d+=W.b*k;else if(U.isLightProbe){for(let Z=0;Z<9;Z++)n.probe[Z].addScaledVector(U.sh.coefficients[Z],k);C++}else if(U.isDirectionalLight){const Z=e.get(U);if(Z.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){const le=U.shadow,Y=t.get(U);Y.shadowIntensity=le.intensity,Y.shadowBias=le.bias,Y.shadowNormalBias=le.normalBias,Y.shadowRadius=le.radius,Y.shadowMapSize=le.mapSize,n.directionalShadow[p]=Y,n.directionalShadowMap[p]=re,n.directionalShadowMatrix[p]=U.shadow.matrix,g++}n.directional[p]=Z,p++}else if(U.isSpotLight){const Z=e.get(U);Z.position.setFromMatrixPosition(U.matrixWorld),Z.color.copy(W).multiplyScalar(k),Z.distance=K,Z.coneCos=Math.cos(U.angle),Z.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),Z.decay=U.decay,n.spot[y]=Z;const le=U.shadow;if(U.map&&(n.spotLightMap[A]=U.map,A++,le.updateMatrices(U),U.castShadow&&E++),n.spotLightMatrix[y]=le.matrix,U.castShadow){const Y=t.get(U);Y.shadowIntensity=le.intensity,Y.shadowBias=le.bias,Y.shadowNormalBias=le.normalBias,Y.shadowRadius=le.radius,Y.shadowMapSize=le.mapSize,n.spotShadow[y]=Y,n.spotShadowMap[y]=re,v++}y++}else if(U.isRectAreaLight){const Z=e.get(U);Z.color.copy(W).multiplyScalar(k),Z.halfWidth.set(U.width*.5,0,0),Z.halfHeight.set(0,U.height*.5,0),n.rectArea[m]=Z,m++}else if(U.isPointLight){const Z=e.get(U);if(Z.color.copy(U.color).multiplyScalar(U.intensity),Z.distance=U.distance,Z.decay=U.decay,U.castShadow){const le=U.shadow,Y=t.get(U);Y.shadowIntensity=le.intensity,Y.shadowBias=le.bias,Y.shadowNormalBias=le.normalBias,Y.shadowRadius=le.radius,Y.shadowMapSize=le.mapSize,Y.shadowCameraNear=le.camera.near,Y.shadowCameraFar=le.camera.far,n.pointShadow[_]=Y,n.pointShadowMap[_]=re,n.pointShadowMatrix[_]=U.shadow.matrix,x++}n.point[_]=Z,_++}else if(U.isHemisphereLight){const Z=e.get(U);Z.skyColor.copy(U.color).multiplyScalar(k),Z.groundColor.copy(U.groundColor).multiplyScalar(k),n.hemi[u]=Z,u++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=xe.LTC_FLOAT_1,n.rectAreaLTC2=xe.LTC_FLOAT_2):(n.rectAreaLTC1=xe.LTC_HALF_1,n.rectAreaLTC2=xe.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=f,n.ambient[2]=d;const R=n.hash;(R.directionalLength!==p||R.pointLength!==_||R.spotLength!==y||R.rectAreaLength!==m||R.hemiLength!==u||R.numDirectionalShadows!==g||R.numPointShadows!==x||R.numSpotShadows!==v||R.numSpotMaps!==A||R.numLightProbes!==C)&&(n.directional.length=p,n.spot.length=y,n.rectArea.length=m,n.point.length=_,n.hemi.length=u,n.directionalShadow.length=g,n.directionalShadowMap.length=g,n.pointShadow.length=x,n.pointShadowMap.length=x,n.spotShadow.length=v,n.spotShadowMap.length=v,n.directionalShadowMatrix.length=g,n.pointShadowMatrix.length=x,n.spotLightMatrix.length=v+A-E,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=E,n.numLightProbes=C,R.directionalLength=p,R.pointLength=_,R.spotLength=y,R.rectAreaLength=m,R.hemiLength=u,R.numDirectionalShadows=g,R.numPointShadows=x,R.numSpotShadows=v,R.numSpotMaps=A,R.numLightProbes=C,n.version=Gp++)}function l(c,h){let f=0,d=0,p=0,_=0,y=0;const m=h.matrixWorldInverse;for(let u=0,g=c.length;u<g;u++){const x=c[u];if(x.isDirectionalLight){const v=n.directional[f];v.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),v.direction.sub(s),v.direction.transformDirection(m),f++}else if(x.isSpotLight){const v=n.spot[p];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(m),v.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),v.direction.sub(s),v.direction.transformDirection(m),p++}else if(x.isRectAreaLight){const v=n.rectArea[_];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(m),o.identity(),r.copy(x.matrixWorld),r.premultiply(m),o.extractRotation(r),v.halfWidth.set(x.width*.5,0,0),v.halfHeight.set(0,x.height*.5,0),v.halfWidth.applyMatrix4(o),v.halfHeight.applyMatrix4(o),_++}else if(x.isPointLight){const v=n.point[d];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(m),d++}else if(x.isHemisphereLight){const v=n.hemi[y];v.direction.setFromMatrixPosition(x.matrixWorld),v.direction.transformDirection(m),y++}}}return{setup:a,setupView:l,state:n}}function Ya(i){const e=new Wp(i),t=[],n=[];function s(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function Xp(i){let e=new WeakMap;function t(s,r=0){const o=e.get(s);let a;return o===void 0?(a=new Ya(i),e.set(s,[a])):r>=o.length?(a=new Ya(i),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class $p extends hs{static get type(){return"MeshDepthMaterial"}constructor(e){super(),this.isMeshDepthMaterial=!0,this.depthPacking=Hc,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class qp extends hs{static get type(){return"MeshDistanceMaterial"}constructor(e){super(),this.isMeshDistanceMaterial=!0,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Yp=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Zp(i,e,t){let n=new zo;const s=new pe,r=new pe,o=new ct,a=new $p({depthPacking:Gc}),l=new qp,c={},h=t.maxTextureSize,f={[Bn]:Bt,[Bt]:Bn,[Qe]:Qe},d=new zt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pe},radius:{value:4}},vertexShader:Yp,fragmentShader:Kp}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ct;_.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new ie(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ol;let u=this.type;this.render=function(E,C,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;const w=i.getRenderTarget(),S=i.getActiveCubeFace(),U=i.getActiveMipmapLevel(),W=i.state;W.setBlending(bn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const k=u!==xn&&this.type===xn,K=u===xn&&this.type!==xn;for(let re=0,Z=E.length;re<Z;re++){const le=E[re],Y=le.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",le,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);const me=Y.getFrameExtents();if(s.multiply(me),r.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,Y.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,Y.mapSize.y=r.y)),Y.map===null||k===!0||K===!0){const Le=this.type!==xn?{minFilter:Et,magFilter:Et}:{};Y.map!==null&&Y.map.dispose(),Y.map=new sn(s.x,s.y,Le),Y.map.texture.name=le.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const be=Y.getViewportCount();for(let Le=0;Le<be;Le++){const qe=Y.getViewport(Le);o.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),W.viewport(o),Y.updateMatrices(le,Le),n=Y.getFrustum(),v(C,R,Y.camera,le,this.type)}Y.isPointLightShadow!==!0&&this.type===xn&&g(Y,R),Y.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(w,S,U)};function g(E,C){const R=e.update(y);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new sn(s.x,s.y)),d.uniforms.shadow_pass.value=E.map.texture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(C,null,R,d,y,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value=E.mapSize,p.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(C,null,R,p,y,null)}function x(E,C,R,w){let S=null;const U=R.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(U!==void 0)S=U;else if(S=R.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const W=S.uuid,k=C.uuid;let K=c[W];K===void 0&&(K={},c[W]=K);let re=K[k];re===void 0&&(re=S.clone(),K[k]=re,C.addEventListener("dispose",A)),S=re}if(S.visible=C.visible,S.wireframe=C.wireframe,w===xn?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:f[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,R.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const W=i.properties.get(S);W.light=R}return S}function v(E,C,R,w,S){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&S===xn)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,E.matrixWorld);const k=e.update(E),K=E.material;if(Array.isArray(K)){const re=k.groups;for(let Z=0,le=re.length;Z<le;Z++){const Y=re[Z],me=K[Y.materialIndex];if(me&&me.visible){const be=x(E,me,w,S);E.onBeforeShadow(i,E,C,R,k,be,Y),i.renderBufferDirect(R,null,k,be,E,Y),E.onAfterShadow(i,E,C,R,k,be,Y)}}}else if(K.visible){const re=x(E,K,w,S);E.onBeforeShadow(i,E,C,R,k,re,null),i.renderBufferDirect(R,null,k,re,E,null),E.onAfterShadow(i,E,C,R,k,re,null)}}const W=E.children;for(let k=0,K=W.length;k<K;k++)v(W[k],C,R,w,S)}function A(E){E.target.removeEventListener("dispose",A);for(const R in c){const w=c[R],S=E.target.uuid;S in w&&(w[S].dispose(),delete w[S])}}}const Jp={[kr]:Hr,[Gr]:Xr,[Vr]:$r,[Ti]:Wr,[Hr]:kr,[Xr]:Gr,[$r]:Vr,[Wr]:Ti};function jp(i,e){function t(){let N=!1;const ve=new ct;let q=null;const Q=new ct(0,0,0,0);return{setMask:function(Se){q!==Se&&!N&&(i.colorMask(Se,Se,Se,Se),q=Se)},setLocked:function(Se){N=Se},setClear:function(Se,ge,Ge,dt,bt){bt===!0&&(Se*=dt,ge*=dt,Ge*=dt),ve.set(Se,ge,Ge,dt),Q.equals(ve)===!1&&(i.clearColor(Se,ge,Ge,dt),Q.copy(ve))},reset:function(){N=!1,q=null,Q.set(-1,0,0,0)}}}function n(){let N=!1,ve=!1,q=null,Q=null,Se=null;return{setReversed:function(ge){if(ve!==ge){const Ge=e.get("EXT_clip_control");ve?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT);const dt=Se;Se=null,this.setClear(dt)}ve=ge},getReversed:function(){return ve},setTest:function(ge){ge?Me(i.DEPTH_TEST):I(i.DEPTH_TEST)},setMask:function(ge){q!==ge&&!N&&(i.depthMask(ge),q=ge)},setFunc:function(ge){if(ve&&(ge=Jp[ge]),Q!==ge){switch(ge){case kr:i.depthFunc(i.NEVER);break;case Hr:i.depthFunc(i.ALWAYS);break;case Gr:i.depthFunc(i.LESS);break;case Ti:i.depthFunc(i.LEQUAL);break;case Vr:i.depthFunc(i.EQUAL);break;case Wr:i.depthFunc(i.GEQUAL);break;case Xr:i.depthFunc(i.GREATER);break;case $r:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=ge}},setLocked:function(ge){N=ge},setClear:function(ge){Se!==ge&&(ve&&(ge=1-ge),i.clearDepth(ge),Se=ge)},reset:function(){N=!1,q=null,Q=null,Se=null,ve=!1}}}function s(){let N=!1,ve=null,q=null,Q=null,Se=null,ge=null,Ge=null,dt=null,bt=null;return{setTest:function(it){N||(it?Me(i.STENCIL_TEST):I(i.STENCIL_TEST))},setMask:function(it){ve!==it&&!N&&(i.stencilMask(it),ve=it)},setFunc:function(it,kt,Oe){(q!==it||Q!==kt||Se!==Oe)&&(i.stencilFunc(it,kt,Oe),q=it,Q=kt,Se=Oe)},setOp:function(it,kt,Oe){(ge!==it||Ge!==kt||dt!==Oe)&&(i.stencilOp(it,kt,Oe),ge=it,Ge=kt,dt=Oe)},setLocked:function(it){N=it},setClear:function(it){bt!==it&&(i.clearStencil(it),bt=it)},reset:function(){N=!1,ve=null,q=null,Q=null,Se=null,ge=null,Ge=null,dt=null,bt=null}}}const r=new t,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let h={},f={},d=new WeakMap,p=[],_=null,y=!1,m=null,u=null,g=null,x=null,v=null,A=null,E=null,C=new Be(0,0,0),R=0,w=!1,S=null,U=null,W=null,k=null,K=null;const re=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,le=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(Y)[1]),Z=le>=1):Y.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),Z=le>=2);let me=null,be={};const Le=i.getParameter(i.SCISSOR_BOX),qe=i.getParameter(i.VIEWPORT),nt=new ct().fromArray(Le),ee=new ct().fromArray(qe);function ae(N,ve,q,Q){const Se=new Uint8Array(4),ge=i.createTexture();i.bindTexture(N,ge),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ge=0;Ge<q;Ge++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ve,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,Se):i.texImage2D(ve+Ge,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Se);return ge}const Pe={};Pe[i.TEXTURE_2D]=ae(i.TEXTURE_2D,i.TEXTURE_2D,1),Pe[i.TEXTURE_CUBE_MAP]=ae(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Pe[i.TEXTURE_2D_ARRAY]=ae(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Pe[i.TEXTURE_3D]=ae(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Me(i.DEPTH_TEST),o.setFunc(Ti),$(!1),fe(Qo),Me(i.CULL_FACE),L(bn);function Me(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function I(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function B(N,ve){return f[N]!==ve?(i.bindFramebuffer(N,ve),f[N]=ve,N===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=ve),N===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=ve),!0):!1}function te(N,ve){let q=p,Q=!1;if(N){q=d.get(ve),q===void 0&&(q=[],d.set(ve,q));const Se=N.textures;if(q.length!==Se.length||q[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,Ge=Se.length;ge<Ge;ge++)q[ge]=i.COLOR_ATTACHMENT0+ge;q.length=Se.length,Q=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,Q=!0);Q&&i.drawBuffers(q)}function ce(N){return _!==N?(i.useProgram(N),_=N,!0):!1}const J={[Zn]:i.FUNC_ADD,[mc]:i.FUNC_SUBTRACT,[_c]:i.FUNC_REVERSE_SUBTRACT};J[gc]=i.MIN,J[vc]=i.MAX;const se={[xc]:i.ZERO,[yc]:i.ONE,[Mc]:i.SRC_COLOR,[zr]:i.SRC_ALPHA,[Ac]:i.SRC_ALPHA_SATURATE,[Ec]:i.DST_COLOR,[wc]:i.DST_ALPHA,[Sc]:i.ONE_MINUS_SRC_COLOR,[Br]:i.ONE_MINUS_SRC_ALPHA,[Tc]:i.ONE_MINUS_DST_COLOR,[bc]:i.ONE_MINUS_DST_ALPHA,[Cc]:i.CONSTANT_COLOR,[Rc]:i.ONE_MINUS_CONSTANT_COLOR,[Pc]:i.CONSTANT_ALPHA,[Lc]:i.ONE_MINUS_CONSTANT_ALPHA};function L(N,ve,q,Q,Se,ge,Ge,dt,bt,it){if(N===bn){y===!0&&(I(i.BLEND),y=!1);return}if(y===!1&&(Me(i.BLEND),y=!0),N!==pc){if(N!==m||it!==w){if((u!==Zn||v!==Zn)&&(i.blendEquation(i.FUNC_ADD),u=Zn,v=Zn),it)switch(N){case wi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Or:i.blendFunc(i.ONE,i.ONE);break;case ea:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ta:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case wi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Or:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ea:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ta:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}g=null,x=null,A=null,E=null,C.set(0,0,0),R=0,m=N,w=it}return}Se=Se||ve,ge=ge||q,Ge=Ge||Q,(ve!==u||Se!==v)&&(i.blendEquationSeparate(J[ve],J[Se]),u=ve,v=Se),(q!==g||Q!==x||ge!==A||Ge!==E)&&(i.blendFuncSeparate(se[q],se[Q],se[ge],se[Ge]),g=q,x=Q,A=ge,E=Ge),(dt.equals(C)===!1||bt!==R)&&(i.blendColor(dt.r,dt.g,dt.b,bt),C.copy(dt),R=bt),m=N,w=!1}function Re(N,ve){N.side===Qe?I(i.CULL_FACE):Me(i.CULL_FACE);let q=N.side===Bt;ve&&(q=!q),$(q),N.blending===wi&&N.transparent===!1?L(bn):L(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const Q=N.stencilWrite;a.setTest(Q),Q&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ke(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Me(i.SAMPLE_ALPHA_TO_COVERAGE):I(i.SAMPLE_ALPHA_TO_COVERAGE)}function $(N){S!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),S=N)}function fe(N){N!==fc?(Me(i.CULL_FACE),N!==U&&(N===Qo?i.cullFace(i.BACK):N===dc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):I(i.CULL_FACE),U=N}function _e(N){N!==W&&(Z&&i.lineWidth(N),W=N)}function ke(N,ve,q){N?(Me(i.POLYGON_OFFSET_FILL),(k!==ve||K!==q)&&(i.polygonOffset(ve,q),k=ve,K=q)):I(i.POLYGON_OFFSET_FILL)}function ue(N){N?Me(i.SCISSOR_TEST):I(i.SCISSOR_TEST)}function T(N){N===void 0&&(N=i.TEXTURE0+re-1),me!==N&&(i.activeTexture(N),me=N)}function M(N,ve,q){q===void 0&&(me===null?q=i.TEXTURE0+re-1:q=me);let Q=be[q];Q===void 0&&(Q={type:void 0,texture:void 0},be[q]=Q),(Q.type!==N||Q.texture!==ve)&&(me!==q&&(i.activeTexture(q),me=q),i.bindTexture(N,ve||Pe[N]),Q.type=N,Q.texture=ve)}function z(){const N=be[me];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function X(){try{i.compressedTexImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ce(){try{i.texSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ee(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Je(){try{i.texStorage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function oe(){try{i.texStorage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Te(){try{i.texImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Fe(){try{i.texImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ze(N){nt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),nt.copy(N))}function Ae(N){ee.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),ee.copy(N))}function Ke(N,ve){let q=c.get(ve);q===void 0&&(q=new WeakMap,c.set(ve,q));let Q=q.get(N);Q===void 0&&(Q=i.getUniformBlockIndex(ve,N.name),q.set(N,Q))}function Ve(N,ve){const Q=c.get(ve).get(N);l.get(ve)!==Q&&(i.uniformBlockBinding(ve,Q,N.__bindingPointIndex),l.set(ve,Q))}function rt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},me=null,be={},f={},d=new WeakMap,p=[],_=null,y=!1,m=null,u=null,g=null,x=null,v=null,A=null,E=null,C=new Be(0,0,0),R=0,w=!1,S=null,U=null,W=null,k=null,K=null,nt.set(0,0,i.canvas.width,i.canvas.height),ee.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:Me,disable:I,bindFramebuffer:B,drawBuffers:te,useProgram:ce,setBlending:L,setMaterial:Re,setFlipSided:$,setCullFace:fe,setLineWidth:_e,setPolygonOffset:ke,setScissorTest:ue,activeTexture:T,bindTexture:M,unbindTexture:z,compressedTexImage2D:X,compressedTexImage3D:ne,texImage2D:Te,texImage3D:Fe,updateUBOMapping:Ke,uniformBlockBinding:Ve,texStorage2D:Je,texStorage3D:oe,texSubImage2D:j,texSubImage3D:Ce,compressedTexSubImage2D:de,compressedTexSubImage3D:Ee,scissor:ze,viewport:Ae,reset:rt}}function Ka(i,e,t,n){const s=Qp(n);switch(t){case pl:return i*e;case _l:return i*e;case gl:return i*e*2;case vl:return i*e/s.components*s.byteLength;case Uo:return i*e/s.components*s.byteLength;case xl:return i*e*2/s.components*s.byteLength;case No:return i*e*2/s.components*s.byteLength;case ml:return i*e*3/s.components*s.byteLength;case nn:return i*e*4/s.components*s.byteLength;case Fo:return i*e*4/s.components*s.byteLength;case ks:case Hs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Gs:case Vs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case jr:case eo:return Math.max(i,16)*Math.max(e,8)/4;case Jr:case Qr:return Math.max(i,8)*Math.max(e,8)/2;case to:case no:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case io:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case so:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ro:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case oo:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case ao:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case lo:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case co:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case ho:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case uo:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case fo:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case po:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case mo:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case _o:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case go:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case vo:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Ws:case xo:case yo:return Math.ceil(i/4)*Math.ceil(e/4)*16;case yl:case Mo:return Math.ceil(i/4)*Math.ceil(e/4)*8;case So:case wo:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Qp(i){switch(i){case An:case ul:return{byteLength:1,components:1};case is:case fl:case En:return{byteLength:2,components:1};case Do:case Io:return{byteLength:2,components:4};case ti:case Lo:case Mn:return{byteLength:4,components:1};case dl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function em(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new pe,h=new WeakMap;let f;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,M){return p?new OffscreenCanvas(T,M):ss("canvas")}function y(T,M,z){let X=1;const ne=ue(T);if((ne.width>z||ne.height>z)&&(X=z/Math.max(ne.width,ne.height)),X<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const j=Math.floor(X*ne.width),Ce=Math.floor(X*ne.height);f===void 0&&(f=_(j,Ce));const de=M?_(j,Ce):f;return de.width=j,de.height=Ce,de.getContext("2d").drawImage(T,0,0,j,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+j+"x"+Ce+")."),de}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),T;return T}function m(T){return T.generateMipmaps}function u(T){i.generateMipmap(T)}function g(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(T,M,z,X,ne=!1){if(T!==null){if(i[T]!==void 0)return i[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let j=M;if(M===i.RED&&(z===i.FLOAT&&(j=i.R32F),z===i.HALF_FLOAT&&(j=i.R16F),z===i.UNSIGNED_BYTE&&(j=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.R8UI),z===i.UNSIGNED_SHORT&&(j=i.R16UI),z===i.UNSIGNED_INT&&(j=i.R32UI),z===i.BYTE&&(j=i.R8I),z===i.SHORT&&(j=i.R16I),z===i.INT&&(j=i.R32I)),M===i.RG&&(z===i.FLOAT&&(j=i.RG32F),z===i.HALF_FLOAT&&(j=i.RG16F),z===i.UNSIGNED_BYTE&&(j=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RG8UI),z===i.UNSIGNED_SHORT&&(j=i.RG16UI),z===i.UNSIGNED_INT&&(j=i.RG32UI),z===i.BYTE&&(j=i.RG8I),z===i.SHORT&&(j=i.RG16I),z===i.INT&&(j=i.RG32I)),M===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGB8UI),z===i.UNSIGNED_SHORT&&(j=i.RGB16UI),z===i.UNSIGNED_INT&&(j=i.RGB32UI),z===i.BYTE&&(j=i.RGB8I),z===i.SHORT&&(j=i.RGB16I),z===i.INT&&(j=i.RGB32I)),M===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),z===i.UNSIGNED_INT&&(j=i.RGBA32UI),z===i.BYTE&&(j=i.RGBA8I),z===i.SHORT&&(j=i.RGBA16I),z===i.INT&&(j=i.RGBA32I)),M===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),M===i.RGBA){const Ce=ne?Zs:et.getTransfer(X);z===i.FLOAT&&(j=i.RGBA32F),z===i.HALF_FLOAT&&(j=i.RGBA16F),z===i.UNSIGNED_BYTE&&(j=Ce===lt?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function v(T,M){let z;return T?M===null||M===ti||M===Ri?z=i.DEPTH24_STENCIL8:M===Mn?z=i.DEPTH32F_STENCIL8:M===is&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===ti||M===Ri?z=i.DEPTH_COMPONENT24:M===Mn?z=i.DEPTH_COMPONENT32F:M===is&&(z=i.DEPTH_COMPONENT16),z}function A(T,M){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Et&&T.minFilter!==cn?Math.log2(Math.max(M.width,M.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?M.mipmaps.length:1}function E(T){const M=T.target;M.removeEventListener("dispose",E),R(M),M.isVideoTexture&&h.delete(M)}function C(T){const M=T.target;M.removeEventListener("dispose",C),S(M)}function R(T){const M=n.get(T);if(M.__webglInit===void 0)return;const z=T.source,X=d.get(z);if(X){const ne=X[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&w(T),Object.keys(X).length===0&&d.delete(z)}n.remove(T)}function w(T){const M=n.get(T);i.deleteTexture(M.__webglTexture);const z=T.source,X=d.get(z);delete X[M.__cacheKey],o.memory.textures--}function S(T){const M=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(M.__webglFramebuffer[X]))for(let ne=0;ne<M.__webglFramebuffer[X].length;ne++)i.deleteFramebuffer(M.__webglFramebuffer[X][ne]);else i.deleteFramebuffer(M.__webglFramebuffer[X]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[X])}else{if(Array.isArray(M.__webglFramebuffer))for(let X=0;X<M.__webglFramebuffer.length;X++)i.deleteFramebuffer(M.__webglFramebuffer[X]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let X=0;X<M.__webglColorRenderbuffer.length;X++)M.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[X]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=T.textures;for(let X=0,ne=z.length;X<ne;X++){const j=n.get(z[X]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),o.memory.textures--),n.remove(z[X])}n.remove(T)}let U=0;function W(){U=0}function k(){const T=U;return T>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),U+=1,T}function K(T){const M=[];return M.push(T.wrapS),M.push(T.wrapT),M.push(T.wrapR||0),M.push(T.magFilter),M.push(T.minFilter),M.push(T.anisotropy),M.push(T.internalFormat),M.push(T.format),M.push(T.type),M.push(T.generateMipmaps),M.push(T.premultiplyAlpha),M.push(T.flipY),M.push(T.unpackAlignment),M.push(T.colorSpace),M.join()}function re(T,M){const z=n.get(T);if(T.isVideoTexture&&_e(T),T.isRenderTargetTexture===!1&&T.version>0&&z.__version!==T.version){const X=T.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(z,T,M);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function Z(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){ee(z,T,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function le(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){ee(z,T,M);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function Y(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){ae(z,T,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const me={[Kr]:i.REPEAT,[jn]:i.CLAMP_TO_EDGE,[Zr]:i.MIRRORED_REPEAT},be={[Et]:i.NEAREST,[kc]:i.NEAREST_MIPMAP_NEAREST,[ds]:i.NEAREST_MIPMAP_LINEAR,[cn]:i.LINEAR,[tr]:i.LINEAR_MIPMAP_NEAREST,[Qn]:i.LINEAR_MIPMAP_LINEAR},Le={[Wc]:i.NEVER,[Zc]:i.ALWAYS,[Xc]:i.LESS,[Sl]:i.LEQUAL,[$c]:i.EQUAL,[Kc]:i.GEQUAL,[qc]:i.GREATER,[Yc]:i.NOTEQUAL};function qe(T,M){if(M.type===Mn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===cn||M.magFilter===tr||M.magFilter===ds||M.magFilter===Qn||M.minFilter===cn||M.minFilter===tr||M.minFilter===ds||M.minFilter===Qn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,me[M.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,me[M.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,me[M.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,be[M.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,be[M.minFilter]),M.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Le[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Et||M.minFilter!==ds&&M.minFilter!==Qn||M.type===Mn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function nt(T,M){let z=!1;T.__webglInit===void 0&&(T.__webglInit=!0,M.addEventListener("dispose",E));const X=M.source;let ne=d.get(X);ne===void 0&&(ne={},d.set(X,ne));const j=K(M);if(j!==T.__cacheKey){ne[j]===void 0&&(ne[j]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ne[j].usedTimes++;const Ce=ne[T.__cacheKey];Ce!==void 0&&(ne[T.__cacheKey].usedTimes--,Ce.usedTimes===0&&w(M)),T.__cacheKey=j,T.__webglTexture=ne[j].texture}return z}function ee(T,M,z){let X=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(X=i.TEXTURE_3D);const ne=nt(T,M),j=M.source;t.bindTexture(X,T.__webglTexture,i.TEXTURE0+z);const Ce=n.get(j);if(j.version!==Ce.__version||ne===!0){t.activeTexture(i.TEXTURE0+z);const de=et.getPrimaries(et.workingColorSpace),Ee=M.colorSpace===Fn?null:et.getPrimaries(M.colorSpace),Je=M.colorSpace===Fn||de===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Je);let oe=y(M.image,!1,s.maxTextureSize);oe=ke(M,oe);const Te=r.convert(M.format,M.colorSpace),Fe=r.convert(M.type);let ze=x(M.internalFormat,Te,Fe,M.colorSpace,M.isVideoTexture);qe(X,M);let Ae;const Ke=M.mipmaps,Ve=M.isVideoTexture!==!0,rt=Ce.__version===void 0||ne===!0,N=j.dataReady,ve=A(M,oe);if(M.isDepthTexture)ze=v(M.format===Pi,M.type),rt&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,ze,oe.width,oe.height):t.texImage2D(i.TEXTURE_2D,0,ze,oe.width,oe.height,0,Te,Fe,null));else if(M.isDataTexture)if(Ke.length>0){Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,Ke[0].width,Ke[0].height);for(let q=0,Q=Ke.length;q<Q;q++)Ae=Ke[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Fe,Ae.data):t.texImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Te,Fe,Ae.data);M.generateMipmaps=!1}else Ve?(rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,oe.width,oe.height),N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,oe.width,oe.height,Te,Fe,oe.data)):t.texImage2D(i.TEXTURE_2D,0,ze,oe.width,oe.height,0,Te,Fe,oe.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ve&&rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,ze,Ke[0].width,Ke[0].height,oe.depth);for(let q=0,Q=Ke.length;q<Q;q++)if(Ae=Ke[q],M.format!==nn)if(Te!==null)if(Ve){if(N)if(M.layerUpdates.size>0){const Se=Ka(Ae.width,Ae.height,M.format,M.type);for(const ge of M.layerUpdates){const Ge=Ae.data.subarray(ge*Se/Ae.data.BYTES_PER_ELEMENT,(ge+1)*Se/Ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,ge,Ae.width,Ae.height,1,Te,Ge)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Ae.width,Ae.height,oe.depth,Te,Ae.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,ze,Ae.width,Ae.height,oe.depth,0,Ae.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Ae.width,Ae.height,oe.depth,Te,Fe,Ae.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,ze,Ae.width,Ae.height,oe.depth,0,Te,Fe,Ae.data)}else{Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,Ke[0].width,Ke[0].height);for(let q=0,Q=Ke.length;q<Q;q++)Ae=Ke[q],M.format!==nn?Te!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Ae.data):t.compressedTexImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Fe,Ae.data):t.texImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Te,Fe,Ae.data)}else if(M.isDataArrayTexture)if(Ve){if(rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,ze,oe.width,oe.height,oe.depth),N)if(M.layerUpdates.size>0){const q=Ka(oe.width,oe.height,M.format,M.type);for(const Q of M.layerUpdates){const Se=oe.data.subarray(Q*q/oe.data.BYTES_PER_ELEMENT,(Q+1)*q/oe.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,oe.width,oe.height,1,Te,Fe,Se)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,oe.width,oe.height,oe.depth,Te,Fe,oe.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ze,oe.width,oe.height,oe.depth,0,Te,Fe,oe.data);else if(M.isData3DTexture)Ve?(rt&&t.texStorage3D(i.TEXTURE_3D,ve,ze,oe.width,oe.height,oe.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,oe.width,oe.height,oe.depth,Te,Fe,oe.data)):t.texImage3D(i.TEXTURE_3D,0,ze,oe.width,oe.height,oe.depth,0,Te,Fe,oe.data);else if(M.isFramebufferTexture){if(rt)if(Ve)t.texStorage2D(i.TEXTURE_2D,ve,ze,oe.width,oe.height);else{let q=oe.width,Q=oe.height;for(let Se=0;Se<ve;Se++)t.texImage2D(i.TEXTURE_2D,Se,ze,q,Q,0,Te,Fe,null),q>>=1,Q>>=1}}else if(Ke.length>0){if(Ve&&rt){const q=ue(Ke[0]);t.texStorage2D(i.TEXTURE_2D,ve,ze,q.width,q.height)}for(let q=0,Q=Ke.length;q<Q;q++)Ae=Ke[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Te,Fe,Ae):t.texImage2D(i.TEXTURE_2D,q,ze,Te,Fe,Ae);M.generateMipmaps=!1}else if(Ve){if(rt){const q=ue(oe);t.texStorage2D(i.TEXTURE_2D,ve,ze,q.width,q.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Te,Fe,oe)}else t.texImage2D(i.TEXTURE_2D,0,ze,Te,Fe,oe);m(M)&&u(X),Ce.__version=j.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function ae(T,M,z){if(M.image.length!==6)return;const X=nt(T,M),ne=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+z);const j=n.get(ne);if(ne.version!==j.__version||X===!0){t.activeTexture(i.TEXTURE0+z);const Ce=et.getPrimaries(et.workingColorSpace),de=M.colorSpace===Fn?null:et.getPrimaries(M.colorSpace),Ee=M.colorSpace===Fn||Ce===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Je=M.isCompressedTexture||M.image[0].isCompressedTexture,oe=M.image[0]&&M.image[0].isDataTexture,Te=[];for(let Q=0;Q<6;Q++)!Je&&!oe?Te[Q]=y(M.image[Q],!0,s.maxCubemapSize):Te[Q]=oe?M.image[Q].image:M.image[Q],Te[Q]=ke(M,Te[Q]);const Fe=Te[0],ze=r.convert(M.format,M.colorSpace),Ae=r.convert(M.type),Ke=x(M.internalFormat,ze,Ae,M.colorSpace),Ve=M.isVideoTexture!==!0,rt=j.__version===void 0||X===!0,N=ne.dataReady;let ve=A(M,Fe);qe(i.TEXTURE_CUBE_MAP,M);let q;if(Je){Ve&&rt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ke,Fe.width,Fe.height);for(let Q=0;Q<6;Q++){q=Te[Q].mipmaps;for(let Se=0;Se<q.length;Se++){const ge=q[Se];M.format!==nn?ze!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Ke,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,Ae,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Ke,ge.width,ge.height,0,ze,Ae,ge.data)}}}else{if(q=M.mipmaps,Ve&&rt){q.length>0&&ve++;const Q=ue(Te[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ke,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(oe){Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Te[Q].width,Te[Q].height,ze,Ae,Te[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ke,Te[Q].width,Te[Q].height,0,ze,Ae,Te[Q].data);for(let Se=0;Se<q.length;Se++){const Ge=q[Se].image[Q].image;Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,Ge.width,Ge.height,ze,Ae,Ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Ke,Ge.width,Ge.height,0,ze,Ae,Ge.data)}}else{Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ze,Ae,Te[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ke,ze,Ae,Te[Q]);for(let Se=0;Se<q.length;Se++){const ge=q[Se];Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,ze,Ae,ge.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Ke,ze,Ae,ge.image[Q])}}}m(M)&&u(i.TEXTURE_CUBE_MAP),j.__version=ne.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function Pe(T,M,z,X,ne,j){const Ce=r.convert(z.format,z.colorSpace),de=r.convert(z.type),Ee=x(z.internalFormat,Ce,de,z.colorSpace),Je=n.get(M),oe=n.get(z);if(oe.__renderTarget=M,!Je.__hasExternalTextures){const Te=Math.max(1,M.width>>j),Fe=Math.max(1,M.height>>j);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,j,Ee,Te,Fe,M.depth,0,Ce,de,null):t.texImage2D(ne,j,Ee,Te,Fe,0,Ce,de,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),fe(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,ne,oe.__webglTexture,0,$(M)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,ne,oe.__webglTexture,j),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Me(T,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,T),M.depthBuffer){const X=M.depthTexture,ne=X&&X.isDepthTexture?X.type:null,j=v(M.stencilBuffer,ne),Ce=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=$(M);fe(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,j,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,j,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,j,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ce,i.RENDERBUFFER,T)}else{const X=M.textures;for(let ne=0;ne<X.length;ne++){const j=X[ne],Ce=r.convert(j.format,j.colorSpace),de=r.convert(j.type),Ee=x(j.internalFormat,Ce,de,j.colorSpace),Je=$(M);z&&fe(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je,Ee,M.width,M.height):fe(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je,Ee,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function I(T,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(M.depthTexture);X.__renderTarget=M,(!X.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),re(M.depthTexture,0);const ne=X.__webglTexture,j=$(M);if(M.depthTexture.format===bi)fe(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(M.depthTexture.format===Pi)fe(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function B(T){const M=n.get(T),z=T.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==T.depthTexture){const X=T.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),X){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,X.removeEventListener("dispose",ne)};X.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=X}if(T.depthTexture&&!M.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");I(M.__webglFramebuffer,T)}else if(z){M.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[X]),M.__webglDepthbuffer[X]===void 0)M.__webglDepthbuffer[X]=i.createRenderbuffer(),Me(M.__webglDepthbuffer[X],T,!1);else{const ne=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=M.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,j)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),Me(M.__webglDepthbuffer,T,!1);else{const X=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,ne)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function te(T,M,z){const X=n.get(T);M!==void 0&&Pe(X.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&B(T)}function ce(T){const M=T.texture,z=n.get(T),X=n.get(M);T.addEventListener("dispose",C);const ne=T.textures,j=T.isWebGLCubeRenderTarget===!0,Ce=ne.length>1;if(Ce||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=M.version,o.memory.textures++),j){z.__webglFramebuffer=[];for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[de]=[];for(let Ee=0;Ee<M.mipmaps.length;Ee++)z.__webglFramebuffer[de][Ee]=i.createFramebuffer()}else z.__webglFramebuffer[de]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let de=0;de<M.mipmaps.length;de++)z.__webglFramebuffer[de]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Ce)for(let de=0,Ee=ne.length;de<Ee;de++){const Je=n.get(ne[de]);Je.__webglTexture===void 0&&(Je.__webglTexture=i.createTexture(),o.memory.textures++)}if(T.samples>0&&fe(T)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let de=0;de<ne.length;de++){const Ee=ne[de];z.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[de]);const Je=r.convert(Ee.format,Ee.colorSpace),oe=r.convert(Ee.type),Te=x(Ee.internalFormat,Je,oe,Ee.colorSpace,T.isXRRenderTarget===!0),Fe=$(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Fe,Te,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,z.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),Me(z.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),qe(i.TEXTURE_CUBE_MAP,M);for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ee=0;Ee<M.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[de][Ee],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ee);else Pe(z.__webglFramebuffer[de],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);m(M)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let de=0,Ee=ne.length;de<Ee;de++){const Je=ne[de],oe=n.get(Je);t.bindTexture(i.TEXTURE_2D,oe.__webglTexture),qe(i.TEXTURE_2D,Je),Pe(z.__webglFramebuffer,T,Je,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),m(Je)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let de=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(de=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,X.__webglTexture),qe(de,M),M.mipmaps&&M.mipmaps.length>0)for(let Ee=0;Ee<M.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[Ee],T,M,i.COLOR_ATTACHMENT0,de,Ee);else Pe(z.__webglFramebuffer,T,M,i.COLOR_ATTACHMENT0,de,0);m(M)&&u(de),t.unbindTexture()}T.depthBuffer&&B(T)}function J(T){const M=T.textures;for(let z=0,X=M.length;z<X;z++){const ne=M[z];if(m(ne)){const j=g(T),Ce=n.get(ne).__webglTexture;t.bindTexture(j,Ce),u(j),t.unbindTexture()}}}const se=[],L=[];function Re(T){if(T.samples>0){if(fe(T)===!1){const M=T.textures,z=T.width,X=T.height;let ne=i.COLOR_BUFFER_BIT;const j=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ce=n.get(T),de=M.length>1;if(de)for(let Ee=0;Ee<M.length;Ee++)t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ee=0;Ee<M.length;Ee++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),de){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const Je=n.get(M[Ee]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Je,0)}i.blitFramebuffer(0,0,z,X,0,0,z,X,ne,i.NEAREST),l===!0&&(se.length=0,L.length=0,se.push(i.COLOR_ATTACHMENT0+Ee),T.depthBuffer&&T.resolveDepthBuffer===!1&&(se.push(j),L.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,L)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let Ee=0;Ee<M.length;Ee++){t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const Je=n.get(M[Ee]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,Je,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const M=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function $(T){return Math.min(s.maxSamples,T.samples)}function fe(T){const M=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function _e(T){const M=o.render.frame;h.get(T)!==M&&(h.set(T,M),T.update())}function ke(T,M){const z=T.colorSpace,X=T.format,ne=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||z!==Ii&&z!==Fn&&(et.getTransfer(z)===lt?(X!==nn||ne!==An)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),M}function ue(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=W,this.setTexture2D=re,this.setTexture2DArray=Z,this.setTexture3D=le,this.setTextureCube=Y,this.rebindTextures=te,this.setupRenderTarget=ce,this.updateRenderTargetMipmap=J,this.updateMultisampleRenderTarget=Re,this.setupDepthRenderbuffer=B,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=fe}function tm(i,e){function t(n,s=Fn){let r;const o=et.getTransfer(s);if(n===An)return i.UNSIGNED_BYTE;if(n===Do)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Io)return i.UNSIGNED_SHORT_5_5_5_1;if(n===dl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ul)return i.BYTE;if(n===fl)return i.SHORT;if(n===is)return i.UNSIGNED_SHORT;if(n===Lo)return i.INT;if(n===ti)return i.UNSIGNED_INT;if(n===Mn)return i.FLOAT;if(n===En)return i.HALF_FLOAT;if(n===pl)return i.ALPHA;if(n===ml)return i.RGB;if(n===nn)return i.RGBA;if(n===_l)return i.LUMINANCE;if(n===gl)return i.LUMINANCE_ALPHA;if(n===bi)return i.DEPTH_COMPONENT;if(n===Pi)return i.DEPTH_STENCIL;if(n===vl)return i.RED;if(n===Uo)return i.RED_INTEGER;if(n===xl)return i.RG;if(n===No)return i.RG_INTEGER;if(n===Fo)return i.RGBA_INTEGER;if(n===ks||n===Hs||n===Gs||n===Vs)if(o===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Vs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Jr||n===jr||n===Qr||n===eo)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===jr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===eo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===to||n===no||n===io)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===to||n===no)return o===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===io)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===so||n===ro||n===oo||n===ao||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===_o||n===go||n===vo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===so)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ro)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===oo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ao)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===lo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===co)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ho)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===uo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===fo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===po)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===mo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===_o)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===go)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===vo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ws||n===xo||n===yo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ws)return o===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===xo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===yo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===yl||n===Mo||n===So||n===wo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ws)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Mo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===So)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ri?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class nm extends Xt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ei extends At{constructor(){super(),this.isGroup=!0,this.type="Group"}}const im={type:"move"};class Pr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ei,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ei,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new D,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new D),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ei,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new D,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new D),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const y of e.hand.values()){const m=t.getJointPose(y,n),u=this._getHandJoint(c,y);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const h=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=h.position.distanceTo(f.position),p=.02,_=.005;c.inputState.pinching&&d>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(im)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ei;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const sm=`
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Di.BlurDirectionX=new pe(1,0);Di.BlurDirectionY=new pe(0,1);const r0={spawnDeathParticles(i,e,t=0){let n;switch(t){case 1:n=[16729088,16737792,13382400,16746496,16755200];break;case 2:n=[4500172,6737134,2263210,8974079,11206655];break;case 3:n=[13412864,16768324,16777096,11175936,16777164];break;case 4:n=[6693546,10040319,4460936,11158783,3407667];break;default:n=[8947848,11184810,13421772,6710886,16777215];break}if(t===1){const s=8+Math.floor(Math.random()*4);for(let l=0;l<s;l++){const c=new an(.06+Math.random()*.08,.15,3),h=new ye({color:n[l%n.length],transparent:!0,opacity:.9}),f=new ie(c,h);f.position.set(i,.4+Math.random()*.3,e),f.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,0),this.scene.add(f);const d=Math.random()*Math.PI*2,p=4+Math.random()*5;this.deathParticles.push({mesh:f,vx:Math.cos(d)*p,vy:3+Math.random()*4,vz:Math.sin(d)*p,life:.5+Math.random()*.3})}const r=new $t(.1,.5,16),o=new ye({color:16729088,transparent:!0,opacity:.7,side:Qe}),a=new ie(r,o);a.position.set(i,.1,e),a.rotation.x=-Math.PI/2,this.scene.add(a),this.deathParticles.push({mesh:a,vx:0,vy:0,vz:0,life:.4,isRing:!0,scale:.3})}else if(t===2){const s=6+Math.floor(Math.random()*3);for(let l=0;l<s;l++){const c=new ii(.08+Math.random()*.06,0),h=new ye({color:n[l%n.length],transparent:!0,opacity:.8}),f=new ie(c,h);f.position.set(i,.4,e),this.scene.add(f);const d=l/s*Math.PI*2;this.deathParticles.push({mesh:f,vx:Math.cos(d)*3,vy:2+Math.random()*2,vz:Math.sin(d)*3,life:.6+Math.random()*.2})}const r=new wn(.6,6),o=new ye({color:1717060,transparent:!0,opacity:.35,side:Qe}),a=new ie(r,o);a.position.set(i,.015,e),a.rotation.x=-Math.PI/2,this.scene.add(a),this.deathParticles.push({mesh:a,vx:0,vy:0,vz:0,life:1.5,isRing:!0,scale:1,noScale:!0})}else if(t===3){const s=new Ye(.5,8,8),r=new ye({color:16777130,transparent:!0,opacity:.9}),o=new ie(s,r);o.position.set(i,.5,e),this.scene.add(o),this.deathParticles.push({mesh:o,vx:0,vy:0,vz:0,life:.08,isRing:!0,scale:1,noScale:!0});for(let a=0;a<4;a++){const l=a/4*Math.PI*2+Math.random()*.5,c=[];for(let _=0;_<=4;_++){const y=_*.3,m=_>0&&_<4?(Math.random()-.5)*.25:0;c.push(new D(i+Math.cos(l)*y+Math.sin(l)*m,.3+Math.random()*.1,e+Math.sin(l)*y-Math.cos(l)*m))}const h=new yn(c),f=new en(h,6,.02,3,!1),d=new ye({color:16777028,transparent:!0,opacity:.8}),p=new ie(f,d);this.scene.add(p),this.deathParticles.push({mesh:p,vx:0,vy:0,vz:0,life:.15,isRing:!0,scale:1,noScale:!0})}}else if(t===4){for(let l=0;l<8;l++){const c=l/8*Math.PI*2,h=.8+Math.random()*.4,f=new Ye(.08,5,5),d=new ye({color:n[l%n.length],transparent:!0,opacity:.6}),p=new ie(f,d);p.position.set(i+Math.cos(c)*h,.3,e+Math.sin(c)*h),this.scene.add(p),this.deathParticles.push({mesh:p,vx:-Math.cos(c)*3,vy:.5,vz:-Math.sin(c)*3,life:.4})}const r=new wn(.4,5),o=new ye({color:1703970,transparent:!0,opacity:.3,side:Qe}),a=new ie(r,o);a.position.set(i,.012,e),a.rotation.x=-Math.PI/2,this.scene.add(a),this.deathParticles.push({mesh:a,vx:0,vy:0,vz:0,life:2,isRing:!0,scale:1,noScale:!0})}else for(let r=0;r<8;r++){const o=new Ye(.05+Math.random()*.08,5,5),a=new ye({color:n[r%n.length],transparent:!0,opacity:.7}),l=new ie(o,a);l.position.set(i,.3+Math.random()*.3,e),this.scene.add(l);const c=Math.random()*Math.PI*2;this.deathParticles.push({mesh:l,vx:Math.cos(c)*4,vy:3+Math.random()*3,vz:Math.sin(c)*4,life:.4+Math.random()*.3})}},spawnSlash(i,e,t,n,s,r=25,o=0){const a=t-i,l=n-e,c=Math.atan2(a,l),h=Math.min((r-25)/80,1),f=(s?2.5:1.5)+h*1,d=(s?.6:.3)+h*.3,p=new Wl;p.moveTo(0,f/2),p.lineTo(-d/2,-f/3),p.lineTo(d/2,-f/3),p.closePath();const _=new $o(p);let y;s?y=new Be(16720384):o===1?y=new Be(1,.4+h*.2,0):o===2?y=new Be(.2,.7+h*.3,1):o===3?y=new Be(1,.9-h*.2,.1):o===4?y=new Be(.2,.9-h*.2,.1):y=new Be(.4+h*.3,.8-h*.6,1);const m=new ye({color:y,transparent:!0,opacity:s?1:.8+h*.2,side:Qe,depthWrite:!1}),u=new ie(_,m);if(u.position.set(t,.8,n),u.lookAt(this.camera.position),u.rotateZ(-c+Math.PI+(Math.random()-.5)*.3),this.scene.add(u),this.slashEffects.push({mesh:u,life:.15,maxLife:.15,isCrit:s,expand:!1}),s){const g=o===1?16729088:o===2?52479:o===3?16763904:o===4?4521728:16729088,x=new $t(.2,.5+h*.3,16),v=new ye({color:g,transparent:!0,opacity:.9,side:Qe,depthWrite:!1}),A=new ie(x,v);A.position.set(t,.1,n),A.rotation.x=-Math.PI/2,this.scene.add(A),this.slashEffects.push({mesh:A,life:.25,maxLife:.25,isCrit:!0,expand:!0})}},updateSlashes(i){for(let e=this.slashEffects.length-1;e>=0;e--){const t=this.slashEffects[e];t.life-=i;const n=1-t.life/t.maxLife;if(t.expand){const s=1+n*3;t.mesh.scale.set(s,s,1)}else t.mesh.position.y+=i*2;t.mesh.material.opacity=(1-n*n)*(t.isCrit?1:.85),t.life<=0&&(this.scene.remove(t.mesh),this.slashEffects.splice(e,1))}}},o0={spawnShieldEffect(i,e,t=0){const s={1:16737843,2:6724027,3:14535748,4:7816362,0:8965375}[t]||8965375,r=new ns(1,.05,8,24),o=new ye({color:s,transparent:!0,opacity:.45}),a=new ie(r,o);a.position.set(i,.5,e),a.rotation.x=Math.PI/2,this.scene.add(a),this._shieldRing={mesh:a,life:5,color:s};const l=new ns(1.2,.03,6,20),c=new ye({color:s,transparent:!0,opacity:.2}),h=new ie(l,c);h.position.set(i,.5,e),h.rotation.x=Math.PI/2,this.scene.add(h),this._shieldOuter={mesh:h}},updateShield(i,e,t){if(this._shieldRing){this._shieldRing.life-=t,this._shieldRing.mesh.position.set(i,.5,e),this._shieldRing.mesh.rotation.z+=t*2;const n=this._shieldRing.life;if(this._shieldRing.mesh.material.opacity=n>1?.45:.2+Math.sin(n*15)*.2,this._shieldOuter&&(this._shieldOuter.mesh.position.set(i,.5,e),this._shieldOuter.mesh.rotation.z-=t*1.5,this._shieldOuter.mesh.material.opacity=n>1?.2:.1),n<=0){this.scene.remove(this._shieldRing.mesh),this._shieldOuter&&this.scene.remove(this._shieldOuter.mesh);const s=new $t(.5,2.5,20),r=new ye({color:this._shieldRing.color,transparent:!0,opacity:.5,side:Qe}),o=new ie(s,r);o.position.set(i,.2,e),o.rotation.x=-Math.PI/2,this.scene.add(o),this.deathParticles.push({mesh:o,vx:0,vy:0,vz:0,life:.4,isRing:!0,scale:1}),this._shieldRing=null,this._shieldOuter=null}}},spawnUltimateEffect(i,e,t,n){const r={1:16729088,2:4508927,3:16763904,4:10040319,0:16777215}[t]||16777215,o=new $t(n*.2,n*.85,48),a=new ye({color:r,transparent:!0,opacity:.35,side:Qe}),l=new ie(o,a);switch(l.position.set(i,.08,e),l.rotation.x=-Math.PI/2,this.scene.add(l),this.deathParticles.push({mesh:l,vx:0,vy:0,vz:0,life:1.5,isRing:!0,scale:.3}),t){case 1:for(let c=0;c<12;c++){const h=c/12*Math.PI*2+Math.random()*.3,f=n*(.2+Math.random()*.6),d=.2+Math.random()*.2,p=new Ye(d,6,6),_=new ye({color:[16729088,16737792,16720384,16755200][c%4],transparent:!0,opacity:.5}),y=new ie(p,_);y.position.set(i+Math.cos(h)*f,.1,e+Math.sin(h)*f),this.scene.add(y),this.deathParticles.push({mesh:y,vx:0,vy:6+Math.random()*4,vz:0,life:.6+Math.random()*.3})}for(let c=0;c<16;c++){const h=c/16*Math.PI*2,f=new Ye(.15,5,5),d=new ye({color:16737792,transparent:!0,opacity:.4}),p=new ie(f,d);p.position.set(i,.3,e),this.scene.add(p),this.deathParticles.push({mesh:p,vx:Math.cos(h)*8,vy:1,vz:Math.sin(h)*8,life:.7,isRing:!0,scale:.8})}break;case 2:for(let c=0;c<10;c++){const h=c/10*Math.PI*2,f=n*(.3+Math.random()*.5),d=new ii(.15+Math.random()*.1),p=new ye({color:[8969727,11202303,6737151,16777215][c%4],transparent:!0,opacity:.6}),_=new ie(d,p);_.position.set(i+Math.cos(h)*f,.5+Math.random()*1.5,e+Math.sin(h)*f),this.scene.add(_),this.deathParticles.push({mesh:_,vx:(Math.random()-.5)*2,vy:-3,vz:(Math.random()-.5)*2,life:1})}for(let c=0;c<20;c++){const h=c/20*Math.PI*2,f=new Ye(.12,4,4),d=new ye({color:10088191,transparent:!0,opacity:.3}),p=new ie(f,d);p.position.set(i,.05,e),this.scene.add(p),this.deathParticles.push({mesh:p,vx:Math.cos(h)*6,vy:0,vz:Math.sin(h)*6,life:.9,isRing:!0,scale:.5})}break;case 3:for(let c=0;c<6;c++){const h=c/6*Math.PI*2+Math.random()*.5,f=n*(.15+Math.random()*.5),d=i+Math.cos(h)*f,p=e+Math.sin(h)*f,_=[];for(let E=0;E<=6;E++){const C=5-E/6*5,R=E>0&&E<6?(Math.random()-.5)*.4:0;_.push(new D(d+R,C,p+R))}const y=new yn(_),m=new en(y,8,.04,4,!1),u=new ye({color:16777096,transparent:!0,opacity:.9}),g=new ie(m,u);this.scene.add(g),this.deathParticles.push({mesh:g,vx:0,vy:0,vz:0,life:.15+Math.random()*.1,isRing:!0,scale:1,noScale:!0});const x=new Ye(.25,6,6),v=new ye({color:16777164,transparent:!0,opacity:.8}),A=new ie(x,v);A.position.set(d,.1,p),this.scene.add(A),this.deathParticles.push({mesh:A,vx:0,vy:0,vz:0,life:.2,isRing:!0,scale:.5})}break;case 4:for(let c=0;c<14;c++){const h=c/14*Math.PI*2+Math.random()*.4,f=n*(.1+Math.random()*.7),d=new Ye(.2+Math.random()*.15,5,5),p=new ye({color:[6693546,10040319,4460936,11158783][c%4],transparent:!0,opacity:.35}),_=new ie(d,p);_.position.set(i+Math.cos(h)*f,.1,e+Math.sin(h)*f),this.scene.add(_),this.deathParticles.push({mesh:_,vx:(Math.random()-.5)*1.5,vy:2+Math.random()*2,vz:(Math.random()-.5)*1.5,life:1.2,isRing:!0,scale:.6})}for(let c=0;c<10;c++){const h=c/10*Math.PI*2,f=n*.6,d=new Ye(.08,4,4),p=new ye({color:3407667,transparent:!0,opacity:.5}),_=new ie(d,p);_.position.set(i+Math.cos(h)*f,.05,e+Math.sin(h)*f),this.scene.add(_),this.deathParticles.push({mesh:_,vx:0,vy:3+Math.random()*2,vz:0,life:.5+Math.random()*.3})}break;default:for(let c=0;c<8;c++){const h=c/8*Math.PI*2,f=n*.5,d=new Ye(.1,4,4),p=new ye({color:16777215,transparent:!0,opacity:.6}),_=new ie(d,p);_.position.set(i+Math.cos(h)*f,.2,e+Math.sin(h)*f),this.scene.add(_),this.deathParticles.push({mesh:_,vx:0,vy:4+Math.random()*2,vz:0,life:.8})}}this.hitStop(.1)},spawnAdvancedUltimateEffect(i,e,t,n){const r={1:16729088,2:4508927,3:16763904,4:10040319}[t]||16777215,o=new $t(n*.1,n*.9,64),a=new ye({color:r,transparent:!0,opacity:.5,side:Qe}),l=new ie(o,a);l.position.set(i,.1,e),l.rotation.x=-Math.PI/2,this.scene.add(l),this.deathParticles.push({mesh:l,vx:0,vy:0,vz:0,life:1.8,isRing:!0,scale:.2});const c=new ns(n*.3,.15,8,32),h=new ye({color:16777215,transparent:!0,opacity:.4}),f=new ie(c,h);f.position.set(i,.5,e),f.rotation.x=-Math.PI/2,this.scene.add(f),this.deathParticles.push({mesh:f,vx:0,vy:0,vz:0,life:1.5,isRing:!0,scale:.5});for(let d=0;d<24;d++){const p=d/24*Math.PI*2,_=8+Math.random()*6,y=.15+Math.random()*.15,m=new Ye(y,5,5),u=new ye({color:r,transparent:!0,opacity:.5}),g=new ie(m,u);g.position.set(i,.3,e),this.scene.add(g),this.deathParticles.push({mesh:g,vx:Math.cos(p)*_,vy:1+Math.random()*2,vz:Math.sin(p)*_,life:.6,isRing:!0,scale:.8})}for(let d=0;d<8;d++){const p=d/8*Math.PI*2,_=n*.5,y=new zn(.08,.15,2.5,6),m=new ye({color:r,transparent:!0,opacity:.6}),u=new ie(y,m);u.position.set(i+Math.cos(p)*_,1,e+Math.sin(p)*_),this.scene.add(u),this.deathParticles.push({mesh:u,vx:0,vy:5+Math.random()*3,vz:0,life:.7})}for(let d=0;d<3;d++){const p=new $t(.1,.3,32),_=new ye({color:r,transparent:!0,opacity:.3,side:Qe}),y=new ie(p,_);y.position.set(i,.05+d*.02,e),y.rotation.x=-Math.PI/2,this.scene.add(y),this.deathParticles.push({mesh:y,vx:0,vy:0,vz:0,life:1+d*.3,isRing:!0,scale:.1+d*.2})}this.hitStop(.18)}},a0={spawnSkillEffect(i,e,t,n){switch(t){case 1:this._spawnFireBurst(i,e,n);break;case 2:this._spawnIceShatter(i,e,n);break;case 3:this._spawnLightningChain(i,e,n);break;case 4:this._spawnPoisonCloud(i,e,n);break;default:this._spawnFireBurst(i,e,n);break}},spawnDirectionalEffect(i,e,t,n,s){const r=Math.cos(t),o=-Math.sin(t);switch(n){case 1:this._spawnFireBreath(i,e,r,o,s);break;case 3:this._spawnLightningBolt(i,e,r,o,s);break;case 2:this._spawnIceWave(i,e,r,o,s);break;case 4:this._spawnPoisonMist(i,e,r,o,s);break;default:this._spawnFireBreath(i,e,r,o,s);break}},spawnAdvancedDirectionalEffect(i,e,t,n,s){const r=Math.cos(t),o=-Math.sin(t);switch(n){case 1:this._advFire(i,e,r,o,s);break;case 2:this._advIce(i,e,r,o,s);break;case 3:this._advThunder(i,e,r,o,s);break;case 4:this._advPoison(i,e,r,o,s);break;default:this._advFire(i,e,r,o,s);break}},_advFire(i,e,t,n,s){for(let r=0;r<6;r++){const o=(r+1)/6*s,a=i+t*o,l=e+n*o,c=new zn(.12,.2,1.5+Math.random(),6),h=new ye({color:[16724736,16737792,16729088][r%3],transparent:!0,opacity:.6}),f=new ie(c,h);f.position.set(a,.75,l),this.scene.add(f),this.deathParticles.push({mesh:f,vx:0,vy:3,vz:0,life:.4+r*.05});const d=new $t(.05,.25,8),p=new ye({color:4460800,transparent:!0,opacity:.4,side:Qe}),_=new ie(d,p);_.position.set(a,.02,l),_.rotation.x=-Math.PI/2,this.scene.add(_),this.deathParticles.push({mesh:_,vx:0,vy:0,vz:0,life:.8,isRing:!0,scale:.8,noScale:!0})}for(let r=0;r<10;r++){const o=Math.random()*s,a=(Math.random()-.5)*1,l=-n,c=t,h=new Ye(.04,3,3),f=new ye({color:16755200,transparent:!0,opacity:.7}),d=new ie(h,f);d.position.set(i+t*o+l*a,.3,e+n*o+c*a),this.scene.add(d),this.deathParticles.push({mesh:d,vx:(Math.random()-.5)*2,vy:3+Math.random()*3,vz:(Math.random()-.5)*2,life:.5})}},_advIce(i,e,t,n,s){for(let r=0;r<3;r++){const o=(r-1)*.4,a=-n,l=t,c=i+a*o,h=e+l*o,f=new kn(.08,.08,s*.7),d=new ye({color:[8974079,11206655,6741503][r],transparent:!0,opacity:.7}),p=new ie(f,d),_=s*.35;p.position.set(c+t*_,.4,h+n*_),p.rotation.y=-Math.atan2(n,t),this.scene.add(p),this.deathParticles.push({mesh:p,vx:t*18,vy:0,vz:n*18,life:.35,isRing:!0,scale:1,noScale:!0})}for(let r=0;r<12;r++){const o=Math.random()*s*.8,a=(Math.random()-.5)*1.2,l=-n,c=t,h=new ii(.06),f=new ye({color:13434879,transparent:!0,opacity:.5}),d=new ie(h,f);d.position.set(i+t*o+l*a,.2+Math.random()*.3,e+n*o+c*a),this.scene.add(d),this.deathParticles.push({mesh:d,vx:t*2,vy:-1,vz:n*2,life:.6})}},_advThunder(i,e,t,n,s){const r=[];for(let g=0;g<=10;g++){const x=g/10*s,v=g>0&&g<10?(Math.random()-.5)*.15:0,A=-n,E=t;r.push(new D(i+t*x+A*v,.4,e+n*x+E*v))}const o=new yn(r),a=new en(o,12,.12,6,!1),l=new ye({color:16776960,transparent:!0,opacity:.9}),c=new ie(a,l);this.scene.add(c),this.deathParticles.push({mesh:c,vx:0,vy:0,vz:0,life:.25,isRing:!0,scale:1,noScale:!0});const h=new en(o,12,.04,4,!1),f=new ye({color:16777215,transparent:!0,opacity:1}),d=new ie(h,f);this.scene.add(d),this.deathParticles.push({mesh:d,vx:0,vy:0,vz:0,life:.2,isRing:!0,scale:1,noScale:!0});for(let g=-1;g<=1;g+=2){const x=[],v=-n*g,A=t*g;for(let R=0;R<=5;R++){const w=R/5*s*.8,S=Math.sin(R*1.5)*.4;x.push(new D(i+t*w+v*(.3+S),.35+Math.random()*.1,e+n*w+A*(.3+S)))}const E=new yn(x),C=new ie(new en(E,6,.025,3,!1),new ye({color:11193599,transparent:!0,opacity:.6}));this.scene.add(C),this.deathParticles.push({mesh:C,vx:0,vy:0,vz:0,life:.15,isRing:!0,scale:1,noScale:!0})}const p=i+t*s,_=e+n*s,y=new Ye(.4,8,8),m=new ye({color:16777130,transparent:!0,opacity:.8}),u=new ie(y,m);u.position.set(p,.4,_),this.scene.add(u),this.deathParticles.push({mesh:u,vx:0,vy:0,vz:0,life:.2,isRing:!0,scale:.5})},_advPoison(i,e,t,n,s){for(let r=0;r<14;r++){const o=(r/13-.5)*2.2,a=t*Math.cos(o)-n*Math.sin(o),l=t*Math.sin(o)+n*Math.cos(o),c=.15+Math.random()*.2,h=new Ye(c,5,5),f=[6693546,10040319,4460936,7812044,2271812],d=new ye({color:f[r%5],transparent:!0,opacity:.4}),p=new ie(h,d);p.position.set(i+a*.5,.15,e+l*.5),this.scene.add(p),this.deathParticles.push({mesh:p,vx:a*7,vy:.5,vz:l*7,life:.7,isRing:!0,scale:.7})}for(let r=0;r<5;r++){const o=(r+1)/5*s*.6,a=new $t(.1,.3+Math.random()*.2,8),l=new ye({color:3394611,transparent:!0,opacity:.3,side:Qe}),c=new ie(a,l);c.position.set(i+t*o+(Math.random()-.5)*.5,.02,e+n*o+(Math.random()-.5)*.5),c.rotation.x=-Math.PI/2,this.scene.add(c),this.deathParticles.push({mesh:c,vx:0,vy:0,vz:0,life:1.2,isRing:!0,scale:.5})}},_spawnFireBreath(i,e,t,n,s){for(let r=0;r<8;r++){const o=(r/7-.5)*1.6,a=t*Math.cos(o)-n*Math.sin(o),l=t*Math.sin(o)+n*Math.cos(o),c=.15+Math.random()*.15,h=new Ye(c,6,6),f=[16737792,16729088,13378048,16746496],d=new ye({color:f[r%4],transparent:!0,opacity:.35}),p=new ie(h,d);p.position.set(i+a*.8,.3,e+l*.8),this.scene.add(p),this.deathParticles.push({mesh:p,vx:a*5,vy:.1,vz:l*5,life:.5,isRing:!0,scale:1})}},_spawnLightningBolt(i,e,t,n,s){const r=[];for(let m=0;m<=8;m++){const u=m/8*s,g=m>0&&m<8?(Math.random()-.5)*.5:0,x=-n,v=t;r.push(new D(i+t*u+x*g,.4,e+n*u+v*g))}const o=new yn(r),a=new en(o,10,.05,4,!1),l=new ye({color:16777062,transparent:!0,opacity:.8}),c=new ie(a,l);this.scene.add(c),this.deathParticles.push({mesh:c,vx:0,vy:0,vz:0,life:.18,isRing:!0,scale:1,noScale:!0});const h=[];for(let m=0;m<=6;m++){const u=m/6*s*.85,g=(Math.random()-.5)*.7,x=-n,v=t;h.push(new D(i+t*u+x*g,.5,e+n*u+v*g))}const f=new yn(h),d=new ie(new en(f,8,.025,3,!1),new ye({color:16777215,transparent:!0,opacity:.6}));this.scene.add(d),this.deathParticles.push({mesh:d,vx:0,vy:0,vz:0,life:.12,isRing:!0,scale:1,noScale:!0});const p=i+t*s,_=e+n*s,y=new ie(new Ye(.2,6,6),new ye({color:16777130,transparent:!0,opacity:.7}));y.position.set(p,.4,_),this.scene.add(y),this.deathParticles.push({mesh:y,vx:0,vy:0,vz:0,life:.12,isRing:!0,scale:1,noScale:!0})},_spawnIceWave(i,e,t,n,s){for(let r=0;r<7;r++){const o=(r/6-.5)*1.4,a=t*Math.cos(o)-n*Math.sin(o),l=t*Math.sin(o)+n*Math.cos(o),c=.12+Math.random()*.1,h=new Ye(c,6,6),f=new ye({color:5605546,transparent:!0,opacity:.3}),d=new ie(h,f);d.position.set(i+a*.6,.2,e+l*.6),this.scene.add(d),this.deathParticles.push({mesh:d,vx:a*5,vy:.1,vz:l*5,life:.45,isRing:!0,scale:1})}},_spawnPoisonMist(i,e,t,n,s){for(let r=0;r<6;r++){const o=(r/5-.5)*1.2,a=t*Math.cos(o)-n*Math.sin(o),l=t*Math.sin(o)+n*Math.cos(o),c=.12+Math.random()*.12,h=new Ye(c,5,5),f=new ye({color:2228275,transparent:!0,opacity:.2}),d=new ie(h,f);d.position.set(i+a*.5,.15,e+l*.5),this.scene.add(d),this.deathParticles.push({mesh:d,vx:a*3,vy:.05,vz:l*3,life:.7,isRing:!0,scale:1})}},_spawnFireBurst(i,e,t){const n=new $t(.3,t*.8,24),s=new ye({color:16729088,transparent:!0,opacity:.7,side:Qe}),r=new ie(n,s);r.position.set(i,.15,e),r.rotation.x=-Math.PI/2,this.scene.add(r),this.deathParticles.push({mesh:r,vx:0,vy:0,vz:0,life:.4,isRing:!0,scale:.3});for(let o=0;o<10;o++){const a=Math.random()*Math.PI*2,l=new Ye(.08+Math.random()*.06,4,4),c=new ye({color:Math.random()>.5?16737792:16763904,transparent:!0,opacity:.9}),h=new ie(l,c);h.position.set(i,.5,e),this.scene.add(h),this.deathParticles.push({mesh:h,vx:Math.cos(a)*5,vy:2+Math.random()*3,vz:Math.sin(a)*5,life:.5})}},_spawnIceShatter(i,e,t){for(let o=0;o<5;o++){const a=o/5*Math.PI*2,l=new an(.04,.2,4),c=new ye({color:6724010,transparent:!0,opacity:.4}),h=new ie(l,c);h.position.set(i,.3,e),h.rotation.z=a,this.scene.add(h),this.deathParticles.push({mesh:h,vx:Math.cos(a)*2.5,vy:.8,vz:Math.sin(a)*2.5,life:.4})}const n=new wn(t*.4,16),s=new ye({color:3364198,transparent:!0,opacity:.15,side:Qe}),r=new ie(n,s);r.position.set(i,.05,e),r.rotation.x=-Math.PI/2,this.scene.add(r),this.deathParticles.push({mesh:r,vx:0,vy:0,vz:0,life:.8,isRing:!0,scale:1})},_spawnLightningChain(i,e,t){for(let o=0;o<5;o++){const a=Math.random()*Math.PI*2,l=t*.5+Math.random()*t*.5,c=[],h=4+Math.floor(Math.random()*3);for(let y=0;y<=h;y++){const m=y/h,u=y>0&&y<h?(Math.random()-.5)*.8:0;c.push(new D(i+Math.cos(a)*l*m+u,.5+Math.random()*.5,e+Math.sin(a)*l*m+u))}const f=new yn(c),d=new en(f,8,.03,4,!1),p=new ye({color:16777028,transparent:!0,opacity:.9}),_=new ie(d,p);this.scene.add(_),this.deathParticles.push({mesh:_,vx:0,vy:0,vz:0,life:.2+Math.random()*.15,isRing:!0,scale:1})}const n=new Ye(.3,8,8),s=new ye({color:16777130,transparent:!0,opacity:.8}),r=new ie(n,s);r.position.set(i,.6,e),this.scene.add(r),this.deathParticles.push({mesh:r,vx:0,vy:0,vz:0,life:.15,isRing:!0,scale:1})},_spawnPoisonCloud(i,e,t){for(let n=0;n<3;n++){const s=(Math.random()-.5)*1,r=(Math.random()-.5)*1,o=.08+Math.random()*.1,a=new Ye(o,4,4),l=[3342404,1703987,4456550,2228258],c=new ye({color:l[n%4],transparent:!0,opacity:.2+Math.random()*.1}),h=new ie(a,c);h.position.set(i+s,.2+Math.random()*.3,e+r),this.scene.add(h),this.deathParticles.push({mesh:h,vx:(Math.random()-.5)*.3,vy:.3,vz:(Math.random()-.5)*.3,life:.8+Math.random()*.4,isRing:!0,scale:1})}},spawnGroundDecal(i,e,t=0){const s={1:{color:3346688,shape:"scorch"},2:{color:1717060,shape:"frost"},3:{color:3351040,shape:"crack"},4:{color:1703970,shape:"corrosion"}}[t]||{color:1710618,shape:"scorch"};let r;if(s.shape==="frost"){const o=new wn(.5+Math.random()*.3,6),a=new ye({color:s.color,transparent:!0,opacity:.3,side:Qe});r=new ie(o,a)}else if(s.shape==="crack"){const o=[],a=.6+Math.random()*.4,l=Math.random()*Math.PI*2;for(let d=0;d<=4;d++){const p=d/4*a,_=d>0&&d<4?(Math.random()-.5)*.2:0;o.push(new D(Math.cos(l)*p+Math.sin(l)*_,0,Math.sin(l)*p-Math.cos(l)*_))}const c=new yn(o),h=new en(c,6,.02,3,!1),f=new ye({color:5587968,transparent:!0,opacity:.4,side:Qe});r=new ie(h,f)}else if(s.shape==="corrosion"){const o=new wn(.3+Math.random()*.2,5+Math.floor(Math.random()*3)),a=new ye({color:s.color,transparent:!0,opacity:.25,side:Qe});r=new ie(o,a)}else{const o=new wn(.35+Math.random()*.25,8),a=new ye({color:s.color,transparent:!0,opacity:.3,side:Qe});r=new ie(o,a)}r.position.set(i,.015,e),r.rotation.x=-Math.PI/2,r.rotation.z=Math.random()*Math.PI*2,this.scene.add(r),this.deathParticles.push({mesh:r,vx:0,vy:0,vz:0,life:2+Math.random()*1,isRing:!0,scale:1,noScale:!0})},spawnDashDecal(i,e,t=0){const s={1:2232576,2:1122867,3:2236928,4:1114146}[t]||1118481,r=new ln(.2,.2),o=new ye({color:s,transparent:!0,opacity:.2,side:Qe}),a=new ie(r,o);a.position.set(i,.012,e),a.rotation.x=-Math.PI/2,a.rotation.z=Math.random()*Math.PI,this.scene.add(a),this.deathParticles.push({mesh:a,vx:0,vy:0,vz:0,life:1,isRing:!0,scale:1,noScale:!0})}};class Ql{constructor(e){this.scene=new fm,this.clock=new Kl,this.renderer=new um({canvas:e,antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=al;const t=window.innerWidth/window.innerHeight;this.camera=new Xt(50,t,.1,200),this.camera.position.set(50,12,60),this.camera.lookAt(50,0,50),window.addEventListener("resize",()=>{const x=window.innerWidth,v=window.innerHeight;this.camera.aspect=x/v,this.camera.updateProjectionMatrix(),this.renderer.setSize(x,v),this.composer.setSize(x,v)}),this.scene.background=new Be(592660);const n=new Jm(10070732,.6);this.scene.add(n);const s=new Zm(14544639,1);s.position.set(10,25,10),s.castShadow=!0,s.shadow.mapSize.set(2048,2048),s.shadow.camera.left=-30,s.shadow.camera.right=30,s.shadow.camera.top=30,s.shadow.camera.bottom=-30,this.scene.add(s);const r=new qm(3359846,1118498,.4);this.scene.add(r),this.playerLight=new Os(14477567,3,12),this.playerLight.position.set(50,3,50),this.scene.add(this.playerLight);const o=new ln(120,120,40,40),a=o.attributes.position;for(let x=0;x<a.count;x++)a.setZ(x,(Math.random()-.5)*.08);const l=new _t({color:1581104,roughness:.92,metalness:.05}),c=new ie(o,l);c.rotation.x=-Math.PI/2,c.position.set(50,0,50),c.receiveShadow=!0,this.scene.add(c);const h=new $t(10,10.3,64),f=new ye({color:1713203,transparent:!0,opacity:.25,side:Qe}),d=new ie(h,f);d.rotation.x=-Math.PI/2,d.position.set(50,.01,50),this.scene.add(d);const p=new ye({color:1713203,transparent:!0,opacity:.15,side:Qe});for(let x=0;x<4;x++){const v=new ln(.15,8),A=new ie(v,p);A.rotation.x=-Math.PI/2,A.rotation.z=x*Math.PI/4,A.position.set(50,.01,50),this.scene.add(A)}const _=new zn(.25,.35,1.8,5),y=new _t({color:1713203,roughness:.95}),m=[[35,35],[65,35],[35,65],[65,65],[30,50],[70,50],[50,30],[50,70]];for(const[x,v]of m){const A=new ie(_,y);A.position.set(x,.9,v),A.castShadow=!0,this.scene.add(A);const E=new an(.3,.3,5),C=new ie(E,y);C.position.set(x,1.85,v),C.rotation.x=Math.PI,this.scene.add(C)}this.scene.fog=new Ho(592660,.008),this.composer=new n0(this.renderer),this.composer.addPass(new i0(this.scene,this.camera));const u=new Di(new pe(window.innerWidth,window.innerHeight),.4,.8,.85);this.composer.addPass(u);const g={uniforms:{tDiffuse:{value:null},darkness:{value:.25},offset:{value:1}},vertexShader:"varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }",fragmentShader:`
        uniform sampler2D tDiffuse;
...
---
\`sig:${$}\` | *UNPLUG: Elemental Survivor*`,ke=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(fe)}&body=${encodeURIComponent(_e)}&labels=record`;window.open(ke,"_blank")}),(Me=document.getElementById("retry-btn"))==null||Me.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",P=new Zi,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]}),window._restartGame=()=>{P=new Zi,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]};const o={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",I=>{const B=o[I.code]||I.key.toLowerCase();if(I.code==="Space"&&I.preventDefault(),I.code==="Space"&&!P.level_up_pending()&&!P.is_paused()&&P.player_dash_cooldown()<=0&&je.playDash(),I.code==="Escape"){P.toggle_pause();const te=P.is_paused();document.getElementById("pause-menu").style.display=te?"flex":"none",te&&C();return}if(I.code==="Tab"){I.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(P.on_key_down(B),P.level_up_pending()){const te=P.player_class_tier();if(B==="1"){const ce=$i(P.level_up_choice(0));P.choose_upgrade(0),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}if(B==="2"){const ce=$i(P.level_up_choice(1));P.choose_upgrade(1),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}if(B==="3"){const ce=$i(P.level_up_choice(2));P.choose_upgrade(2),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}}}),document.addEventListener("keyup",I=>{const B=o[I.code]||I.key.toLowerCase();P.on_key_up(B)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",I=>I.preventDefault()),document.addEventListener("contextmenu",I=>{t&&I.preventDefault()}),a.addEventListener("selectstart",I=>I.preventDefault());let l=null,c=!1,h=null,f=[],d=null,p=null;a.addEventListener("mousedown",I=>{if(!(!t||!P))if(I.preventDefault(),I.button===0){if(l={x:I.clientX,y:I.clientY,button:0},f=[{x:I.clientX,y:I.clientY}],c=!1,Xi.clear(),Xi.addPoint(I.clientX,I.clientY),g(),document.body.style.cursor="crosshair",!document.getElementById("gesture-desaturate")){const B=document.createElement("div");B.id="gesture-desaturate",B.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.15);pointer-events:none;z-index:990;transition:opacity 0.1s",document.body.appendChild(B)}}else I.button===2&&P.player_class_tier()>=2&&(l={x:I.clientX,y:I.clientY,button:2},f=[{x:I.clientX,y:I.clientY}],c=!1,g())}),document.addEventListener("mousemove",I=>{if(!l)return;const B=I.clientX-l.x,te=I.clientY-l.y,ce=Math.sqrt(B*B+te*te);if(f.push({x:I.clientX,y:I.clientY}),v(f),ce>20){c=!0;const J=_(f,l);if(!p){const ue=document.createElement("canvas");ue.width=window.innerWidth,ue.height=window.innerHeight,ue.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(ue),p=ue}const se=p.getContext("2d");if(se.clearRect(0,0,p.width,p.height),f.length>2){const ue=gt(),T={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};se.strokeStyle=T[ue]||T[0],se.lineWidth=3,se.lineCap="round",se.beginPath(),se.moveTo(f[0].x,f[0].y);for(let M=1;M<f.length;M++)se.lineTo(f[M].x,f[M].y);se.stroke(),J==="circle"&&(se.strokeStyle="rgba(255,200,0,0.7)",se.lineWidth=5,se.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),d||(d=document.createElement("div"),d.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(d));const L=Math.min(50+ce*.4,100),Re=gt(),$=l.button===2,_e=($?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[Re]||($?"#ccaaff":"#8888ff");h.style.width=L+"px",h.style.height=L+"px",h.style.borderColor=_e,h.style.boxShadow=`0 0 ${L/4}px ${_e}, inset 0 0 ${L/6}px ${_e}`;const ke={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=ke[J]||"...",e&&e.camera){const ue=e.projectToScreen(P.player_x(),.5,P.player_z());if(h.style.left=ue.x-L/2+"px",h.style.top=ue.y-L/2+"px",J==="outward"){const T=Math.atan2(te,B),M=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let z=Math.round(T/(Math.PI/4));z<0&&(z+=8),z=z%8,d.textContent=M[z],d.style.fontSize="32px";const X=50;d.style.left=ue.x+Math.cos(T)*X-16+"px",d.style.top=ue.y+Math.sin(T)*X-16+"px",d.style.opacity="1"}else J==="inward"?(d.textContent="🛡️",d.style.fontSize="28px",d.style.left=ue.x-14+"px",d.style.top=ue.y-14+"px",d.style.opacity="1"):J==="circle"?(d.textContent="🌀",d.style.left=ue.x-14+"px",d.style.top=ue.y-40+"px",d.style.opacity="1"):(d.style.opacity="0.3",d.textContent="?")}}}),document.addEventListener("mouseup",I=>{if(!l||!P){l=null;return}const B=I.clientX-l.x,te=I.clientY-l.y,ce=Math.sqrt(B*B+te*te),J=l.button;document.body.style.cursor="";const se=document.getElementById("gesture-desaturate");if(se&&se.remove(),A(),h&&(h.remove(),h=null),d&&(d.remove(),d=null),p&&(p.remove(),p=null),x(),J===0&&P.player_class_tier()>0)if(c&&ce>30){const L=_(f,l),Re=Math.atan2(-te,B);if(L==="outward"){if(P.player_class_tier()>0&&!m(20)){l=null,c=!1,f=[];return}P.use_directional_skill(Re);const $=gt(),fe=document.createElement("div"),_e={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};fe.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${_e[$]||_e[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(fe),setTimeout(()=>fe.remove(),150),e.spawnDirectionalEffect(P.player_x(),P.player_z(),Re,$,7),e.hitStop(.04),e.shake(.3,.1),e.zoomPunch(1,.12),window._onboardingActive&&s(),$===1?je.playElementFire():$===2?je.playElementIce():$===3?je.playElementThunder():$===4?je.playElementPoison():je.playHit(),E("outward")}else if(L==="inward")P.use_shield_skill(),je.playShield(),e.spawnShieldEffect(P.player_x(),P.player_z(),gt()),e.shake(.15,.05),E("inward");else if(L==="circle"){if(P.player_class_tier()>0&&!m(50)){l=null,c=!1,f=[];return}P.use_ultimate_skill(),je.playUltimate(gt());const $=gt();e.spawnUltimateEffect(P.player_x(),P.player_z(),$,10),e.hitStop(.12),e.shake(.8,.25),E("circle");const fe={0:"rgba(255,255,255,0.4)",1:"rgba(255,80,0,0.35)",2:"rgba(50,180,255,0.35)",3:"rgba(255,200,0,0.35)",4:"rgba(150,50,255,0.35)"},_e=document.createElement("div");_e.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${fe[$]||fe[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(_e),setTimeout(()=>_e.remove(),400);const ke=document.createElement("div");ke.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(ke),setTimeout(()=>ke.remove(),600),window._onboardingActive&&s()}else if(L==="zigzag"){if(P.player_class_tier()>0&&!m(35)){l=null,c=!1,f=[];return}const $=gt();for(let fe=-1;fe<=1;fe++){const _e=Math.atan2(-te,B)+fe*.4;setTimeout(()=>{P.use_directional_skill(_e),e.spawnDirectionalEffect(P.player_x(),P.player_z(),_e,$,5)},fe*80+80)}e.hitStop(.06),e.shake(.4,.15),je.playElementThunder(),E("zigzag")}else if(L==="vshape"){if(P.player_class_tier()>0&&!m(25)){l=null,c=!1,f=[];return}P.use_shield_skill();const $=gt();e.spawnShieldEffect(P.player_x(),P.player_z(),$),setTimeout(()=>{const fe=Math.atan2(-te,B);P.use_directional_skill(fe),e.spawnDirectionalEffect(P.player_x(),P.player_z(),fe,$,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),je.playShield(),E("vshape")}else if(L==="upstroke"){if(P.player_class_tier()>0&&!m(30)){l=null,c=!1,f=[];return}const $=Math.atan2(-te,B);P.use_directional_skill($);const fe=gt();e.spawnDirectionalEffect(P.player_x(),P.player_z(),$,fe,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),fe===1?je.playElementFire():fe===2?je.playElementIce():fe===3?je.playElementThunder():je.playHit(),E("upstroke")}else P.use_directional_skill(Math.atan2(-te,B)),e.shake(.1,.05)}else c||P.use_active_skill();else if(J===2&&P.player_class_tier()>=2)if(c&&ce>30){const L=_(f,l),Re=Math.atan2(-te,B);if(L==="outward"){if(!m(20)){l=null,c=!1,f=[];return}P.use_directional_skill(Re);const $=gt();e.spawnAdvancedDirectionalEffect(P.player_x(),P.player_z(),Re,$,9),je.playAdvancedSkill($),e.shake(.55,.15),E("outward")}else if(L==="circle"){if(!m(50)){l=null,c=!1,f=[];return}const $=gt();P.use_ultimate_skill(),je.playAdvancedUltimate($),e.spawnAdvancedUltimateEffect(P.player_x(),P.player_z(),$,12),e.shake(.9,.3),E("circle");const fe=document.createElement("div");fe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",fe.style.background=$===1?"rgba(255,100,0,0.3)":$===2?"rgba(100,200,255,0.3)":$===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(fe),setTimeout(()=>fe.remove(),400),e.shake(.7,.25),E("circle")}else P.use_active_skill(),e.shake(.3,.1),E("outward")}else c||(P.use_active_skill(),e.spawnSkillEffect(P.player_x(),P.player_z(),gt(),4),e.shake(.25,.08));l=null,c=!1,f=[]});function _(I,B){if(I.length<5)return"unknown";const te=I[I.length-1],ce=te.x-B.x,J=te.y-B.y,se=Math.sqrt(ce*ce+J*J);if(I.length>30){let L=0;for(let $=2;$<I.length;$++){const fe=I[$-1].x-I[$-2].x,_e=I[$-1].y-I[$-2].y,ke=I[$].x-I[$-1].x,ue=I[$].y-I[$-1].y,T=fe*ue-_e*ke,M=fe*ke+_e*ue;L+=Math.atan2(T,M)}const Re=Math.sqrt((te.x-B.x)**2+(te.y-B.y)**2);if(Math.abs(L)>Math.PI*1.9&&Re<120)return"circle"}if(I.length>15){let L=0,Re=0;for(let $=3;$<I.length;$+=3){const fe=I[$].x-I[$-3].x;Re!==0&&Math.sign(fe)!==Math.sign(Re)&&Math.abs(fe)>10&&L++,Math.abs(fe)>10&&(Re=fe)}if(L>=3&&se<200)return"zigzag"}if(I.length>10){let L=0;for(let $=1;$<I.length;$++)I[$].y>I[L].y&&(L=$);const Re=L/I.length;if(Re>.25&&Re<.75){const $=I[L].y-B.y,fe=I[L].y-te.y;if($>40&&fe>40&&se<150)return"vshape"}}if(se>60&&J<-50&&Math.abs(ce)<Math.abs(J)*.5)return"upstroke";if(e&&e.camera){const L=e.projectToScreen(P.player_x(),.5,P.player_z()),Re=Math.sqrt((B.x-L.x)**2+(B.y-L.y)**2),$=Math.sqrt((te.x-L.x)**2+(te.y-L.y)**2);if($<Re-20)return"inward";if($>Re+20)return"outward"}return se>40?"outward":"unknown"}function y(){const I=document.getElementById("stamina-bar-bg");if(!I)return;I.style.border="2px solid #ff4444";const B=document.createElement("div");B.textContent="Not enough mana",B.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(B),setTimeout(()=>{B.remove(),I.style.border="1px solid #2a4a2a"},1e3)}function m(I){return P.player_stamina()<I?(y(),!1):!0}let u=null;function g(){u||(u=document.createElement("div"),u.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",u.innerHTML=`
        ...
        `,document.body.appendChild(u))}function x(){u&&(u.remove(),u=null)}function v(I){Xi.setStyle(P.player_class_tier(),gt());const B=I[I.length-1];B&&Xi.addPoint(B.x,B.y)}function A(){const I=f.length>5?_(f,l||{x:0,y:0}):"unknown";Xi.release(I)}function E(I){const B=P.learned_skill_count();if(B===0)return;let te="",ce="#fff";if(I==="outward"){for(let se=0;se<B;se++)if(P.learned_skill_type(se)===0){te=P.learned_skill_name(se);break}ce="#ff8844"}else if(I==="inward"){for(let se=0;se<B;se++)if(P.learned_skill_type(se)===1){te=P.learned_skill_name(se);break}te||(te="Shield"),ce="#44ff88"}else if(I==="circle"){for(let se=0;se<B;se++)if(P.learned_skill_type(se)===2){te=P.learned_skill_name(se);break}te||(te="Ultimate"),ce="#ffcc00"}else I==="zigzag"?(te="Chain Strike",ce="#ffdd44"):I==="vshape"?(te="Parry Counter",ce="#88ffaa"):I==="upstroke"&&(te="Pierce",ce="#ff66aa");te||(te="Skill");const J=document.createElement("div");J.textContent=I==="circle"?`✨ ${te} ✨`:te,J.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${ce};font-size:${I==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${ce},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(J),setTimeout(()=>J.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{P.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function C(){let I="<b>📜 Status</b><br><br>";const B=P.fire_level(),te=P.ice_level(),ce=P.thunder_level(),J=P.poison_level();I+="<b>⚗️ Element Orbs</b><br>",B>0&&(I+=`  🔥 Fire: ${B}<br>`),te>0&&(I+=`  ❄️ Ice: ${te}<br>`),ce>0&&(I+=`  ⚡ Thunder: ${ce}<br>`),J>0&&(I+=`  ☠️ Poison: ${J}<br>`),B+te+ce+J===0&&(I+='  <span style="color:#666">None</span><br>');const se=P.player_class_tier();if(se>0){I+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[se]||""} ${P.player_class_name()}</b> (Tier ${se})<br>`;const Re=P.learned_skill_count();if(Re>0){I+="<br><b>🗡️ Class Skills</b><br>";for(let $=0;$<Re;$++){const fe=P.learned_skill_name($),_e=P.learned_skill_level($);I+=`  📈 ${fe} <span style="color:#ffcc00">Lv.${_e}</span><br>`}}}else I+='<br><span style="color:#666">Reach Lv.2 for first promotion</span><br>',I+='<span style="color:#555;font-size:10px">Collect element orbs to meet requirements</span>';if(se===0||se===1||se===2){const L=se===0?10:se===1?25:45;P.player_level()<L&&(I+=`<br><br><span style="color:#888;font-size:10px">Next promotion: Lv.${L}</span>`)}document.getElementById("pause-skills").innerHTML=I}for(let I=0;I<3;I++)document.getElementById(`choice-${I}`).addEventListener("click",()=>{const B=P.level_up_choice(I),te=$i(B),ce=P.player_class_tier();P.choose_upgrade(I);const J=P.player_class_tier();if(J>ce)U(J);else{S(te);const se=P.player_x(),L=P.player_z();if(B>=50&&B<=53){const Re=B-49;e.spawnDirectionalEffect(se,L,0,Re,4),e.spawnGroundDecal(se,L,Re),e.zoomPunch(.8,.1)}else B>=60&&e.spawnDeathParticles(se,L,gt())}w()});function R(){const I=document.getElementById("levelup");I.style.display="block",I.classList.add("shown");for(let te=0;te<3;te++){const ce=P.level_up_choice(te),J=$i(ce),se=m0(ce);let L="";if(ce>=50&&ce<=53){const $=ce-50+1,fe=[0,P.fire_level(),P.ice_level(),P.thunder_level(),P.poison_level()][$],_e=P.player_class_tier()===0?1:4,ke=Math.max(0,_e-fe-1);ke===0?L='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':L=`<span style="color:#555;font-size:10px">→ ${ke} more to promote</span>`}else ce>=100&&(L=`<span style="color:#daa520;font-size:10px">${Wt.star(10)} Class change!</span>`);const Re=ce>=50&&ce<=53?Fr(ce-49,18):ce>=100?Wt.star(18):"";document.getElementById(`choice-${te}`).innerHTML=`
          ...
          `}let B=document.getElementById("levelup-hint");B||(B=document.createElement("div"),B.id="levelup-hint",B.style.cssText="color:#daa520;font-size:11px;margin-top:10px;text-align:center;opacity:0.8",I.appendChild(B)),P.player_class_tier()===0&&P.player_level()<=4?(B.textContent="Choose element orbs to unlock class promotion",B.style.display="block"):B.style.display="none"}function w(){const I=document.getElementById("levelup");I.style.display="none",I.classList.remove("shown"),K=!1,je.playPickup()}function S(I){const B=gt(),ce={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[B]||"#daa520",J=document.createElement("div");J.style.cssText="position:fixed;top:18%;left:50%;transform:translateX(-50%) scale(0.8);z-index:9998;pointer-events:none;text-align:center;opacity:0;transition:all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",J.innerHTML=`<div style="font-size:14px;color:#fff;text-shadow:0 0 8px ${ce};background:rgba(0,0,0,0.8);padding:8px 20px;border-radius:20px;border:1px solid ${ce}44;font-family:'Inter',sans-serif">${Fr(B,14)} ${I}</div>`,document.body.appendChild(J),requestAnimationFrame(()=>{J.style.opacity="1",J.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{J.style.opacity="0",J.style.transform="translateX(-50%) scale(0.9) translateY(-10px)"},1400),setTimeout(()=>J.remove(),1800);const se=document.createElement("div");se.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ce}11;pointer-events:none;z-index:990;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(se),setTimeout(()=>se.remove(),400)}function U(I){const B=gt(),te=P.player_class_name()||"",J={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[B]||"#daa520";e.hitStop(.3);const se=document.createElement("div");se.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:9998;
          ...
          pointer-events:none;z-index:9997;transition:all 0.6s ease-out`,document.body.appendChild(L),requestAnimationFrame(()=>{L.style.width="300px",L.style.height="300px"}),setTimeout(()=>{const Re=["","CLASS PROMOTION","ADVANCED CLASS","MASTER CLASS"],$=document.createElement("div");$.style.cssText=`position:fixed;top:38%;left:50%;transform:translate(-50%,-50%) scale(0.5);
            ...
            <div style="font-size:14px;color:#aaa;margin-top:12px;opacity:0.8">${Fr(B,16)} New abilities unlocked</div>
          `,document.body.appendChild($),requestAnimationFrame(()=>{$.style.opacity="1",$.style.transform="translate(-50%,-50%) scale(1)"}),setTimeout(()=>{$.style.opacity="0",$.style.transform="translate(-50%,-50%) scale(1.1)"},1800),setTimeout(()=>$.remove(),2300)},400),setTimeout(()=>{const Re=document.createElement("div");Re.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${J}55;
            pointer-events:none;z-index:9999;animation:flash-fade 0.5s ease-out forwards`,document.body.appendChild(Re),setTimeout(()=>Re.remove(),500),e.shake(.6,.25),e.zoomPunch(3,.2),je.playLevelUp(),setTimeout(()=>je.playShield(),100)},800),setTimeout(()=>{B===1?P.use_ultimate_skill():B===2?P.use_shield_skill():B===3||B===4?P.use_ultimate_skill():P.use_directional_skill(0),e.spawnUltimateEffect(P.player_x(),P.player_z(),B,12),e.shake(.3,.15)},1200),setTimeout(()=>{se.style.boxShadow="inset 0 0 0 0 rgba(0,0,0,0)",L.style.opacity="0",setTimeout(()=>{se.remove(),L.remove()},500)},2e3)}const W=[];let k="",K=!1;function re(){const I=P.player_promoted(),B=I?P.player_class_name():"",te={1:"⭐",2:"🌟",3:"👑"},ce=P.player_class_tier(),J=te[ce]||"";document.getElementById("level").textContent=P.player_level()+(B?` ${J}${B}`:"");const se=gt(),L=document.getElementById("portrait"),Re={0:Wt.sword(24),1:Wt.fire(24),2:Wt.ice(24),3:Wt.thunder(24),4:Wt.poison(24)},$={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"};L.innerHTML=Re[se]||Wt.sword(24),L.style.borderColor=$[se]||"#555",I?L.style.boxShadow=`0 0 10px ${$[se]}`:L.style.boxShadow="none";const fe=Math.max(0,P.player_hp()/P.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=fe+"%";const _e=Math.max(0,P.player_shield()/P.player_max_hp()*100),ke=document.getElementById("shield-bar-fill");ke.style.width=_e+"%",ke.style.left=fe+"%";const ue=P.player_xp()/P.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=ue+"%";const T=document.getElementById("stat-panel"),M=P.player_class_tier(),z=P.fire_level(),X=P.ice_level(),ne=P.thunder_level(),j=P.poison_level(),Ce=P.element_total();let de=document.getElementById("promo-hud");if(de||(de=document.createElement("div"),de.id="promo-hud",de.style.cssText="margin-top:6px;font-size:11px;color:#8a8680;line-height:1.5;background:rgba(8,6,12,0.85);padding:4px 8px;border-radius:4px;border:1px solid rgba(218,165,32,0.15);max-width:170px;backdrop-filter:blur(4px)",document.getElementById("stats").appendChild(de)),M<3){const Oe=M===0?1:M===1?4:7,st=M===0?2:M===1?4:7,It=P.player_level()>=st,vt=P.promotion_available_count()>0;let yt;vt?yt="⭐ PROMOTION READY! (Level up to choose)":It?yt=`Need ${Oe} of same element (${Ce} total)`:yt=`Next: Lv${st} + ${Oe} orbs (${Ce}/${Oe})`,de.innerHTML=`<span style="color:${z>0?"#ff4400":"#333"}">${Wt.fire(12,z>0?"#ff4400":"#333")}${z}</span> <span style="color:${X>0?"#44ccff":"#333"}">${Wt.ice(12,X>0?"#44ccff":"#333")}${X}</span> <span style="color:${ne>0?"#ffcc00":"#333"}">${Wt.thunder(12,ne>0?"#ffcc00":"#333")}${ne}</span> <span style="color:${j>0?"#9933ff":"#333"}">${Wt.poison(12,j>0?"#9933ff":"#333")}${j}</span><br><span style="color:${vt?"#daa520":"#666"};font-size:10px">${yt}</span>`,de.style.display="block"}else de.style.display="none";T&&(T.style.display=window._showDetailStats?"block":"none",window._showDetailStats&&(T.innerHTML=`ATK <span style="color:#ff8844">${Math.round(P.player_damage())}</span><br>SPD <span style="color:#44ccff">${P.player_atk_speed().toFixed(1)}/s</span><br>RNG <span style="color:#88ff44">${P.player_range().toFixed(1)}</span><br>CRT <span style="color:#ff4488">${Math.round(P.player_crit()*100)}%</span><br>PRC <span style="color:#ffcc44">${P.player_pierce()}</span> ×<span style="color:#44ffcc">${P.player_multi()}</span><br>STEAL <span style="color:#ff44ff">${Math.round(P.player_lifesteal()*100)}%</span>`));const Ee={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},Je={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},oe={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},Te=P.skill_slot_count(),Fe=P.learned_skill_count();let ze="";for(let Oe=0;Oe<Te;Oe++)ze+=P.skill_slot_id(Oe)+":"+P.skill_slot_level(Oe)+",";ze+="|"+Fe;for(let Oe=0;Oe<Fe;Oe++)ze+=P.learned_skill_id(Oe)+":"+P.learned_skill_level(Oe)+",";if(ze!==k){k=ze;let Oe="";for(let st=0;st<Te;st++){const It=P.skill_slot_id(st),vt=P.skill_slot_level(st),yt=Ee[It]||"⭐",Rt=Je[It]||"#888",si=oe[It]||"Skill";Oe+=`<div class="skill-icon" style="background:${Rt}22;border-color:${Rt}">
              ${yt}<span class="sk-lvl">${vt}</span>
              <div class="sk-tooltip"><b style="color:${Rt}">${si} Lv.${vt}</b></div>
            </div>`}if(Fe>0){Oe+='<div style="width:2px;height:28px;background:#333;margin:0 4px"></div>';for(let st=0;st<Fe;st++){const It=P.learned_skill_name(st),vt=P.learned_skill_level(st),yt=P.learned_skill_desc(st),Rt=P.learned_skill_type(st),si=Rt===0?"⚔️":Rt===1?"🛡️":"💫",ri=Rt===0?"AUTO":Rt===1?"PASSIVE":"ULT",Hn=Rt===0?"#44ccff":Rt===1?"#44ff44":"#ffcc00";Oe+=`<div class="skill-icon class-skill" data-skill-idx="${st}" style="background:${Hn}15;border-color:${Hn}">
                ${si}<span class="sk-lvl" style="color:${Hn}">${vt}</span>
                <div class="sk-cd-overlay"></div>
                <div class="sk-tooltip"><b style="color:${Hn}">${It} Lv.${vt}</b><br><span style="color:#888">[${ri}]</span> ${yt}</div>
              </div>`}}document.getElementById("skill-slots").innerHTML=Oe,document.querySelectorAll(".skill-icon").forEach(st=>{st.addEventListener("click",It=>{const vt=st.classList.contains("active-tip");document.querySelectorAll(".skill-icon").forEach(yt=>yt.classList.remove("active-tip")),vt||st.classList.add("active-tip"),It.stopPropagation()})})}document.querySelectorAll(".class-skill").forEach(Oe=>{const st=parseInt(Oe.dataset.skillIdx);if(isNaN(st))return;const It=P.learned_skill_cd(st),vt=P.learned_skill_max_cd(st),yt=Oe.querySelector(".sk-cd-overlay");if(yt)if(It>0){const Rt=It/vt;yt.style.background=`conic-gradient(rgba(0,0,0,0.7) ${Rt*360}deg, transparent ${Rt*360}deg)`,yt.style.display="block"}else yt.style.display="none"});const Ae=Math.floor(P.game_time()),Ke=Math.floor(Ae/60),Ve=Ae%60;document.getElementById("timer").textContent=`${Ke}:${Ve.toString().padStart(2,"0")}`;const rt=P.wave_number(),N=rt>0&&rt%10===0;if(document.getElementById("kills").textContent=N?`⚠️ WAVE 0 — BOSS ⚠️ | ${P.kills()} kills`:`Wave ${rt} | ${P.kills()} kills`,N&&!window._bossShown){window._bossShown=!0;const Oe=document.createElement("div");Oe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,0,0,0.4);pointer-events:none;z-index:9999;transition:opacity 1s",document.body.appendChild(Oe),setTimeout(()=>{Oe.style.opacity="0"},200),setTimeout(()=>Oe.remove(),1200);const st=document.createElement("div");st.style.cssText="position:fixed;top:40%;left:50%;transform:translate(-50%,-50%);z-index:9999;pointer-events:none;text-align:center;animation:promo-pop 2s ease-out forwards",st.innerHTML='<div style="font-size:42px;color:#ff2200;text-shadow:0 0 30px #ff0000,0 0 60px #880000;font-weight:bold">💀 BOSS 💀</div><div style="font-size:18px;color:#ffaa00;margin-top:8px">ALL ENEMIES CLEARED — DUEL!</div>',document.body.appendChild(st),setTimeout(()=>st.remove(),2500),e.shake(.8,.3),e.hitStop(.2),je.playUltimate(1)}else N||(window._bossShown=!1);if(P.boss_active()){let Oe=document.getElementById("boss-bar");Oe||(Oe=document.createElement("div"),Oe.id="boss-bar",Oe.style.cssText="position:fixed;top:50px;left:50%;transform:translateX(-50%);width:300px;text-align:center;z-index:100",Oe.innerHTML='<div style="color:#ff4444;font-size:12px;margin-bottom:4px">💀 BOSS</div><div style="width:100%;height:10px;background:#333;border-radius:5px;border:1px solid #ff4444"><div id="boss-hp-fill" style="height:100%;background:linear-gradient(90deg,#ff2222,#ff6644);border-radius:4px;transition:width 0.1s"></div></div>',document.body.appendChild(Oe)),document.getElementById("boss-hp-fill").style.width=P.boss_hp_pct()*100+"%"}else{const Oe=document.getElementById("boss-bar");Oe&&Oe.remove()}P.level_up_pending()&&!K&&(R(),K=!0,je.playLevelUp()),P.wave_event_pending()&&!P.level_up_pending()&&!window._waveEventShown&&(window._waveEventShown=!0,u0(P)),P.wave_event_pending()||(window._waveEventShown=!1),f0(P);let ve;for(;(ve=P.pop_log())!==void 0;)W.push(ve),W.length>4&&W.shift();document.getElementById("log").textContent=W.join(`
`);const q=P.player_dash_cooldown(),Q=document.getElementById("dash-bar"),Se=document.getElementById("dash-cd-text"),ge=P.player_dash_type(),Ge={1:"🔥 BLINK",2:"❄️ SKATE",3:"⚡ DASH×3",4:"☠️ SMOKE",5:"💨 DASH"},dt={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44",5:"#44ccff"},it={1:3,2:0,3:.8,4:4,5:2}[ge]||2;if(document.querySelector("#dash-ui span").textContent=Ge[ge]||"💨 DASH",ge===2)Q.style.width="100%",Q.style.background="#44ccff",Se.textContent="+40% SPD";else if(ge===3){const Oe=P.player_dash_charges();Q.style.width=Oe/3*100+"%",Q.style.background=Oe>0?"#ffcc00":"#333",Se.textContent=`⚡${Oe}/3`}else q>0?(Q.style.width=Math.max(0,(1-q/it)*100)+"%",Q.style.background="#666",Se.textContent=q.toFixed(1)+"s"):(Q.style.width="100%",Q.style.background=dt[ge]||"#44ccff",Se.textContent="READY");const kt=document.getElementById("stamina-bar-bg");if(P.player_class_tier()>0){kt.style.display="block";const Oe=P.player_stamina()/P.player_max_stamina()*100;document.getElementById("stamina-bar-fill").style.width=Oe+"%"}}function Z(I,B,te,ce){const J=document.createElement("div");J.className="dmg-popup"+(ce?" crit":""),J.textContent=Math.round(te);const se=ce?18:13,L=Math.min(12,Math.floor(te/30));if(J.style.fontSize=se+L+"px",document.getElementById("game-canvas"),e&&e.camera){const Re=e.projectToScreen(I,1.8,B);J.style.left=Re.x+"px",J.style.top=Re.y-20+"px"}else J.style.left=window.innerWidth/2+"px",J.style.top=window.innerHeight/2-50+"px";document.body.appendChild(J),setTimeout(()=>J.remove(),900)}function le(I){c0(I)}let Y=0,me=!1,be=0,Le=0;function qe(I){let B=document.getElementById("combo-display");B||(B=document.createElement("div"),B.id="combo-display",B.style.cssText="position:fixed;top:45%;right:20px;pointer-events:none;z-index:999;text-align:right;transition:opacity 0.3s,transform 0.2s",document.body.appendChild(B));const te=Math.min(20+I*.8,40),ce=I>=30?"#ff44ff":I>=20?"#ffcc00":I>=10?"#ff8844":"#44ff88";let J="";I===5?J='<div style="font-size:10px;color:#888;margin-top:2px">♪ rhythm up</div>':I===10?J='<div style="font-size:10px;color:#ffcc00;margin-top:2px">✦ XP range +</div>':I===20?J='<div style="font-size:10px;color:#ff8844;margin-top:2px">✦ mana regen</div>':I===30&&(J='<div style="font-size:10px;color:#ff44ff;margin-top:2px">✦✦ ELEMENTAL BURST</div>'),B.innerHTML=`<div style="font-size:${te}px;color:${ce};font-weight:bold;text-shadow:0 0 6px ${ce};font-family:monospace;line-height:1">${I}</div><div style="font-size:10px;color:#666;letter-spacing:1px">COMBO</div>${J}`,B.style.opacity="1",B.style.transform="scale(1.1)",setTimeout(()=>{B.style.transform="scale(1)"},100),clearTimeout(B._fadeTimer),B._fadeTimer=setTimeout(()=>{B.style.opacity="0"},2e3)}function nt(I){const B=Y?(I-Y)/1e3:.016;if(Y=I,!t){requestAnimationFrame(nt);return}Le>0&&(Le-=B,Le<=0&&(be=0)),!P.player_alive()&&!me&&(me=!0,le(P)),c&&l?(window._gestureFrameSkip||(window._gestureFrameSkip=0),window._gestureFrameSkip++,window._gestureFrameSkip%3!==0||P.update(I)):(window._gestureFrameSkip=0,P.update(I));const te=[],ce=P.enemy_count();for(let $=0;$<ce;$++)te.push({x:P.enemy_x($),z:P.enemy_z($),type:P.enemy_type($),hit:P.enemy_hit($)});const J=[],se=P.bullet_count();for(let $=0;$<se;$++)J.push({x:P.bullet_x($),z:P.bullet_z($)});const L=[],Re=P.orb_count();for(let $=0;$<Re;$++)L.push({x:P.orb_x($),z:P.orb_z($),type:P.orb_type($)});if(!P.level_up_pending()){const $=P.damage_event_count(),fe=P.player_x(),_e=P.player_z(),ke=P.player_damage(),ue=gt();let T=!1;for(let X=0;X<$;X++){const ne=P.damage_event_x(X),j=P.damage_event_z(X),Ce=P.damage_event_crit(X);Ce&&(T=!0),Z(ne,j,P.damage_event_amount(X),Ce),e.spawnSlash(fe,_e,ne,j,Ce,ke,ue),X===0&&(Ce?je.playCrit():ue===1?je.playElementFire():ue===2?je.playElementIce():ue===3?je.playElementThunder():ue===4?je.playElementPoison():je.playHit())}T?(e.shake(.4,.12),e.hitStop(.04)):$>=3&&e.shake(.2,.08);const M=P.death_event_count();for(let X=0;X<M;X++)if(e.spawnDeathParticles(P.death_event_x(X),P.death_event_z(X),gt()),e.spawnGroundDecal(P.death_event_x(X),P.death_event_z(X),gt()),X===0)je.playDeath();else if(X<4)try{je.playDeath()}catch{}if(M>0){const X=Math.min(.03+M*.015,.1);if(e.hitStop(X),e.shake(Math.min(.15+M*.08,.5),Math.min(.08+M*.01,.15)),be+=M,Le=2,be>=5&&qe(be),M>=3){const ne=document.createElement("div");ne.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.08);pointer-events:none;z-index:997;animation:flash-fade 0.2s ease-out forwards",document.body.appendChild(ne),setTimeout(()=>ne.remove(),200)}}const z=P.skill_event_count();for(let X=0;X<z;X++)e.spawnSkillEffect(P.skill_event_x(X),P.skill_event_z(X),P.skill_event_element(X),P.skill_event_range(X))}e._shieldRing&&P.player_shield()<=0?(e.scene.remove(e._shieldRing.mesh),e._shieldOuter&&e.scene.remove(e._shieldOuter.mesh),e._shieldRing=null,e._shieldOuter=null):e.updateShield&&e.updateShield(P.player_x(),P.player_z(),B/1e3),e.update({playerX:P.player_x(),playerZ:P.player_z(),playerMoving:P.player_moving(),playerDirX:P.player_dir_x(),playerDirZ:P.player_dir_z(),playerHit:P.player_hit(),playerAttacking:P.player_attacking(),playerDashing:P.player_dashing(),dashType:P.player_dash_type(),hp:P.player_hp(),maxHp:P.player_max_hp(),nearestEnemyDirX:P.nearest_enemy_dir_x(),element:gt(),elementLevel:P.active_element_level(),fireLv:P.fire_level(),iceLv:P.ice_level(),thunderLv:P.thunder_level(),poisonLv:P.poison_level(),bossActive:P.boss_active(),bossX:P.boss_x(),bossZ:P.boss_z(),bossHpPct:P.boss_hp_pct(),promoted:P.player_promoted(),enemies:te,bullets:J,orbs:L},B),re(),requestAnimationFrame(nt)}requestAnimationFrame(nt)}_0().catch(i=>{document.body.innerHTML=`<pre style="color:red;padding:20px">FATAL: ${i}
${i.stack||""}</pre>`});
