...
`].filter(Li).join(`
`)),a=ca(a),a=Do(a,t),a=Io(a,t),o=ca(o),o=Do(o,t),o=Io(o,t),a=Uo(a),o=Uo(o),t.isRawShaderMaterial!==!0&&(g=`#version 300 es
...
`)+`
`+f);const x=g+m+a,v=g+f+o,C=Co(s,s.VERTEX_SHADER,x),b=Co(s,s.FRAGMENT_SHADER,v);s.attachShader(y,C),s.attachShader(y,b),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(D){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(y).trim(),k=s.getShaderInfoLog(C).trim(),Y=s.getShaderInfoLog(b).trim();let ne=!0,$=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(ne=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,C,b);else{const oe=Lo(s,C,"vertex"),A=Lo(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
