...
`)+`
`+f);const x=v+m+a,g=v+f+o,R=Co(r,r.VERTEX_SHADER,x),b=Co(r,r.FRAGMENT_SHADER,g);r.attachShader(y,R),r.attachShader(y,b),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(D){if(i.debug.checkShaderErrors){const X=r.getProgramInfoLog(y).trim(),V=r.getShaderInfoLog(R).trim(),Y=r.getShaderInfoLog(b).trim();let te=!0,C=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,y,R,b);else{const H=Lo(r,R,"vertex"),I=Lo(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
}`;function Up(i,e,t){let n=new Ma;const r=new ve,s=new ve,a=new tt,o=new Pp({depthPacking:bl}),c=new Lp,l={},u=t.maxTextureSize,h={[Sn]:Ct,[Ct]:Sn,[ft]:ft},d=new En({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ve},radius:{value:4}},vertexShader:Dp,fragmentShader:Ip}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new St;_.setAttribute("position",new $t(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new Re(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zo;let f=this.type;this.render=function(b,A,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const T=i.getRenderTarget(),S=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),X=i.state;X.setBlending(yn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const V=f!==sn&&this.type===sn,Y=f===sn&&this.type!==sn;for(let te=0,C=b.length;te<C;te++){const H=b[te],I=H.shadow;if(I===void 0){console.warn("THREE.WebGLShadowMap:",H,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;r.copy(I.mapSize);const j=I.getFrameExtents();if(r.multiply(j),s.copy(I.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/j.x),r.x=s.x*j.x,I.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/j.y),r.y=s.y*j.y,I.mapSize.y=s.y)),I.map===null||V===!0||Y===!0){const Z=this.type!==sn?{minFilter:bt,magFilter:bt}:{};I.map!==null&&I.map.dispose(),I.map=new Hn(r.x,r.y,Z),I.map.texture.name=H.name+".shadowMap",I.camera.updateProjectionMatrix()}i.setRenderTarget(I.map),i.clear();const q=I.getViewportCount();for(let Z=0;Z<q;Z++){const le=I.getViewport(Z);a.set(s.x*le.x,s.y*le.y,s.x*le.z,s.y*le.w),X.viewport(a),I.updateMatrices(H,Z),n=I.getFrustum(),g(A,L,I.camera,H,this.type)}I.isPointLightShadow!==!0&&this.type===sn&&v(I,L),I.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(T,S,D)};function v(b,A){const L=e.update(y);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Hn(r.x,r.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(A,null,L,d,y,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(A,null,L,p,y,null)}function x(b,A,L,T){let S=null;const D=L.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(D!==void 0)S=D;else if(S=L.isPointLight===!0?c:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const X=S.uuid,V=A.uuid;let Y=l[X];Y===void 0&&(Y={},l[X]=Y);let te=Y[V];te===void 0&&(te=S.clone(),Y[V]=te,A.addEventListener("dispose",R)),S=te}if(S.visible=A.visible,S.wireframe=A.wireframe,T===sn?S.side=A.shadowSide!==null?A.shadowSide:A.side:S.side=A.shadowSide!==null?A.shadowSide:h[A.side],S.alphaMap=A.alphaMap,S.alphaTest=A.alphaTest,S.map=A.map,S.clipShadows=A.clipShadows,S.clippingPlanes=A.clippingPlanes,S.clipIntersection=A.clipIntersection,S.displacementMap=A.displacementMap,S.displacementScale=A.displacementScale,S.displacementBias=A.displacementBias,S.wireframeLinewidth=A.wireframeLinewidth,S.linewidth=A.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const X=i.properties.get(S);X.light=L}return S}function g(b,A,L,T,S){if(b.visible===!1)return;if(b.layers.test(A.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&S===sn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,b.matrixWorld);const V=e.update(b),Y=b.material;if(Array.isArray(Y)){const te=V.groups;for(let C=0,H=te.length;C<H;C++){const I=te[C],j=Y[I.materialIndex];if(j&&j.visible){const q=x(b,j,T,S);b.onBeforeShadow(i,b,A,L,V,q,I),i.renderBufferDirect(L,null,V,q,b,I),b.onAfterShadow(i,b,A,L,V,q,I)}}}else if(Y.visible){const te=x(b,Y,T,S);b.onBeforeShadow(i,b,A,L,V,te,null),i.renderBufferDirect(L,null,V,te,b,null),b.onAfterShadow(i,b,A,L,V,te,null)}}const X=b.children;for(let V=0,Y=X.length;V<Y;V++)g(X[V],A,L,T,S)}function R(b){b.target.removeEventListener("dispose",R);for(const L in l){const T=l[L],S=b.target.uuid;S in T&&(T[S].dispose(),delete T[S])}}}const Np={[Ts]:bs,[ws]:Cs,[As]:Ps,[hi]:Rs,[bs]:Ts,[Cs]:ws,[Ps]:As,[Rs]:hi};function Fp(i,e){function t(){let N=!1;const de=new tt;let $=null;const ee=new tt(0,0,0,0);return{setMask:function(ge){$!==ge&&!N&&(i.colorMask(ge,ge,ge,ge),$=ge)},setLocked:function(ge){N=ge},setClear:function(ge,me,Be,lt,xt){xt===!0&&(ge*=lt,me*=lt,Be*=lt),de.set(ge,me,Be,lt),ee.equals(de)===!1&&(i.clearColor(ge,me,Be,lt),ee.copy(de))},reset:function(){N=!1,$=null,ee.set(-1,0,0,0)}}}function n(){let N=!1,de=!1,$=null,ee=null,ge=null;return{setReversed:function(me){if(de!==me){const Be=e.get("EXT_clip_control");de?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT);const lt=ge;ge=null,this.setClear(lt)}de=me},getReversed:function(){return de},setTest:function(me){me?ae(i.DEPTH_TEST):fe(i.DEPTH_TEST)},setMask:function(me){$!==me&&!N&&(i.depthMask(me),$=me)},setFunc:function(me){if(de&&(me=Np[me]),ee!==me){switch(me){case Ts:i.depthFunc(i.NEVER);break;case bs:i.depthFunc(i.ALWAYS);break;case ws:i.depthFunc(i.LESS);break;case hi:i.depthFunc(i.LEQUAL);break;case As:i.depthFunc(i.EQUAL);break;case Rs:i.depthFunc(i.GEQUAL);break;case Cs:i.depthFunc(i.GREATER);break;case Ps:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ee=me}},setLocked:function(me){N=me},setClear:function(me){ge!==me&&(de&&(me=1-me),i.clearDepth(me),ge=me)},reset:function(){N=!1,$=null,ee=null,ge=null,de=!1}}}function r(){let N=!1,de=null,$=null,ee=null,ge=null,me=null,Be=null,lt=null,xt=null;return{setTest:function(je){N||(je?ae(i.STENCIL_TEST):fe(i.STENCIL_TEST))},setMask:function(je){de!==je&&!N&&(i.stencilMask(je),de=je)},setFunc:function(je,Ot,Jt){($!==je||ee!==Ot||ge!==Jt)&&(i.stencilFunc(je,Ot,Jt),$=je,ee=Ot,ge=Jt)},setOp:function(je,Ot,Jt){(me!==je||Be!==Ot||lt!==Jt)&&(i.stencilOp(je,Ot,Jt),me=je,Be=Ot,lt=Jt)},setLocked:function(je){N=je},setClear:function(je){xt!==je&&(i.clearStencil(je),xt=je)},reset:function(){N=!1,de=null,$=null,ee=null,ge=null,me=null,Be=null,lt=null,xt=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,p=[],_=null,y=!1,m=null,f=null,v=null,x=null,g=null,R=null,b=null,A=new Ve(0,0,0),L=0,T=!1,S=null,D=null,X=null,V=null,Y=null;const te=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let C=!1,H=0;const I=i.getParameter(i.VERSION);I.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(I)[1]),C=H>=1):I.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(I)[1]),C=H>=2);let j=null,q={};const Z=i.getParameter(i.SCISSOR_BOX),le=i.getParameter(i.VIEWPORT),xe=new tt().fromArray(Z),k=new tt().fromArray(le);function se(N,de,$,ee){const ge=new Uint8Array(4),me=i.createTexture();i.bindTexture(N,me),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Be=0;Be<$;Be++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(de,0,i.RGBA,1,1,ee,0,i.RGBA,i.UNSIGNED_BYTE,ge):i.texImage2D(de+Be,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ge);return me}const pe={};pe[i.TEXTURE_2D]=se(i.TEXTURE_2D,i.TEXTURE_2D,1),pe[i.TEXTURE_CUBE_MAP]=se(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),pe[i.TEXTURE_2D_ARRAY]=se(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),pe[i.TEXTURE_3D]=se(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(i.DEPTH_TEST),a.setFunc(hi),Ge(!1),We(Ha),ae(i.CULL_FACE),U(yn);function ae(N){u[N]!==!0&&(i.enable(N),u[N]=!0)}function fe(N){u[N]!==!1&&(i.disable(N),u[N]=!1)}function Ee(N,de){return h[N]!==de?(i.bindFramebuffer(N,de),h[N]=de,N===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=de),N===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=de),!0):!1}function Ue(N,de){let $=p,ee=!1;if(N){$=d.get(de),$===void 0&&($=[],d.set(de,$));const ge=N.textures;if($.length!==ge.length||$[0]!==i.COLOR_ATTACHMENT0){for(let me=0,Be=ge.length;me<Be;me++)$[me]=i.COLOR_ATTACHMENT0+me;$.length=ge.length,ee=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,ee=!0);ee&&i.drawBuffers($)}function De(N){return _!==N?(i.useProgram(N),_=N,!0):!1}const Oe={[Un]:i.FUNC_ADD,[Jc]:i.FUNC_SUBTRACT,[jc]:i.FUNC_REVERSE_SUBTRACT};Oe[Qc]=i.MIN,Oe[el]=i.MAX;const nt={[tl]:i.ZERO,[nl]:i.ONE,[il]:i.SRC_COLOR,[Ss]:i.SRC_ALPHA,[ll]:i.SRC_ALPHA_SATURATE,[ol]:i.DST_COLOR,[sl]:i.DST_ALPHA,[rl]:i.ONE_MINUS_SRC_COLOR,[Es]:i.ONE_MINUS_SRC_ALPHA,[cl]:i.ONE_MINUS_DST_COLOR,[al]:i.ONE_MINUS_DST_ALPHA,[hl]:i.CONSTANT_COLOR,[ul]:i.ONE_MINUS_CONSTANT_COLOR,[fl]:i.CONSTANT_ALPHA,[dl]:i.ONE_MINUS_CONSTANT_ALPHA};function U(N,de,$,ee,ge,me,Be,lt,xt,je){if(N===yn){y===!0&&(fe(i.BLEND),y=!1);return}if(y===!1&&(ae(i.BLEND),y=!0),N!==Kc){if(N!==m||je!==T){if((f!==Un||g!==Un)&&(i.blendEquation(i.FUNC_ADD),f=Un,g=Un),je)switch(N){case oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Va:i.blendFunc(i.ONE,i.ONE);break;case Ga:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Va:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ga:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}v=null,x=null,R=null,b=null,A.set(0,0,0),L=0,m=N,T=je}return}ge=ge||de,me=me||$,Be=Be||ee,(de!==f||ge!==g)&&(i.blendEquationSeparate(Oe[de],Oe[ge]),f=de,g=ge),($!==v||ee!==x||me!==R||Be!==b)&&(i.blendFuncSeparate(nt[$],nt[ee],nt[me],nt[Be]),v=$,x=ee,R=me,b=Be),(lt.equals(A)===!1||xt!==L)&&(i.blendColor(lt.r,lt.g,lt.b,xt),A.copy(lt),L=xt),m=N,T=!1}function mt(N,de){N.side===ft?fe(i.CULL_FACE):ae(i.CULL_FACE);let $=N.side===Ct;de&&($=!$),Ge($),N.blending===oi&&N.transparent===!1?U(yn):U(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const ee=N.stencilWrite;o.setTest(ee),ee&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Qe(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ae(i.SAMPLE_ALPHA_TO_COVERAGE):fe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(N){S!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),S=N)}function We(N){N!==$c?(ae(i.CULL_FACE),N!==D&&(N===Ha?i.cullFace(i.BACK):N===Zc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):fe(i.CULL_FACE),D=N}function Ie(N){N!==X&&(C&&i.lineWidth(N),X=N)}function Qe(N,de,$){N?(ae(i.POLYGON_OFFSET_FILL),(V!==de||Y!==$)&&(i.polygonOffset(de,$),V=de,Y=$)):fe(i.POLYGON_OFFSET_FILL)}function Pe(N){N?ae(i.SCISSOR_TEST):fe(i.SCISSOR_TEST)}function w(N){N===void 0&&(N=i.TEXTURE0+te-1),j!==N&&(i.activeTexture(N),j=N)}function M(N,de,$){$===void 0&&(j===null?$=i.TEXTURE0+te-1:$=j);let ee=q[$];ee===void 0&&(ee={type:void 0,texture:void 0},q[$]=ee),(ee.type!==N||ee.texture!==de)&&(j!==$&&(i.activeTexture($),j=$),i.bindTexture(N,de||pe[N]),ee.type=N,ee.texture=de)}function z(){const N=q[j];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function Q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function J(){try{i.texSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Te(){try{i.texSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function he(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ie(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Le(){try{i.texStorage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function re(){try{i.texStorage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ue(){try{i.texImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Me(){try{i.texImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Se(N){xe.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),xe.copy(N))}function ye(N){k.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),k.copy(N))}function Xe(N,de){let $=l.get(de);$===void 0&&($=new WeakMap,l.set(de,$));let ee=$.get(N);ee===void 0&&(ee=i.getUniformBlockIndex(de,N.name),$.set(N,ee))}function Ne(N,de){const ee=l.get(de).get(N);c.get(de)!==ee&&(i.uniformBlockBinding(de,ee,N.__bindingPointIndex),c.set(de,ee))}function it(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},j=null,q={},h={},d=new WeakMap,p=[],_=null,y=!1,m=null,f=null,v=null,x=null,g=null,R=null,b=null,A=new Ve(0,0,0),L=0,T=!1,S=null,D=null,X=null,V=null,Y=null,xe.set(0,0,i.canvas.width,i.canvas.height),k.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ae,disable:fe,bindFramebuffer:Ee,drawBuffers:Ue,useProgram:De,setBlending:U,setMaterial:mt,setFlipSided:Ge,setCullFace:We,setLineWidth:Ie,setPolygonOffset:Qe,setScissorTest:Pe,activeTexture:w,bindTexture:M,unbindTexture:z,compressedTexImage2D:Q,compressedTexImage3D:ne,texImage2D:ue,texImage3D:Me,updateUBOMapping:Xe,uniformBlockBinding:Ne,texStorage2D:Le,texStorage3D:re,texSubImage2D:J,texSubImage3D:Te,compressedTexSubImage2D:he,compressedTexSubImage3D:ie,scissor:Se,viewport:ye,reset:it}}function zo(i,e,t,n){const r=Op(n);switch(t){case nc:return i*e;case rc:return i*e;case sc:return i*e*2;case ac:return i*e/r.components*r.byteLength;case ga:return i*e/r.components*r.byteLength;case oc:return i*e*2/r.components*r.byteLength;case va:return i*e*2/r.components*r.byteLength;case ic:return i*e*3/r.components*r.byteLength;case Wt:return i*e*4/r.components*r.byteLength;case xa:return i*e*4/r.components*r.byteLength;case Mr:case Sr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Er:case Tr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Fs:case Bs:return Math.max(i,16)*Math.max(e,8)/4;case Ns:case Os:return Math.max(i,8)*Math.max(e,8)/2;case zs:case ks:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Hs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Vs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Gs:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Ws:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Xs:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case qs:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Ys:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case $s:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Zs:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Ks:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Js:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case js:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Qs:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case ea:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ta:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case br:case na:case ia:return Math.ceil(i/4)*Math.ceil(e/4)*16;case cc:case ra:return Math.ceil(i/4)*Math.ceil(e/4)*8;case sa:case aa:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Op(i){switch(i){case hn:case Qo:return{byteLength:1,components:1};case Bi:case ec:case Gi:return{byteLength:2,components:1};case ma:case _a:return{byteLength:2,components:4};case kn:case pa:case on:return{byteLength:4,components:1};case tc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Bp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ve,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(w,M){return p?new OffscreenCanvas(w,M):zi("canvas")}function y(w,M,z){let Q=1;const ne=Pe(w);if((ne.width>z||ne.height>z)&&(Q=z/Math.max(ne.width,ne.height)),Q<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const J=Math.floor(Q*ne.width),Te=Math.floor(Q*ne.height);h===void 0&&(h=_(J,Te));const he=M?_(J,Te):h;return he.width=J,he.height=Te,he.getContext("2d").drawImage(w,0,0,J,Te),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+J+"x"+Te+")."),he}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),w;return w}function m(w){return w.generateMipmaps}function f(w){i.generateMipmap(w)}function v(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(w,M,z,Q,ne=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let J=M;if(M===i.RED&&(z===i.FLOAT&&(J=i.R32F),z===i.HALF_FLOAT&&(J=i.R16F),z===i.UNSIGNED_BYTE&&(J=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(J=i.R8UI),z===i.UNSIGNED_SHORT&&(J=i.R16UI),z===i.UNSIGNED_INT&&(J=i.R32UI),z===i.BYTE&&(J=i.R8I),z===i.SHORT&&(J=i.R16I),z===i.INT&&(J=i.R32I)),M===i.RG&&(z===i.FLOAT&&(J=i.RG32F),z===i.HALF_FLOAT&&(J=i.RG16F),z===i.UNSIGNED_BYTE&&(J=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(J=i.RG8UI),z===i.UNSIGNED_SHORT&&(J=i.RG16UI),z===i.UNSIGNED_INT&&(J=i.RG32UI),z===i.BYTE&&(J=i.RG8I),z===i.SHORT&&(J=i.RG16I),z===i.INT&&(J=i.RG32I)),M===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(J=i.RGB8UI),z===i.UNSIGNED_SHORT&&(J=i.RGB16UI),z===i.UNSIGNED_INT&&(J=i.RGB32UI),z===i.BYTE&&(J=i.RGB8I),z===i.SHORT&&(J=i.RGB16I),z===i.INT&&(J=i.RGB32I)),M===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),z===i.UNSIGNED_INT&&(J=i.RGBA32UI),z===i.BYTE&&(J=i.RGBA8I),z===i.SHORT&&(J=i.RGBA16I),z===i.INT&&(J=i.RGBA32I)),M===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),M===i.RGBA){const Te=ne?Ur:Ye.getTransfer(Q);z===i.FLOAT&&(J=i.RGBA32F),z===i.HALF_FLOAT&&(J=i.RGBA16F),z===i.UNSIGNED_BYTE&&(J=Te===et?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function g(w,M){let z;return w?M===null||M===kn||M===di?z=i.DEPTH24_STENCIL8:M===on?z=i.DEPTH32F_STENCIL8:M===Bi&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===kn||M===di?z=i.DEPTH_COMPONENT24:M===on?z=i.DEPTH_COMPONENT32F:M===Bi&&(z=i.DEPTH_COMPONENT16),z}function R(w,M){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==bt&&w.minFilter!==Yt?Math.log2(Math.max(M.width,M.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?M.mipmaps.length:1}function b(w){const M=w.target;M.removeEventListener("dispose",b),L(M),M.isVideoTexture&&u.delete(M)}function A(w){const M=w.target;M.removeEventListener("dispose",A),S(M)}function L(w){const M=n.get(w);if(M.__webglInit===void 0)return;const z=w.source,Q=d.get(z);if(Q){const ne=Q[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&T(w),Object.keys(Q).length===0&&d.delete(z)}n.remove(w)}function T(w){const M=n.get(w);i.deleteTexture(M.__webglTexture);const z=w.source,Q=d.get(z);delete Q[M.__cacheKey],a.memory.textures--}function S(w){const M=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(M.__webglFramebuffer[Q]))for(let ne=0;ne<M.__webglFramebuffer[Q].length;ne++)i.deleteFramebuffer(M.__webglFramebuffer[Q][ne]);else i.deleteFramebuffer(M.__webglFramebuffer[Q]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[Q])}else{if(Array.isArray(M.__webglFramebuffer))for(let Q=0;Q<M.__webglFramebuffer.length;Q++)i.deleteFramebuffer(M.__webglFramebuffer[Q]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Q=0;Q<M.__webglColorRenderbuffer.length;Q++)M.__webglColorRenderbuffer[Q]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[Q]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=w.textures;for(let Q=0,ne=z.length;Q<ne;Q++){const J=n.get(z[Q]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),a.memory.textures--),n.remove(z[Q])}n.remove(w)}let D=0;function X(){D=0}function V(){const w=D;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),D+=1,w}function Y(w){const M=[];return M.push(w.wrapS),M.push(w.wrapT),M.push(w.wrapR||0),M.push(w.magFilter),M.push(w.minFilter),M.push(w.anisotropy),M.push(w.internalFormat),M.push(w.format),M.push(w.type),M.push(w.generateMipmaps),M.push(w.premultiplyAlpha),M.push(w.flipY),M.push(w.unpackAlignment),M.push(w.colorSpace),M.join()}function te(w,M){const z=n.get(w);if(w.isVideoTexture&&Ie(w),w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){const Q=w.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{k(z,w,M);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function C(w,M){const z=n.get(w);if(w.version>0&&z.__version!==w.version){k(z,w,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function H(w,M){const z=n.get(w);if(w.version>0&&z.__version!==w.version){k(z,w,M);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function I(w,M){const z=n.get(w);if(w.version>0&&z.__version!==w.version){se(z,w,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const j={[Is]:i.REPEAT,[Fn]:i.CLAMP_TO_EDGE,[Us]:i.MIRRORED_REPEAT},q={[bt]:i.NEAREST,[El]:i.NEAREST_MIPMAP_NEAREST,[Zi]:i.NEAREST_MIPMAP_LINEAR,[Yt]:i.LINEAR,[kr]:i.LINEAR_MIPMAP_NEAREST,[On]:i.LINEAR_MIPMAP_LINEAR},Z={[Al]:i.NEVER,[Il]:i.ALWAYS,[Rl]:i.LESS,[hc]:i.LEQUAL,[Cl]:i.EQUAL,[Dl]:i.GEQUAL,[Pl]:i.GREATER,[Ll]:i.NOTEQUAL};function le(w,M){if(M.type===on&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Yt||M.magFilter===kr||M.magFilter===Zi||M.magFilter===On||M.minFilter===Yt||M.minFilter===kr||M.minFilter===Zi||M.minFilter===On)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,j[M.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,j[M.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,j[M.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,q[M.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,q[M.minFilter]),M.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===bt||M.minFilter!==Zi&&M.minFilter!==On||M.type===on&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function xe(w,M){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,M.addEventListener("dispose",b));const Q=M.source;let ne=d.get(Q);ne===void 0&&(ne={},d.set(Q,ne));const J=Y(M);if(J!==w.__cacheKey){ne[J]===void 0&&(ne[J]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),ne[J].usedTimes++;const Te=ne[w.__cacheKey];Te!==void 0&&(ne[w.__cacheKey].usedTimes--,Te.usedTimes===0&&T(M)),w.__cacheKey=J,w.__webglTexture=ne[J].texture}return z}function k(w,M,z){let Q=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Q=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Q=i.TEXTURE_3D);const ne=xe(w,M),J=M.source;t.bindTexture(Q,w.__webglTexture,i.TEXTURE0+z);const Te=n.get(J);if(J.version!==Te.__version||ne===!0){t.activeTexture(i.TEXTURE0+z);const he=Ye.getPrimaries(Ye.workingColorSpace),ie=M.colorSpace===xn?null:Ye.getPrimaries(M.colorSpace),Le=M.colorSpace===xn||he===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le);let re=y(M.image,!1,r.maxTextureSize);re=Qe(M,re);const ue=s.convert(M.format,M.colorSpace),Me=s.convert(M.type);let Se=x(M.internalFormat,ue,Me,M.colorSpace,M.isVideoTexture);le(Q,M);let ye;const Xe=M.mipmaps,Ne=M.isVideoTexture!==!0,it=Te.__version===void 0||ne===!0,N=J.dataReady,de=R(M,re);if(M.isDepthTexture)Se=g(M.format===pi,M.type),it&&(Ne?t.texStorage2D(i.TEXTURE_2D,1,Se,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,Se,re.width,re.height,0,ue,Me,null));else if(M.isDataTexture)if(Xe.length>0){Ne&&it&&t.texStorage2D(i.TEXTURE_2D,de,Se,Xe[0].width,Xe[0].height);for(let $=0,ee=Xe.length;$<ee;$++)ye=Xe[$],Ne?N&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ye.width,ye.height,ue,Me,ye.data):t.texImage2D(i.TEXTURE_2D,$,Se,ye.width,ye.height,0,ue,Me,ye.data);M.generateMipmaps=!1}else Ne?(it&&t.texStorage2D(i.TEXTURE_2D,de,Se,re.width,re.height),N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re.width,re.height,ue,Me,re.data)):t.texImage2D(i.TEXTURE_2D,0,Se,re.width,re.height,0,ue,Me,re.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ne&&it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Se,Xe[0].width,Xe[0].height,re.depth);for(let $=0,ee=Xe.length;$<ee;$++)if(ye=Xe[$],M.format!==Wt)if(ue!==null)if(Ne){if(N)if(M.layerUpdates.size>0){const ge=zo(ye.width,ye.height,M.format,M.type);for(const me of M.layerUpdates){const Be=ye.data.subarray(me*ge/ye.data.BYTES_PER_ELEMENT,(me+1)*ge/ye.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,me,ye.width,ye.height,1,ue,Be)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ye.width,ye.height,re.depth,ue,ye.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,Se,ye.width,ye.height,re.depth,0,ye.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ye.width,ye.height,re.depth,ue,Me,ye.data):t.texImage3D(i.TEXTURE_2D_ARRAY,$,Se,ye.width,ye.height,re.depth,0,ue,Me,ye.data)}else{Ne&&it&&t.texStorage2D(i.TEXTURE_2D,de,Se,Xe[0].width,Xe[0].height);for(let $=0,ee=Xe.length;$<ee;$++)ye=Xe[$],M.format!==Wt?ue!==null?Ne?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,ye.width,ye.height,ue,ye.data):t.compressedTexImage2D(i.TEXTURE_2D,$,Se,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?N&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ye.width,ye.height,ue,Me,ye.data):t.texImage2D(i.TEXTURE_2D,$,Se,ye.width,ye.height,0,ue,Me,ye.data)}else if(M.isDataArrayTexture)if(Ne){if(it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Se,re.width,re.height,re.depth),N)if(M.layerUpdates.size>0){const $=zo(re.width,re.height,M.format,M.type);for(const ee of M.layerUpdates){const ge=re.data.subarray(ee*$/re.data.BYTES_PER_ELEMENT,(ee+1)*$/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ee,re.width,re.height,1,ue,Me,ge)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,ue,Me,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,re.width,re.height,re.depth,0,ue,Me,re.data);else if(M.isData3DTexture)Ne?(it&&t.texStorage3D(i.TEXTURE_3D,de,Se,re.width,re.height,re.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,ue,Me,re.data)):t.texImage3D(i.TEXTURE_3D,0,Se,re.width,re.height,re.depth,0,ue,Me,re.data);else if(M.isFramebufferTexture){if(it)if(Ne)t.texStorage2D(i.TEXTURE_2D,de,Se,re.width,re.height);else{let $=re.width,ee=re.height;for(let ge=0;ge<de;ge++)t.texImage2D(i.TEXTURE_2D,ge,Se,$,ee,0,ue,Me,null),$>>=1,ee>>=1}}else if(Xe.length>0){if(Ne&&it){const $=Pe(Xe[0]);t.texStorage2D(i.TEXTURE_2D,de,Se,$.width,$.height)}for(let $=0,ee=Xe.length;$<ee;$++)ye=Xe[$],Ne?N&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ue,Me,ye):t.texImage2D(i.TEXTURE_2D,$,Se,ue,Me,ye);M.generateMipmaps=!1}else if(Ne){if(it){const $=Pe(re);t.texStorage2D(i.TEXTURE_2D,de,Se,$.width,$.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,Me,re)}else t.texImage2D(i.TEXTURE_2D,0,Se,ue,Me,re);m(M)&&f(Q),Te.__version=J.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function se(w,M,z){if(M.image.length!==6)return;const Q=xe(w,M),ne=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+z);const J=n.get(ne);if(ne.version!==J.__version||Q===!0){t.activeTexture(i.TEXTURE0+z);const Te=Ye.getPrimaries(Ye.workingColorSpace),he=M.colorSpace===xn?null:Ye.getPrimaries(M.colorSpace),ie=M.colorSpace===xn||Te===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ie);const Le=M.isCompressedTexture||M.image[0].isCompressedTexture,re=M.image[0]&&M.image[0].isDataTexture,ue=[];for(let ee=0;ee<6;ee++)!Le&&!re?ue[ee]=y(M.image[ee],!0,r.maxCubemapSize):ue[ee]=re?M.image[ee].image:M.image[ee],ue[ee]=Qe(M,ue[ee]);const Me=ue[0],Se=s.convert(M.format,M.colorSpace),ye=s.convert(M.type),Xe=x(M.internalFormat,Se,ye,M.colorSpace),Ne=M.isVideoTexture!==!0,it=J.__version===void 0||Q===!0,N=ne.dataReady;let de=R(M,Me);le(i.TEXTURE_CUBE_MAP,M);let $;if(Le){Ne&&it&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Xe,Me.width,Me.height);for(let ee=0;ee<6;ee++){$=ue[ee].mipmaps;for(let ge=0;ge<$.length;ge++){const me=$[ge];M.format!==Wt?Se!==null?Ne?N&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge,0,0,me.width,me.height,Se,me.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge,Xe,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge,0,0,me.width,me.height,Se,ye,me.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge,Xe,me.width,me.height,0,Se,ye,me.data)}}}else{if($=M.mipmaps,Ne&&it){$.length>0&&de++;const ee=Pe(ue[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Xe,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(re){Ne?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,ue[ee].width,ue[ee].height,Se,ye,ue[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Xe,ue[ee].width,ue[ee].height,0,Se,ye,ue[ee].data);for(let ge=0;ge<$.length;ge++){const Be=$[ge].image[ee].image;Ne?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge+1,0,0,Be.width,Be.height,Se,ye,Be.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge+1,Xe,Be.width,Be.height,0,Se,ye,Be.data)}}else{Ne?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Se,ye,ue[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Xe,Se,ye,ue[ee]);for(let ge=0;ge<$.length;ge++){const me=$[ge];Ne?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge+1,0,0,Se,ye,me.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ge+1,Xe,Se,ye,me.image[ee])}}}m(M)&&f(i.TEXTURE_CUBE_MAP),J.__version=ne.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function pe(w,M,z,Q,ne,J){const Te=s.convert(z.format,z.colorSpace),he=s.convert(z.type),ie=x(z.internalFormat,Te,he,z.colorSpace),Le=n.get(M),re=n.get(z);if(re.__renderTarget=M,!Le.__hasExternalTextures){const ue=Math.max(1,M.width>>J),Me=Math.max(1,M.height>>J);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,J,ie,ue,Me,M.depth,0,Te,he,null):t.texImage2D(ne,J,ie,ue,Me,0,Te,he,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,ne,re.__webglTexture,0,Ge(M)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Q,ne,re.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ae(w,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,w),M.depthBuffer){const Q=M.depthTexture,ne=Q&&Q.isDepthTexture?Q.type:null,J=g(M.stencilBuffer,ne),Te=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,he=Ge(M);We(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,he,J,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,he,J,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,J,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Te,i.RENDERBUFFER,w)}else{const Q=M.textures;for(let ne=0;ne<Q.length;ne++){const J=Q[ne],Te=s.convert(J.format,J.colorSpace),he=s.convert(J.type),ie=x(J.internalFormat,Te,he,J.colorSpace),Le=Ge(M);z&&We(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Le,ie,M.width,M.height):We(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Le,ie,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,ie,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function fe(w,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(M.depthTexture);Q.__renderTarget=M,(!Q.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),te(M.depthTexture,0);const ne=Q.__webglTexture,J=Ge(M);if(M.depthTexture.format===ci)We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(M.depthTexture.format===pi)We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function Ee(w){const M=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==w.depthTexture){const Q=w.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Q){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Q.removeEventListener("dispose",ne)};Q.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=Q}if(w.depthTexture&&!M.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");fe(M.__webglFramebuffer,w)}else if(z){M.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[Q]),M.__webglDepthbuffer[Q]===void 0)M.__webglDepthbuffer[Q]=i.createRenderbuffer(),ae(M.__webglDepthbuffer[Q],w,!1);else{const ne=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=M.__webglDepthbuffer[Q];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,J)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),ae(M.__webglDepthbuffer,w,!1);else{const Q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(w,M,z){const Q=n.get(w);M!==void 0&&pe(Q.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&Ee(w)}function De(w){const M=w.texture,z=n.get(w),Q=n.get(M);w.addEventListener("dispose",A);const ne=w.textures,J=w.isWebGLCubeRenderTarget===!0,Te=ne.length>1;if(Te||(Q.__webglTexture===void 0&&(Q.__webglTexture=i.createTexture()),Q.__version=M.version,a.memory.textures++),J){z.__webglFramebuffer=[];for(let he=0;he<6;he++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[he]=[];for(let ie=0;ie<M.mipmaps.length;ie++)z.__webglFramebuffer[he][ie]=i.createFramebuffer()}else z.__webglFramebuffer[he]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let he=0;he<M.mipmaps.length;he++)z.__webglFramebuffer[he]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Te)for(let he=0,ie=ne.length;he<ie;he++){const Le=n.get(ne[he]);Le.__webglTexture===void 0&&(Le.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&We(w)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let he=0;he<ne.length;he++){const ie=ne[he];z.__webglColorRenderbuffer[he]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[he]);const Le=s.convert(ie.format,ie.colorSpace),re=s.convert(ie.type),ue=x(ie.internalFormat,Le,re,ie.colorSpace,w.isXRRenderTarget===!0),Me=Ge(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,ue,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,z.__webglColorRenderbuffer[he])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),ae(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),le(i.TEXTURE_CUBE_MAP,M);for(let he=0;he<6;he++)if(M.mipmaps&&M.mipmaps.length>0)for(let ie=0;ie<M.mipmaps.length;ie++)pe(z.__webglFramebuffer[he][ie],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+he,ie);else pe(z.__webglFramebuffer[he],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+he,0);m(M)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let he=0,ie=ne.length;he<ie;he++){const Le=ne[he],re=n.get(Le);t.bindTexture(i.TEXTURE_2D,re.__webglTexture),le(i.TEXTURE_2D,Le),pe(z.__webglFramebuffer,w,Le,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,0),m(Le)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let he=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(he=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,Q.__webglTexture),le(he,M),M.mipmaps&&M.mipmaps.length>0)for(let ie=0;ie<M.mipmaps.length;ie++)pe(z.__webglFramebuffer[ie],w,M,i.COLOR_ATTACHMENT0,he,ie);else pe(z.__webglFramebuffer,w,M,i.COLOR_ATTACHMENT0,he,0);m(M)&&f(he),t.unbindTexture()}w.depthBuffer&&Ee(w)}function Oe(w){const M=w.textures;for(let z=0,Q=M.length;z<Q;z++){const ne=M[z];if(m(ne)){const J=v(w),Te=n.get(ne).__webglTexture;t.bindTexture(J,Te),f(J),t.unbindTexture()}}}const nt=[],U=[];function mt(w){if(w.samples>0){if(We(w)===!1){const M=w.textures,z=w.width,Q=w.height;let ne=i.COLOR_BUFFER_BIT;const J=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Te=n.get(w),he=M.length>1;if(he)for(let ie=0;ie<M.length;ie++)t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let ie=0;ie<M.length;ie++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),he){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Te.__webglColorRenderbuffer[ie]);const Le=n.get(M[ie]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Le,0)}i.blitFramebuffer(0,0,z,Q,0,0,z,Q,ne,i.NEAREST),c===!0&&(nt.length=0,U.length=0,nt.push(i.COLOR_ATTACHMENT0+ie),w.depthBuffer&&w.resolveDepthBuffer===!1&&(nt.push(J),U.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,U)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,nt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),he)for(let ie=0;ie<M.length;ie++){t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,Te.__webglColorRenderbuffer[ie]);const Le=n.get(M[ie]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.TEXTURE_2D,Le,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){const M=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function Ge(w){return Math.min(r.maxSamples,w.samples)}function We(w){const M=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ie(w){const M=a.render.frame;u.get(w)!==M&&(u.set(w,M),w.update())}function Qe(w,M){const z=w.colorSpace,Q=w.format,ne=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==_i&&z!==xn&&(Ye.getTransfer(z)===et?(Q!==Wt||ne!==hn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),M}function Pe(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=V,this.resetTextureUnits=X,this.setTexture2D=te,this.setTexture2DArray=C,this.setTexture3D=H,this.setTextureCube=I,this.rebindTextures=Ue,this.setupRenderTarget=De,this.updateRenderTargetMipmap=Oe,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=Ee,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=We}function zp(i,e){function t(n,r=xn){let s;const a=Ye.getTransfer(r);if(n===hn)return i.UNSIGNED_BYTE;if(n===ma)return i.UNSIGNED_SHORT_4_4_4_4;if(n===_a)return i.UNSIGNED_SHORT_5_5_5_1;if(n===tc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Qo)return i.BYTE;if(n===ec)return i.SHORT;if(n===Bi)return i.UNSIGNED_SHORT;if(n===pa)return i.INT;if(n===kn)return i.UNSIGNED_INT;if(n===on)return i.FLOAT;if(n===Gi)return i.HALF_FLOAT;if(n===nc)return i.ALPHA;if(n===ic)return i.RGB;if(n===Wt)return i.RGBA;if(n===rc)return i.LUMINANCE;if(n===sc)return i.LUMINANCE_ALPHA;if(n===ci)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===ac)return i.RED;if(n===ga)return i.RED_INTEGER;if(n===oc)return i.RG;if(n===va)return i.RG_INTEGER;if(n===xa)return i.RGBA_INTEGER;if(n===Mr||n===Sr||n===Er||n===Tr)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Mr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Sr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Mr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Sr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ns||n===Fs||n===Os||n===Bs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ns)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Fs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Os)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Bs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===zs||n===ks||n===Hs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===zs||n===ks)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Hs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Vs||n===Gs||n===Ws||n===Xs||n===qs||n===Ys||n===$s||n===Zs||n===Ks||n===Js||n===js||n===Qs||n===ea||n===ta)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Vs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Gs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ws)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Xs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===qs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ys)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===$s)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Zs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ks)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Js)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===js)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Qs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ea)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ta)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===br||n===na||n===ia)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===br)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===na)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ia)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===cc||n===ra||n===sa||n===aa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===br)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ra)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===sa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===aa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===di?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class kp extends Ut{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Bn extends vt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Hp={type:"move"};class ms{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Bn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Bn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Bn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){a=!0;for(const y of e.hand.values()){const m=t.getJointPose(y,n),f=this._getHandJoint(l,y);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),p=.02,_=.005;l.inputState.pinching&&d>p+_?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=p-_&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Hp)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Bn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Vp=`
void main() {
...
조합에 따라 전직이 결정됩니다`,duration:5e3},{time:25e3,text:"🖱️ 전직 후: 마우스 클릭/드래그로 스킬 사용!",duration:4e3}],H=document.getElementById("tutorial");C.forEach(I=>{setTimeout(()=>{H.innerHTML=I.text.replace(/\n/g,"<br>"),H.style.opacity="1",setTimeout(()=>{H.style.opacity="0"},I.duration)},I.time)})}document.getElementById("tree-btn").addEventListener("click",()=>{document.getElementById("class-tree-screen").style.display="flex",r()}),document.getElementById("tree-close-btn").addEventListener("click",()=>{document.getElementById("class-tree-screen").style.display="none"});function r(){const C=[{name:"Flame Knight",req:"🔥×2",concept:"Melee burst"},{name:"Frost Mage",req:"❄️×2",concept:"AoE slow"},{name:"Storm Warrior",req:"⚡×2",concept:"Speed+chain"},{name:"Plague Bearer",req:"☠️×2",concept:"DOT stack"},{name:"Steam Engineer",req:"🔥+❄️",concept:"Explode+slow"},{name:"Plasma Mage",req:"🔥+⚡",concept:"Chain explode"},{name:"Hellfire Witch",req:"🔥+☠️",concept:"Burn+poison"},{name:"Aurora Knight",req:"❄️+⚡",concept:"Freeze+shock"},{name:"Cryo Alchemist",req:"❄️+☠️",concept:"Slow+weaken"},{name:"Volt Chemist",req:"⚡+☠️",concept:"Shock+blast"},{name:"Elemental Blade",req:"🔥+❄️+⚡",concept:"Balanced"},{name:"Frost Plague",req:"❄️+☠️",concept:"Freeze+disease"},{name:"Thunder Toxin",req:"⚡+☠️",concept:"Chain+spread"},{name:"Vile Storm",req:"❄️+⚡+☠️",concept:"Chaotic AoE"},{name:"Primordial Novice",req:"🔥+❄️+⚡+☠️",concept:"Jack of all"}],H=[{name:"Weapon Master",req:"ATK 120+",concept:"Pure physical god"},{name:"Vampire Lord",req:"Lifesteal 25%+",concept:"Undying drain"},{name:"Berserker",req:"AOE 6+",concept:"Rage AoE"},{name:"Assassin",req:"Crit 50%+",concept:"One-shot stealth"},{name:"Windwalker",req:"Speed 9+",concept:"Movement = attack"}],I=["Inferno Lord","Volcanic Thunder","Blizzard Warden","Permafrost Plague","Thunder God","Plasma Overlord","Venom Lord","Toxic Glacier","Reactor Core","Nova Cannon","Demon Summoner","Absolute Zero","Bio Freeze","Acid Storm","Prism Knight","Pandemic Frost","Chain Decay","Chaos Shaman","Primordial Adept","Awakened One"],j=["Phoenix","Cryomancer","Ragnarok","Pandemic","Antimatter","Supernova","Entropy","Archfiend","Avatar","Primordial God"];let q='<h3 style="color:#ffcc00;margin:8px 0">⭐ 1차 전직 (Lv 10+ / Orb 2+)</h3>';q+='<table style="width:100%;border-collapse:collapse;margin-bottom:16px">',q+='<tr style="color:#888;border-bottom:1px solid #333"><td>Class</td><td>Requirement</td><td>Style</td></tr>',C.forEach(Z=>{q+=`<tr style="border-bottom:1px solid #222"><td style="color:#ff8844;padding:4px 0">${Z.name}</td><td>${Z.req}</td><td style="color:#666">${Z.concept}</td></tr>`}),q+="</table>",q+='<h3 style="color:#ff44ff;margin:8px 0">🌈 히든 전직 (스탯 특화)</h3>',q+='<table style="width:100%;border-collapse:collapse;margin-bottom:16px">',q+='<tr style="color:#888;border-bottom:1px solid #333"><td>Class</td><td>Requirement</td><td>Style</td></tr>',H.forEach(Z=>{q+=`<tr style="border-bottom:1px solid #222"><td style="color:#ff44ff;padding:4px 0">${Z.name}</td><td>${Z.req}</td><td style="color:#666">${Z.concept}</td></tr>`}),q+="</table>",q+='<h3 style="color:#44ccff;margin:8px 0">🌟 2차 전직 (Lv 25+ / Orb 6+)</h3>',q+='<div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:16px">',I.forEach(Z=>{q+=`<span style="background:#1a2a3a;padding:3px 8px;border-radius:4px;font-size:11px">${Z}</span>`}),q+="</div>",q+='<h3 style="color:#ffcc00;margin:8px 0">👑 3차 전직 (Lv 45+ / Orb 10+)</h3>',q+='<div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:16px">',j.forEach(Z=>{q+=`<span style="background:#2a1a00;padding:3px 8px;border-radius:4px;font-size:11px;color:#ffcc00">${Z}</span>`}),q+="</div>",q+='<p style="color:#555;font-size:10px;margin-top:12px">※ 같은 원소를 집중하면 순수 전직, 분산하면 하이브리드 전직이 해금됩니다.</p>',document.getElementById("class-tree-content").innerHTML=q}document.getElementById("retry-btn").addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",F=new Rr,t=!0,Y=!1,e.enemyMeshes.forEach(C=>e.scene.remove(C)),e.enemyMeshes=[],e.orbMeshes.forEach(C=>e.scene.remove(C)),e.orbMeshes=[],e.bulletMeshes.forEach(C=>e.scene.remove(C)),e.bulletMeshes=[]});const s={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",C=>{const H=s[C.code]||C.key.toLowerCase();if(C.code==="Space"&&C.preventDefault(),C.code==="Escape"){F.toggle_pause();const I=F.is_paused();document.getElementById("pause-menu").style.display=I?"flex":"none",I&&v();return}F.on_key_down(H),F.level_up_pending()&&(H==="1"&&(F.choose_upgrade(0),g()),H==="2"&&(F.choose_upgrade(1),g()),H==="3"&&(F.choose_upgrade(2),g()))}),document.addEventListener("keyup",C=>{const H=s[C.code]||C.key.toLowerCase();F.on_key_up(H)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",C=>C.preventDefault()),document.addEventListener("contextmenu",C=>{t&&C.preventDefault()}),a.addEventListener("selectstart",C=>C.preventDefault());let o=null,c=!1,l=null,u=[],h=null,d=null;a.addEventListener("mousedown",C=>{!t||!F||(C.preventDefault(),C.button===0&&F.player_class_tier()>0?(o={x:C.clientX,y:C.clientY,button:0},u=[{x:C.clientX,y:C.clientY}],c=!1,y()):C.button===2&&F.player_class_tier()>=2&&(o={x:C.clientX,y:C.clientY,button:2},u=[{x:C.clientX,y:C.clientY}],c=!1,y()))}),document.addEventListener("mousemove",C=>{if(!o)return;const H=C.clientX-o.x,I=C.clientY-o.y,j=Math.sqrt(H*H+I*I);if(u.push({x:C.clientX,y:C.clientY}),j>20){c=!0;const q=p(u,o);if(!d){const fe=document.createElement("canvas");fe.width=window.innerWidth,fe.height=window.innerHeight,fe.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(fe),d=fe}const Z=d.getContext("2d");if(Z.clearRect(0,0,d.width,d.height),u.length>2){const fe=F.player_class_element()||F.active_element(),Ee={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};Z.strokeStyle=Ee[fe]||Ee[0],Z.lineWidth=3,Z.lineCap="round",Z.beginPath(),Z.moveTo(u[0].x,u[0].y);for(let Ue=1;Ue<u.length;Ue++)Z.lineTo(u[Ue].x,u[Ue].y);Z.stroke(),q==="circle"&&(Z.strokeStyle="rgba(255,200,0,0.7)",Z.lineWidth=5,Z.stroke())}l||(l=document.createElement("div"),l.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(l)),h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(h));const le=Math.min(50+j*.4,100),xe=F.player_class_element()||F.active_element(),k=o.button===2,pe=(k?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[xe]||(k?"#ccaaff":"#8888ff");l.style.width=le+"px",l.style.height=le+"px",l.style.borderColor=pe,l.style.boxShadow=`0 0 ${le/4}px ${pe}, inset 0 0 ${le/6}px ${pe}`;const ae={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(l.textContent=ae[q]||"...",e&&e.camera){const fe=e.projectToScreen(F.player_x(),.5,F.player_z());if(l.style.left=fe.x-le/2+"px",l.style.top=fe.y-le/2+"px",q==="outward"){const Ee=Math.atan2(I,H),Ue=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let De=Math.round(Ee/(Math.PI/4));De<0&&(De+=8),De=De%8,h.textContent=Ue[De],h.style.fontSize="32px";const Oe=50;h.style.left=fe.x+Math.cos(Ee)*Oe-16+"px",h.style.top=fe.y+Math.sin(Ee)*Oe-16+"px",h.style.opacity="1"}else q==="inward"?(h.textContent="🛡️",h.style.fontSize="28px",h.style.left=fe.x-14+"px",h.style.top=fe.y-14+"px",h.style.opacity="1"):q==="circle"?(h.textContent="🌀",h.style.left=fe.x-14+"px",h.style.top=fe.y-40+"px",h.style.opacity="1"):(h.style.opacity="0.3",h.textContent="?")}}}),document.addEventListener("mouseup",C=>{if(!o||!F){o=null;return}const H=C.clientX-o.x,I=C.clientY-o.y,j=Math.sqrt(H*H+I*I),q=o.button;if(l&&(l.remove(),l=null),h&&(h.remove(),h=null),d&&(d.remove(),d=null),m(),q===0&&F.player_class_tier()>0)if(c&&j>30){const Z=p(u,o),le=Math.atan2(-I,H);if(Z==="outward")F.use_directional_skill(le),e.spawnDirectionalEffect(F.player_x(),F.player_z(),le,F.player_class_element()||F.active_element(),5),e.shake(.35,.1),f("outward");else if(Z==="inward")F.use_shield_skill(),e.spawnShieldEffect(F.player_x(),F.player_z(),F.player_class_element()||F.active_element()),e.shake(.15,.05),f("inward");else if(Z==="circle"){F.use_ultimate_skill(),e.spawnUltimateEffect(F.player_x(),F.player_z(),F.player_class_element()||F.active_element(),8),e.shake(.6,.2),f("circle");const xe=document.createElement("div");xe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.3);pointer-events:none;z-index:999;animation:flash-fade 0.3s ease-out forwards",document.body.appendChild(xe),setTimeout(()=>xe.remove(),300)}}else c||(F.use_active_skill(),e.shake(.2,.08));else if(q===2&&F.player_class_tier()>=2)if(c&&j>30){const Z=p(u,o),le=Math.atan2(-I,H);Z==="outward"?(F.use_directional_skill(le),e.spawnDirectionalEffect(F.player_x(),F.player_z(),le,F.player_class_element()||F.active_element(),7),e.shake(.4,.12),f("outward")):Z==="circle"?(F.use_ultimate_skill(),e.spawnUltimateEffect(F.player_x(),F.player_z(),F.player_class_element()||F.active_element(),10),e.shake(.7,.25),f("circle")):(F.use_active_skill(),e.shake(.3,.1),f("outward"))}else c||(F.use_active_skill(),e.spawnSkillEffect(F.player_x(),F.player_z(),F.active_element(),4),e.shake(.25,.08));o=null,c=!1,u=[]});function p(C,H){if(C.length<5)return"unknown";const I=C[C.length-1],j=I.x-H.x,q=I.y-H.y,Z=Math.sqrt(j*j+q*q);if(C.length>30){let le=0;for(let k=2;k<C.length;k++){const se=C[k-1].x-C[k-2].x,pe=C[k-1].y-C[k-2].y,ae=C[k].x-C[k-1].x,fe=C[k].y-C[k-1].y,Ee=se*fe-pe*ae,Ue=se*ae+pe*fe;le+=Math.atan2(Ee,Ue)}const xe=Math.sqrt((I.x-H.x)**2+(I.y-H.y)**2);if(Math.abs(le)>Math.PI*1.9&&xe<120)return"circle"}if(e&&e.camera){const le=e.projectToScreen(F.player_x(),.5,F.player_z()),xe=Math.sqrt((H.x-le.x)**2+(H.y-le.y)**2),k=Math.sqrt((I.x-le.x)**2+(I.y-le.y)**2);if(k<xe-20)return"inward";if(k>xe+20)return"outward"}return Z>40?"outward":"unknown"}let _=null;function y(){_||(_=document.createElement("div"),_.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",_.innerHTML=`
        ...
        `,document.body.appendChild(_))}function m(){_&&(_.remove(),_=null)}function f(C){const H=F.learned_skill_count();if(H===0)return;let I="",j="#fff";if(C==="outward"){for(let Z=0;Z<H;Z++)if(F.learned_skill_type(Z)===0){I=F.learned_skill_name(Z);break}j="#ff8844"}else if(C==="inward"){for(let Z=0;Z<H;Z++)if(F.learned_skill_type(Z)===1){I=F.learned_skill_name(Z);break}I||(I="Shield"),j="#44ff88"}else if(C==="circle"){for(let Z=0;Z<H;Z++)if(F.learned_skill_type(Z)===2){I=F.learned_skill_name(Z);break}I||(I="Ultimate"),j="#ffcc00"}I||(I="Skill");const q=document.createElement("div");q.textContent=C==="circle"?`✨ ${I} ✨`:I,q.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${j};font-size:${C==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${j},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(q),setTimeout(()=>q.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{F.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function v(){let C="<b>📜 Status</b><br><br>";const H=F.fire_level(),I=F.ice_level(),j=F.thunder_level(),q=F.poison_level();C+="<b>⚗️ Element Orbs</b><br>",H>0&&(C+=`  🔥 Fire: ${H}<br>`),I>0&&(C+=`  ❄️ Ice: ${I}<br>`),j>0&&(C+=`  ⚡ Thunder: ${j}<br>`),q>0&&(C+=`  ☠️ Poison: ${q}<br>`),H+I+j+q===0&&(C+='  <span style="color:#666">없음</span><br>');const Z=F.player_class_tier();if(Z>0){C+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[Z]||""} ${F.player_class_name()}</b> (Tier ${Z})<br>`;const xe=F.learned_skill_count();if(xe>0){C+="<br><b>🗡️ Class Skills</b><br>";for(let k=0;k<xe;k++){const se=F.learned_skill_name(k),pe=F.learned_skill_level(k);C+=`  📈 ${se} <span style="color:#ffcc00">Lv.${pe}</span><br>`}}}else C+='<br><span style="color:#666">Lv.10에서 첫 전직 가능</span><br>',C+='<span style="color:#555;font-size:10px">원소를 모아 조합 조건을 맞추세요!</span>';if(Z===0||Z===1||Z===2){const le=Z===0?10:Z===1?25:45;F.player_level()<le&&(C+=`<br><br><span style="color:#888;font-size:10px">다음 전직: Lv.${le}</span>`)}document.getElementById("pause-skills").innerHTML=C}for(let C=0;C<3;C++)document.getElementById(`choice-${C}`).addEventListener("click",()=>{F.choose_upgrade(C),g()});function x(){const C=document.getElementById("levelup");C.style.display="block",C.classList.add("shown");for(let H=0;H<3;H++){const I=F.level_up_choice(H),j=Bm(I),q=zm(I);document.getElementById(`choice-${H}`).innerHTML=`<span>[${H+1}]</span> ${j}<br><small style="color:#999;font-size:11px">${q}</small>`}}function g(){const C=document.getElementById("levelup");C.style.display="none",C.classList.remove("shown"),A=!1,Vt.playPickup()}const R=[];let b="",A=!1;function L(){const C=F.player_promoted(),H=C?F.player_class_name():"",I={1:"⭐",2:"🌟",3:"👑"},j=F.player_class_tier(),q=I[j]||"";document.getElementById("level").textContent=F.player_level()+(H?` ${q}${H}`:"");const Z=F.active_element(),le=document.getElementById("portrait"),xe={0:"🗡️",1:"🔥",2:"❄️",3:"⚡",4:"☠️"},k={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44"};le.textContent=xe[Z]||"🗡️",le.style.borderColor=k[Z]||"#555",C?le.style.boxShadow=`0 0 10px ${k[Z]}`:le.style.boxShadow="none";const se=Math.max(0,F.player_hp()/F.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=se+"%";const pe=Math.max(0,F.player_shield()/F.player_max_hp()*100),ae=document.getElementById("shield-bar-fill");ae.style.width=pe+"%",ae.style.left=se+"%";const fe=F.player_xp()/F.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=fe+"%";const Ee=document.getElementById("stat-panel");Ee&&(Ee.innerHTML=`⚔️ ATK <span style="color:#ff8844">${Math.round(F.player_damage())}</span><br>⚡ SPD <span style="color:#44ccff">${F.player_atk_speed().toFixed(1)}/s</span><br>🎯 RNG <span style="color:#88ff44">${F.player_range().toFixed(1)}</span><br>💥 CRT <span style="color:#ff4488">${Math.round(F.player_crit()*100)}%</span><br>🗡️ PRC <span style="color:#ffcc44">${F.player_pierce()}</span> 🔫 ×<span style="color:#44ffcc">${F.player_multi()}</span><br>🧛 STEAL <span style="color:#ff44ff">${Math.round(F.player_lifesteal()*100)}%</span>`);const Ue={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},De={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},Oe={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},nt=F.skill_slot_count(),U=F.learned_skill_count();let mt="";for(let ie=0;ie<nt;ie++)mt+=F.skill_slot_id(ie)+":"+F.skill_slot_level(ie)+",";mt+="|"+U;for(let ie=0;ie<U;ie++)mt+=F.learned_skill_id(ie)+":"+F.learned_skill_level(ie)+",";if(mt!==b){b=mt;let ie="";for(let Le=0;Le<nt;Le++){const re=F.skill_slot_id(Le),ue=F.skill_slot_level(Le),Me=Ue[re]||"⭐",Se=De[re]||"#888",ye=Oe[re]||"Skill";ie+=`<div class="skill-icon" style="background:${Se}22;border-color:${Se}">
              ${Me}<span class="sk-lvl">${ue}</span>
              <div class="sk-tooltip"><b style="color:${Se}">${ye} Lv.${ue}</b></div>
            </div>`}if(U>0){ie+='<div style="width:2px;height:28px;background:#333;margin:0 4px"></div>';for(let Le=0;Le<U;Le++){const re=F.learned_skill_name(Le),ue=F.learned_skill_level(Le),Me=F.learned_skill_desc(Le),Se=F.learned_skill_type(Le),ye=Se===0?"⚔️":Se===1?"🛡️":"💫",Xe=Se===0?"AUTO":Se===1?"PASSIVE":"ULT",Ne=Se===0?"#44ccff":Se===1?"#44ff44":"#ffcc00";ie+=`<div class="skill-icon class-skill" data-skill-idx="${Le}" style="background:${Ne}15;border-color:${Ne}">
                ${ye}<span class="sk-lvl" style="color:${Ne}">${ue}</span>
                <div class="sk-cd-overlay"></div>
                <div class="sk-tooltip"><b style="color:${Ne}">${re} Lv.${ue}</b><br><span style="color:#888">[${Xe}]</span> ${Me}</div>
              </div>`}}document.getElementById("skill-slots").innerHTML=ie,document.querySelectorAll(".skill-icon").forEach(Le=>{Le.addEventListener("click",re=>{const ue=Le.classList.contains("active-tip");document.querySelectorAll(".skill-icon").forEach(Me=>Me.classList.remove("active-tip")),ue||Le.classList.add("active-tip"),re.stopPropagation()})})}document.querySelectorAll(".class-skill").forEach(ie=>{const Le=parseInt(ie.dataset.skillIdx);if(isNaN(Le))return;const re=F.learned_skill_cd(Le),ue=F.learned_skill_max_cd(Le),Me=ie.querySelector(".sk-cd-overlay");if(Me)if(re>0){const Se=re/ue;Me.style.background=`conic-gradient(rgba(0,0,0,0.7) ${Se*360}deg, transparent ${Se*360}deg)`,Me.style.display="block"}else Me.style.display="none"});const Ge=Math.floor(F.game_time()),We=Math.floor(Ge/60),Ie=Ge%60;if(document.getElementById("timer").textContent=`${We}:${Ie.toString().padStart(2,"0")}`,document.getElementById("kills").textContent=`Wave ${F.wave_number()} | ${F.kills()} kills`,F.boss_active()){let ie=document.getElementById("boss-bar");ie||(ie=document.createElement("div"),ie.id="boss-bar",ie.style.cssText="position:fixed;top:50px;left:50%;transform:translateX(-50%);width:300px;text-align:center;z-index:100",ie.innerHTML='<div style="color:#ff4444;font-size:12px;margin-bottom:4px">💀 BOSS</div><div style="width:100%;height:10px;background:#333;border-radius:5px;border:1px solid #ff4444"><div id="boss-hp-fill" style="height:100%;background:linear-gradient(90deg,#ff2222,#ff6644);border-radius:4px;transition:width 0.1s"></div></div>',document.body.appendChild(ie)),document.getElementById("boss-hp-fill").style.width=F.boss_hp_pct()*100+"%"}else{const ie=document.getElementById("boss-bar");ie&&ie.remove()}F.level_up_pending()&&!A&&(x(),A=!0,Vt.playLevelUp());let Qe;for(;(Qe=F.pop_log())!==void 0;)R.push(Qe),R.length>4&&R.shift();document.getElementById("log").textContent=R.join(`
`);const Pe=F.player_dash_cooldown(),w=document.getElementById("dash-bar"),M=document.getElementById("dash-cd-text"),z=F.player_dash_type(),Q={1:"🔥 BLINK",2:"❄️ SKATE",3:"⚡ DASH×3",4:"☠️ SMOKE",5:"💨 DASH"},ne={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44",5:"#44ccff"},Te={1:3,2:0,3:.8,4:4,5:2}[z]||2;if(document.querySelector("#dash-ui span").textContent=Q[z]||"💨 DASH",z===2)w.style.width="100%",w.style.background="#44ccff",M.textContent="+40% SPD";else if(z===3){const ie=F.player_dash_charges();w.style.width=ie/3*100+"%",w.style.background=ie>0?"#ffcc00":"#333",M.textContent=`⚡${ie}/3`}else Pe>0?(w.style.width=Math.max(0,(1-Pe/Te)*100)+"%",w.style.background="#666",M.textContent=Pe.toFixed(1)+"s"):(w.style.width="100%",w.style.background=ne[z]||"#44ccff",M.textContent="READY");const he=document.getElementById("stamina-bar-bg");if(F.player_class_tier()>0){he.style.display="block";const ie=F.player_stamina()/F.player_max_stamina()*100;document.getElementById("stamina-bar-fill").style.width=ie+"%"}}function T(C,H,I,j){const q=document.createElement("div");q.className="dmg-popup"+(j?" crit":""),q.textContent=Math.round(I);const Z=j?18:13,le=Math.min(12,Math.floor(I/30));if(q.style.fontSize=Z+le+"px",document.getElementById("game-canvas"),e&&e.camera){const xe=e.projectToScreen(C,1.8,H);q.style.left=xe.x+"px",q.style.top=xe.y-20+"px"}else q.style.left=window.innerWidth/2+"px",q.style.top=window.innerHeight/2-50+"px";document.body.appendChild(q),setTimeout(()=>q.remove(),900)}function S(C){const H=Math.floor(C.game_time()),I=Math.floor(H/60),j=H%60,q=C.kills(),Z=C.player_level(),le=C.final_points();let xe=parseInt(localStorage.getItem("unplug_points")||"0");xe+=le,localStorage.setItem("unplug_points",xe),document.getElementById("final-stats").innerHTML=`⏱️ Survived: ${I}:${j.toString().padStart(2,"0")}<br>☠️ Kills: ${q}<br>⭐ Level: ${Z}<br>⚔️ Final ATK: ${Math.round(C.player_damage())}`,document.getElementById("points-earned").innerHTML=`💰 +${le} pts (Total: ${xe})`;const k=[];q>=100&&k.push("💀 Century Slayer"),q>=50&&k.push("⚔️ Warrior"),q>=20&&k.push("🗡️ Fighter"),Z>=15&&k.push("👑 Legend"),Z>=10&&k.push("📈 Veteran"),Z>=5&&k.push("🌱 Apprentice"),H>=300&&k.push("⏳ Eternal Survivor"),H>=180&&k.push("🕐 Endurer"),H>=60&&k.push("⌛ Lasted a Minute"),C.player_promoted()&&k.push("👑 Class Promoted"),C.player_damage()>=100&&k.push("🔥 Weapon Master"),document.getElementById("achievements").innerHTML=k.length>0?k.map(se=>"🏆 "+se).join("<br>"):"",X(),document.getElementById("gameover-screen").style.display="flex"}const D=[{name:"⚔️ 시작 ATK +5",stat:"atk",value:5,rarity:"일반"},{name:"❤️ 시작 HP +20",stat:"hp",value:20,rarity:"일반"},{name:"👟 시작 SPD +0.3",stat:"spd",value:.3,rarity:"일반"},{name:"🎯 시작 RNG +0.5",stat:"rng",value:.5,rarity:"일반"},{name:"💥 시작 CRT +5%",stat:"crt",value:.05,rarity:"희귀"},{name:"🧲 시작 MAGNET +1",stat:"mag",value:1,rarity:"희귀"},{name:"🔥 Fire Starter (시작 시 불 Lv1)",stat:"elem_fire",value:1,rarity:"에픽"},{name:"❄️ Ice Starter (시작 시 얼음 Lv1)",stat:"elem_ice",value:1,rarity:"에픽"},{name:"⚡ Thunder Starter (시작 시 번개 Lv1)",stat:"elem_thunder",value:1,rarity:"에픽"},{name:"☠️ Poison Starter (시작 시 독 Lv1)",stat:"elem_poison",value:1,rarity:"에픽"},{name:"👑 즉시 전직권",stat:"instant_promote",value:1,rarity:"전설"}];document.getElementById("gacha-btn").addEventListener("click",()=>{let C=parseInt(localStorage.getItem("unplug_points")||"0");if(C<10){document.getElementById("gacha-result").innerHTML='<span style="color:#ff4444">포인트 부족! (10pt 필요)</span>';return}C-=10,localStorage.setItem("unplug_points",C),document.getElementById("points-earned").innerHTML=`💰 Total: ${C}`,Vt.playGacha();const H=Math.random();let I;H<.05?I=D[10]:H<.2?I=D[6+Math.floor(Math.random()*4)]:H<.45?I=D[4+Math.floor(Math.random()*2)]:I=D[Math.floor(Math.random()*4)];let j=JSON.parse(localStorage.getItem("unplug_unlocked")||"[]");j.push(I),localStorage.setItem("unplug_unlocked",JSON.stringify(j));const q={일반:"#aaa",희귀:"#4488ff",에픽:"#aa44ff",전설:"#ffcc00"};document.getElementById("gacha-result").innerHTML=`🎉 <span style="color:${q[I.rarity]}">[${I.rarity}] ${I.name}</span>`,X()});function X(){const C=JSON.parse(localStorage.getItem("unplug_unlocked")||"[]");if(C.length===0)document.getElementById("unlocked-list").textContent="아직 해금된 아이템 없음";else{const H={};C.forEach(I=>{H[I.name]=(H[I.name]||0)+1}),document.getElementById("unlocked-list").innerHTML="📦 보유: "+Object.entries(H).map(([I,j])=>`${I}${j>1?" x"+j:""}`).join(", ")}}let V=0,Y=!1;function te(C){const H=V?(C-V)/1e3:.016;if(V=C,!t){requestAnimationFrame(te);return}!F.player_alive()&&!Y&&(Y=!0,S(F)),F.update(C);const I=[],j=F.enemy_count();for(let xe=0;xe<j;xe++)I.push({x:F.enemy_x(xe),z:F.enemy_z(xe),type:F.enemy_type(xe),hit:F.enemy_hit(xe)});const q=[],Z=[],le=F.orb_count();for(let xe=0;xe<le;xe++)Z.push({x:F.orb_x(xe),z:F.orb_z(xe),type:F.orb_type(xe)});if(!F.level_up_pending()){const xe=F.damage_event_count(),k=F.player_x(),se=F.player_z(),pe=F.player_damage(),ae=F.active_element();let fe=!1;for(let De=0;De<xe;De++){const Oe=F.damage_event_x(De),nt=F.damage_event_z(De),U=F.damage_event_crit(De);U&&(fe=!0),T(Oe,nt,F.damage_event_amount(De),U),e.spawnSlash(k,se,Oe,nt,U,pe,ae),De===0&&(U?Vt.playCrit():ae===1?Vt.playElementFire():ae===2?Vt.playElementIce():ae===3?Vt.playElementThunder():ae===4?Vt.playElementPoison():Vt.playHit())}fe?(e.shake(.4,.12),e.hitStop(.04)):xe>=3&&e.shake(.2,.08);const Ee=F.death_event_count();for(let De=0;De<Ee;De++)e.spawnDeathParticles(F.death_event_x(De),F.death_event_z(De),F.active_element()),De===0&&Vt.playDeath();Ee>0&&e.shake(.25+Ee*.1,.1);const Ue=F.skill_event_count();for(let De=0;De<Ue;De++)e.spawnSkillEffect(F.skill_event_x(De),F.skill_event_z(De),F.skill_event_element(De),F.skill_event_range(De))}e._shieldRing&&F.player_shield()<=0?(e.scene.remove(e._shieldRing.mesh),e._shieldOuter&&e.scene.remove(e._shieldOuter.mesh),e._shieldRing=null,e._shieldOuter=null):e.updateShield&&e.updateShield(F.player_x(),F.player_z(),H/1e3),e.update({playerX:F.player_x(),playerZ:F.player_z(),playerMoving:F.player_moving(),playerDirX:F.player_dir_x(),playerDirZ:F.player_dir_z(),playerHit:F.player_hit(),playerAttacking:F.player_attacking(),playerDashing:F.player_dashing(),dashType:F.player_dash_type(),nearestEnemyDirX:F.nearest_enemy_dir_x(),element:F.active_element(),elementLevel:F.active_element_level(),fireLv:F.fire_level(),iceLv:F.ice_level(),thunderLv:F.thunder_level(),poisonLv:F.poison_level(),bossActive:F.boss_active(),bossX:F.boss_x(),bossZ:F.boss_z(),bossHpPct:F.boss_hp_pct(),promoted:F.player_promoted(),enemies:I,bullets:q,orbs:Z},H),L(),requestAnimationFrame(te)}requestAnimationFrame(te)}km().catch(i=>{document.body.innerHTML=`<pre style="color:red;padding:20px">FATAL: ${i}
${i.stack||""}</pre>`});
