...
`)+`
`+f);const y=g+m+o,v=g+f+a,C=Ba(s,s.VERTEX_SHADER,y),E=Ba(s,s.FRAGMENT_SHADER,v);s.attachShader(x,C),s.attachShader(x,E),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function A(U){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(C).trim(),K=s.getShaderInfoLog(E).trim();let ie=!0,Z=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,C,E);else{const le=ka(s,C,"vertex"),Y=ka(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`;function Zp(i,e,t){let n=new Oo;const s=new de,r=new de,o=new ct,a=new $p({depthPacking:Gc}),l=new qp,c={},h=t.maxTextureSize,u={[Bn]:zt,[zt]:Bn,[at]:at},d=new Bt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new de},radius:{value:4}},vertexShader:Yp,fragmentShader:Kp}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ct;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new se(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ol;let f=this.type;this.render=function(E,A,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;const b=i.getRenderTarget(),S=i.getActiveCubeFace(),U=i.getActiveMipmapLevel(),W=i.state;W.setBlending(Mn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const k=f!==gn&&this.type===gn,K=f===gn&&this.type!==gn;for(let ie=0,Z=E.length;ie<Z;ie++){const le=E[ie],Y=le.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",le,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);const me=Y.getFrameExtents();if(s.multiply(me),r.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,Y.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,Y.mapSize.y=r.y)),Y.map===null||k===!0||K===!0){const Le=this.type!==gn?{minFilter:Et,magFilter:Et}:{};Y.map!==null&&Y.map.dispose(),Y.map=new nn(s.x,s.y,Le),Y.map.texture.name=le.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const we=Y.getViewportCount();for(let Le=0;Le<we;Le++){const qe=Y.getViewport(Le);o.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),W.viewport(o),Y.updateMatrices(le,Le),n=Y.getFrustum(),v(A,D,Y.camera,le,this.type)}Y.isPointLightShadow!==!0&&this.type===gn&&g(Y,D),Y.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(b,S,U)};function g(E,A){const D=e.update(x);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new nn(s.x,s.y)),d.uniforms.shadow_pass.value=E.map.texture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(A,null,D,d,x,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value=E.mapSize,p.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(A,null,D,p,x,null)}function y(E,A,D,b){let S=null;const U=D.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(U!==void 0)S=U;else if(S=D.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const W=S.uuid,k=A.uuid;let K=c[W];K===void 0&&(K={},c[W]=K);let ie=K[k];ie===void 0&&(ie=S.clone(),K[k]=ie,A.addEventListener("dispose",C)),S=ie}if(S.visible=A.visible,S.wireframe=A.wireframe,b===gn?S.side=A.shadowSide!==null?A.shadowSide:A.side:S.side=A.shadowSide!==null?A.shadowSide:u[A.side],S.alphaMap=A.alphaMap,S.alphaTest=A.alphaTest,S.map=A.map,S.clipShadows=A.clipShadows,S.clippingPlanes=A.clippingPlanes,S.clipIntersection=A.clipIntersection,S.displacementMap=A.displacementMap,S.displacementScale=A.displacementScale,S.displacementBias=A.displacementBias,S.wireframeLinewidth=A.wireframeLinewidth,S.linewidth=A.linewidth,D.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const W=i.properties.get(S);W.light=D}return S}function v(E,A,D,b,S){if(E.visible===!1)return;if(E.layers.test(A.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&S===gn)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,E.matrixWorld);const k=e.update(E),K=E.material;if(Array.isArray(K)){const ie=k.groups;for(let Z=0,le=ie.length;Z<le;Z++){const Y=ie[Z],me=K[Y.materialIndex];if(me&&me.visible){const we=y(E,me,b,S);E.onBeforeShadow(i,E,A,D,k,we,Y),i.renderBufferDirect(D,null,k,we,E,Y),E.onAfterShadow(i,E,A,D,k,we,Y)}}}else if(K.visible){const ie=y(E,K,b,S);E.onBeforeShadow(i,E,A,D,k,ie,null),i.renderBufferDirect(D,null,k,ie,E,null),E.onAfterShadow(i,E,A,D,k,ie,null)}}const W=E.children;for(let k=0,K=W.length;k<K;k++)v(W[k],A,D,b,S)}function C(E){E.target.removeEventListener("dispose",C);for(const D in c){const b=c[D],S=E.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}const Jp={[zr]:kr,[Hr]:Wr,[Gr]:Xr,[Ei]:Vr,[kr]:zr,[Wr]:Hr,[Xr]:Gr,[Vr]:Ei};function jp(i,e){function t(){let N=!1;const ve=new ct;let q=null;const j=new ct(0,0,0,0);return{setMask:function(Me){q!==Me&&!N&&(i.colorMask(Me,Me,Me,Me),q=Me)},setLocked:function(Me){N=Me},setClear:function(Me,ge,Ge,dt,bt){bt===!0&&(Me*=dt,ge*=dt,Ge*=dt),ve.set(Me,ge,Ge,dt),j.equals(ve)===!1&&(i.clearColor(Me,ge,Ge,dt),j.copy(ve))},reset:function(){N=!1,q=null,j.set(-1,0,0,0)}}}function n(){let N=!1,ve=!1,q=null,j=null,Me=null;return{setReversed:function(ge){if(ve!==ge){const Ge=e.get("EXT_clip_control");ve?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT);const dt=Me;Me=null,this.setClear(dt)}ve=ge},getReversed:function(){return ve},setTest:function(ge){ge?ye(i.DEPTH_TEST):I(i.DEPTH_TEST)},setMask:function(ge){q!==ge&&!N&&(i.depthMask(ge),q=ge)},setFunc:function(ge){if(ve&&(ge=Jp[ge]),j!==ge){switch(ge){case zr:i.depthFunc(i.NEVER);break;case kr:i.depthFunc(i.ALWAYS);break;case Hr:i.depthFunc(i.LESS);break;case Ei:i.depthFunc(i.LEQUAL);break;case Gr:i.depthFunc(i.EQUAL);break;case Vr:i.depthFunc(i.GEQUAL);break;case Wr:i.depthFunc(i.GREATER);break;case Xr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=ge}},setLocked:function(ge){N=ge},setClear:function(ge){Me!==ge&&(ve&&(ge=1-ge),i.clearDepth(ge),Me=ge)},reset:function(){N=!1,q=null,j=null,Me=null,ve=!1}}}function s(){let N=!1,ve=null,q=null,j=null,Me=null,ge=null,Ge=null,dt=null,bt=null;return{setTest:function(nt){N||(nt?ye(i.STENCIL_TEST):I(i.STENCIL_TEST))},setMask:function(nt){ve!==nt&&!N&&(i.stencilMask(nt),ve=nt)},setFunc:function(nt,kt,Oe){(q!==nt||j!==kt||Me!==Oe)&&(i.stencilFunc(nt,kt,Oe),q=nt,j=kt,Me=Oe)},setOp:function(nt,kt,Oe){(ge!==nt||Ge!==kt||dt!==Oe)&&(i.stencilOp(nt,kt,Oe),ge=nt,Ge=kt,dt=Oe)},setLocked:function(nt){N=nt},setClear:function(nt){bt!==nt&&(i.clearStencil(nt),bt=nt)},reset:function(){N=!1,ve=null,q=null,j=null,Me=null,ge=null,Ge=null,dt=null,bt=null}}}const r=new t,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,g=null,y=null,v=null,C=null,E=null,A=new He(0,0,0),D=0,b=!1,S=null,U=null,W=null,k=null,K=null;const ie=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,le=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(Y)[1]),Z=le>=1):Y.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),Z=le>=2);let me=null,we={};const Le=i.getParameter(i.SCISSOR_BOX),qe=i.getParameter(i.VIEWPORT),tt=new ct().fromArray(Le),Q=new ct().fromArray(qe);function ae(N,ve,q,j){const Me=new Uint8Array(4),ge=i.createTexture();i.bindTexture(N,ge),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ge=0;Ge<q;Ge++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ve,0,i.RGBA,1,1,j,0,i.RGBA,i.UNSIGNED_BYTE,Me):i.texImage2D(ve+Ge,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Me);return ge}const Re={};Re[i.TEXTURE_2D]=ae(i.TEXTURE_2D,i.TEXTURE_2D,1),Re[i.TEXTURE_CUBE_MAP]=ae(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Re[i.TEXTURE_2D_ARRAY]=ae(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Re[i.TEXTURE_3D]=ae(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ye(i.DEPTH_TEST),o.setFunc(Ei),$(!1),ue(jo),ye(i.CULL_FACE),P(Mn);function ye(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function I(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function z(N,ve){return u[N]!==ve?(i.bindFramebuffer(N,ve),u[N]=ve,N===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ve),N===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ve),!0):!1}function ne(N,ve){let q=p,j=!1;if(N){q=d.get(ve),q===void 0&&(q=[],d.set(ve,q));const Me=N.textures;if(q.length!==Me.length||q[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,Ge=Me.length;ge<Ge;ge++)q[ge]=i.COLOR_ATTACHMENT0+ge;q.length=Me.length,j=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,j=!0);j&&i.drawBuffers(q)}function pe(N){return _!==N?(i.useProgram(N),_=N,!0):!1}const ee={[Kn]:i.FUNC_ADD,[mc]:i.FUNC_SUBTRACT,[_c]:i.FUNC_REVERSE_SUBTRACT};ee[gc]=i.MIN,ee[vc]=i.MAX;const re={[xc]:i.ZERO,[yc]:i.ONE,[Mc]:i.SRC_COLOR,[Or]:i.SRC_ALPHA,[Ac]:i.SRC_ALPHA_SATURATE,[Ec]:i.DST_COLOR,[wc]:i.DST_ALPHA,[Sc]:i.ONE_MINUS_SRC_COLOR,[Br]:i.ONE_MINUS_SRC_ALPHA,[Tc]:i.ONE_MINUS_DST_COLOR,[bc]:i.ONE_MINUS_DST_ALPHA,[Cc]:i.CONSTANT_COLOR,[Rc]:i.ONE_MINUS_CONSTANT_COLOR,[Pc]:i.CONSTANT_ALPHA,[Lc]:i.ONE_MINUS_CONSTANT_ALPHA};function P(N,ve,q,j,Me,ge,Ge,dt,bt,nt){if(N===Mn){x===!0&&(I(i.BLEND),x=!1);return}if(x===!1&&(ye(i.BLEND),x=!0),N!==pc){if(N!==m||nt!==b){if((f!==Kn||v!==Kn)&&(i.blendEquation(i.FUNC_ADD),f=Kn,v=Kn),nt)switch(N){case Si:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fr:i.blendFunc(i.ONE,i.ONE);break;case Qo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ea:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Si:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fr:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Qo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ea:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}g=null,y=null,C=null,E=null,A.set(0,0,0),D=0,m=N,b=nt}return}Me=Me||ve,ge=ge||q,Ge=Ge||j,(ve!==f||Me!==v)&&(i.blendEquationSeparate(ee[ve],ee[Me]),f=ve,v=Me),(q!==g||j!==y||ge!==C||Ge!==E)&&(i.blendFuncSeparate(re[q],re[j],re[ge],re[Ge]),g=q,y=j,C=ge,E=Ge),(dt.equals(A)===!1||bt!==D)&&(i.blendColor(dt.r,dt.g,dt.b,bt),A.copy(dt),D=bt),m=N,b=!1}function Pe(N,ve){N.side===at?I(i.CULL_FACE):ye(i.CULL_FACE);let q=N.side===zt;ve&&(q=!q),$(q),N.blending===Si&&N.transparent===!1?P(Mn):P(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const j=N.stencilWrite;a.setTest(j),j&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ze(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ye(i.SAMPLE_ALPHA_TO_COVERAGE):I(i.SAMPLE_ALPHA_TO_COVERAGE)}function $(N){S!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),S=N)}function ue(N){N!==fc?(ye(i.CULL_FACE),N!==U&&(N===jo?i.cullFace(i.BACK):N===dc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):I(i.CULL_FACE),U=N}function _e(N){N!==W&&(Z&&i.lineWidth(N),W=N)}function ze(N,ve,q){N?(ye(i.POLYGON_OFFSET_FILL),(k!==ve||K!==q)&&(i.polygonOffset(ve,q),k=ve,K=q)):I(i.POLYGON_OFFSET_FILL)}function he(N){N?ye(i.SCISSOR_TEST):I(i.SCISSOR_TEST)}function T(N){N===void 0&&(N=i.TEXTURE0+ie-1),me!==N&&(i.activeTexture(N),me=N)}function M(N,ve,q){q===void 0&&(me===null?q=i.TEXTURE0+ie-1:q=me);let j=we[q];j===void 0&&(j={type:void 0,texture:void 0},we[q]=j),(j.type!==N||j.texture!==ve)&&(me!==q&&(i.activeTexture(q),me=q),i.bindTexture(N,ve||Re[N]),j.type=N,j.texture=ve)}function B(){const N=we[me];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function X(){try{i.compressedTexImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function te(){try{i.compressedTexImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function J(){try{i.texSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ce(){try{i.texSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function fe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function be(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Je(){try{i.texStorage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function oe(){try{i.texStorage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ee(){try{i.texImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Fe(){try{i.texImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Be(N){tt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),tt.copy(N))}function Te(N){Q.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),Q.copy(N))}function Ke(N,ve){let q=c.get(ve);q===void 0&&(q=new WeakMap,c.set(ve,q));let j=q.get(N);j===void 0&&(j=i.getUniformBlockIndex(ve,N.name),q.set(N,j))}function Ve(N,ve){const j=c.get(ve).get(N);l.get(ve)!==j&&(i.uniformBlockBinding(ve,j,N.__bindingPointIndex),l.set(ve,j))}function st(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},me=null,we={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,g=null,y=null,v=null,C=null,E=null,A=new He(0,0,0),D=0,b=!1,S=null,U=null,W=null,k=null,K=null,tt.set(0,0,i.canvas.width,i.canvas.height),Q.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:ye,disable:I,bindFramebuffer:z,drawBuffers:ne,useProgram:pe,setBlending:P,setMaterial:Pe,setFlipSided:$,setCullFace:ue,setLineWidth:_e,setPolygonOffset:ze,setScissorTest:he,activeTexture:T,bindTexture:M,unbindTexture:B,compressedTexImage2D:X,compressedTexImage3D:te,texImage2D:Ee,texImage3D:Fe,updateUBOMapping:Ke,uniformBlockBinding:Ve,texStorage2D:Je,texStorage3D:oe,texSubImage2D:J,texSubImage3D:Ce,compressedTexSubImage2D:fe,compressedTexSubImage3D:be,scissor:Be,viewport:Te,reset:st}}function Ya(i,e,t,n){const s=Qp(n);switch(t){case pl:return i*e;case _l:return i*e;case gl:return i*e*2;case vl:return i*e/s.components*s.byteLength;case Io:return i*e/s.components*s.byteLength;case xl:return i*e*2/s.components*s.byteLength;case Uo:return i*e*2/s.components*s.byteLength;case ml:return i*e*3/s.components*s.byteLength;case tn:return i*e*4/s.components*s.byteLength;case No:return i*e*4/s.components*s.byteLength;case zs:case ks:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Hs:case Gs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Jr:case Qr:return Math.max(i,16)*Math.max(e,8)/4;case Zr:case jr:return Math.max(i,8)*Math.max(e,8)/2;case eo:case to:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case no:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case io:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case so:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case ro:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case oo:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case ao:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case lo:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case co:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ho:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case uo:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case fo:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case po:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case mo:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case _o:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case go:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Vs:case vo:case xo:return Math.ceil(i/4)*Math.ceil(e/4)*16;case yl:case yo:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Mo:case So:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Qp(i){switch(i){case bn:case ul:return{byteLength:1,components:1};case ns:case fl:case Sn:return{byteLength:2,components:1};case Lo:case Do:return{byteLength:2,components:4};case ti:case Po:case xn:return{byteLength:4,components:1};case dl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function em(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new de,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,M){return p?new OffscreenCanvas(T,M):is("canvas")}function x(T,M,B){let X=1;const te=he(T);if((te.width>B||te.height>B)&&(X=B/Math.max(te.width,te.height)),X<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const J=Math.floor(X*te.width),Ce=Math.floor(X*te.height);u===void 0&&(u=_(J,Ce));const fe=M?_(J,Ce):u;return fe.width=J,fe.height=Ce,fe.getContext("2d").drawImage(T,0,0,J,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+J+"x"+Ce+")."),fe}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),T;return T}function m(T){return T.generateMipmaps}function f(T){i.generateMipmap(T)}function g(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(T,M,B,X,te=!1){if(T!==null){if(i[T]!==void 0)return i[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let J=M;if(M===i.RED&&(B===i.FLOAT&&(J=i.R32F),B===i.HALF_FLOAT&&(J=i.R16F),B===i.UNSIGNED_BYTE&&(J=i.R8)),M===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.R8UI),B===i.UNSIGNED_SHORT&&(J=i.R16UI),B===i.UNSIGNED_INT&&(J=i.R32UI),B===i.BYTE&&(J=i.R8I),B===i.SHORT&&(J=i.R16I),B===i.INT&&(J=i.R32I)),M===i.RG&&(B===i.FLOAT&&(J=i.RG32F),B===i.HALF_FLOAT&&(J=i.RG16F),B===i.UNSIGNED_BYTE&&(J=i.RG8)),M===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RG8UI),B===i.UNSIGNED_SHORT&&(J=i.RG16UI),B===i.UNSIGNED_INT&&(J=i.RG32UI),B===i.BYTE&&(J=i.RG8I),B===i.SHORT&&(J=i.RG16I),B===i.INT&&(J=i.RG32I)),M===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RGB8UI),B===i.UNSIGNED_SHORT&&(J=i.RGB16UI),B===i.UNSIGNED_INT&&(J=i.RGB32UI),B===i.BYTE&&(J=i.RGB8I),B===i.SHORT&&(J=i.RGB16I),B===i.INT&&(J=i.RGB32I)),M===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),B===i.UNSIGNED_INT&&(J=i.RGBA32UI),B===i.BYTE&&(J=i.RGBA8I),B===i.SHORT&&(J=i.RGBA16I),B===i.INT&&(J=i.RGBA32I)),M===i.RGB&&B===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),M===i.RGBA){const Ce=te?Ks:Qe.getTransfer(X);B===i.FLOAT&&(J=i.RGBA32F),B===i.HALF_FLOAT&&(J=i.RGBA16F),B===i.UNSIGNED_BYTE&&(J=Ce===lt?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function v(T,M){let B;return T?M===null||M===ti||M===Ci?B=i.DEPTH24_STENCIL8:M===xn?B=i.DEPTH32F_STENCIL8:M===ns&&(B=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===ti||M===Ci?B=i.DEPTH_COMPONENT24:M===xn?B=i.DEPTH_COMPONENT32F:M===ns&&(B=i.DEPTH_COMPONENT16),B}function C(T,M){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Et&&T.minFilter!==an?Math.log2(Math.max(M.width,M.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?M.mipmaps.length:1}function E(T){const M=T.target;M.removeEventListener("dispose",E),D(M),M.isVideoTexture&&h.delete(M)}function A(T){const M=T.target;M.removeEventListener("dispose",A),S(M)}function D(T){const M=n.get(T);if(M.__webglInit===void 0)return;const B=T.source,X=d.get(B);if(X){const te=X[M.__cacheKey];te.usedTimes--,te.usedTimes===0&&b(T),Object.keys(X).length===0&&d.delete(B)}n.remove(T)}function b(T){const M=n.get(T);i.deleteTexture(M.__webglTexture);const B=T.source,X=d.get(B);delete X[M.__cacheKey],o.memory.textures--}function S(T){const M=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(M.__webglFramebuffer[X]))for(let te=0;te<M.__webglFramebuffer[X].length;te++)i.deleteFramebuffer(M.__webglFramebuffer[X][te]);else i.deleteFramebuffer(M.__webglFramebuffer[X]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[X])}else{if(Array.isArray(M.__webglFramebuffer))for(let X=0;X<M.__webglFramebuffer.length;X++)i.deleteFramebuffer(M.__webglFramebuffer[X]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let X=0;X<M.__webglColorRenderbuffer.length;X++)M.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[X]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const B=T.textures;for(let X=0,te=B.length;X<te;X++){const J=n.get(B[X]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(B[X])}n.remove(T)}let U=0;function W(){U=0}function k(){const T=U;return T>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),U+=1,T}function K(T){const M=[];return M.push(T.wrapS),M.push(T.wrapT),M.push(T.wrapR||0),M.push(T.magFilter),M.push(T.minFilter),M.push(T.anisotropy),M.push(T.internalFormat),M.push(T.format),M.push(T.type),M.push(T.generateMipmaps),M.push(T.premultiplyAlpha),M.push(T.flipY),M.push(T.unpackAlignment),M.push(T.colorSpace),M.join()}function ie(T,M){const B=n.get(T);if(T.isVideoTexture&&_e(T),T.isRenderTargetTexture===!1&&T.version>0&&B.__version!==T.version){const X=T.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Q(B,T,M);return}}t.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+M)}function Z(T,M){const B=n.get(T);if(T.version>0&&B.__version!==T.version){Q(B,T,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+M)}function le(T,M){const B=n.get(T);if(T.version>0&&B.__version!==T.version){Q(B,T,M);return}t.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+M)}function Y(T,M){const B=n.get(T);if(T.version>0&&B.__version!==T.version){ae(B,T,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+M)}const me={[Yr]:i.REPEAT,[Jn]:i.CLAMP_TO_EDGE,[Kr]:i.MIRRORED_REPEAT},we={[Et]:i.NEAREST,[kc]:i.NEAREST_MIPMAP_NEAREST,[ds]:i.NEAREST_MIPMAP_LINEAR,[an]:i.LINEAR,[er]:i.LINEAR_MIPMAP_NEAREST,[jn]:i.LINEAR_MIPMAP_LINEAR},Le={[Wc]:i.NEVER,[Zc]:i.ALWAYS,[Xc]:i.LESS,[Sl]:i.LEQUAL,[$c]:i.EQUAL,[Kc]:i.GEQUAL,[qc]:i.GREATER,[Yc]:i.NOTEQUAL};function qe(T,M){if(M.type===xn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===an||M.magFilter===er||M.magFilter===ds||M.magFilter===jn||M.minFilter===an||M.minFilter===er||M.minFilter===ds||M.minFilter===jn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,me[M.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,me[M.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,me[M.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,we[M.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,we[M.minFilter]),M.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Le[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Et||M.minFilter!==ds&&M.minFilter!==jn||M.type===xn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function tt(T,M){let B=!1;T.__webglInit===void 0&&(T.__webglInit=!0,M.addEventListener("dispose",E));const X=M.source;let te=d.get(X);te===void 0&&(te={},d.set(X,te));const J=K(M);if(J!==T.__cacheKey){te[J]===void 0&&(te[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,B=!0),te[J].usedTimes++;const Ce=te[T.__cacheKey];Ce!==void 0&&(te[T.__cacheKey].usedTimes--,Ce.usedTimes===0&&b(M)),T.__cacheKey=J,T.__webglTexture=te[J].texture}return B}function Q(T,M,B){let X=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(X=i.TEXTURE_3D);const te=tt(T,M),J=M.source;t.bindTexture(X,T.__webglTexture,i.TEXTURE0+B);const Ce=n.get(J);if(J.version!==Ce.__version||te===!0){t.activeTexture(i.TEXTURE0+B);const fe=Qe.getPrimaries(Qe.workingColorSpace),be=M.colorSpace===Un?null:Qe.getPrimaries(M.colorSpace),Je=M.colorSpace===Un||fe===be?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Je);let oe=x(M.image,!1,s.maxTextureSize);oe=ze(M,oe);const Ee=r.convert(M.format,M.colorSpace),Fe=r.convert(M.type);let Be=y(M.internalFormat,Ee,Fe,M.colorSpace,M.isVideoTexture);qe(X,M);let Te;const Ke=M.mipmaps,Ve=M.isVideoTexture!==!0,st=Ce.__version===void 0||te===!0,N=J.dataReady,ve=C(M,oe);if(M.isDepthTexture)Be=v(M.format===Ri,M.type),st&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,Be,oe.width,oe.height):t.texImage2D(i.TEXTURE_2D,0,Be,oe.width,oe.height,0,Ee,Fe,null));else if(M.isDataTexture)if(Ke.length>0){Ve&&st&&t.texStorage2D(i.TEXTURE_2D,ve,Be,Ke[0].width,Ke[0].height);for(let q=0,j=Ke.length;q<j;q++)Te=Ke[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Te.width,Te.height,Ee,Fe,Te.data):t.texImage2D(i.TEXTURE_2D,q,Be,Te.width,Te.height,0,Ee,Fe,Te.data);M.generateMipmaps=!1}else Ve?(st&&t.texStorage2D(i.TEXTURE_2D,ve,Be,oe.width,oe.height),N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,oe.width,oe.height,Ee,Fe,oe.data)):t.texImage2D(i.TEXTURE_2D,0,Be,oe.width,oe.height,0,Ee,Fe,oe.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ve&&st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,Be,Ke[0].width,Ke[0].height,oe.depth);for(let q=0,j=Ke.length;q<j;q++)if(Te=Ke[q],M.format!==tn)if(Ee!==null)if(Ve){if(N)if(M.layerUpdates.size>0){const Me=Ya(Te.width,Te.height,M.format,M.type);for(const ge of M.layerUpdates){const Ge=Te.data.subarray(ge*Me/Te.data.BYTES_PER_ELEMENT,(ge+1)*Me/Te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,ge,Te.width,Te.height,1,Ee,Ge)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Te.width,Te.height,oe.depth,Ee,Te.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,Be,Te.width,Te.height,oe.depth,0,Te.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Te.width,Te.height,oe.depth,Ee,Fe,Te.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,Be,Te.width,Te.height,oe.depth,0,Ee,Fe,Te.data)}else{Ve&&st&&t.texStorage2D(i.TEXTURE_2D,ve,Be,Ke[0].width,Ke[0].height);for(let q=0,j=Ke.length;q<j;q++)Te=Ke[q],M.format!==tn?Ee!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,Te.width,Te.height,Ee,Te.data):t.compressedTexImage2D(i.TEXTURE_2D,q,Be,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Te.width,Te.height,Ee,Fe,Te.data):t.texImage2D(i.TEXTURE_2D,q,Be,Te.width,Te.height,0,Ee,Fe,Te.data)}else if(M.isDataArrayTexture)if(Ve){if(st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,Be,oe.width,oe.height,oe.depth),N)if(M.layerUpdates.size>0){const q=Ya(oe.width,oe.height,M.format,M.type);for(const j of M.layerUpdates){const Me=oe.data.subarray(j*q/oe.data.BYTES_PER_ELEMENT,(j+1)*q/oe.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,oe.width,oe.height,1,Ee,Fe,Me)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,oe.width,oe.height,oe.depth,Ee,Fe,oe.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Be,oe.width,oe.height,oe.depth,0,Ee,Fe,oe.data);else if(M.isData3DTexture)Ve?(st&&t.texStorage3D(i.TEXTURE_3D,ve,Be,oe.width,oe.height,oe.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,oe.width,oe.height,oe.depth,Ee,Fe,oe.data)):t.texImage3D(i.TEXTURE_3D,0,Be,oe.width,oe.height,oe.depth,0,Ee,Fe,oe.data);else if(M.isFramebufferTexture){if(st)if(Ve)t.texStorage2D(i.TEXTURE_2D,ve,Be,oe.width,oe.height);else{let q=oe.width,j=oe.height;for(let Me=0;Me<ve;Me++)t.texImage2D(i.TEXTURE_2D,Me,Be,q,j,0,Ee,Fe,null),q>>=1,j>>=1}}else if(Ke.length>0){if(Ve&&st){const q=he(Ke[0]);t.texStorage2D(i.TEXTURE_2D,ve,Be,q.width,q.height)}for(let q=0,j=Ke.length;q<j;q++)Te=Ke[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Ee,Fe,Te):t.texImage2D(i.TEXTURE_2D,q,Be,Ee,Fe,Te);M.generateMipmaps=!1}else if(Ve){if(st){const q=he(oe);t.texStorage2D(i.TEXTURE_2D,ve,Be,q.width,q.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ee,Fe,oe)}else t.texImage2D(i.TEXTURE_2D,0,Be,Ee,Fe,oe);m(M)&&f(X),Ce.__version=J.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function ae(T,M,B){if(M.image.length!==6)return;const X=tt(T,M),te=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+B);const J=n.get(te);if(te.version!==J.__version||X===!0){t.activeTexture(i.TEXTURE0+B);const Ce=Qe.getPrimaries(Qe.workingColorSpace),fe=M.colorSpace===Un?null:Qe.getPrimaries(M.colorSpace),be=M.colorSpace===Un||Ce===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Je=M.isCompressedTexture||M.image[0].isCompressedTexture,oe=M.image[0]&&M.image[0].isDataTexture,Ee=[];for(let j=0;j<6;j++)!Je&&!oe?Ee[j]=x(M.image[j],!0,s.maxCubemapSize):Ee[j]=oe?M.image[j].image:M.image[j],Ee[j]=ze(M,Ee[j]);const Fe=Ee[0],Be=r.convert(M.format,M.colorSpace),Te=r.convert(M.type),Ke=y(M.internalFormat,Be,Te,M.colorSpace),Ve=M.isVideoTexture!==!0,st=J.__version===void 0||X===!0,N=te.dataReady;let ve=C(M,Fe);qe(i.TEXTURE_CUBE_MAP,M);let q;if(Je){Ve&&st&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ke,Fe.width,Fe.height);for(let j=0;j<6;j++){q=Ee[j].mipmaps;for(let Me=0;Me<q.length;Me++){const ge=q[Me];M.format!==tn?Be!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,ge.width,ge.height,Be,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ke,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,ge.width,ge.height,Be,Te,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ke,ge.width,ge.height,0,Be,Te,ge.data)}}}else{if(q=M.mipmaps,Ve&&st){q.length>0&&ve++;const j=he(Ee[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ke,j.width,j.height)}for(let j=0;j<6;j++)if(oe){Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Ee[j].width,Ee[j].height,Be,Te,Ee[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ke,Ee[j].width,Ee[j].height,0,Be,Te,Ee[j].data);for(let Me=0;Me<q.length;Me++){const Ge=q[Me].image[j].image;Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,Ge.width,Ge.height,Be,Te,Ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ke,Ge.width,Ge.height,0,Be,Te,Ge.data)}}else{Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Be,Te,Ee[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ke,Be,Te,Ee[j]);for(let Me=0;Me<q.length;Me++){const ge=q[Me];Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,Be,Te,ge.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ke,Be,Te,ge.image[j])}}}m(M)&&f(i.TEXTURE_CUBE_MAP),J.__version=te.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function Re(T,M,B,X,te,J){const Ce=r.convert(B.format,B.colorSpace),fe=r.convert(B.type),be=y(B.internalFormat,Ce,fe,B.colorSpace),Je=n.get(M),oe=n.get(B);if(oe.__renderTarget=M,!Je.__hasExternalTextures){const Ee=Math.max(1,M.width>>J),Fe=Math.max(1,M.height>>J);te===i.TEXTURE_3D||te===i.TEXTURE_2D_ARRAY?t.texImage3D(te,J,be,Ee,Fe,M.depth,0,Ce,fe,null):t.texImage2D(te,J,be,Ee,Fe,0,Ce,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),ue(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,te,oe.__webglTexture,0,$(M)):(te===i.TEXTURE_2D||te>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,te,oe.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ye(T,M,B){if(i.bindRenderbuffer(i.RENDERBUFFER,T),M.depthBuffer){const X=M.depthTexture,te=X&&X.isDepthTexture?X.type:null,J=v(M.stencilBuffer,te),Ce=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=$(M);ue(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe,J,M.width,M.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,J,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,J,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ce,i.RENDERBUFFER,T)}else{const X=M.textures;for(let te=0;te<X.length;te++){const J=X[te],Ce=r.convert(J.format,J.colorSpace),fe=r.convert(J.type),be=y(J.internalFormat,Ce,fe,J.colorSpace),Je=$(M);B&&ue(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je,be,M.width,M.height):ue(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je,be,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,be,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function I(T,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(M.depthTexture);X.__renderTarget=M,(!X.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),ie(M.depthTexture,0);const te=X.__webglTexture,J=$(M);if(M.depthTexture.format===wi)ue(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0);else if(M.depthTexture.format===Ri)ue(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function z(T){const M=n.get(T),B=T.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==T.depthTexture){const X=T.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),X){const te=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,X.removeEventListener("dispose",te)};X.addEventListener("dispose",te),M.__depthDisposeCallback=te}M.__boundDepthTexture=X}if(T.depthTexture&&!M.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");I(M.__webglFramebuffer,T)}else if(B){M.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[X]),M.__webglDepthbuffer[X]===void 0)M.__webglDepthbuffer[X]=i.createRenderbuffer(),ye(M.__webglDepthbuffer[X],T,!1);else{const te=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=M.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,te,i.RENDERBUFFER,J)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),ye(M.__webglDepthbuffer,T,!1);else{const X=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,te=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,te),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,te)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ne(T,M,B){const X=n.get(T);M!==void 0&&Re(X.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&z(T)}function pe(T){const M=T.texture,B=n.get(T),X=n.get(M);T.addEventListener("dispose",A);const te=T.textures,J=T.isWebGLCubeRenderTarget===!0,Ce=te.length>1;if(Ce||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=M.version,o.memory.textures++),J){B.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0){B.__webglFramebuffer[fe]=[];for(let be=0;be<M.mipmaps.length;be++)B.__webglFramebuffer[fe][be]=i.createFramebuffer()}else B.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){B.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)B.__webglFramebuffer[fe]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(Ce)for(let fe=0,be=te.length;fe<be;fe++){const Je=n.get(te[fe]);Je.__webglTexture===void 0&&(Je.__webglTexture=i.createTexture(),o.memory.textures++)}if(T.samples>0&&ue(T)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let fe=0;fe<te.length;fe++){const be=te[fe];B.__webglColorRenderbuffer[fe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[fe]);const Je=r.convert(be.format,be.colorSpace),oe=r.convert(be.type),Ee=y(be.internalFormat,Je,oe,be.colorSpace,T.isXRRenderTarget===!0),Fe=$(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Fe,Ee,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,B.__webglColorRenderbuffer[fe])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),ye(B.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),qe(i.TEXTURE_CUBE_MAP,M);for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0)for(let be=0;be<M.mipmaps.length;be++)Re(B.__webglFramebuffer[fe][be],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be);else Re(B.__webglFramebuffer[fe],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);m(M)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let fe=0,be=te.length;fe<be;fe++){const Je=te[fe],oe=n.get(Je);t.bindTexture(i.TEXTURE_2D,oe.__webglTexture),qe(i.TEXTURE_2D,Je),Re(B.__webglFramebuffer,T,Je,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,0),m(Je)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(fe=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(fe,X.__webglTexture),qe(fe,M),M.mipmaps&&M.mipmaps.length>0)for(let be=0;be<M.mipmaps.length;be++)Re(B.__webglFramebuffer[be],T,M,i.COLOR_ATTACHMENT0,fe,be);else Re(B.__webglFramebuffer,T,M,i.COLOR_ATTACHMENT0,fe,0);m(M)&&f(fe),t.unbindTexture()}T.depthBuffer&&z(T)}function ee(T){const M=T.textures;for(let B=0,X=M.length;B<X;B++){const te=M[B];if(m(te)){const J=g(T),Ce=n.get(te).__webglTexture;t.bindTexture(J,Ce),f(J),t.unbindTexture()}}}const re=[],P=[];function Pe(T){if(T.samples>0){if(ue(T)===!1){const M=T.textures,B=T.width,X=T.height;let te=i.COLOR_BUFFER_BIT;const J=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ce=n.get(T),fe=M.length>1;if(fe)for(let be=0;be<M.length;be++)t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let be=0;be<M.length;be++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(te|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(te|=i.STENCIL_BUFFER_BIT)),fe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[be]);const Je=n.get(M[be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Je,0)}i.blitFramebuffer(0,0,B,X,0,0,B,X,te,i.NEAREST),l===!0&&(re.length=0,P.length=0,re.push(i.COLOR_ATTACHMENT0+be),T.depthBuffer&&T.resolveDepthBuffer===!1&&(re.push(J),P.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,re))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),fe)for(let be=0;be<M.length;be++){t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[be]);const Je=n.get(M[be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,Je,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const M=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function $(T){return Math.min(s.maxSamples,T.samples)}function ue(T){const M=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function _e(T){const M=o.render.frame;h.get(T)!==M&&(h.set(T,M),T.update())}function ze(T,M){const B=T.colorSpace,X=T.format,te=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||B!==Di&&B!==Un&&(Qe.getTransfer(B)===lt?(X!==tn||te!==bn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),M}function he(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=W,this.setTexture2D=ie,this.setTexture2DArray=Z,this.setTexture3D=le,this.setTextureCube=Y,this.rebindTextures=ne,this.setupRenderTarget=pe,this.updateRenderTargetMipmap=ee,this.updateMultisampleRenderTarget=Pe,this.setupDepthRenderbuffer=z,this.setupFrameBufferTexture=Re,this.useMultisampledRTT=ue}function tm(i,e){function t(n,s=Un){let r;const o=Qe.getTransfer(s);if(n===bn)return i.UNSIGNED_BYTE;if(n===Lo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Do)return i.UNSIGNED_SHORT_5_5_5_1;if(n===dl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ul)return i.BYTE;if(n===fl)return i.SHORT;if(n===ns)return i.UNSIGNED_SHORT;if(n===Po)return i.INT;if(n===ti)return i.UNSIGNED_INT;if(n===xn)return i.FLOAT;if(n===Sn)return i.HALF_FLOAT;if(n===pl)return i.ALPHA;if(n===ml)return i.RGB;if(n===tn)return i.RGBA;if(n===_l)return i.LUMINANCE;if(n===gl)return i.LUMINANCE_ALPHA;if(n===wi)return i.DEPTH_COMPONENT;if(n===Ri)return i.DEPTH_STENCIL;if(n===vl)return i.RED;if(n===Io)return i.RED_INTEGER;if(n===xl)return i.RG;if(n===Uo)return i.RG_INTEGER;if(n===No)return i.RGBA_INTEGER;if(n===zs||n===ks||n===Hs||n===Gs)if(o===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===zs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===zs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ks)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Zr||n===Jr||n===jr||n===Qr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Zr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Jr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===jr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===eo||n===to||n===no)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===eo||n===to)return o===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===no)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===io||n===so||n===ro||n===oo||n===ao||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===_o||n===go)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===io)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===so)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ro)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ao)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===lo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===co)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ho)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===uo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===po)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===mo)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===_o)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===go)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Vs||n===vo||n===xo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Vs)return o===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===xo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===yl||n===yo||n===Mo||n===So)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Vs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===yo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Mo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===So)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ci?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class nm extends Xt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Qn extends At{constructor(){super(),this.isGroup=!0,this.type="Group"}}const im={type:"move"};class Rr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Qn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Qn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Qn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const x of e.hand.values()){const m=t.getJointPose(x,n),f=this._getHandJoint(c,x);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,_=.005;c.inputState.pinching&&d>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(im)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Qn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const sm=`
void main() {
...
---
\`sig:${$}\` | *UNPLUG: Elemental Survivor*`,ze=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(ue)}&body=${encodeURIComponent(_e)}&labels=record`;window.open(ze,"_blank")}),(ye=document.getElementById("retry-btn"))==null||ye.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",R=new Ki,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]}),window._restartGame=()=>{R=new Ki,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]};const o={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",I=>{const z=o[I.code]||I.key.toLowerCase();if(I.code==="Space"&&I.preventDefault(),I.code==="Space"&&!R.level_up_pending()&&!R.is_paused()&&R.player_dash_cooldown()<=0&&je.playDash(),I.code==="Escape"){R.toggle_pause();const ne=R.is_paused();document.getElementById("pause-menu").style.display=ne?"flex":"none",ne&&A();return}if(I.code==="Tab"){I.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(R.on_key_down(z),R.level_up_pending()){const ne=R.player_class_tier();if(z==="1"){const pe=Xi(R.level_up_choice(0));R.choose_upgrade(0),R.player_class_tier()>ne?U(R.player_class_tier()):S(pe),b()}if(z==="2"){const pe=Xi(R.level_up_choice(1));R.choose_upgrade(1),R.player_class_tier()>ne?U(R.player_class_tier()):S(pe),b()}if(z==="3"){const pe=Xi(R.level_up_choice(2));R.choose_upgrade(2),R.player_class_tier()>ne?U(R.player_class_tier()):S(pe),b()}}}),document.addEventListener("keyup",I=>{const z=o[I.code]||I.key.toLowerCase();R.on_key_up(z)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",I=>I.preventDefault()),document.addEventListener("contextmenu",I=>{t&&I.preventDefault()}),a.addEventListener("selectstart",I=>I.preventDefault());let l=null,c=!1,h=null,u=[],d=null,p=null;a.addEventListener("mousedown",I=>{if(!(!t||!R))if(I.preventDefault(),I.button===0){if(l={x:I.clientX,y:I.clientY,button:0},u=[{x:I.clientX,y:I.clientY}],c=!1,Wi.clear(),Wi.addPoint(I.clientX,I.clientY),g(),document.body.style.cursor="crosshair",!document.getElementById("gesture-desaturate")){const z=document.createElement("div");z.id="gesture-desaturate",z.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.15);pointer-events:none;z-index:990;transition:opacity 0.1s",document.body.appendChild(z)}}else I.button===2&&R.player_class_tier()>=2&&(l={x:I.clientX,y:I.clientY,button:2},u=[{x:I.clientX,y:I.clientY}],c=!1,g())}),document.addEventListener("mousemove",I=>{if(!l)return;const z=I.clientX-l.x,ne=I.clientY-l.y,pe=Math.sqrt(z*z+ne*ne);if(u.push({x:I.clientX,y:I.clientY}),v(u),pe>20){c=!0;const ee=_(u,l);if(!p){const he=document.createElement("canvas");he.width=window.innerWidth,he.height=window.innerHeight,he.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(he),p=he}const re=p.getContext("2d");if(re.clearRect(0,0,p.width,p.height),u.length>2){const he=yt(),T={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};re.strokeStyle=T[he]||T[0],re.lineWidth=3,re.lineCap="round",re.beginPath(),re.moveTo(u[0].x,u[0].y);for(let M=1;M<u.length;M++)re.lineTo(u[M].x,u[M].y);re.stroke(),ee==="circle"&&(re.strokeStyle="rgba(255,200,0,0.7)",re.lineWidth=5,re.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),d||(d=document.createElement("div"),d.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(d));const P=Math.min(50+pe*.4,100),Pe=yt(),$=l.button===2,_e=($?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[Pe]||($?"#ccaaff":"#8888ff");h.style.width=P+"px",h.style.height=P+"px",h.style.borderColor=_e,h.style.boxShadow=`0 0 ${P/4}px ${_e}, inset 0 0 ${P/6}px ${_e}`;const ze={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=ze[ee]||"...",e&&e.camera){const he=e.projectToScreen(R.player_x(),.5,R.player_z());if(h.style.left=he.x-P/2+"px",h.style.top=he.y-P/2+"px",ee==="outward"){const T=Math.atan2(ne,z),M=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let B=Math.round(T/(Math.PI/4));B<0&&(B+=8),B=B%8,d.textContent=M[B],d.style.fontSize="32px";const X=50;d.style.left=he.x+Math.cos(T)*X-16+"px",d.style.top=he.y+Math.sin(T)*X-16+"px",d.style.opacity="1"}else ee==="inward"?(d.textContent="🛡️",d.style.fontSize="28px",d.style.left=he.x-14+"px",d.style.top=he.y-14+"px",d.style.opacity="1"):ee==="circle"?(d.textContent="🌀",d.style.left=he.x-14+"px",d.style.top=he.y-40+"px",d.style.opacity="1"):(d.style.opacity="0.3",d.textContent="?")}}}),document.addEventListener("mouseup",I=>{if(!l||!R){l=null;return}const z=I.clientX-l.x,ne=I.clientY-l.y,pe=Math.sqrt(z*z+ne*ne),ee=l.button;document.body.style.cursor="";const re=document.getElementById("gesture-desaturate");if(re&&re.remove(),C(),h&&(h.remove(),h=null),d&&(d.remove(),d=null),p&&(p.remove(),p=null),y(),ee===0&&R.player_class_tier()>0)if(c&&pe>30){const P=_(u,l),Pe=Math.atan2(-ne,z);if(P==="outward"){if(R.player_class_tier()>0&&!m(20)){l=null,c=!1,u=[];return}R.use_directional_skill(Pe);const $=yt(),ue=document.createElement("div"),_e={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};ue.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${_e[$]||_e[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(ue),setTimeout(()=>ue.remove(),150),e.spawnDirectionalEffect(R.player_x(),R.player_z(),Pe,$,7),e.hitStop(.05),e.shake(.5,.12),e.zoomPunch(1.5,.15),window._onboardingActive&&s(),$===1?je.playElementFire():$===2?je.playElementIce():$===3?je.playElementThunder():$===4?je.playElementPoison():je.playHit(),E("outward")}else if(P==="inward")R.use_shield_skill(),je.playShield(),e.spawnShieldEffect(R.player_x(),R.player_z(),yt()),e.shake(.15,.05),E("inward");else if(P==="circle"){if(R.player_class_tier()>0&&!m(50)){l=null,c=!1,u=[];return}R.use_ultimate_skill(),je.playUltimate(yt());const $=yt();e.spawnUltimateEffect(R.player_x(),R.player_z(),$,10),e.hitStop(.12),e.shake(.8,.25),E("circle");const ue={0:"rgba(255,255,255,0.4)",1:"rgba(255,80,0,0.35)",2:"rgba(50,180,255,0.35)",3:"rgba(255,200,0,0.35)",4:"rgba(150,50,255,0.35)"},_e=document.createElement("div");_e.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ue[$]||ue[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(_e),setTimeout(()=>_e.remove(),400);const ze=document.createElement("div");ze.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(ze),setTimeout(()=>ze.remove(),600),window._onboardingActive&&s()}else if(P==="zigzag"){if(R.player_class_tier()>0&&!m(35)){l=null,c=!1,u=[];return}const $=yt();for(let ue=-1;ue<=1;ue++){const _e=Math.atan2(-ne,z)+ue*.4;setTimeout(()=>{R.use_directional_skill(_e),e.spawnDirectionalEffect(R.player_x(),R.player_z(),_e,$,5)},ue*80+80)}e.hitStop(.06),e.shake(.4,.15),je.playElementThunder(),E("zigzag")}else if(P==="vshape"){if(R.player_class_tier()>0&&!m(25)){l=null,c=!1,u=[];return}R.use_shield_skill();const $=yt();e.spawnShieldEffect(R.player_x(),R.player_z(),$),setTimeout(()=>{const ue=Math.atan2(-ne,z);R.use_directional_skill(ue),e.spawnDirectionalEffect(R.player_x(),R.player_z(),ue,$,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),je.playShield(),E("vshape")}else if(P==="upstroke"){if(R.player_class_tier()>0&&!m(30)){l=null,c=!1,u=[];return}const $=Math.atan2(-ne,z);R.use_directional_skill($);const ue=yt();e.spawnDirectionalEffect(R.player_x(),R.player_z(),$,ue,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),ue===1?je.playElementFire():ue===2?je.playElementIce():ue===3?je.playElementThunder():je.playHit(),E("upstroke")}else R.use_directional_skill(Math.atan2(-ne,z)),e.shake(.1,.05)}else c||(R.use_active_skill(),e.shake(.2,.08));else if(ee===2&&R.player_class_tier()>=2)if(c&&pe>30){const P=_(u,l),Pe=Math.atan2(-ne,z);if(P==="outward"){if(!m(20)){l=null,c=!1,u=[];return}R.use_directional_skill(Pe);const $=yt();e.spawnAdvancedDirectionalEffect(R.player_x(),R.player_z(),Pe,$,9),je.playAdvancedSkill($),e.shake(.55,.15),E("outward")}else if(P==="circle"){if(!m(50)){l=null,c=!1,u=[];return}const $=yt();R.use_ultimate_skill(),je.playAdvancedUltimate($),e.spawnAdvancedUltimateEffect(R.player_x(),R.player_z(),$,12),e.shake(.9,.3),E("circle");const ue=document.createElement("div");ue.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",ue.style.background=$===1?"rgba(255,100,0,0.3)":$===2?"rgba(100,200,255,0.3)":$===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(ue),setTimeout(()=>ue.remove(),400),e.shake(.7,.25),E("circle")}else R.use_active_skill(),e.shake(.3,.1),E("outward")}else c||(R.use_active_skill(),e.spawnSkillEffect(R.player_x(),R.player_z(),yt(),4),e.shake(.25,.08));l=null,c=!1,u=[]});function _(I,z){if(I.length<5)return"unknown";const ne=I[I.length-1],pe=ne.x-z.x,ee=ne.y-z.y,re=Math.sqrt(pe*pe+ee*ee);if(I.length>30){let P=0;for(let $=2;$<I.length;$++){const ue=I[$-1].x-I[$-2].x,_e=I[$-1].y-I[$-2].y,ze=I[$].x-I[$-1].x,he=I[$].y-I[$-1].y,T=ue*he-_e*ze,M=ue*ze+_e*he;P+=Math.atan2(T,M)}const Pe=Math.sqrt((ne.x-z.x)**2+(ne.y-z.y)**2);if(Math.abs(P)>Math.PI*1.9&&Pe<120)return"circle"}if(I.length>15){let P=0,Pe=0;for(let $=3;$<I.length;$+=3){const ue=I[$].x-I[$-3].x;Pe!==0&&Math.sign(ue)!==Math.sign(Pe)&&Math.abs(ue)>10&&P++,Math.abs(ue)>10&&(Pe=ue)}if(P>=3&&re<200)return"zigzag"}if(I.length>10){let P=0;for(let $=1;$<I.length;$++)I[$].y>I[P].y&&(P=$);const Pe=P/I.length;if(Pe>.25&&Pe<.75){const $=I[P].y-z.y,ue=I[P].y-ne.y;if($>40&&ue>40&&re<150)return"vshape"}}if(re>60&&ee<-50&&Math.abs(pe)<Math.abs(ee)*.5)return"upstroke";if(e&&e.camera){const P=e.projectToScreen(R.player_x(),.5,R.player_z()),Pe=Math.sqrt((z.x-P.x)**2+(z.y-P.y)**2),$=Math.sqrt((ne.x-P.x)**2+(ne.y-P.y)**2);if($<Pe-20)return"inward";if($>Pe+20)return"outward"}return re>40?"outward":"unknown"}function x(){const I=document.getElementById("stamina-bar-bg");if(!I)return;I.style.border="2px solid #ff4444";const z=document.createElement("div");z.textContent="⚠️ Mana 부족!",z.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(z),setTimeout(()=>{z.remove(),I.style.border="1px solid #2a4a2a"},1e3)}function m(I){return R.player_stamina()<I?(x(),!1):!0}let f=null;function g(){f||(f=document.createElement("div"),f.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",f.innerHTML=`
        ...
        `,document.body.appendChild(f))}function y(){f&&(f.remove(),f=null)}function v(I){Wi.setStyle(R.player_class_tier(),yt());const z=I[I.length-1];z&&Wi.addPoint(z.x,z.y)}function C(){Wi.release()}function E(I){const z=R.learned_skill_count();if(z===0)return;let ne="",pe="#fff";if(I==="outward"){for(let re=0;re<z;re++)if(R.learned_skill_type(re)===0){ne=R.learned_skill_name(re);break}pe="#ff8844"}else if(I==="inward"){for(let re=0;re<z;re++)if(R.learned_skill_type(re)===1){ne=R.learned_skill_name(re);break}ne||(ne="Shield"),pe="#44ff88"}else if(I==="circle"){for(let re=0;re<z;re++)if(R.learned_skill_type(re)===2){ne=R.learned_skill_name(re);break}ne||(ne="Ultimate"),pe="#ffcc00"}ne||(ne="Skill");const ee=document.createElement("div");ee.textContent=I==="circle"?`✨ ${ne} ✨`:ne,ee.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${pe};font-size:${I==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${pe},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(ee),setTimeout(()=>ee.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{R.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function A(){let I="<b>📜 Status</b><br><br>";const z=R.fire_level(),ne=R.ice_level(),pe=R.thunder_level(),ee=R.poison_level();I+="<b>⚗️ Element Orbs</b><br>",z>0&&(I+=`  🔥 Fire: ${z}<br>`),ne>0&&(I+=`  ❄️ Ice: ${ne}<br>`),pe>0&&(I+=`  ⚡ Thunder: ${pe}<br>`),ee>0&&(I+=`  ☠️ Poison: ${ee}<br>`),z+ne+pe+ee===0&&(I+='  <span style="color:#666">없음</span><br>');const re=R.player_class_tier();if(re>0){I+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[re]||""} ${R.player_class_name()}</b> (Tier ${re})<br>`;const Pe=R.learned_skill_count();if(Pe>0){I+="<br><b>🗡️ Class Skills</b><br>";for(let $=0;$<Pe;$++){const ue=R.learned_skill_name($),_e=R.learned_skill_level($);I+=`  📈 ${ue} <span style="color:#ffcc00">Lv.${_e}</span><br>`}}}else I+='<br><span style="color:#666">Lv.10에서 첫 전직 가능</span><br>',I+='<span style="color:#555;font-size:10px">원소를 모아 조합 조건을 맞추세요!</span>';if(re===0||re===1||re===2){const P=re===0?10:re===1?25:45;R.player_level()<P&&(I+=`<br><br><span style="color:#888;font-size:10px">다음 전직: Lv.${P}</span>`)}document.getElementById("pause-skills").innerHTML=I}for(let I=0;I<3;I++)document.getElementById(`choice-${I}`).addEventListener("click",()=>{const z=R.level_up_choice(I),ne=Xi(z),pe=R.player_class_tier();R.choose_upgrade(I);const ee=R.player_class_tier();ee>pe?U(ee):S(ne),b()});function D(){const I=document.getElementById("levelup");I.style.display="block",I.classList.add("shown");for(let ne=0;ne<3;ne++){const pe=R.level_up_choice(ne),ee=Xi(pe),re=m0(pe);let P="";if(pe>=50&&pe<=53){const $=pe-50+1,ue=[0,R.fire_level(),R.ice_level(),R.thunder_level(),R.poison_level()][$],_e=R.player_class_tier()===0?1:4,ze=Math.max(0,_e-ue-1);ze===0?P='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':P=`<span style="color:#555;font-size:10px">→ ${ze} more to promote</span>`}else pe>=100&&(P=`<span style="color:#daa520;font-size:10px">${Wt.star(10)} Class change!</span>`);const Pe=pe>=50&&pe<=53?rl(pe-49,18):pe>=100?Wt.star(18):"";document.getElementById(`choice-${ne}`).innerHTML=`
            <div style="display:flex;align-items:center;gap:6px">
              ${Pe}<span style="font-size:13px;font-weight:bold">[${ne+1}] ${ee}</span>
            </div>
            <div style="color:#999;font-size:11px;margin-top:4px">${re}</div>
            ${P?`<div style="margin-top:4px">${P}</div>`:""}
          `}let z=document.getElementById("levelup-hint");z||(z=document.createElement("div"),z.id="levelup-hint",z.style.cssText="color:#daa520;font-size:11px;margin-top:10px;text-align:center;opacity:0.8",I.appendChild(z)),R.player_class_tier()===0&&R.player_level()<=4?(z.textContent="Choose element orbs to unlock class promotion",z.style.display="block"):z.style.display="none"}function b(){const I=document.getElementById("levelup");I.style.display="none",I.classList.remove("shown"),K=!1,je.playPickup()}function S(I){const z=document.createElement("div");z.style.cssText="position:fixed;top:18%;left:50%;transform:translateX(-50%);z-index:9998;pointer-events:none;text-align:center;animation:skill-acquired 1.8s ease-out forwards",z.innerHTML=`<div style="font-size:16px;color:#fff;text-shadow:0 0 8px rgba(255,200,50,0.8);background:rgba(0,0,0,0.7);padding:8px 20px;border-radius:20px;border:1px solid rgba(255,200,50,0.4)">✨ ${I}</div>`,document.body.appendChild(z),setTimeout(()=>z.remove(),1800)}function U(I){const z=yt(),ne=R.player_class_name()||"",ee={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[z]||"#daa520";e.hitStop(.3);const re=document.createElement("div");re.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:9998;
          ...
          `,document.body.appendChild($),requestAnimationFrame(()=>{$.style.opacity="1",$.style.transform="translate(-50%,-50%) scale(1)"}),setTimeout(()=>{$.style.opacity="0",$.style.transform="translate(-50%,-50%) scale(1.1)"},1800),setTimeout(()=>$.remove(),2300)},400),setTimeout(()=>{const Pe=document.createElement("div");Pe.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ee}55;
            pointer-events:none;z-index:9999;animation:flash-fade 0.5s ease-out forwards`,document.body.appendChild(Pe),setTimeout(()=>Pe.remove(),500),e.shake(.6,.25),e.zoomPunch(3,.2),je.playLevelUp(),setTimeout(()=>je.playShield(),100)},800),setTimeout(()=>{z===1?R.use_ultimate_skill():z===2?R.use_shield_skill():z===3||z===4?R.use_ultimate_skill():R.use_directional_skill(0),e.spawnUltimateEffect(R.player_x(),R.player_z(),z,12),e.shake(.3,.15)},1200),setTimeout(()=>{re.style.boxShadow="inset 0 0 0 0 rgba(0,0,0,0)",P.style.opacity="0",setTimeout(()=>{re.remove(),P.remove()},500)},2e3)}const W=[];let k="",K=!1;function ie(){const I=R.player_promoted(),z=I?R.player_class_name():"",ne={1:"⭐",2:"🌟",3:"👑"},pe=R.player_class_tier(),ee=ne[pe]||"";document.getElementById("level").textContent=R.player_level()+(z?` ${ee}${z}`:"");const re=yt(),P=document.getElementById("portrait"),Pe={0:Wt.sword(24),1:Wt.fire(24),2:Wt.ice(24),3:Wt.thunder(24),4:Wt.poison(24)},$={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"};P.innerHTML=Pe[re]||Wt.sword(24),P.style.borderColor=$[re]||"#555",I?P.style.boxShadow=`0 0 10px ${$[re]}`:P.style.boxShadow="none";const ue=Math.max(0,R.player_hp()/R.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=ue+"%";const _e=Math.max(0,R.player_shield()/R.player_max_hp()*100),ze=document.getElementById("shield-bar-fill");ze.style.width=_e+"%",ze.style.left=ue+"%";const he=R.player_xp()/R.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=he+"%";const T=document.getElementById("stat-panel"),M=R.player_class_tier(),B=R.fire_level(),X=R.ice_level(),te=R.thunder_level(),J=R.poison_level(),Ce=R.element_total();let fe=document.getElementById("promo-hud");if(fe||(fe=document.createElement("div"),fe.id="promo-hud",fe.style.cssText="margin-top:6px;font-size:11px;color:#8a8680;line-height:1.5;background:rgba(8,6,12,0.85);padding:4px 8px;border-radius:4px;border:1px solid rgba(218,165,32,0.15);max-width:170px;backdrop-filter:blur(4px)",document.getElementById("stats").appendChild(fe)),M<3){const Oe=M===0?1:M===1?4:7,it=M===0?2:M===1?4:7,It=R.player_level()>=it,gt=R.promotion_available_count()>0;let xt;gt?xt="⭐ PROMOTION READY! (Level up to choose)":It?xt=`Need ${Oe} of same element (${Ce} total)`:xt=`Next: Lv${it} + ${Oe} orbs (${Ce}/${Oe})`,fe.innerHTML=`<span style="color:${B>0?"#ff4400":"#333"}">${Wt.fire(12,B>0?"#ff4400":"#333")}${B}</span> <span style="color:${X>0?"#44ccff":"#333"}">${Wt.ice(12,X>0?"#44ccff":"#333")}${X}</span> <span style="color:${te>0?"#ffcc00":"#333"}">${Wt.thunder(12,te>0?"#ffcc00":"#333")}${te}</span> <span style="color:${J>0?"#9933ff":"#333"}">${Wt.poison(12,J>0?"#9933ff":"#333")}${J}</span><br><span style="color:${gt?"#daa520":"#666"};font-size:10px">${xt}</span>`,fe.style.display="block"}else fe.style.display="none";T&&(T.style.display=window._showDetailStats?"block":"none",window._showDetailStats&&(T.innerHTML=`⚔️ ATK <span style="color:#ff8844">${Math.round(R.player_damage())}</span><br>⚡ SPD <span style="color:#44ccff">${R.player_atk_speed().toFixed(1)}/s</span><br>🎯 RNG <span style="color:#88ff44">${R.player_range().toFixed(1)}</span><br>💥 CRT <span style="color:#ff4488">${Math.round(R.player_crit()*100)}%</span><br>🗡️ PRC <span style="color:#ffcc44">${R.player_pierce()}</span> 🔫 ×<span style="color:#44ffcc">${R.player_multi()}</span><br>🧛 STEAL <span style="color:#ff44ff">${Math.round(R.player_lifesteal()*100)}%</span>`));const be={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},Je={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},oe={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},Ee=R.skill_slot_count(),Fe=R.learned_skill_count();let Be="";for(let Oe=0;Oe<Ee;Oe++)Be+=R.skill_slot_id(Oe)+":"+R.skill_slot_level(Oe)+",";Be+="|"+Fe;for(let Oe=0;Oe<Fe;Oe++)Be+=R.learned_skill_id(Oe)+":"+R.learned_skill_level(Oe)+",";if(Be!==k){k=Be;let Oe="";for(let it=0;it<Ee;it++){const It=R.skill_slot_id(it),gt=R.skill_slot_level(it),xt=be[It]||"⭐",Rt=Je[It]||"#888",ii=oe[It]||"Skill";Oe+=`<div class="skill-icon" style="background:${Rt}22;border-color:${Rt}">
              ${xt}<span class="sk-lvl">${gt}</span>
              <div class="sk-tooltip"><b style="color:${Rt}">${ii} Lv.${gt}</b></div>
            </div>`}if(Fe>0){Oe+='<div style="width:2px;height:28px;background:#333;margin:0 4px"></div>';for(let it=0;it<Fe;it++){const It=R.learned_skill_name(it),gt=R.learned_skill_level(it),xt=R.learned_skill_desc(it),Rt=R.learned_skill_type(it),ii=Rt===0?"⚔️":Rt===1?"🛡️":"💫",si=Rt===0?"AUTO":Rt===1?"PASSIVE":"ULT",kn=Rt===0?"#44ccff":Rt===1?"#44ff44":"#ffcc00";Oe+=`<div class="skill-icon class-skill" data-skill-idx="${it}" style="background:${kn}15;border-color:${kn}">
              ...
              </div>`}}document.getElementById("skill-slots").innerHTML=Oe,document.querySelectorAll(".skill-icon").forEach(it=>{it.addEventListener("click",It=>{const gt=it.classList.contains("active-tip");document.querySelectorAll(".skill-icon").forEach(xt=>xt.classList.remove("active-tip")),gt||it.classList.add("active-tip"),It.stopPropagation()})})}document.querySelectorAll(".class-skill").forEach(Oe=>{const it=parseInt(Oe.dataset.skillIdx);if(isNaN(it))return;const It=R.learned_skill_cd(it),gt=R.learned_skill_max_cd(it),xt=Oe.querySelector(".sk-cd-overlay");if(xt)if(It>0){const Rt=It/gt;xt.style.background=`conic-gradient(rgba(0,0,0,0.7) ${Rt*360}deg, transparent ${Rt*360}deg)`,xt.style.display="block"}else xt.style.display="none"});const Te=Math.floor(R.game_time()),Ke=Math.floor(Te/60),Ve=Te%60;document.getElementById("timer").textContent=`${Ke}:${Ve.toString().padStart(2,"0")}`;const st=R.wave_number(),N=st>0&&st%10===0;if(document.getElementById("kills").textContent=N?`⚠️ WAVE 0 — BOSS ⚠️ | ${R.kills()} kills`:`Wave ${st} | ${R.kills()} kills`,N&&!window._bossShown){window._bossShown=!0;const Oe=document.createElement("div");Oe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,0,0,0.4);pointer-events:none;z-index:9999;transition:opacity 1s",document.body.appendChild(Oe),setTimeout(()=>{Oe.style.opacity="0"},200),setTimeout(()=>Oe.remove(),1200);const it=document.createElement("div");it.style.cssText="position:fixed;top:40%;left:50%;transform:translate(-50%,-50%);z-index:9999;pointer-events:none;text-align:center;animation:promo-pop 2s ease-out forwards",it.innerHTML='<div style="font-size:42px;color:#ff2200;text-shadow:0 0 30px #ff0000,0 0 60px #880000;font-weight:bold">💀 BOSS 💀</div><div style="font-size:18px;color:#ffaa00;margin-top:8px">ALL ENEMIES CLEARED — DUEL!</div>',document.body.appendChild(it),setTimeout(()=>it.remove(),2500),e.shake(.8,.3),e.hitStop(.2),je.playUltimate(1)}else N||(window._bossShown=!1);if(R.boss_active()){let Oe=document.getElementById("boss-bar");Oe||(Oe=document.createElement("div"),Oe.id="boss-bar",Oe.style.cssText="position:fixed;top:50px;left:50%;transform:translateX(-50%);width:300px;text-align:center;z-index:100",Oe.innerHTML='<div style="color:#ff4444;font-size:12px;margin-bottom:4px">💀 BOSS</div><div style="width:100%;height:10px;background:#333;border-radius:5px;border:1px solid #ff4444"><div id="boss-hp-fill" style="height:100%;background:linear-gradient(90deg,#ff2222,#ff6644);border-radius:4px;transition:width 0.1s"></div></div>',document.body.appendChild(Oe)),document.getElementById("boss-hp-fill").style.width=R.boss_hp_pct()*100+"%"}else{const Oe=document.getElementById("boss-bar");Oe&&Oe.remove()}R.level_up_pending()&&!K&&(D(),K=!0,je.playLevelUp()),R.wave_event_pending()&&!R.level_up_pending()&&!window._waveEventShown&&(window._waveEventShown=!0,u0(R)),R.wave_event_pending()||(window._waveEventShown=!1),f0(R);let ve;for(;(ve=R.pop_log())!==void 0;)W.push(ve),W.length>4&&W.shift();document.getElementById("log").textContent=W.join(`
`);const q=R.player_dash_cooldown(),j=document.getElementById("dash-bar"),Me=document.getElementById("dash-cd-text"),ge=R.player_dash_type(),Ge={1:"🔥 BLINK",2:"❄️ SKATE",3:"⚡ DASH×3",4:"☠️ SMOKE",5:"💨 DASH"},dt={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44",5:"#44ccff"},nt={1:3,2:0,3:.8,4:4,5:2}[ge]||2;if(document.querySelector("#dash-ui span").textContent=Ge[ge]||"💨 DASH",ge===2)j.style.width="100%",j.style.background="#44ccff",Me.textContent="+40% SPD";else if(ge===3){const Oe=R.player_dash_charges();j.style.width=Oe/3*100+"%",j.style.background=Oe>0?"#ffcc00":"#333",Me.textContent=`⚡${Oe}/3`}else q>0?(j.style.width=Math.max(0,(1-q/nt)*100)+"%",j.style.background="#666",Me.textContent=q.toFixed(1)+"s"):(j.style.width="100%",j.style.background=dt[ge]||"#44ccff",Me.textContent="READY");const kt=document.getElementById("stamina-bar-bg");if(R.player_class_tier()>0){kt.style.display="block";const Oe=R.player_stamina()/R.player_max_stamina()*100;document.getElementById("stamina-bar-fill").style.width=Oe+"%"}}function Z(I,z,ne,pe){const ee=document.createElement("div");ee.className="dmg-popup"+(pe?" crit":""),ee.textContent=Math.round(ne);const re=pe?18:13,P=Math.min(12,Math.floor(ne/30));if(ee.style.fontSize=re+P+"px",document.getElementById("game-canvas"),e&&e.camera){const Pe=e.projectToScreen(I,1.8,z);ee.style.left=Pe.x+"px",ee.style.top=Pe.y-20+"px"}else ee.style.left=window.innerWidth/2+"px",ee.style.top=window.innerHeight/2-50+"px";document.body.appendChild(ee),setTimeout(()=>ee.remove(),900)}function le(I){c0(I)}let Y=0,me=!1,we=0,Le=0;function qe(I){let z=document.getElementById("combo-display");z||(z=document.createElement("div"),z.id="combo-display",z.style.cssText="position:fixed;top:45%;right:20px;pointer-events:none;z-index:999;text-align:right;transition:opacity 0.3s,transform 0.2s",document.body.appendChild(z));const ne=Math.min(20+I*.8,40),pe=I>=30?"#ff44ff":I>=20?"#ffcc00":I>=10?"#ff8844":"#44ff88";let ee="";I===5?ee='<div style="font-size:10px;color:#888;margin-top:2px">♪ rhythm up</div>':I===10?ee='<div style="font-size:10px;color:#ffcc00;margin-top:2px">✦ XP range +</div>':I===20?ee='<div style="font-size:10px;color:#ff8844;margin-top:2px">✦ mana regen</div>':I===30&&(ee='<div style="font-size:10px;color:#ff44ff;margin-top:2px">✦✦ ELEMENTAL BURST</div>'),z.innerHTML=`<div style="font-size:${ne}px;color:${pe};font-weight:bold;text-shadow:0 0 6px ${pe};font-family:monospace;line-height:1">${I}</div><div style="font-size:10px;color:#666;letter-spacing:1px">COMBO</div>${ee}`,z.style.opacity="1",z.style.transform="scale(1.1)",setTimeout(()=>{z.style.transform="scale(1)"},100),clearTimeout(z._fadeTimer),z._fadeTimer=setTimeout(()=>{z.style.opacity="0"},2e3)}function tt(I){const z=Y?(I-Y)/1e3:.016;if(Y=I,!t){requestAnimationFrame(tt);return}Le>0&&(Le-=z,Le<=0&&(we=0)),!R.player_alive()&&!me&&(me=!0,le(R)),c&&l?(window._gestureFrameSkip||(window._gestureFrameSkip=0),window._gestureFrameSkip++,window._gestureFrameSkip%3!==0||R.update(I)):(window._gestureFrameSkip=0,R.update(I));const ne=[],pe=R.enemy_count();for(let $=0;$<pe;$++)ne.push({x:R.enemy_x($),z:R.enemy_z($),type:R.enemy_type($),hit:R.enemy_hit($)});const ee=[],re=R.bullet_count();for(let $=0;$<re;$++)ee.push({x:R.bullet_x($),z:R.bullet_z($)});const P=[],Pe=R.orb_count();for(let $=0;$<Pe;$++)P.push({x:R.orb_x($),z:R.orb_z($),type:R.orb_type($)});if(!R.level_up_pending()){const $=R.damage_event_count(),ue=R.player_x(),_e=R.player_z(),ze=R.player_damage(),he=yt();let T=!1;for(let X=0;X<$;X++){const te=R.damage_event_x(X),J=R.damage_event_z(X),Ce=R.damage_event_crit(X);Ce&&(T=!0),Z(te,J,R.damage_event_amount(X),Ce),e.spawnSlash(ue,_e,te,J,Ce,ze,he),X===0&&(Ce?je.playCrit():he===1?je.playElementFire():he===2?je.playElementIce():he===3?je.playElementThunder():he===4?je.playElementPoison():je.playHit())}T?(e.shake(.4,.12),e.hitStop(.04)):$>=3&&e.shake(.2,.08);const M=R.death_event_count();for(let X=0;X<M;X++)if(e.spawnDeathParticles(R.death_event_x(X),R.death_event_z(X),yt()),e.spawnGroundDecal(R.death_event_x(X),R.death_event_z(X),yt()),X===0)je.playDeath();else if(X<4)try{je.playDeath()}catch{}if(M>0){const X=Math.min(.03+M*.015,.1);if(e.hitStop(X),e.shake(.25+M*.15,.1+M*.02),we+=M,Le=2,we>=5&&qe(we),M>=3){const te=document.createElement("div");te.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.08);pointer-events:none;z-index:997;animation:flash-fade 0.2s ease-out forwards",document.body.appendChild(te),setTimeout(()=>te.remove(),200)}}const B=R.skill_event_count();for(let X=0;X<B;X++)e.spawnSkillEffect(R.skill_event_x(X),R.skill_event_z(X),R.skill_event_element(X),R.skill_event_range(X))}e._shieldRing&&R.player_shield()<=0?(e.scene.remove(e._shieldRing.mesh),e._shieldOuter&&e.scene.remove(e._shieldOuter.mesh),e._shieldRing=null,e._shieldOuter=null):e.updateShield&&e.updateShield(R.player_x(),R.player_z(),z/1e3),e.update({playerX:R.player_x(),playerZ:R.player_z(),playerMoving:R.player_moving(),playerDirX:R.player_dir_x(),playerDirZ:R.player_dir_z(),playerHit:R.player_hit(),playerAttacking:R.player_attacking(),playerDashing:R.player_dashing(),dashType:R.player_dash_type(),nearestEnemyDirX:R.nearest_enemy_dir_x(),element:yt(),elementLevel:R.active_element_level(),fireLv:R.fire_level(),iceLv:R.ice_level(),thunderLv:R.thunder_level(),poisonLv:R.poison_level(),bossActive:R.boss_active(),bossX:R.boss_x(),bossZ:R.boss_z(),bossHpPct:R.boss_hp_pct(),promoted:R.player_promoted(),enemies:ne,bullets:ee,orbs:P},z),ie(),requestAnimationFrame(tt)}requestAnimationFrame(tt)}_0().catch(i=>{document.body.innerHTML=`<pre style="color:red;padding:20px">FATAL: ${i}
${i.stack||""}</pre>`});
