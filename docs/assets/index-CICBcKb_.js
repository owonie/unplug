...
`)+`
`+d);const y=g+m+a,v=g+d+o,R=Co(s,s.VERTEX_SHADER,y),b=Co(s,s.FRAGMENT_SHADER,v);s.attachShader(x,R),s.attachShader(x,b),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function A(D){if(i.debug.checkShaderErrors){const X=s.getProgramInfoLog(x).trim(),G=s.getShaderInfoLog(R).trim(),$=s.getShaderInfoLog(b).trim();let te=!0,C=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,R,b);else{const V=Lo(s,R,"vertex"),U=Lo(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
