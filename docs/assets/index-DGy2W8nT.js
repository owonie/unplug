...
}`;function cm(i,e,t){let n=new qa;const s=new pe,r=new pe,a=new ht,o=new rm({depthPacking:eh}),l=new am,c={},h=t.maxTextureSize,d={[Gn]:Bt,[Bt]:Gn,[Ke]:Ke},f=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pe},radius:{value:4}},vertexShader:om,fragmentShader:lm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new an(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new se(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=vl;let u=this.type;this.render=function(b,C,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const w=i.getRenderTarget(),M=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),F=i.state;F.setBlending(Bn),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const k=u!==yn&&this.type===yn,G=u===yn&&this.type!==yn;for(let j=0,q=b.length;j<q;j++){const ae=b[j],Z=ae.shadow;if(Z===void 0){console.warn("THREE.WebGLShadowMap:",ae,"has no shadow.");continue}if(Z.autoUpdate===!1&&Z.needsUpdate===!1)continue;s.copy(Z.mapSize);const me=Z.getFrameExtents();if(s.multiply(me),r.copy(Z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,Z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,Z.mapSize.y=r.y)),Z.map===null||k===!0||G===!0){const Le=this.type!==yn?{minFilter:rn,magFilter:rn}:{};Z.map!==null&&Z.map.dispose(),Z.map=new si(s.x,s.y,Le),Z.map.texture.name=ae.name+".shadowMap",Z.camera.updateProjectionMatrix()}i.setRenderTarget(Z.map),i.clear();const Ee=Z.getViewportCount();for(let Le=0;Le<Ee;Le++){const qe=Z.getViewport(Le);a.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),F.viewport(a),Z.updateMatrices(ae,Le),n=Z.getFrustum(),v(C,L,Z.camera,ae,this.type)}Z.isPointLightShadow!==!0&&this.type===yn&&_(Z,L),Z.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(w,M,D)};function _(b,C){const L=e.update(y);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new si(s.x,s.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(C,null,L,f,y,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(C,null,L,p,y,null)}function x(b,C,L,w){let M=null;const D=L.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(D!==void 0)M=D;else if(M=L.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const F=M.uuid,k=C.uuid;let G=c[F];G===void 0&&(G={},c[F]=G);let j=G[k];j===void 0&&(j=M.clone(),G[k]=j,C.addEventListener("dispose",A)),M=j}if(M.visible=C.visible,M.wireframe=C.wireframe,w===yn?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:d[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const F=i.properties.get(M);F.light=L}return M}function v(b,C,L,w,M){if(b.visible===!1)return;if(b.layers.test(C.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===yn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,b.matrixWorld);const k=e.update(b),G=b.material;if(Array.isArray(G)){const j=k.groups;for(let q=0,ae=j.length;q<ae;q++){const Z=j[q],me=G[Z.materialIndex];if(me&&me.visible){const Ee=x(b,me,w,M);b.onBeforeShadow(i,b,C,L,k,Ee,Z),i.renderBufferDirect(L,null,k,Ee,b,Z),b.onAfterShadow(i,b,C,L,k,Ee,Z)}}}else if(G.visible){const j=x(b,G,w,M);b.onBeforeShadow(i,b,C,L,k,j,null),i.renderBufferDirect(L,null,k,j,b,null),b.onAfterShadow(i,b,C,L,k,j,null)}}const F=b.children;for(let k=0,G=F.length;k<G;k++)v(F[k],C,L,w,M)}function A(b){b.target.removeEventListener("dispose",A);for(const L in c){const w=c[L],M=b.target.uuid;M in w&&(w[M].dispose(),delete w[M])}}}const hm={[Zr]:Kr,[Jr]:ea,[jr]:ta,[Ii]:Qr,[Kr]:Zr,[ea]:Jr,[ta]:jr,[Qr]:Ii};function um(i,e){function t(){let N=!1;const ve=new ht;let Y=null;const Q=new ht(0,0,0,0);return{setMask:function(Me){Y!==Me&&!N&&(i.colorMask(Me,Me,Me,Me),Y=Me)},setLocked:function(Me){N=Me},setClear:function(Me,_e,Ge,mt,Ct){Ct===!0&&(Me*=mt,_e*=mt,Ge*=mt),ve.set(Me,_e,Ge,mt),Q.equals(ve)===!1&&(i.clearColor(Me,_e,Ge,mt),Q.copy(ve))},reset:function(){N=!1,Y=null,Q.set(-1,0,0,0)}}}function n(){let N=!1,ve=!1,Y=null,Q=null,Me=null;return{setReversed:function(_e){if(ve!==_e){const Ge=e.get("EXT_clip_control");ve?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT);const mt=Me;Me=null,this.setClear(mt)}ve=_e},getReversed:function(){return ve},setTest:function(_e){_e?ye(i.DEPTH_TEST):U(i.DEPTH_TEST)},setMask:function(_e){Y!==_e&&!N&&(i.depthMask(_e),Y=_e)},setFunc:function(_e){if(ve&&(_e=hm[_e]),Q!==_e){switch(_e){case Zr:i.depthFunc(i.NEVER);break;case Kr:i.depthFunc(i.ALWAYS);break;case Jr:i.depthFunc(i.LESS);break;case Ii:i.depthFunc(i.LEQUAL);break;case jr:i.depthFunc(i.EQUAL);break;case Qr:i.depthFunc(i.GEQUAL);break;case ea:i.depthFunc(i.GREATER);break;case ta:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=_e}},setLocked:function(_e){N=_e},setClear:function(_e){Me!==_e&&(ve&&(_e=1-_e),i.clearDepth(_e),Me=_e)},reset:function(){N=!1,Y=null,Q=null,Me=null,ve=!1}}}function s(){let N=!1,ve=null,Y=null,Q=null,Me=null,_e=null,Ge=null,mt=null,Ct=null;return{setTest:function(it){N||(it?ye(i.STENCIL_TEST):U(i.STENCIL_TEST))},setMask:function(it){ve!==it&&!N&&(i.stencilMask(it),ve=it)},setFunc:function(it,kt,ze){(Y!==it||Q!==kt||Me!==ze)&&(i.stencilFunc(it,kt,ze),Y=it,Q=kt,Me=ze)},setOp:function(it,kt,ze){(_e!==it||Ge!==kt||mt!==ze)&&(i.stencilOp(it,kt,ze),_e=it,Ge=kt,mt=ze)},setLocked:function(it){N=it},setClear:function(it){Ct!==it&&(i.clearStencil(it),Ct=it)},reset:function(){N=!1,ve=null,Y=null,Q=null,Me=null,_e=null,Ge=null,mt=null,Ct=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},d={},f=new WeakMap,p=[],g=null,y=!1,m=null,u=null,_=null,x=null,v=null,A=null,b=null,C=new He(0,0,0),L=0,w=!1,M=null,D=null,F=null,k=null,G=null;const j=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,ae=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(ae=parseFloat(/^WebGL (\d)/.exec(Z)[1]),q=ae>=1):Z.indexOf("OpenGL ES")!==-1&&(ae=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),q=ae>=2);let me=null,Ee={};const Le=i.getParameter(i.SCISSOR_BOX),qe=i.getParameter(i.VIEWPORT),nt=new ht().fromArray(Le),ee=new ht().fromArray(qe);function ue(N,ve,Y,Q){const Me=new Uint8Array(4),_e=i.createTexture();i.bindTexture(N,_e),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ge=0;Ge<Y;Ge++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ve,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,Me):i.texImage2D(ve+Ge,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Me);return _e}const Pe={};Pe[i.TEXTURE_2D]=ue(i.TEXTURE_2D,i.TEXTURE_2D,1),Pe[i.TEXTURE_CUBE_MAP]=ue(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Pe[i.TEXTURE_2D_ARRAY]=ue(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Pe[i.TEXTURE_3D]=ue(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ye(i.DEPTH_TEST),a.setFunc(Ii),ne(!1),he(lo),ye(i.CULL_FACE),P(Bn);function ye(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function U(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function H(N,ve){return d[N]!==ve?(i.bindFramebuffer(N,ve),d[N]=ve,N===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ve),N===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ve),!0):!1}function te(N,ve){let Y=p,Q=!1;if(N){Y=f.get(ve),Y===void 0&&(Y=[],f.set(ve,Y));const Me=N.textures;if(Y.length!==Me.length||Y[0]!==i.COLOR_ATTACHMENT0){for(let _e=0,Ge=Me.length;_e<Ge;_e++)Y[_e]=i.COLOR_ATTACHMENT0+_e;Y.length=Me.length,Q=!0}}else Y[0]!==i.BACK&&(Y[0]=i.BACK,Q=!0);Q&&i.drawBuffers(Y)}function oe(N){return g!==N?(i.useProgram(N),g=N,!0):!1}const K={[Qn]:i.FUNC_ADD,[Tc]:i.FUNC_SUBTRACT,[Ac]:i.FUNC_REVERSE_SUBTRACT};K[Cc]=i.MIN,K[Rc]=i.MAX;const re={[Pc]:i.ZERO,[Lc]:i.ONE,[Ic]:i.SRC_COLOR,[qr]:i.SRC_ALPHA,[zc]:i.SRC_ALPHA_SATURATE,[Fc]:i.DST_COLOR,[Uc]:i.DST_ALPHA,[Dc]:i.ONE_MINUS_SRC_COLOR,[Yr]:i.ONE_MINUS_SRC_ALPHA,[Oc]:i.ONE_MINUS_DST_COLOR,[Nc]:i.ONE_MINUS_DST_ALPHA,[Bc]:i.CONSTANT_COLOR,[kc]:i.ONE_MINUS_CONSTANT_COLOR,[Hc]:i.CONSTANT_ALPHA,[Gc]:i.ONE_MINUS_CONSTANT_ALPHA};function P(N,ve,Y,Q,Me,_e,Ge,mt,Ct,it){if(N===Bn){y===!0&&(U(i.BLEND),y=!1);return}if(y===!1&&(ye(i.BLEND),y=!0),N!==Ec){if(N!==m||it!==w){if((u!==Qn||v!==Qn)&&(i.blendEquation(i.FUNC_ADD),u=Qn,v=Qn),it)switch(N){case un:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nr:i.blendFunc(i.ONE,i.ONE);break;case co:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ho:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case un:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nr:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case co:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ho:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}_=null,x=null,A=null,b=null,C.set(0,0,0),L=0,m=N,w=it}return}Me=Me||ve,_e=_e||Y,Ge=Ge||Q,(ve!==u||Me!==v)&&(i.blendEquationSeparate(K[ve],K[Me]),u=ve,v=Me),(Y!==_||Q!==x||_e!==A||Ge!==b)&&(i.blendFuncSeparate(re[Y],re[Q],re[_e],re[Ge]),_=Y,x=Q,A=_e,b=Ge),(mt.equals(C)===!1||Ct!==L)&&(i.blendColor(mt.r,mt.g,mt.b,Ct),C.copy(mt),L=Ct),m=N,w=!1}function Se(N,ve){N.side===Ke?U(i.CULL_FACE):ye(i.CULL_FACE);let Y=N.side===Bt;ve&&(Y=!Y),ne(Y),N.blending===un&&N.transparent===!1?P(Bn):P(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),r.setMask(N.colorWrite);const Q=N.stencilWrite;o.setTest(Q),Q&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Oe(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ye(i.SAMPLE_ALPHA_TO_COVERAGE):U(i.SAMPLE_ALPHA_TO_COVERAGE)}function ne(N){M!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),M=N)}function he(N){N!==wc?(ye(i.CULL_FACE),N!==D&&(N===lo?i.cullFace(i.BACK):N===bc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):U(i.CULL_FACE),D=N}function le(N){N!==F&&(q&&i.lineWidth(N),F=N)}function Oe(N,ve,Y){N?(ye(i.POLYGON_OFFSET_FILL),(k!==ve||G!==Y)&&(i.polygonOffset(ve,Y),k=ve,G=Y)):U(i.POLYGON_OFFSET_FILL)}function we(N){N?ye(i.SCISSOR_TEST):U(i.SCISSOR_TEST)}function T(N){N===void 0&&(N=i.TEXTURE0+j-1),me!==N&&(i.activeTexture(N),me=N)}function S(N,ve,Y){Y===void 0&&(me===null?Y=i.TEXTURE0+j-1:Y=me);let Q=Ee[Y];Q===void 0&&(Q={type:void 0,texture:void 0},Ee[Y]=Q),(Q.type!==N||Q.texture!==ve)&&(me!==Y&&(i.activeTexture(Y),me=Y),i.bindTexture(N,ve||Pe[N]),Q.type=N,Q.texture=ve)}function B(){const N=Ee[me];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function V(){try{i.compressedTexImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ie(){try{i.compressedTexImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function J(){try{i.texSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Re(){try{i.texSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function fe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Te(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Je(){try{i.texStorage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ce(){try{i.texStorage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ae(){try{i.texImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Fe(){try{i.texImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Be(N){nt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),nt.copy(N))}function Ce(N){ee.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),ee.copy(N))}function Ze(N,ve){let Y=c.get(ve);Y===void 0&&(Y=new WeakMap,c.set(ve,Y));let Q=Y.get(N);Q===void 0&&(Q=i.getUniformBlockIndex(ve,N.name),Y.set(N,Q))}function Ve(N,ve){const Q=c.get(ve).get(N);l.get(ve)!==Q&&(i.uniformBlockBinding(ve,Q,N.__bindingPointIndex),l.set(ve,Q))}function rt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},me=null,Ee={},d={},f=new WeakMap,p=[],g=null,y=!1,m=null,u=null,_=null,x=null,v=null,A=null,b=null,C=new He(0,0,0),L=0,w=!1,M=null,D=null,F=null,k=null,G=null,nt.set(0,0,i.canvas.width,i.canvas.height),ee.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ye,disable:U,bindFramebuffer:H,drawBuffers:te,useProgram:oe,setBlending:P,setMaterial:Se,setFlipSided:ne,setCullFace:he,setLineWidth:le,setPolygonOffset:Oe,setScissorTest:we,activeTexture:T,bindTexture:S,unbindTexture:B,compressedTexImage2D:V,compressedTexImage3D:ie,texImage2D:Ae,texImage3D:Fe,updateUBOMapping:Ze,uniformBlockBinding:Ve,texStorage2D:Je,texStorage3D:ce,texSubImage2D:J,texSubImage3D:Re,compressedTexSubImage2D:fe,compressedTexSubImage3D:Te,scissor:Be,viewport:Ce,reset:rt}}function sl(i,e,t,n){const s=dm(n);switch(t){case El:return i*e;case Al:return i*e;case Cl:return i*e*2;case Rl:return i*e/s.components*s.byteLength;case Va:return i*e/s.components*s.byteLength;case Pl:return i*e*2/s.components*s.byteLength;case Wa:return i*e*2/s.components*s.byteLength;case Tl:return i*e*3/s.components*s.byteLength;case sn:return i*e*4/s.components*s.byteLength;case Xa:return i*e*4/s.components*s.byteLength;case Zs:case Ks:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Js:case js:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case oa:case ca:return Math.max(i,16)*Math.max(e,8)/4;case aa:case la:return Math.max(i,8)*Math.max(e,8)/2;case ha:case ua:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case da:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case fa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case pa:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case ma:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case _a:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case ga:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case va:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case xa:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ya:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Ma:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Sa:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case wa:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case ba:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Ea:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Ta:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Qs:case Aa:case Ca:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Ll:case Ra:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Pa:case La:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function dm(i){switch(i){case Cn:case Sl:return{byteLength:1,components:1};case hs:case wl:case ms:return{byteLength:2,components:1};case Ha:case Ga:return{byteLength:2,components:4};case ii:case ka:case wn:return{byteLength:4,components:1};case bl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function fm(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new pe,h=new WeakMap;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,S){return p?new OffscreenCanvas(T,S):us("canvas")}function y(T,S,B){let V=1;const ie=we(T);if((ie.width>B||ie.height>B)&&(V=B/Math.max(ie.width,ie.height)),V<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const J=Math.floor(V*ie.width),Re=Math.floor(V*ie.height);d===void 0&&(d=g(J,Re));const fe=S?g(J,Re):d;return fe.width=J,fe.height=Re,fe.getContext("2d").drawImage(T,0,0,J,Re),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+J+"x"+Re+")."),fe}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),T;return T}function m(T){return T.generateMipmaps}function u(T){i.generateMipmap(T)}function _(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(T,S,B,V,ie=!1){if(T!==null){if(i[T]!==void 0)return i[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let J=S;if(S===i.RED&&(B===i.FLOAT&&(J=i.R32F),B===i.HALF_FLOAT&&(J=i.R16F),B===i.UNSIGNED_BYTE&&(J=i.R8)),S===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.R8UI),B===i.UNSIGNED_SHORT&&(J=i.R16UI),B===i.UNSIGNED_INT&&(J=i.R32UI),B===i.BYTE&&(J=i.R8I),B===i.SHORT&&(J=i.R16I),B===i.INT&&(J=i.R32I)),S===i.RG&&(B===i.FLOAT&&(J=i.RG32F),B===i.HALF_FLOAT&&(J=i.RG16F),B===i.UNSIGNED_BYTE&&(J=i.RG8)),S===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RG8UI),B===i.UNSIGNED_SHORT&&(J=i.RG16UI),B===i.UNSIGNED_INT&&(J=i.RG32UI),B===i.BYTE&&(J=i.RG8I),B===i.SHORT&&(J=i.RG16I),B===i.INT&&(J=i.RG32I)),S===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RGB8UI),B===i.UNSIGNED_SHORT&&(J=i.RGB16UI),B===i.UNSIGNED_INT&&(J=i.RGB32UI),B===i.BYTE&&(J=i.RGB8I),B===i.SHORT&&(J=i.RGB16I),B===i.INT&&(J=i.RGB32I)),S===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),B===i.UNSIGNED_INT&&(J=i.RGBA32UI),B===i.BYTE&&(J=i.RGBA8I),B===i.SHORT&&(J=i.RGBA16I),B===i.INT&&(J=i.RGBA32I)),S===i.RGB&&B===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),S===i.RGBA){const Re=ie?ar:et.getTransfer(V);B===i.FLOAT&&(J=i.RGBA32F),B===i.HALF_FLOAT&&(J=i.RGBA16F),B===i.UNSIGNED_BYTE&&(J=Re===lt?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function v(T,S){let B;return T?S===null||S===ii||S===Ni?B=i.DEPTH24_STENCIL8:S===wn?B=i.DEPTH32F_STENCIL8:S===hs&&(B=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===ii||S===Ni?B=i.DEPTH_COMPONENT24:S===wn?B=i.DEPTH_COMPONENT32F:S===hs&&(B=i.DEPTH_COMPONENT16),B}function A(T,S){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==rn&&T.minFilter!==_t?Math.log2(Math.max(S.width,S.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?S.mipmaps.length:1}function b(T){const S=T.target;S.removeEventListener("dispose",b),L(S),S.isVideoTexture&&h.delete(S)}function C(T){const S=T.target;S.removeEventListener("dispose",C),M(S)}function L(T){const S=n.get(T);if(S.__webglInit===void 0)return;const B=T.source,V=f.get(B);if(V){const ie=V[S.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&w(T),Object.keys(V).length===0&&f.delete(B)}n.remove(T)}function w(T){const S=n.get(T);i.deleteTexture(S.__webglTexture);const B=T.source,V=f.get(B);delete V[S.__cacheKey],a.memory.textures--}function M(T){const S=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(S.__webglFramebuffer[V]))for(let ie=0;ie<S.__webglFramebuffer[V].length;ie++)i.deleteFramebuffer(S.__webglFramebuffer[V][ie]);else i.deleteFramebuffer(S.__webglFramebuffer[V]);S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer[V])}else{if(Array.isArray(S.__webglFramebuffer))for(let V=0;V<S.__webglFramebuffer.length;V++)i.deleteFramebuffer(S.__webglFramebuffer[V]);else i.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&i.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let V=0;V<S.__webglColorRenderbuffer.length;V++)S.__webglColorRenderbuffer[V]&&i.deleteRenderbuffer(S.__webglColorRenderbuffer[V]);S.__webglDepthRenderbuffer&&i.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const B=T.textures;for(let V=0,ie=B.length;V<ie;V++){const J=n.get(B[V]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),a.memory.textures--),n.remove(B[V])}n.remove(T)}let D=0;function F(){D=0}function k(){const T=D;return T>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),D+=1,T}function G(T){const S=[];return S.push(T.wrapS),S.push(T.wrapT),S.push(T.wrapR||0),S.push(T.magFilter),S.push(T.minFilter),S.push(T.anisotropy),S.push(T.internalFormat),S.push(T.format),S.push(T.type),S.push(T.generateMipmaps),S.push(T.premultiplyAlpha),S.push(T.flipY),S.push(T.unpackAlignment),S.push(T.colorSpace),S.join()}function j(T,S){const B=n.get(T);if(T.isVideoTexture&&le(T),T.isRenderTargetTexture===!1&&T.version>0&&B.__version!==T.version){const V=T.image;if(V===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(B,T,S);return}}t.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+S)}function q(T,S){const B=n.get(T);if(T.version>0&&B.__version!==T.version){ee(B,T,S);return}t.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+S)}function ae(T,S){const B=n.get(T);if(T.version>0&&B.__version!==T.version){ee(B,T,S);return}t.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+S)}function Z(T,S){const B=n.get(T);if(T.version>0&&B.__version!==T.version){ue(B,T,S);return}t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+S)}const me={[sa]:i.REPEAT,[Sn]:i.CLAMP_TO_EDGE,[ra]:i.MIRRORED_REPEAT},Ee={[rn]:i.NEAREST,[jc]:i.NEAREST_MIPMAP_NEAREST,[xs]:i.NEAREST_MIPMAP_LINEAR,[_t]:i.LINEAR,[hr]:i.LINEAR_MIPMAP_NEAREST,[ti]:i.LINEAR_MIPMAP_LINEAR},Le={[nh]:i.NEVER,[lh]:i.ALWAYS,[ih]:i.LESS,[Dl]:i.LEQUAL,[sh]:i.EQUAL,[oh]:i.GEQUAL,[rh]:i.GREATER,[ah]:i.NOTEQUAL};function qe(T,S){if(S.type===wn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===_t||S.magFilter===hr||S.magFilter===xs||S.magFilter===ti||S.minFilter===_t||S.minFilter===hr||S.minFilter===xs||S.minFilter===ti)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,me[S.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,me[S.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,me[S.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,Ee[S.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,Ee[S.minFilter]),S.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Le[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===rn||S.minFilter!==xs&&S.minFilter!==ti||S.type===wn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,s.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function nt(T,S){let B=!1;T.__webglInit===void 0&&(T.__webglInit=!0,S.addEventListener("dispose",b));const V=S.source;let ie=f.get(V);ie===void 0&&(ie={},f.set(V,ie));const J=G(S);if(J!==T.__cacheKey){ie[J]===void 0&&(ie[J]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),ie[J].usedTimes++;const Re=ie[T.__cacheKey];Re!==void 0&&(ie[T.__cacheKey].usedTimes--,Re.usedTimes===0&&w(S)),T.__cacheKey=J,T.__webglTexture=ie[J].texture}return B}function ee(T,S,B){let V=i.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(V=i.TEXTURE_2D_ARRAY),S.isData3DTexture&&(V=i.TEXTURE_3D);const ie=nt(T,S),J=S.source;t.bindTexture(V,T.__webglTexture,i.TEXTURE0+B);const Re=n.get(J);if(J.version!==Re.__version||ie===!0){t.activeTexture(i.TEXTURE0+B);const fe=et.getPrimaries(et.workingColorSpace),Te=S.colorSpace===zn?null:et.getPrimaries(S.colorSpace),Je=S.colorSpace===zn||fe===Te?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Je);let ce=y(S.image,!1,s.maxTextureSize);ce=Oe(S,ce);const Ae=r.convert(S.format,S.colorSpace),Fe=r.convert(S.type);let Be=x(S.internalFormat,Ae,Fe,S.colorSpace,S.isVideoTexture);qe(V,S);let Ce;const Ze=S.mipmaps,Ve=S.isVideoTexture!==!0,rt=Re.__version===void 0||ie===!0,N=J.dataReady,ve=A(S,ce);if(S.isDepthTexture)Be=v(S.format===Fi,S.type),rt&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,Be,ce.width,ce.height):t.texImage2D(i.TEXTURE_2D,0,Be,ce.width,ce.height,0,Ae,Fe,null));else if(S.isDataTexture)if(Ze.length>0){Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,Be,Ze[0].width,Ze[0].height);for(let Y=0,Q=Ze.length;Y<Q;Y++)Ce=Ze[Y],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,Ae,Fe,Ce.data):t.texImage2D(i.TEXTURE_2D,Y,Be,Ce.width,Ce.height,0,Ae,Fe,Ce.data);S.generateMipmaps=!1}else Ve?(rt&&t.texStorage2D(i.TEXTURE_2D,ve,Be,ce.width,ce.height),N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce.width,ce.height,Ae,Fe,ce.data)):t.texImage2D(i.TEXTURE_2D,0,Be,ce.width,ce.height,0,Ae,Fe,ce.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ve&&rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,Be,Ze[0].width,Ze[0].height,ce.depth);for(let Y=0,Q=Ze.length;Y<Q;Y++)if(Ce=Ze[Y],S.format!==sn)if(Ae!==null)if(Ve){if(N)if(S.layerUpdates.size>0){const Me=sl(Ce.width,Ce.height,S.format,S.type);for(const _e of S.layerUpdates){const Ge=Ce.data.subarray(_e*Me/Ce.data.BYTES_PER_ELEMENT,(_e+1)*Me/Ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,_e,Ce.width,Ce.height,1,Ae,Ge)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,Ce.width,Ce.height,ce.depth,Ae,Ce.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Y,Be,Ce.width,Ce.height,ce.depth,0,Ce.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,Ce.width,Ce.height,ce.depth,Ae,Fe,Ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Y,Be,Ce.width,Ce.height,ce.depth,0,Ae,Fe,Ce.data)}else{Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,Be,Ze[0].width,Ze[0].height);for(let Y=0,Q=Ze.length;Y<Q;Y++)Ce=Ze[Y],S.format!==sn?Ae!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,Ae,Ce.data):t.compressedTexImage2D(i.TEXTURE_2D,Y,Be,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?N&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,Ae,Fe,Ce.data):t.texImage2D(i.TEXTURE_2D,Y,Be,Ce.width,Ce.height,0,Ae,Fe,Ce.data)}else if(S.isDataArrayTexture)if(Ve){if(rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,Be,ce.width,ce.height,ce.depth),N)if(S.layerUpdates.size>0){const Y=sl(ce.width,ce.height,S.format,S.type);for(const Q of S.layerUpdates){const Me=ce.data.subarray(Q*Y/ce.data.BYTES_PER_ELEMENT,(Q+1)*Y/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,ce.width,ce.height,1,Ae,Fe,Me)}S.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,Ae,Fe,ce.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Be,ce.width,ce.height,ce.depth,0,Ae,Fe,ce.data);else if(S.isData3DTexture)Ve?(rt&&t.texStorage3D(i.TEXTURE_3D,ve,Be,ce.width,ce.height,ce.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,Ae,Fe,ce.data)):t.texImage3D(i.TEXTURE_3D,0,Be,ce.width,ce.height,ce.depth,0,Ae,Fe,ce.data);else if(S.isFramebufferTexture){if(rt)if(Ve)t.texStorage2D(i.TEXTURE_2D,ve,Be,ce.width,ce.height);else{let Y=ce.width,Q=ce.height;for(let Me=0;Me<ve;Me++)t.texImage2D(i.TEXTURE_2D,Me,Be,Y,Q,0,Ae,Fe,null),Y>>=1,Q>>=1}}else if(Ze.length>0){if(Ve&&rt){const Y=we(Ze[0]);t.texStorage2D(i.TEXTURE_2D,ve,Be,Y.width,Y.height)}for(let Y=0,Q=Ze.length;Y<Q;Y++)Ce=Ze[Y],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,Ae,Fe,Ce):t.texImage2D(i.TEXTURE_2D,Y,Be,Ae,Fe,Ce);S.generateMipmaps=!1}else if(Ve){if(rt){const Y=we(ce);t.texStorage2D(i.TEXTURE_2D,ve,Be,Y.width,Y.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ae,Fe,ce)}else t.texImage2D(i.TEXTURE_2D,0,Be,Ae,Fe,ce);m(S)&&u(V),Re.__version=J.version,S.onUpdate&&S.onUpdate(S)}T.__version=S.version}function ue(T,S,B){if(S.image.length!==6)return;const V=nt(T,S),ie=S.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+B);const J=n.get(ie);if(ie.version!==J.__version||V===!0){t.activeTexture(i.TEXTURE0+B);const Re=et.getPrimaries(et.workingColorSpace),fe=S.colorSpace===zn?null:et.getPrimaries(S.colorSpace),Te=S.colorSpace===zn||Re===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);const Je=S.isCompressedTexture||S.image[0].isCompressedTexture,ce=S.image[0]&&S.image[0].isDataTexture,Ae=[];for(let Q=0;Q<6;Q++)!Je&&!ce?Ae[Q]=y(S.image[Q],!0,s.maxCubemapSize):Ae[Q]=ce?S.image[Q].image:S.image[Q],Ae[Q]=Oe(S,Ae[Q]);const Fe=Ae[0],Be=r.convert(S.format,S.colorSpace),Ce=r.convert(S.type),Ze=x(S.internalFormat,Be,Ce,S.colorSpace),Ve=S.isVideoTexture!==!0,rt=J.__version===void 0||V===!0,N=ie.dataReady;let ve=A(S,Fe);qe(i.TEXTURE_CUBE_MAP,S);let Y;if(Je){Ve&&rt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ze,Fe.width,Fe.height);for(let Q=0;Q<6;Q++){Y=Ae[Q].mipmaps;for(let Me=0;Me<Y.length;Me++){const _e=Y[Me];S.format!==sn?Be!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me,0,0,_e.width,_e.height,Be,_e.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me,Ze,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me,0,0,_e.width,_e.height,Be,Ce,_e.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me,Ze,_e.width,_e.height,0,Be,Ce,_e.data)}}}else{if(Y=S.mipmaps,Ve&&rt){Y.length>0&&ve++;const Q=we(Ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ze,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ce){Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ae[Q].width,Ae[Q].height,Be,Ce,Ae[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ze,Ae[Q].width,Ae[Q].height,0,Be,Ce,Ae[Q].data);for(let Me=0;Me<Y.length;Me++){const Ge=Y[Me].image[Q].image;Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me+1,0,0,Ge.width,Ge.height,Be,Ce,Ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me+1,Ze,Ge.width,Ge.height,0,Be,Ce,Ge.data)}}else{Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Be,Ce,Ae[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ze,Be,Ce,Ae[Q]);for(let Me=0;Me<Y.length;Me++){const _e=Y[Me];Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me+1,0,0,Be,Ce,_e.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Me+1,Ze,Be,Ce,_e.image[Q])}}}m(S)&&u(i.TEXTURE_CUBE_MAP),J.__version=ie.version,S.onUpdate&&S.onUpdate(S)}T.__version=S.version}function Pe(T,S,B,V,ie,J){const Re=r.convert(B.format,B.colorSpace),fe=r.convert(B.type),Te=x(B.internalFormat,Re,fe,B.colorSpace),Je=n.get(S),ce=n.get(B);if(ce.__renderTarget=S,!Je.__hasExternalTextures){const Ae=Math.max(1,S.width>>J),Fe=Math.max(1,S.height>>J);ie===i.TEXTURE_3D||ie===i.TEXTURE_2D_ARRAY?t.texImage3D(ie,J,Te,Ae,Fe,S.depth,0,Re,fe,null):t.texImage2D(ie,J,Te,Ae,Fe,0,Re,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),he(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,V,ie,ce.__webglTexture,0,ne(S)):(ie===i.TEXTURE_2D||ie>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,V,ie,ce.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ye(T,S,B){if(i.bindRenderbuffer(i.RENDERBUFFER,T),S.depthBuffer){const V=S.depthTexture,ie=V&&V.isDepthTexture?V.type:null,J=v(S.stencilBuffer,ie),Re=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=ne(S);he(S)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe,J,S.width,S.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,J,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,J,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Re,i.RENDERBUFFER,T)}else{const V=S.textures;for(let ie=0;ie<V.length;ie++){const J=V[ie],Re=r.convert(J.format,J.colorSpace),fe=r.convert(J.type),Te=x(J.internalFormat,Re,fe,J.colorSpace),Je=ne(S);B&&he(S)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je,Te,S.width,S.height):he(S)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je,Te,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,Te,S.width,S.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function U(T,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const V=n.get(S.depthTexture);V.__renderTarget=S,(!V.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),j(S.depthTexture,0);const ie=V.__webglTexture,J=ne(S);if(S.depthTexture.format===Pi)he(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ie,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ie,0);else if(S.depthTexture.format===Fi)he(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ie,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function H(T){const S=n.get(T),B=T.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==T.depthTexture){const V=T.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),V){const ie=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,V.removeEventListener("dispose",ie)};V.addEventListener("dispose",ie),S.__depthDisposeCallback=ie}S.__boundDepthTexture=V}if(T.depthTexture&&!S.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");U(S.__webglFramebuffer,T)}else if(B){S.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[V]),S.__webglDepthbuffer[V]===void 0)S.__webglDepthbuffer[V]=i.createRenderbuffer(),ye(S.__webglDepthbuffer[V],T,!1);else{const ie=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=S.__webglDepthbuffer[V];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ie,i.RENDERBUFFER,J)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=i.createRenderbuffer(),ye(S.__webglDepthbuffer,T,!1);else{const V=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=S.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,V,i.RENDERBUFFER,ie)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function te(T,S,B){const V=n.get(T);S!==void 0&&Pe(V.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&H(T)}function oe(T){const S=T.texture,B=n.get(T),V=n.get(S);T.addEventListener("dispose",C);const ie=T.textures,J=T.isWebGLCubeRenderTarget===!0,Re=ie.length>1;if(Re||(V.__webglTexture===void 0&&(V.__webglTexture=i.createTexture()),V.__version=S.version,a.memory.textures++),J){B.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer[fe]=[];for(let Te=0;Te<S.mipmaps.length;Te++)B.__webglFramebuffer[fe][Te]=i.createFramebuffer()}else B.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer=[];for(let fe=0;fe<S.mipmaps.length;fe++)B.__webglFramebuffer[fe]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(Re)for(let fe=0,Te=ie.length;fe<Te;fe++){const Je=n.get(ie[fe]);Je.__webglTexture===void 0&&(Je.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&he(T)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let fe=0;fe<ie.length;fe++){const Te=ie[fe];B.__webglColorRenderbuffer[fe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[fe]);const Je=r.convert(Te.format,Te.colorSpace),ce=r.convert(Te.type),Ae=x(Te.internalFormat,Je,ce,Te.colorSpace,T.isXRRenderTarget===!0),Fe=ne(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Fe,Ae,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,B.__webglColorRenderbuffer[fe])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),ye(B.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture),qe(i.TEXTURE_CUBE_MAP,S);for(let fe=0;fe<6;fe++)if(S.mipmaps&&S.mipmaps.length>0)for(let Te=0;Te<S.mipmaps.length;Te++)Pe(B.__webglFramebuffer[fe][Te],T,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Te);else Pe(B.__webglFramebuffer[fe],T,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);m(S)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Re){for(let fe=0,Te=ie.length;fe<Te;fe++){const Je=ie[fe],ce=n.get(Je);t.bindTexture(i.TEXTURE_2D,ce.__webglTexture),qe(i.TEXTURE_2D,Je),Pe(B.__webglFramebuffer,T,Je,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,0),m(Je)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(fe=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(fe,V.__webglTexture),qe(fe,S),S.mipmaps&&S.mipmaps.length>0)for(let Te=0;Te<S.mipmaps.length;Te++)Pe(B.__webglFramebuffer[Te],T,S,i.COLOR_ATTACHMENT0,fe,Te);else Pe(B.__webglFramebuffer,T,S,i.COLOR_ATTACHMENT0,fe,0);m(S)&&u(fe),t.unbindTexture()}T.depthBuffer&&H(T)}function K(T){const S=T.textures;for(let B=0,V=S.length;B<V;B++){const ie=S[B];if(m(ie)){const J=_(T),Re=n.get(ie).__webglTexture;t.bindTexture(J,Re),u(J),t.unbindTexture()}}}const re=[],P=[];function Se(T){if(T.samples>0){if(he(T)===!1){const S=T.textures,B=T.width,V=T.height;let ie=i.COLOR_BUFFER_BIT;const J=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Re=n.get(T),fe=S.length>1;if(fe)for(let Te=0;Te<S.length;Te++)t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Re.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Re.__webglFramebuffer);for(let Te=0;Te<S.length;Te++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(ie|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(ie|=i.STENCIL_BUFFER_BIT)),fe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Re.__webglColorRenderbuffer[Te]);const Je=n.get(S[Te]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Je,0)}i.blitFramebuffer(0,0,B,V,0,0,B,V,ie,i.NEAREST),l===!0&&(re.length=0,P.length=0,re.push(i.COLOR_ATTACHMENT0+Te),T.depthBuffer&&T.resolveDepthBuffer===!1&&(re.push(J),P.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,re))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),fe)for(let Te=0;Te<S.length;Te++){t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.RENDERBUFFER,Re.__webglColorRenderbuffer[Te]);const Je=n.get(S[Te]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.TEXTURE_2D,Je,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Re.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const S=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[S])}}}function ne(T){return Math.min(s.maxSamples,T.samples)}function he(T){const S=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function le(T){const S=a.render.frame;h.get(T)!==S&&(h.set(T,S),T.update())}function Oe(T,S){const B=T.colorSpace,V=T.format,ie=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||B!==zi&&B!==zn&&(et.getTransfer(B)===lt?(V!==sn||ie!==Cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),S}function we(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=F,this.setTexture2D=j,this.setTexture2DArray=q,this.setTexture3D=ae,this.setTextureCube=Z,this.rebindTextures=te,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=K,this.updateMultisampleRenderTarget=Se,this.setupDepthRenderbuffer=H,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=he}function pm(i,e){function t(n,s=zn){let r;const a=et.getTransfer(s);if(n===Cn)return i.UNSIGNED_BYTE;if(n===Ha)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ga)return i.UNSIGNED_SHORT_5_5_5_1;if(n===bl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Sl)return i.BYTE;if(n===wl)return i.SHORT;if(n===hs)return i.UNSIGNED_SHORT;if(n===ka)return i.INT;if(n===ii)return i.UNSIGNED_INT;if(n===wn)return i.FLOAT;if(n===ms)return i.HALF_FLOAT;if(n===El)return i.ALPHA;if(n===Tl)return i.RGB;if(n===sn)return i.RGBA;if(n===Al)return i.LUMINANCE;if(n===Cl)return i.LUMINANCE_ALPHA;if(n===Pi)return i.DEPTH_COMPONENT;if(n===Fi)return i.DEPTH_STENCIL;if(n===Rl)return i.RED;if(n===Va)return i.RED_INTEGER;if(n===Pl)return i.RG;if(n===Wa)return i.RG_INTEGER;if(n===Xa)return i.RGBA_INTEGER;if(n===Zs||n===Ks||n===Js||n===js)if(a===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Zs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Zs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===aa||n===oa||n===la||n===ca)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===aa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===la)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ha||n===ua||n===da)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ha||n===ua)return a===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===da)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===fa||n===pa||n===ma||n===_a||n===ga||n===va||n===xa||n===ya||n===Ma||n===Sa||n===wa||n===ba||n===Ea||n===Ta)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===fa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===pa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ma)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===_a)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ga)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===va)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ya)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ma)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Sa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===wa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ba)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ea)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ta)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Qs||n===Aa||n===Ca)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Qs)return a===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Aa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ca)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ll||n===Ra||n===Pa||n===La)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Qs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ra)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Pa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===La)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ni?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class mm extends Xt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ni extends wt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const _m={type:"move"};class Br{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ni,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ni,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ni,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const y of e.hand.values()){const m=t.getJointPose(y,n),u=this._getHandJoint(c,y);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=h.position.distanceTo(d.position),p=.02,g=.005;c.inputState.pinching&&f>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(_m)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ni;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const gm=`
void main() {
...
\`sig:${ne}\` | *UNPLUG: Elemental Survivor*`,Oe=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(he)}&body=${encodeURIComponent(le)}&labels=record`;window.open(Oe,"_blank")}),(ye=document.getElementById("retry-btn"))==null||ye.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",R=new is,t=!0,me=!1,e.enemyMeshes.forEach(U=>e.scene.remove(U)),e.enemyMeshes=[],e.orbMeshes.forEach(U=>e.scene.remove(U)),e.orbMeshes=[],e.bulletMeshes.forEach(U=>e.scene.remove(U)),e.bulletMeshes=[]}),window._restartGame=()=>{R=new is,t=!0,me=!1,e.enemyMeshes.forEach(U=>e.scene.remove(U)),e.enemyMeshes=[],e.orbMeshes.forEach(U=>e.scene.remove(U)),e.orbMeshes=[],e.bulletMeshes.forEach(U=>e.scene.remove(U)),e.bulletMeshes=[]};const a={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",U=>{const H=a[U.code]||U.key.toLowerCase();if(U.code==="Space"&&U.preventDefault(),U.code==="Space"&&!R.level_up_pending()&&!R.is_paused()&&R.player_dash_cooldown()<=0&&je.playDash(),U.code==="Escape"){R.toggle_pause();const te=R.is_paused();document.getElementById("pause-menu").style.display=te?"flex":"none",te&&C();return}if(U.code==="Tab"){U.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(R.on_key_down(H),R.level_up_pending()){const te=R.player_class_tier();if(H==="1"){const oe=Qi(R.level_up_choice(0));R.choose_upgrade(0),R.player_class_tier()>te?D(R.player_class_tier()):M(oe),w()}if(H==="2"){const oe=Qi(R.level_up_choice(1));R.choose_upgrade(1),R.player_class_tier()>te?D(R.player_class_tier()):M(oe),w()}if(H==="3"){const oe=Qi(R.level_up_choice(2));R.choose_upgrade(2),R.player_class_tier()>te?D(R.player_class_tier()):M(oe),w()}}}),document.addEventListener("keyup",U=>{const H=a[U.code]||U.key.toLowerCase();R.on_key_up(H)});const o=document.getElementById("game-canvas");o.addEventListener("contextmenu",U=>U.preventDefault()),document.addEventListener("contextmenu",U=>{t&&U.preventDefault()}),o.addEventListener("selectstart",U=>U.preventDefault());let l=null,c=!1,h=null,d=[],f=null,p=null;o.addEventListener("mousedown",U=>{if(!(!t||!R))if(U.preventDefault(),U.button===0){if(l={x:U.clientX,y:U.clientY,button:0},d=[{x:U.clientX,y:U.clientY}],c=!1,ji.clear(),ji.addPoint(U.clientX,U.clientY),_(),document.body.style.cursor="crosshair",window._gestureStartTime=performance.now(),window._gestureTimeLimit=2500,!document.getElementById("gesture-timer-hud")){const H=document.createElement("div");H.id="gesture-timer-hud",H.innerHTML=`<svg width="160" height="90" viewBox="0 0 160 90" style="filter:drop-shadow(0 0 8px rgba(100,180,255,0.4))">
            ...
            </svg>`,H.style.cssText="position:fixed;top:50%;left:50%;transform:translate(-50%,-60%);pointer-events:none;z-index:995;opacity:0;transition:opacity 0.2s",document.body.appendChild(H),requestAnimationFrame(()=>H.style.opacity="1")}if(window._gestureTimerRAF=requestAnimationFrame(function H(){const te=performance.now()-window._gestureStartTime,oe=Math.min(1,te/window._gestureTimeLimit),K=document.getElementById("gesture-arc");if(K&&(K.style.strokeDasharray=220,K.style.strokeDashoffset=220*oe,oe>.7&&K.setAttribute("stroke",`rgba(255,${Math.floor(180*(1-oe))},50,0.8)`)),oe>=1&&l){document.dispatchEvent(new MouseEvent("mouseup",{clientX:l.x,clientY:l.y,button:0}));return}l&&(window._gestureTimerRAF=requestAnimationFrame(H))}),!document.getElementById("gesture-desaturate")){const H=document.createElement("div");H.id="gesture-desaturate",H.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:990;opacity:0;transition:opacity 0.3s ease-in;background:radial-gradient(circle 280px at var(--gx, 50%) var(--gy, 50%), rgba(0,0,0,0.0) 0%, rgba(0,0,0,0.05) 40%, rgba(0,0,0,0.22) 100%)",document.body.appendChild(H),requestAnimationFrame(()=>H.style.opacity="1"),document.body.appendChild(H)}}else U.button===2&&R.player_class_tier()>=2&&(l={x:U.clientX,y:U.clientY,button:2},d=[{x:U.clientX,y:U.clientY}],c=!1,_())}),document.addEventListener("mousemove",U=>{if(window._lastMouseX=U.clientX,window._lastMouseY=U.clientY,!l)return;const H=U.clientX-l.x,te=U.clientY-l.y,oe=Math.sqrt(H*H+te*te);d.push({x:U.clientX,y:U.clientY});const K=document.getElementById("gesture-desaturate");if(K&&(K.style.setProperty("--gx",U.clientX+"px"),K.style.setProperty("--gy",U.clientY+"px")),v(d),oe>20){c=!0;const re=g(d,l);if(!p){const T=document.createElement("canvas");T.width=window.innerWidth,T.height=window.innerHeight,T.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(T),p=T}const P=p.getContext("2d");if(P.clearRect(0,0,p.width,p.height),d.length>2){const T=xt(),S={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};P.strokeStyle=S[T]||S[0],P.lineWidth=3,P.lineCap="round",P.beginPath(),P.moveTo(d[0].x,d[0].y);for(let B=1;B<d.length;B++)P.lineTo(d[B].x,d[B].y);P.stroke(),re==="circle"&&(P.strokeStyle="rgba(255,200,0,0.7)",P.lineWidth=5,P.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),f||(f=document.createElement("div"),f.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(f));const Se=Math.min(50+oe*.4,100),ne=xt(),he=l.button===2,Oe=(he?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[ne]||(he?"#ccaaff":"#8888ff");h.style.width=Se+"px",h.style.height=Se+"px",h.style.borderColor=Oe,h.style.boxShadow=`0 0 ${Se/4}px ${Oe}, inset 0 0 ${Se/6}px ${Oe}`;const we={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=we[re]||"...",e&&e.camera){const T=e.projectToScreen(R.player_x(),.5,R.player_z());if(h.style.left=T.x-Se/2+"px",h.style.top=T.y-Se/2+"px",re==="outward"){const S=Math.atan2(te,H),B=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let V=Math.round(S/(Math.PI/4));V<0&&(V+=8),V=V%8,f.textContent=B[V],f.style.fontSize="32px";const ie=50;f.style.left=T.x+Math.cos(S)*ie-16+"px",f.style.top=T.y+Math.sin(S)*ie-16+"px",f.style.opacity="1"}else re==="inward"?(f.textContent="🛡️",f.style.fontSize="28px",f.style.left=T.x-14+"px",f.style.top=T.y-14+"px",f.style.opacity="1"):re==="circle"?(f.textContent="🌀",f.style.left=T.x-14+"px",f.style.top=T.y-40+"px",f.style.opacity="1"):(f.style.opacity="0.3",f.textContent="?")}}}),document.addEventListener("mouseup",U=>{if(!l||!R){l=null;return}const H=U.clientX-l.x,te=U.clientY-l.y,oe=Math.sqrt(H*H+te*te),K=l.button;document.body.style.cursor="";const re=document.getElementById("gesture-desaturate");re&&re.remove();const P=document.getElementById("gesture-timer-hud");if(P&&P.remove(),window._gestureTimerRAF&&cancelAnimationFrame(window._gestureTimerRAF),A(),h&&(h.remove(),h=null),f&&(f.remove(),f=null),p&&(p.remove(),p=null),x(),K===0&&R.player_class_tier()>0)if(c&&oe>30){const Se=g(d,l),ne=Math.atan2(-te,H);if(Se==="outward"){if(R.player_class_tier()>0&&!m(20)){l=null,c=!1,d=[];return}R.use_directional_skill(ne);const he=xt(),le=document.createElement("div"),Oe={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};le.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${Oe[he]||Oe[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(le),setTimeout(()=>le.remove(),150),e.spawnDirectionalEffect(R.player_x(),R.player_z(),ne,he,7),e.hitStop(.04),e.shake(.3,.1),e.zoomPunch(1,.12),window._onboardingActive&&s(),he===1?je.playElementFire():he===2?je.playElementIce():he===3?je.playElementThunder():he===4?je.playElementPoison():je.playHit(),b("outward")}else if(Se==="inward")R.use_shield_skill(),je.playShield(),e.spawnShieldEffect(R.player_x(),R.player_z(),xt()),e.shake(.15,.05),b("inward");else if(Se==="circle"){if(R.player_class_tier()>0&&!m(50)){l=null,c=!1,d=[];return}R.use_ultimate_skill(),je.playUltimate(xt());const he=xt();e.spawnUltimateEffect(R.player_x(),R.player_z(),he,10),e.hitStop(.12),e.shake(.8,.25),b("circle");const le={0:"rgba(255,255,255,0.15)",1:"rgba(255,80,0,0.12)",2:"rgba(50,180,255,0.12)",3:"rgba(255,200,0,0.12)",4:"rgba(150,50,255,0.12)"},Oe=document.createElement("div");Oe.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${le[he]||le[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(Oe),setTimeout(()=>Oe.remove(),400);const we=document.createElement("div");we.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(we),setTimeout(()=>we.remove(),600),window._onboardingActive&&s()}else if(Se==="zigzag"){if(R.player_class_tier()>0&&!m(35)){l=null,c=!1,d=[];return}const he=xt();for(let le=-1;le<=1;le++){const Oe=Math.atan2(-te,H)+le*.4;setTimeout(()=>{R.use_directional_skill(Oe),e.spawnDirectionalEffect(R.player_x(),R.player_z(),Oe,he,5)},le*80+80)}e.hitStop(.06),e.shake(.4,.15),je.playElementThunder(),b("zigzag")}else if(Se==="vshape"){if(R.player_class_tier()>0&&!m(25)){l=null,c=!1,d=[];return}R.use_shield_skill();const he=xt();e.spawnShieldEffect(R.player_x(),R.player_z(),he),setTimeout(()=>{const le=Math.atan2(-te,H);R.use_directional_skill(le),e.spawnDirectionalEffect(R.player_x(),R.player_z(),le,he,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),je.playShield(),b("vshape")}else if(Se==="upstroke"){if(R.player_class_tier()>0&&!m(30)){l=null,c=!1,d=[];return}const he=Math.atan2(-te,H);R.use_directional_skill(he);const le=xt();e.spawnDirectionalEffect(R.player_x(),R.player_z(),he,le,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),le===1?je.playElementFire():le===2?je.playElementIce():le===3?je.playElementThunder():je.playHit(),b("upstroke")}else R.use_directional_skill(Math.atan2(-te,H)),e.shake(.1,.05)}else c||R.use_active_skill();else if(K===2&&R.player_class_tier()>=2)if(c&&oe>30){const Se=g(d,l),ne=Math.atan2(-te,H);if(Se==="outward"){if(!m(20)){l=null,c=!1,d=[];return}R.use_directional_skill(ne);const he=xt();e.spawnAdvancedDirectionalEffect(R.player_x(),R.player_z(),ne,he,9),je.playAdvancedSkill(he),e.shake(.55,.15),b("outward")}else if(Se==="circle"){if(!m(50)){l=null,c=!1,d=[];return}const he=xt();R.use_ultimate_skill(),je.playAdvancedUltimate(he),e.spawnAdvancedUltimateEffect(R.player_x(),R.player_z(),he,12),e.shake(.9,.3),b("circle");const le=document.createElement("div");le.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",le.style.background=he===1?"rgba(255,100,0,0.3)":he===2?"rgba(100,200,255,0.3)":he===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(le),setTimeout(()=>le.remove(),400),e.shake(.7,.25),b("circle")}else R.use_active_skill(),e.shake(.3,.1),b("outward")}else c||(R.use_active_skill(),e.spawnSkillEffect(R.player_x(),R.player_z(),xt(),4),e.shake(.25,.08));l=null,c=!1,d=[]});function g(U,H){if(U.length<5)return"unknown";const te=U[U.length-1],oe=te.x-H.x,K=te.y-H.y,re=Math.sqrt(oe*oe+K*K);if(U.length>30){let P=0;for(let ne=2;ne<U.length;ne++){const he=U[ne-1].x-U[ne-2].x,le=U[ne-1].y-U[ne-2].y,Oe=U[ne].x-U[ne-1].x,we=U[ne].y-U[ne-1].y,T=he*we-le*Oe,S=he*Oe+le*we;P+=Math.atan2(T,S)}const Se=Math.sqrt((te.x-H.x)**2+(te.y-H.y)**2);if(Math.abs(P)>Math.PI*1.9&&Se<120)return"circle"}if(U.length>15){let P=0,Se=0;for(let ne=3;ne<U.length;ne+=3){const he=U[ne].x-U[ne-3].x;Se!==0&&Math.sign(he)!==Math.sign(Se)&&Math.abs(he)>10&&P++,Math.abs(he)>10&&(Se=he)}if(P>=3&&re<200)return"zigzag"}if(U.length>10){let P=0;for(let ne=1;ne<U.length;ne++)U[ne].y>U[P].y&&(P=ne);const Se=P/U.length;if(Se>.25&&Se<.75){const ne=U[P].y-H.y,he=U[P].y-te.y;if(ne>40&&he>40&&re<150)return"vshape"}}if(re>60&&K<-50&&Math.abs(oe)<Math.abs(K)*.5)return"upstroke";if(e&&e.camera){const P=e.projectToScreen(R.player_x(),.5,R.player_z()),Se=Math.sqrt((H.x-P.x)**2+(H.y-P.y)**2),ne=Math.sqrt((te.x-P.x)**2+(te.y-P.y)**2);if(ne<Se-20)return"inward";if(ne>Se+20)return"outward"}return re>40?"outward":"unknown"}function y(){const U=document.getElementById("stamina-bar-bg");if(!U)return;U.style.border="2px solid #ff4444";const H=document.createElement("div");H.textContent="Not enough mana",H.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(H),setTimeout(()=>{H.remove(),U.style.border="1px solid #2a4a2a"},1e3)}function m(U){return R.player_stamina()<U?(y(),!1):!0}let u=null;function _(){u||(u=document.createElement("div"),u.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",u.innerHTML=`
        ...
        `,document.body.appendChild(u))}function x(){u&&(u.remove(),u=null)}function v(U){ji.setStyle(R.player_class_tier(),xt());const H=U[U.length-1];H&&ji.addPoint(H.x,H.y)}function A(){const U=d.length>5?g(d,l||{x:0,y:0}):"unknown";ji.release(U)}function b(U){const H=R.learned_skill_count();if(H===0)return;let te="",oe="#fff";if(U==="outward"){for(let re=0;re<H;re++)if(R.learned_skill_type(re)===0){te=R.learned_skill_name(re);break}oe="#ff8844"}else if(U==="inward"){for(let re=0;re<H;re++)if(R.learned_skill_type(re)===1){te=R.learned_skill_name(re);break}te||(te="Shield"),oe="#44ff88"}else if(U==="circle"){for(let re=0;re<H;re++)if(R.learned_skill_type(re)===2){te=R.learned_skill_name(re);break}te||(te="Ultimate"),oe="#ffcc00"}else U==="zigzag"?(te="Chain Strike",oe="#ffdd44"):U==="vshape"?(te="Parry Counter",oe="#88ffaa"):U==="upstroke"&&(te="Pierce",oe="#ff66aa");te||(te="Skill");const K=document.createElement("div");K.textContent=U==="circle"?`✨ ${te} ✨`:te,K.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${oe};font-size:${U==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${oe},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(K),setTimeout(()=>K.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{R.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function C(){let U="<b>📜 Status</b><br><br>";const H=R.fire_level(),te=R.ice_level(),oe=R.thunder_level(),K=R.poison_level();U+="<b>⚗️ Element Orbs</b><br>",H>0&&(U+=`  🔥 Fire: ${H}<br>`),te>0&&(U+=`  ❄️ Ice: ${te}<br>`),oe>0&&(U+=`  ⚡ Thunder: ${oe}<br>`),K>0&&(U+=`  ☠️ Poison: ${K}<br>`),H+te+oe+K===0&&(U+='  <span style="color:#666">None</span><br>');const re=R.player_class_tier();if(re>0){U+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[re]||""} ${R.player_class_name()}</b> (Tier ${re})<br>`;const Se=R.learned_skill_count();if(Se>0){U+="<br><b>🗡️ Class Skills</b><br>";for(let ne=0;ne<Se;ne++){const he=R.learned_skill_name(ne),le=R.learned_skill_level(ne);U+=`  📈 ${he} <span style="color:#ffcc00">Lv.${le}</span><br>`}}}else U+='<br><span style="color:#666">Reach Lv.2 for first promotion</span><br>',U+='<span style="color:#555;font-size:10px">Collect element orbs to meet requirements</span>';if(re===0||re===1||re===2){const P=re===0?10:re===1?25:45;R.player_level()<P&&(U+=`<br><br><span style="color:#888;font-size:10px">Next promotion: Lv.${P}</span>`)}document.getElementById("pause-skills").innerHTML=U}for(let U=0;U<3;U++)document.getElementById(`choice-${U}`).addEventListener("click",()=>{const H=R.level_up_choice(U),te=Qi(H),oe=R.player_class_tier();R.choose_upgrade(U);const K=R.player_class_tier();if(K>oe)D(K);else{M(te);const re=R.player_x(),P=R.player_z();if(H>=50&&H<=53){const Se=H-49;e.spawnDirectionalEffect(re,P,0,Se,4),e.spawnGroundDecal(re,P,Se),e.zoomPunch(.8,.1)}else H>=60&&e.spawnDeathParticles(re,P,xt())}w()});function L(){const U=document.getElementById("levelup");U.style.display="block",U.classList.add("shown");for(let te=0;te<3;te++){const oe=R.level_up_choice(te),K=Qi(oe),re=M0(oe);let P="";if(oe>=50&&oe<=53){const ne=oe-50+1,he=[0,R.fire_level(),R.ice_level(),R.thunder_level(),R.poison_level()][ne],le=R.player_class_tier()===0?1:4,Oe=Math.max(0,le-he-1);Oe===0?P='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':P=`<span style="color:#555;font-size:10px">→ ${Oe} more to promote</span>`}else oe>=100&&(P=`<span style="color:#daa520;font-size:10px">${Wt.star(10)} Class change!</span>`);const Se=oe>=50&&oe<=53?$r(oe-49,18):oe>=100?Wt.star(18):"";document.getElementById(`choice-${te}`).innerHTML=`
          ...
          `}let H=document.getElementById("levelup-hint");H||(H=document.createElement("div"),H.id="levelup-hint",H.style.cssText="color:#daa520;font-size:11px;margin-top:10px;text-align:center;opacity:0.8",U.appendChild(H)),R.player_class_tier()===0&&R.player_level()<=4?(H.textContent="Choose element orbs to unlock class promotion",H.style.display="block"):H.style.display="none"}function w(){const U=document.getElementById("levelup");U.style.display="none",U.classList.remove("shown"),G=!1,je.playPickup()}function M(U){const H=xt(),oe={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[H]||"#daa520",K=document.createElement("div");K.style.cssText="position:fixed;top:18%;left:50%;transform:translateX(-50%) scale(0.8);z-index:9998;pointer-events:none;text-align:center;opacity:0;transition:all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",K.innerHTML=`<div style="font-size:14px;color:#fff;text-shadow:0 0 8px ${oe};background:rgba(0,0,0,0.8);padding:8px 20px;border-radius:20px;border:1px solid ${oe}44;font-family:'Inter',sans-serif">${$r(H,14)} ${U}</div>`,document.body.appendChild(K),requestAnimationFrame(()=>{K.style.opacity="1",K.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{K.style.opacity="0",K.style.transform="translateX(-50%) scale(0.9) translateY(-10px)"},1400),setTimeout(()=>K.remove(),1800);const re=document.createElement("div");re.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${oe}11;pointer-events:none;z-index:990;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(re),setTimeout(()=>re.remove(),400)}function D(U){const H=xt(),te=R.player_class_name()||"",K={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[H]||"#daa520";e.hitStop(.3);const re=document.createElement("div");re.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:9998;
          ...
          pointer-events:none;z-index:9997;transition:all 0.6s ease-out`,document.body.appendChild(P),requestAnimationFrame(()=>{P.style.width="300px",P.style.height="300px"}),setTimeout(()=>{const Se=["","CLASS PROMOTION","ADVANCED CLASS","MASTER CLASS"],ne=document.createElement("div");ne.style.cssText=`position:fixed;top:38%;left:50%;transform:translate(-50%,-50%) scale(0.5);
          ...
          `,document.body.appendChild(ne),requestAnimationFrame(()=>{ne.style.opacity="1",ne.style.transform="translate(-50%,-50%) scale(1)"}),setTimeout(()=>{ne.style.opacity="0",ne.style.transform="translate(-50%,-50%) scale(1.1)"},1800),setTimeout(()=>ne.remove(),2300)},400),setTimeout(()=>{const Se=document.createElement("div");Se.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${K}55;
            pointer-events:none;z-index:9999;animation:flash-fade 0.5s ease-out forwards`,document.body.appendChild(Se),setTimeout(()=>Se.remove(),500),e.shake(.6,.25),e.zoomPunch(3,.2),je.playLevelUp(),setTimeout(()=>je.playShield(),100)},800),setTimeout(()=>{H===1?R.use_ultimate_skill():H===2?R.use_shield_skill():H===3||H===4?R.use_ultimate_skill():R.use_directional_skill(0),e.spawnUltimateEffect(R.player_x(),R.player_z(),H,12),e.shake(.3,.15)},1200),setTimeout(()=>{re.style.boxShadow="inset 0 0 0 0 rgba(0,0,0,0)",P.style.opacity="0",setTimeout(()=>{re.remove(),P.remove()},500)},2e3)}const F=[];let k="",G=!1;function j(){const U=R.player_promoted(),H=U?R.player_class_name():"",te={1:"⭐",2:"🌟",3:"👑"},oe=R.player_class_tier(),K=te[oe]||"";document.getElementById("level").textContent=R.player_level()+(H?` ${K}${H}`:"");const re=xt(),P=document.getElementById("portrait"),Se={0:Wt.sword(24),1:Wt.fire(24),2:Wt.ice(24),3:Wt.thunder(24),4:Wt.poison(24)},ne={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"};P.innerHTML=Se[re]||Wt.sword(24),P.style.borderColor=ne[re]||"#555",U?P.style.boxShadow=`0 0 10px ${ne[re]}`:P.style.boxShadow="none";const he=Math.max(0,R.player_hp()/R.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=he+"%";const le=Math.max(0,R.player_shield()/R.player_max_hp()*100),Oe=document.getElementById("shield-bar-fill");Oe.style.width=le+"%",Oe.style.left=he+"%";const we=R.player_xp()/R.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=we+"%";const T=document.getElementById("stat-panel"),S=R.player_class_tier(),B=R.fire_level(),V=R.ice_level(),ie=R.thunder_level(),J=R.poison_level(),Re=R.element_total();let fe=document.getElementById("promo-hud");if(fe||(fe=document.createElement("div"),fe.id="promo-hud",fe.style.cssText="margin-top:6px;font-size:11px;color:#8a8680;line-height:1.5;background:rgba(8,6,12,0.85);padding:4px 8px;border-radius:4px;border:1px solid rgba(218,165,32,0.15);max-width:170px;backdrop-filter:blur(4px)",document.getElementById("stats").appendChild(fe)),S<3){const ze=S===0?1:S===1?4:7,st=S===0?2:S===1?4:7,Ut=R.player_level()>=st,yt=R.promotion_available_count()>0;let St;yt?St="⭐ PROMOTION READY! (Level up to choose)":Ut?St=`Need ${ze} of same element (${Re} total)`:St=`Next: Lv${st} + ${ze} orbs (${Re}/${ze})`,fe.innerHTML=`<span style="color:${B>0?"#ff4400":"#333"}">${Wt.fire(12,B>0?"#ff4400":"#333")}${B}</span> <span style="color:${V>0?"#44ccff":"#333"}">${Wt.ice(12,V>0?"#44ccff":"#333")}${V}</span> <span style="color:${ie>0?"#ffcc00":"#333"}">${Wt.thunder(12,ie>0?"#ffcc00":"#333")}${ie}</span> <span style="color:${J>0?"#9933ff":"#333"}">${Wt.poison(12,J>0?"#9933ff":"#333")}${J}</span><br><span style="color:${yt?"#daa520":"#666"};font-size:10px">${St}</span>`,fe.style.display="block"}else fe.style.display="none";T&&(T.style.display=window._showDetailStats?"block":"none",window._showDetailStats&&(T.innerHTML=`ATK <span style="color:#ff8844">${Math.round(R.player_damage())}</span><br>SPD <span style="color:#44ccff">${R.player_atk_speed().toFixed(1)}/s</span><br>RNG <span style="color:#88ff44">${R.player_range().toFixed(1)}</span><br>CRT <span style="color:#ff4488">${Math.round(R.player_crit()*100)}%</span><br>PRC <span style="color:#ffcc44">${R.player_pierce()}</span> ×<span style="color:#44ffcc">${R.player_multi()}</span><br>STEAL <span style="color:#ff44ff">${Math.round(R.player_lifesteal()*100)}%</span>`));const Te={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},Je={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},ce={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},Ae=R.skill_slot_count(),Fe=R.learned_skill_count();let Be="";for(let ze=0;ze<Ae;ze++)Be+=R.skill_slot_id(ze)+":"+R.skill_slot_level(ze)+",";Be+="|"+Fe;for(let ze=0;ze<Fe;ze++)Be+=R.learned_skill_id(ze)+":"+R.learned_skill_level(ze)+",";if(Be!==k){k=Be;let ze="";for(let st=0;st<Ae;st++){const Ut=R.skill_slot_id(st),yt=R.skill_slot_level(st),St=Te[Ut]||"⭐",Lt=Je[Ut]||"#888",oi=ce[Ut]||"Skill";ze+=`<div class="skill-icon" style="background:${Lt}22;border-color:${Lt}">
