...
조합에 따라 전직이 결정됩니다`,duration:5e3},{time:25e3,text:"🖱️ 전직 후: 마우스 클릭/드래그로 스킬 사용!",duration:4e3}],H=document.getElementById("tutorial");A.forEach(X=>{setTimeout(()=>{H.innerHTML=X.text.replace(/\n/g,"<br>"),H.style.opacity="1",setTimeout(()=>{H.style.opacity="0"},X.duration)},X.time)})}document.getElementById("tree-btn").addEventListener("click",()=>{document.getElementById("class-tree-screen").style.display="flex",s()}),document.getElementById("tree-close-btn").addEventListener("click",()=>{document.getElementById("class-tree-screen").style.display="none"});function s(){const A=[{name:"Flame Knight",req:"🔥×2",concept:"Melee burst"},{name:"Frost Mage",req:"❄️×2",concept:"AoE slow"},{name:"Storm Warrior",req:"⚡×2",concept:"Speed+chain"},{name:"Plague Bearer",req:"☠️×2",concept:"DOT stack"},{name:"Steam Engineer",req:"🔥+❄️",concept:"Explode+slow"},{name:"Plasma Mage",req:"🔥+⚡",concept:"Chain explode"},{name:"Hellfire Witch",req:"🔥+☠️",concept:"Burn+poison"},{name:"Aurora Knight",req:"❄️+⚡",concept:"Freeze+shock"},{name:"Cryo Alchemist",req:"❄️+☠️",concept:"Slow+weaken"},{name:"Volt Chemist",req:"⚡+☠️",concept:"Shock+blast"},{name:"Elemental Blade",req:"🔥+❄️+⚡",concept:"Balanced"},{name:"Frost Plague",req:"❄️+☠️",concept:"Freeze+disease"},{name:"Thunder Toxin",req:"⚡+☠️",concept:"Chain+spread"},{name:"Vile Storm",req:"❄️+⚡+☠️",concept:"Chaotic AoE"},{name:"Primordial Novice",req:"🔥+❄️+⚡+☠️",concept:"Jack of all"}],H=[{name:"Weapon Master",req:"ATK 120+",concept:"Pure physical god"},{name:"Vampire Lord",req:"Lifesteal 25%+",concept:"Undying drain"},{name:"Berserker",req:"AOE 6+",concept:"Rage AoE"},{name:"Assassin",req:"Crit 50%+",concept:"One-shot stealth"},{name:"Windwalker",req:"Speed 9+",concept:"Movement = attack"}],X=["Inferno Lord","Volcanic Thunder","Blizzard Warden","Permafrost Plague","Thunder God","Plasma Overlord","Venom Lord","Toxic Glacier","Reactor Core","Nova Cannon","Demon Summoner","Absolute Zero","Bio Freeze","Acid Storm","Prism Knight","Pandemic Frost","Chain Decay","Chaos Shaman","Primordial Adept","Awakened One"],ae=["Phoenix","Cryomancer","Ragnarok","Pandemic","Antimatter","Supernova","Entropy","Archfiend","Avatar","Primordial God"];let ie='<h3 style="color:#ffcc00;margin:8px 0">⭐ 1차 전직 (Lv 10+ / Orb 2+)</h3>';ie+='<table style="width:100%;border-collapse:collapse;margin-bottom:16px">',ie+='<tr style="color:#888;border-bottom:1px solid #333"><td>Class</td><td>Requirement</td><td>Style</td></tr>',A.forEach(se=>{ie+=`<tr style="border-bottom:1px solid #222"><td style="color:#ff8844;padding:4px 0">${se.name}</td><td>${se.req}</td><td style="color:#666">${se.concept}</td></tr>`}),ie+="</table>",ie+='<h3 style="color:#ff44ff;margin:8px 0">🌈 히든 전직 (스탯 특화)</h3>',ie+='<table style="width:100%;border-collapse:collapse;margin-bottom:16px">',ie+='<tr style="color:#888;border-bottom:1px solid #333"><td>Class</td><td>Requirement</td><td>Style</td></tr>',H.forEach(se=>{ie+=`<tr style="border-bottom:1px solid #222"><td style="color:#ff44ff;padding:4px 0">${se.name}</td><td>${se.req}</td><td style="color:#666">${se.concept}</td></tr>`}),ie+="</table>",ie+='<h3 style="color:#44ccff;margin:8px 0">🌟 2차 전직 (Lv 25+ / Orb 6+)</h3>',ie+='<div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:16px">',X.forEach(se=>{ie+=`<span style="background:#1a2a3a;padding:3px 8px;border-radius:4px;font-size:11px">${se}</span>`}),ie+="</div>",ie+='<h3 style="color:#ffcc00;margin:8px 0">👑 3차 전직 (Lv 45+ / Orb 10+)</h3>',ie+='<div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:16px">',ae.forEach(se=>{ie+=`<span style="background:#2a1a00;padding:3px 8px;border-radius:4px;font-size:11px;color:#ffcc00">${se}</span>`}),ie+="</div>",ie+='<p style="color:#555;font-size:10px;margin-top:12px">※ 같은 원소를 집중하면 순수 전직, 분산하면 하이브리드 전직이 해금됩니다.</p>',document.getElementById("class-tree-content").innerHTML=ie}document.getElementById("retry-btn").addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",U=new Rs,t=!0,$=!1,e.enemyMeshes.forEach(A=>e.scene.remove(A)),e.enemyMeshes=[],e.orbMeshes.forEach(A=>e.scene.remove(A)),e.orbMeshes=[],e.bulletMeshes.forEach(A=>e.scene.remove(A)),e.bulletMeshes=[]});const r={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",A=>{const H=r[A.code]||A.key.toLowerCase();if(A.code==="Space"&&A.preventDefault(),A.code==="Escape"){U.toggle_pause();const X=U.is_paused();document.getElementById("pause-menu").style.display=X?"flex":"none",X&&g();return}U.on_key_down(H),U.level_up_pending()&&(H==="1"&&(U.choose_upgrade(0),b()),H==="2"&&(U.choose_upgrade(1),b()),H==="3"&&(U.choose_upgrade(2),b()))}),document.addEventListener("keyup",A=>{const H=r[A.code]||A.key.toLowerCase();U.on_key_up(H)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",A=>A.preventDefault()),document.addEventListener("contextmenu",A=>{t&&A.preventDefault()}),a.addEventListener("selectstart",A=>A.preventDefault());let o=null,c=!1,l=null,u=[],h=null,d=null;a.addEventListener("mousedown",A=>{!t||!U||(A.preventDefault(),A.button===0&&U.player_class_tier()>0?(o={x:A.clientX,y:A.clientY,button:0},u=[{x:A.clientX,y:A.clientY}],c=!1,f()):A.button===2&&U.player_class_tier()>=2&&(o={x:A.clientX,y:A.clientY,button:2},u=[{x:A.clientX,y:A.clientY}],c=!1,f()))}),document.addEventListener("mousemove",A=>{if(!o)return;const H=A.clientX-o.x,X=A.clientY-o.y,ae=Math.sqrt(H*H+X*X);if(u.push({x:A.clientX,y:A.clientY}),ae>20){c=!0;const ie=p(u,o);if(!d){const ye=document.createElement("canvas");ye.width=window.innerWidth,ye.height=window.innerHeight,ye.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(ye),d=ye}const se=d.getContext("2d");if(se.clearRect(0,0,d.width,d.height),u.length>2){const ye=U.player_class_element()||U.active_element(),Xe={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};se.strokeStyle=Xe[ye]||Xe[0],se.lineWidth=3,se.lineCap="round",se.beginPath(),se.moveTo(u[0].x,u[0].y);for(let Ne=1;Ne<u.length;Ne++)se.lineTo(u[Ne].x,u[Ne].y);se.stroke(),ie==="circle"&&(se.strokeStyle="rgba(255,200,0,0.7)",se.lineWidth=5,se.stroke())}l||(l=document.createElement("div"),l.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(l)),h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(h));const z=Math.min(50+ae*.4,100),K=U.player_class_element()||U.active_element(),re=o.button===2,Me=(re?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[K]||(re?"#ccaaff":"#8888ff");l.style.width=z+"px",l.style.height=z+"px",l.style.borderColor=Me,l.style.boxShadow=`0 0 ${z/4}px ${Me}, inset 0 0 ${z/6}px ${Me}`;const Re={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(l.textContent=Re[ie]||"...",e&&e.camera){const ye=e.projectToScreen(U.player_x(),.5,U.player_z());if(l.style.left=ye.x-z/2+"px",l.style.top=ye.y-z/2+"px",ie==="outward"){const Xe=Math.atan2(X,H),Ne=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let Ie=Math.round(Xe/(Math.PI/4));Ie<0&&(Ie+=8),Ie=Ie%8,h.textContent=Ne[Ie],h.style.fontSize="32px";const N=50;h.style.left=ye.x+Math.cos(Xe)*N-16+"px",h.style.top=ye.y+Math.sin(Xe)*N-16+"px",h.style.opacity="1"}else ie==="inward"?(h.textContent="🛡️",h.style.fontSize="28px",h.style.left=ye.x-14+"px",h.style.top=ye.y-14+"px",h.style.opacity="1"):ie==="circle"?(h.textContent="🌀",h.style.left=ye.x-14+"px",h.style.top=ye.y-40+"px",h.style.opacity="1"):(h.style.opacity="0.3",h.textContent="?")}}}),document.addEventListener("mouseup",A=>{if(!o||!U){o=null;return}const H=A.clientX-o.x,X=A.clientY-o.y,ae=Math.sqrt(H*H+X*X),ie=o.button;if(l&&(l.remove(),l=null),h&&(h.remove(),h=null),d&&(d.remove(),d=null),v(),ie===0&&U.player_class_tier()>0)if(c&&ae>30){const se=p(u,o),z=Math.atan2(-X,H);if(se==="outward"){if(!y(20)){o=null,c=!1,u=[];return}U.use_directional_skill(z),e.spawnDirectionalEffect(U.player_x(),U.player_z(),z,U.player_class_element()||U.active_element(),5),e.shake(.35,.1),x("outward")}else if(se==="inward")U.use_shield_skill(),e.spawnShieldEffect(U.player_x(),U.player_z(),U.player_class_element()||U.active_element()),e.shake(.15,.05),x("inward");else if(se==="circle"){if(!y(50)){o=null,c=!1,u=[];return}U.use_ultimate_skill(),e.spawnUltimateEffect(U.player_x(),U.player_z(),U.player_class_element()||U.active_element(),8),e.shake(.6,.2),x("circle");const K=document.createElement("div");K.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.3);pointer-events:none;z-index:999;animation:flash-fade 0.3s ease-out forwards",document.body.appendChild(K),setTimeout(()=>K.remove(),300)}}else c||(U.use_active_skill(),e.shake(.2,.08));else if(ie===2&&U.player_class_tier()>=2)if(c&&ae>30){const se=p(u,o),z=Math.atan2(-X,H);if(se==="outward"){if(!y(20)){o=null,c=!1,u=[];return}U.use_directional_skill(z),e.spawnDirectionalEffect(U.player_x(),U.player_z(),z,U.player_class_element()||U.active_element(),7),e.shake(.4,.12),x("outward")}else if(se==="circle"){if(!y(50)){o=null,c=!1,u=[];return}U.use_ultimate_skill(),e.spawnUltimateEffect(U.player_x(),U.player_z(),U.player_class_element()||U.active_element(),10),e.shake(.7,.25),x("circle")}else U.use_active_skill(),e.shake(.3,.1),x("outward")}else c||(U.use_active_skill(),e.spawnSkillEffect(U.player_x(),U.player_z(),U.active_element(),4),e.shake(.25,.08));o=null,c=!1,u=[]});function p(A,H){if(A.length<5)return"unknown";const X=A[A.length-1],ae=X.x-H.x,ie=X.y-H.y,se=Math.sqrt(ae*ae+ie*ie);if(A.length>30){let z=0;for(let re=2;re<A.length;re++){const le=A[re-1].x-A[re-2].x,Me=A[re-1].y-A[re-2].y,Re=A[re].x-A[re-1].x,ye=A[re].y-A[re-1].y,Xe=le*ye-Me*Re,Ne=le*Re+Me*ye;z+=Math.atan2(Xe,Ne)}const K=Math.sqrt((X.x-H.x)**2+(X.y-H.y)**2);if(Math.abs(z)>Math.PI*1.9&&K<120)return"circle"}if(e&&e.camera){const z=e.projectToScreen(U.player_x(),.5,U.player_z()),K=Math.sqrt((H.x-z.x)**2+(H.y-z.y)**2),re=Math.sqrt((X.x-z.x)**2+(X.y-z.y)**2);if(re<K-20)return"inward";if(re>K+20)return"outward"}return se>40?"outward":"unknown"}function _(){const A=document.getElementById("stamina-bar-bg");if(!A)return;A.style.border="2px solid #ff4444";const H=document.createElement("div");H.textContent="⚠️ Mana 부족!",H.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(H),setTimeout(()=>{H.remove(),A.style.border="1px solid #2a4a2a"},1e3)}function y(A){return U.player_stamina()<A?(_(),!1):!0}let m=null;function f(){m||(m=document.createElement("div"),m.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",m.innerHTML=`
        ...
        `,document.body.appendChild(m))}function v(){m&&(m.remove(),m=null)}function x(A){const H=U.learned_skill_count();if(H===0)return;let X="",ae="#fff";if(A==="outward"){for(let se=0;se<H;se++)if(U.learned_skill_type(se)===0){X=U.learned_skill_name(se);break}ae="#ff8844"}else if(A==="inward"){for(let se=0;se<H;se++)if(U.learned_skill_type(se)===1){X=U.learned_skill_name(se);break}X||(X="Shield"),ae="#44ff88"}else if(A==="circle"){for(let se=0;se<H;se++)if(U.learned_skill_type(se)===2){X=U.learned_skill_name(se);break}X||(X="Ultimate"),ae="#ffcc00"}X||(X="Skill");const ie=document.createElement("div");ie.textContent=A==="circle"?`✨ ${X} ✨`:X,ie.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${ae};font-size:${A==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${ae},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(ie),setTimeout(()=>ie.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{U.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function g(){let A="<b>📜 Status</b><br><br>";const H=U.fire_level(),X=U.ice_level(),ae=U.thunder_level(),ie=U.poison_level();A+="<b>⚗️ Element Orbs</b><br>",H>0&&(A+=`  🔥 Fire: ${H}<br>`),X>0&&(A+=`  ❄️ Ice: ${X}<br>`),ae>0&&(A+=`  ⚡ Thunder: ${ae}<br>`),ie>0&&(A+=`  ☠️ Poison: ${ie}<br>`),H+X+ae+ie===0&&(A+='  <span style="color:#666">없음</span><br>');const se=U.player_class_tier();if(se>0){A+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[se]||""} ${U.player_class_name()}</b> (Tier ${se})<br>`;const K=U.learned_skill_count();if(K>0){A+="<br><b>🗡️ Class Skills</b><br>";for(let re=0;re<K;re++){const le=U.learned_skill_name(re),Me=U.learned_skill_level(re);A+=`  📈 ${le} <span style="color:#ffcc00">Lv.${Me}</span><br>`}}}else A+='<br><span style="color:#666">Lv.10에서 첫 전직 가능</span><br>',A+='<span style="color:#555;font-size:10px">원소를 모아 조합 조건을 맞추세요!</span>';if(se===0||se===1||se===2){const z=se===0?10:se===1?25:45;U.player_level()<z&&(A+=`<br><br><span style="color:#888;font-size:10px">다음 전직: Lv.${z}</span>`)}document.getElementById("pause-skills").innerHTML=A}for(let A=0;A<3;A++)document.getElementById(`choice-${A}`).addEventListener("click",()=>{U.choose_upgrade(A),b()});function C(){const A=document.getElementById("levelup");A.style.display="block",A.classList.add("shown");for(let H=0;H<3;H++){const X=U.level_up_choice(H),ae=Bm(X),ie=zm(X);document.getElementById(`choice-${H}`).innerHTML=`<span>[${H+1}]</span> ${ae}<br><small style="color:#999;font-size:11px">${ie}</small>`}}function b(){const A=document.getElementById("levelup");A.style.display="none",A.classList.remove("shown"),T=!1,Ot.playPickup()}const R=[];let L="",T=!1;function S(){const A=U.player_promoted(),H=A?U.player_class_name():"",X={1:"⭐",2:"🌟",3:"👑"},ae=U.player_class_tier(),ie=X[ae]||"";document.getElementById("level").textContent=U.player_level()+(H?` ${ie}${H}`:"");const se=U.active_element(),z=document.getElementById("portrait"),K={0:"🗡️",1:"🔥",2:"❄️",3:"⚡",4:"☠️"},re={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44"};z.textContent=K[se]||"🗡️",z.style.borderColor=re[se]||"#555",A?z.style.boxShadow=`0 0 10px ${re[se]}`:z.style.boxShadow="none";const le=Math.max(0,U.player_hp()/U.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=le+"%";const Me=Math.max(0,U.player_shield()/U.player_max_hp()*100),Re=document.getElementById("shield-bar-fill");Re.style.width=Me+"%",Re.style.left=le+"%";const ye=U.player_xp()/U.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=ye+"%";const Xe=document.getElementById("stat-panel");Xe&&(Xe.innerHTML=`⚔️ ATK <span style="color:#ff8844">${Math.round(U.player_damage())}</span><br>⚡ SPD <span style="color:#44ccff">${U.player_atk_speed().toFixed(1)}/s</span><br>🎯 RNG <span style="color:#88ff44">${U.player_range().toFixed(1)}</span><br>💥 CRT <span style="color:#ff4488">${Math.round(U.player_crit()*100)}%</span><br>🗡️ PRC <span style="color:#ffcc44">${U.player_pierce()}</span> 🔫 ×<span style="color:#44ffcc">${U.player_multi()}</span><br>🧛 STEAL <span style="color:#ff44ff">${Math.round(U.player_lifesteal()*100)}%</span>`);const Ne={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},Ie={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},N={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},mt=U.skill_slot_count(),Fe=U.learned_skill_count();let Ge="";for(let J=0;J<mt;J++)Ge+=U.skill_slot_id(J)+":"+U.skill_slot_level(J)+",";Ge+="|"+Fe;for(let J=0;J<Fe;J++)Ge+=U.learned_skill_id(J)+":"+U.learned_skill_level(J)+",";if(Ge!==L){L=Ge;let J="";for(let he=0;he<mt;he++){const Se=U.skill_slot_id(he),Pe=U.skill_slot_level(he),fe=Ne[Se]||"⭐",Ue=Ie[Se]||"#888",Oe=N[Se]||"Skill";J+=`<div class="skill-icon" style="background:${Ue}22;border-color:${Ue}">
