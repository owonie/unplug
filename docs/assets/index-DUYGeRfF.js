...
`)+`
`+u);const x=g+m+o,v=g+u+a,A=Ba(s,s.VERTEX_SHADER,x),E=Ba(s,s.FRAGMENT_SHADER,v);s.attachShader(y,A),s.attachShader(y,E),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(U){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(y).trim(),B=s.getShaderInfoLog(A).trim(),K=s.getShaderInfoLog(E).trim();let se=!0,Z=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(se=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,A,E);else{const le=Ha(s,A,"vertex"),Y=Ha(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
---
\`sig:${$}\` | *UNPLUG: Elemental Survivor*`,Be=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(fe)}&body=${encodeURIComponent(_e)}&labels=record`;window.open(Be,"_blank")}),(ye=document.getElementById("retry-btn"))==null||ye.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",P=new Zi,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]}),window._restartGame=()=>{P=new Zi,t=!0,me=!1,e.enemyMeshes.forEach(I=>e.scene.remove(I)),e.enemyMeshes=[],e.orbMeshes.forEach(I=>e.scene.remove(I)),e.orbMeshes=[],e.bulletMeshes.forEach(I=>e.scene.remove(I)),e.bulletMeshes=[]};const o={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",I=>{const k=o[I.code]||I.key.toLowerCase();if(I.code==="Space"&&I.preventDefault(),I.code==="Space"&&!P.level_up_pending()&&!P.is_paused()&&P.player_dash_cooldown()<=0&&je.playDash(),I.code==="Escape"){P.toggle_pause();const te=P.is_paused();document.getElementById("pause-menu").style.display=te?"flex":"none",te&&R();return}if(I.code==="Tab"){I.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(P.on_key_down(k),P.level_up_pending()){const te=P.player_class_tier();if(k==="1"){const ce=$i(P.level_up_choice(0));P.choose_upgrade(0),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}if(k==="2"){const ce=$i(P.level_up_choice(1));P.choose_upgrade(1),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}if(k==="3"){const ce=$i(P.level_up_choice(2));P.choose_upgrade(2),P.player_class_tier()>te?U(P.player_class_tier()):S(ce),w()}}}),document.addEventListener("keyup",I=>{const k=o[I.code]||I.key.toLowerCase();P.on_key_up(k)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",I=>I.preventDefault()),document.addEventListener("contextmenu",I=>{t&&I.preventDefault()}),a.addEventListener("selectstart",I=>I.preventDefault());let l=null,c=!1,h=null,f=[],d=null,p=null;a.addEventListener("mousedown",I=>{if(!(!t||!P))if(I.preventDefault(),I.button===0){if(l={x:I.clientX,y:I.clientY,button:0},f=[{x:I.clientX,y:I.clientY}],c=!1,Xi.clear(),Xi.addPoint(I.clientX,I.clientY),g(),document.body.style.cursor="crosshair",!document.getElementById("gesture-desaturate")){const k=document.createElement("div");k.id="gesture-desaturate",k.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.15);pointer-events:none;z-index:990;transition:opacity 0.1s",document.body.appendChild(k)}}else I.button===2&&P.player_class_tier()>=2&&(l={x:I.clientX,y:I.clientY,button:2},f=[{x:I.clientX,y:I.clientY}],c=!1,g())}),document.addEventListener("mousemove",I=>{if(!l)return;const k=I.clientX-l.x,te=I.clientY-l.y,ce=Math.sqrt(k*k+te*te);if(f.push({x:I.clientX,y:I.clientY}),v(f),ce>20){c=!0;const J=_(f,l);if(!p){const ue=document.createElement("canvas");ue.width=window.innerWidth,ue.height=window.innerHeight,ue.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(ue),p=ue}const re=p.getContext("2d");if(re.clearRect(0,0,p.width,p.height),f.length>2){const ue=xt(),T={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};re.strokeStyle=T[ue]||T[0],re.lineWidth=3,re.lineCap="round",re.beginPath(),re.moveTo(f[0].x,f[0].y);for(let M=1;M<f.length;M++)re.lineTo(f[M].x,f[M].y);re.stroke(),J==="circle"&&(re.strokeStyle="rgba(255,200,0,0.7)",re.lineWidth=5,re.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),d||(d=document.createElement("div"),d.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(d));const L=Math.min(50+ce*.4,100),Pe=xt(),$=l.button===2,_e=($?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[Pe]||($?"#ccaaff":"#8888ff");h.style.width=L+"px",h.style.height=L+"px",h.style.borderColor=_e,h.style.boxShadow=`0 0 ${L/4}px ${_e}, inset 0 0 ${L/6}px ${_e}`;const Be={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=Be[J]||"...",e&&e.camera){const ue=e.projectToScreen(P.player_x(),.5,P.player_z());if(h.style.left=ue.x-L/2+"px",h.style.top=ue.y-L/2+"px",J==="outward"){const T=Math.atan2(te,k),M=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let z=Math.round(T/(Math.PI/4));z<0&&(z+=8),z=z%8,d.textContent=M[z],d.style.fontSize="32px";const X=50;d.style.left=ue.x+Math.cos(T)*X-16+"px",d.style.top=ue.y+Math.sin(T)*X-16+"px",d.style.opacity="1"}else J==="inward"?(d.textContent="🛡️",d.style.fontSize="28px",d.style.left=ue.x-14+"px",d.style.top=ue.y-14+"px",d.style.opacity="1"):J==="circle"?(d.textContent="🌀",d.style.left=ue.x-14+"px",d.style.top=ue.y-40+"px",d.style.opacity="1"):(d.style.opacity="0.3",d.textContent="?")}}}),document.addEventListener("mouseup",I=>{if(!l||!P){l=null;return}const k=I.clientX-l.x,te=I.clientY-l.y,ce=Math.sqrt(k*k+te*te),J=l.button;document.body.style.cursor="";const re=document.getElementById("gesture-desaturate");if(re&&re.remove(),A(),h&&(h.remove(),h=null),d&&(d.remove(),d=null),p&&(p.remove(),p=null),x(),J===0&&P.player_class_tier()>0)if(c&&ce>30){const L=_(f,l),Pe=Math.atan2(-te,k);if(L==="outward"){if(P.player_class_tier()>0&&!m(20)){l=null,c=!1,f=[];return}P.use_directional_skill(Pe);const $=xt(),fe=document.createElement("div"),_e={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};fe.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${_e[$]||_e[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(fe),setTimeout(()=>fe.remove(),150),e.spawnDirectionalEffect(P.player_x(),P.player_z(),Pe,$,7),e.hitStop(.04),e.shake(.3,.1),e.zoomPunch(1,.12),window._onboardingActive&&s(),$===1?je.playElementFire():$===2?je.playElementIce():$===3?je.playElementThunder():$===4?je.playElementPoison():je.playHit(),E("outward")}else if(L==="inward")P.use_shield_skill(),je.playShield(),e.spawnShieldEffect(P.player_x(),P.player_z(),xt()),e.shake(.15,.05),E("inward");else if(L==="circle"){if(P.player_class_tier()>0&&!m(50)){l=null,c=!1,f=[];return}P.use_ultimate_skill(),je.playUltimate(xt());const $=xt();e.spawnUltimateEffect(P.player_x(),P.player_z(),$,10),e.hitStop(.12),e.shake(.8,.25),E("circle");const fe={0:"rgba(255,255,255,0.4)",1:"rgba(255,80,0,0.35)",2:"rgba(50,180,255,0.35)",3:"rgba(255,200,0,0.35)",4:"rgba(150,50,255,0.35)"},_e=document.createElement("div");_e.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${fe[$]||fe[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(_e),setTimeout(()=>_e.remove(),400);const Be=document.createElement("div");Be.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(Be),setTimeout(()=>Be.remove(),600),window._onboardingActive&&s()}else if(L==="zigzag"){if(P.player_class_tier()>0&&!m(35)){l=null,c=!1,f=[];return}const $=xt();for(let fe=-1;fe<=1;fe++){const _e=Math.atan2(-te,k)+fe*.4;setTimeout(()=>{P.use_directional_skill(_e),e.spawnDirectionalEffect(P.player_x(),P.player_z(),_e,$,5)},fe*80+80)}e.hitStop(.06),e.shake(.4,.15),je.playElementThunder(),E("zigzag")}else if(L==="vshape"){if(P.player_class_tier()>0&&!m(25)){l=null,c=!1,f=[];return}P.use_shield_skill();const $=xt();e.spawnShieldEffect(P.player_x(),P.player_z(),$),setTimeout(()=>{const fe=Math.atan2(-te,k);P.use_directional_skill(fe),e.spawnDirectionalEffect(P.player_x(),P.player_z(),fe,$,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),je.playShield(),E("vshape")}else if(L==="upstroke"){if(P.player_class_tier()>0&&!m(30)){l=null,c=!1,f=[];return}const $=Math.atan2(-te,k);P.use_directional_skill($);const fe=xt();e.spawnDirectionalEffect(P.player_x(),P.player_z(),$,fe,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),fe===1?je.playElementFire():fe===2?je.playElementIce():fe===3?je.playElementThunder():je.playHit(),E("upstroke")}else P.use_directional_skill(Math.atan2(-te,k)),e.shake(.1,.05)}else c||P.use_active_skill();else if(J===2&&P.player_class_tier()>=2)if(c&&ce>30){const L=_(f,l),Pe=Math.atan2(-te,k);if(L==="outward"){if(!m(20)){l=null,c=!1,f=[];return}P.use_directional_skill(Pe);const $=xt();e.spawnAdvancedDirectionalEffect(P.player_x(),P.player_z(),Pe,$,9),je.playAdvancedSkill($),e.shake(.55,.15),E("outward")}else if(L==="circle"){if(!m(50)){l=null,c=!1,f=[];return}const $=xt();P.use_ultimate_skill(),je.playAdvancedUltimate($),e.spawnAdvancedUltimateEffect(P.player_x(),P.player_z(),$,12),e.shake(.9,.3),E("circle");const fe=document.createElement("div");fe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",fe.style.background=$===1?"rgba(255,100,0,0.3)":$===2?"rgba(100,200,255,0.3)":$===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(fe),setTimeout(()=>fe.remove(),400),e.shake(.7,.25),E("circle")}else P.use_active_skill(),e.shake(.3,.1),E("outward")}else c||(P.use_active_skill(),e.spawnSkillEffect(P.player_x(),P.player_z(),xt(),4),e.shake(.25,.08));l=null,c=!1,f=[]});function _(I,k){if(I.length<5)return"unknown";const te=I[I.length-1],ce=te.x-k.x,J=te.y-k.y,re=Math.sqrt(ce*ce+J*J);if(I.length>30){let L=0;for(let $=2;$<I.length;$++){const fe=I[$-1].x-I[$-2].x,_e=I[$-1].y-I[$-2].y,Be=I[$].x-I[$-1].x,ue=I[$].y-I[$-1].y,T=fe*ue-_e*Be,M=fe*Be+_e*ue;L+=Math.atan2(T,M)}const Pe=Math.sqrt((te.x-k.x)**2+(te.y-k.y)**2);if(Math.abs(L)>Math.PI*1.9&&Pe<120)return"circle"}if(I.length>15){let L=0,Pe=0;for(let $=3;$<I.length;$+=3){const fe=I[$].x-I[$-3].x;Pe!==0&&Math.sign(fe)!==Math.sign(Pe)&&Math.abs(fe)>10&&L++,Math.abs(fe)>10&&(Pe=fe)}if(L>=3&&re<200)return"zigzag"}if(I.length>10){let L=0;for(let $=1;$<I.length;$++)I[$].y>I[L].y&&(L=$);const Pe=L/I.length;if(Pe>.25&&Pe<.75){const $=I[L].y-k.y,fe=I[L].y-te.y;if($>40&&fe>40&&re<150)return"vshape"}}if(re>60&&J<-50&&Math.abs(ce)<Math.abs(J)*.5)return"upstroke";if(e&&e.camera){const L=e.projectToScreen(P.player_x(),.5,P.player_z()),Pe=Math.sqrt((k.x-L.x)**2+(k.y-L.y)**2),$=Math.sqrt((te.x-L.x)**2+(te.y-L.y)**2);if($<Pe-20)return"inward";if($>Pe+20)return"outward"}return re>40?"outward":"unknown"}function y(){const I=document.getElementById("stamina-bar-bg");if(!I)return;I.style.border="2px solid #ff4444";const k=document.createElement("div");k.textContent="Not enough mana",k.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(k),setTimeout(()=>{k.remove(),I.style.border="1px solid #2a4a2a"},1e3)}function m(I){return P.player_stamina()<I?(y(),!1):!0}let u=null;function g(){u||(u=document.createElement("div"),u.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",u.innerHTML=`
        ...
        `,document.body.appendChild(u))}function x(){u&&(u.remove(),u=null)}function v(I){Xi.setStyle(P.player_class_tier(),xt());const k=I[I.length-1];k&&Xi.addPoint(k.x,k.y)}function A(){const I=f.length>5?_(f,l||{x:0,y:0}):"unknown";Xi.release(I)}function E(I){const k=P.learned_skill_count();if(k===0)return;let te="",ce="#fff";if(I==="outward"){for(let re=0;re<k;re++)if(P.learned_skill_type(re)===0){te=P.learned_skill_name(re);break}ce="#ff8844"}else if(I==="inward"){for(let re=0;re<k;re++)if(P.learned_skill_type(re)===1){te=P.learned_skill_name(re);break}te||(te="Shield"),ce="#44ff88"}else if(I==="circle"){for(let re=0;re<k;re++)if(P.learned_skill_type(re)===2){te=P.learned_skill_name(re);break}te||(te="Ultimate"),ce="#ffcc00"}else I==="zigzag"?(te="Chain Strike",ce="#ffdd44"):I==="vshape"?(te="Parry Counter",ce="#88ffaa"):I==="upstroke"&&(te="Pierce",ce="#ff66aa");te||(te="Skill");const J=document.createElement("div");J.textContent=I==="circle"?`✨ ${te} ✨`:te,J.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${ce};font-size:${I==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${ce},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(J),setTimeout(()=>J.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{P.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function R(){let I="<b>📜 Status</b><br><br>";const k=P.fire_level(),te=P.ice_level(),ce=P.thunder_level(),J=P.poison_level();I+="<b>⚗️ Element Orbs</b><br>",k>0&&(I+=`  🔥 Fire: ${k}<br>`),te>0&&(I+=`  ❄️ Ice: ${te}<br>`),ce>0&&(I+=`  ⚡ Thunder: ${ce}<br>`),J>0&&(I+=`  ☠️ Poison: ${J}<br>`),k+te+ce+J===0&&(I+='  <span style="color:#666">없음</span><br>');const re=P.player_class_tier();if(re>0){I+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[re]||""} ${P.player_class_name()}</b> (Tier ${re})<br>`;const Pe=P.learned_skill_count();if(Pe>0){I+="<br><b>🗡️ Class Skills</b><br>";for(let $=0;$<Pe;$++){const fe=P.learned_skill_name($),_e=P.learned_skill_level($);I+=`  📈 ${fe} <span style="color:#ffcc00">Lv.${_e}</span><br>`}}}else I+='<br><span style="color:#666">Lv.10에서 첫 전직 가능</span><br>',I+='<span style="color:#555;font-size:10px">원소를 모아 조합 조건을 맞추세요!</span>';if(re===0||re===1||re===2){const L=re===0?10:re===1?25:45;P.player_level()<L&&(I+=`<br><br><span style="color:#888;font-size:10px">다음 전직: Lv.${L}</span>`)}document.getElementById("pause-skills").innerHTML=I}for(let I=0;I<3;I++)document.getElementById(`choice-${I}`).addEventListener("click",()=>{const k=P.level_up_choice(I),te=$i(k),ce=P.player_class_tier();P.choose_upgrade(I);const J=P.player_class_tier();J>ce?U(J):S(te),w()});function C(){const I=document.getElementById("levelup");I.style.display="block",I.classList.add("shown");for(let te=0;te<3;te++){const ce=P.level_up_choice(te),J=$i(ce),re=m0(ce);let L="";if(ce>=50&&ce<=53){const $=ce-50+1,fe=[0,P.fire_level(),P.ice_level(),P.thunder_level(),P.poison_level()][$],_e=P.player_class_tier()===0?1:4,Be=Math.max(0,_e-fe-1);Be===0?L='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':L=`<span style="color:#555;font-size:10px">→ ${Be} more to promote</span>`}else ce>=100&&(L=`<span style="color:#daa520;font-size:10px">${Wt.star(10)} Class change!</span>`);const Pe=ce>=50&&ce<=53?Fr(ce-49,18):ce>=100?Wt.star(18):"";document.getElementById(`choice-${te}`).innerHTML=`
