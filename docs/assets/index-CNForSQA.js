...
`)+`
`+u);const x=_+m+a,v=_+u+o,T=Yo(s,s.VERTEX_SHADER,x),E=Yo(s,s.FRAGMENT_SHADER,v);s.attachShader(y,T),s.attachShader(y,E),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(D){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(y).trim(),H=s.getShaderInfoLog(T).trim(),Y=s.getShaderInfoLog(E).trim();let re=!0,K=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(re=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,E);else{const le=Ko(s,T,"vertex"),Z=Ko(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`;function cm(i,e,t){let n=new qa;const s=new pe,r=new pe,a=new ht,o=new rm({depthPacking:eh}),l=new am,c={},h=t.maxTextureSize,d={[Gn]:Bt,[Bt]:Gn,[Je]:Je},f=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pe},radius:{value:4}},vertexShader:om,fragmentShader:lm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new an(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new ie(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=vl;let u=this.type;this.render=function(E,R,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;const w=i.getRenderTarget(),S=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),B=i.state;B.setBlending(Bn),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const H=u!==xn&&this.type===xn,Y=u===xn&&this.type!==xn;for(let re=0,K=E.length;re<K;re++){const le=E[re],Z=le.shadow;if(Z===void 0){console.warn("THREE.WebGLShadowMap:",le,"has no shadow.");continue}if(Z.autoUpdate===!1&&Z.needsUpdate===!1)continue;s.copy(Z.mapSize);const me=Z.getFrameExtents();if(s.multiply(me),r.copy(Z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,Z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,Z.mapSize.y=r.y)),Z.map===null||H===!0||Y===!0){const Le=this.type!==xn?{minFilter:rn,magFilter:rn}:{};Z.map!==null&&Z.map.dispose(),Z.map=new si(s.x,s.y,Le),Z.map.texture.name=le.name+".shadowMap",Z.camera.updateProjectionMatrix()}i.setRenderTarget(Z.map),i.clear();const be=Z.getViewportCount();for(let Le=0;Le<be;Le++){const qe=Z.getViewport(Le);a.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),B.viewport(a),Z.updateMatrices(le,Le),n=Z.getFrustum(),v(R,C,Z.camera,le,this.type)}Z.isPointLightShadow!==!0&&this.type===xn&&_(Z,C),Z.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(w,S,D)};function _(E,R){const C=e.update(y);f.defines.VSM_SAMPLES!==E.blurSamples&&(f.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new si(s.x,s.y)),f.uniforms.shadow_pass.value=E.map.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(R,null,C,f,y,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value=E.mapSize,p.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(R,null,C,p,y,null)}function x(E,R,C,w){let S=null;const D=C.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(D!==void 0)S=D;else if(S=C.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const B=S.uuid,H=R.uuid;let Y=c[B];Y===void 0&&(Y={},c[B]=Y);let re=Y[H];re===void 0&&(re=S.clone(),Y[H]=re,R.addEventListener("dispose",T)),S=re}if(S.visible=R.visible,S.wireframe=R.wireframe,w===xn?S.side=R.shadowSide!==null?R.shadowSide:R.side:S.side=R.shadowSide!==null?R.shadowSide:d[R.side],S.alphaMap=R.alphaMap,S.alphaTest=R.alphaTest,S.map=R.map,S.clipShadows=R.clipShadows,S.clippingPlanes=R.clippingPlanes,S.clipIntersection=R.clipIntersection,S.displacementMap=R.displacementMap,S.displacementScale=R.displacementScale,S.displacementBias=R.displacementBias,S.wireframeLinewidth=R.wireframeLinewidth,S.linewidth=R.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const B=i.properties.get(S);B.light=C}return S}function v(E,R,C,w,S){if(E.visible===!1)return;if(E.layers.test(R.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&S===xn)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,E.matrixWorld);const H=e.update(E),Y=E.material;if(Array.isArray(Y)){const re=H.groups;for(let K=0,le=re.length;K<le;K++){const Z=re[K],me=Y[Z.materialIndex];if(me&&me.visible){const be=x(E,me,w,S);E.onBeforeShadow(i,E,R,C,H,be,Z),i.renderBufferDirect(C,null,H,be,E,Z),E.onAfterShadow(i,E,R,C,H,be,Z)}}}else if(Y.visible){const re=x(E,Y,w,S);E.onBeforeShadow(i,E,R,C,H,re,null),i.renderBufferDirect(C,null,H,re,E,null),E.onAfterShadow(i,E,R,C,H,re,null)}}const B=E.children;for(let H=0,Y=B.length;H<Y;H++)v(B[H],R,C,w,S)}function T(E){E.target.removeEventListener("dispose",T);for(const C in c){const w=c[C],S=E.target.uuid;S in w&&(w[S].dispose(),delete w[S])}}}const hm={[Zr]:Kr,[Jr]:ea,[jr]:ta,[Ii]:Qr,[Kr]:Zr,[ea]:Jr,[ta]:jr,[Qr]:Ii};function um(i,e){function t(){let N=!1;const ve=new ht;let q=null;const Q=new ht(0,0,0,0);return{setMask:function(Se){q!==Se&&!N&&(i.colorMask(Se,Se,Se,Se),q=Se)},setLocked:function(Se){N=Se},setClear:function(Se,ge,He,mt,At){At===!0&&(Se*=mt,ge*=mt,He*=mt),ve.set(Se,ge,He,mt),Q.equals(ve)===!1&&(i.clearColor(Se,ge,He,mt),Q.copy(ve))},reset:function(){N=!1,q=null,Q.set(-1,0,0,0)}}}function n(){let N=!1,ve=!1,q=null,Q=null,Se=null;return{setReversed:function(ge){if(ve!==ge){const He=e.get("EXT_clip_control");ve?He.clipControlEXT(He.LOWER_LEFT_EXT,He.ZERO_TO_ONE_EXT):He.clipControlEXT(He.LOWER_LEFT_EXT,He.NEGATIVE_ONE_TO_ONE_EXT);const mt=Se;Se=null,this.setClear(mt)}ve=ge},getReversed:function(){return ve},setTest:function(ge){ge?Me(i.DEPTH_TEST):U(i.DEPTH_TEST)},setMask:function(ge){q!==ge&&!N&&(i.depthMask(ge),q=ge)},setFunc:function(ge){if(ve&&(ge=hm[ge]),Q!==ge){switch(ge){case Zr:i.depthFunc(i.NEVER);break;case Kr:i.depthFunc(i.ALWAYS);break;case Jr:i.depthFunc(i.LESS);break;case Ii:i.depthFunc(i.LEQUAL);break;case jr:i.depthFunc(i.EQUAL);break;case Qr:i.depthFunc(i.GEQUAL);break;case ea:i.depthFunc(i.GREATER);break;case ta:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=ge}},setLocked:function(ge){N=ge},setClear:function(ge){Se!==ge&&(ve&&(ge=1-ge),i.clearDepth(ge),Se=ge)},reset:function(){N=!1,q=null,Q=null,Se=null,ve=!1}}}function s(){let N=!1,ve=null,q=null,Q=null,Se=null,ge=null,He=null,mt=null,At=null;return{setTest:function(it){N||(it?Me(i.STENCIL_TEST):U(i.STENCIL_TEST))},setMask:function(it){ve!==it&&!N&&(i.stencilMask(it),ve=it)},setFunc:function(it,kt,Oe){(q!==it||Q!==kt||Se!==Oe)&&(i.stencilFunc(it,kt,Oe),q=it,Q=kt,Se=Oe)},setOp:function(it,kt,Oe){(ge!==it||He!==kt||mt!==Oe)&&(i.stencilOp(it,kt,Oe),ge=it,He=kt,mt=Oe)},setLocked:function(it){N=it},setClear:function(it){At!==it&&(i.clearStencil(it),At=it)},reset:function(){N=!1,ve=null,q=null,Q=null,Se=null,ge=null,He=null,mt=null,At=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},d={},f=new WeakMap,p=[],g=null,y=!1,m=null,u=null,_=null,x=null,v=null,T=null,E=null,R=new Ge(0,0,0),C=0,w=!1,S=null,D=null,B=null,H=null,Y=null;const re=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,le=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(Z)[1]),K=le>=1):Z.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),K=le>=2);let me=null,be={};const Le=i.getParameter(i.SCISSOR_BOX),qe=i.getParameter(i.VIEWPORT),nt=new ht().fromArray(Le),ee=new ht().fromArray(qe);function oe(N,ve,q,Q){const Se=new Uint8Array(4),ge=i.createTexture();i.bindTexture(N,ge),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let He=0;He<q;He++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ve,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,Se):i.texImage2D(ve+He,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Se);return ge}const Pe={};Pe[i.TEXTURE_2D]=oe(i.TEXTURE_2D,i.TEXTURE_2D,1),Pe[i.TEXTURE_CUBE_MAP]=oe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Pe[i.TEXTURE_2D_ARRAY]=oe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Pe[i.TEXTURE_3D]=oe(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Me(i.DEPTH_TEST),a.setFunc(Ii),$(!1),ue(lo),Me(i.CULL_FACE),L(Bn);function Me(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function U(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function k(N,ve){return d[N]!==ve?(i.bindFramebuffer(N,ve),d[N]=ve,N===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ve),N===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ve),!0):!1}function te(N,ve){let q=p,Q=!1;if(N){q=f.get(ve),q===void 0&&(q=[],f.set(ve,q));const Se=N.textures;if(q.length!==Se.length||q[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,He=Se.length;ge<He;ge++)q[ge]=i.COLOR_ATTACHMENT0+ge;q.length=Se.length,Q=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,Q=!0);Q&&i.drawBuffers(q)}function ce(N){return g!==N?(i.useProgram(N),g=N,!0):!1}const J={[Qn]:i.FUNC_ADD,[Tc]:i.FUNC_SUBTRACT,[Ac]:i.FUNC_REVERSE_SUBTRACT};J[Cc]=i.MIN,J[Rc]=i.MAX;const se={[Pc]:i.ZERO,[Lc]:i.ONE,[Ic]:i.SRC_COLOR,[qr]:i.SRC_ALPHA,[zc]:i.SRC_ALPHA_SATURATE,[Fc]:i.DST_COLOR,[Uc]:i.DST_ALPHA,[Dc]:i.ONE_MINUS_SRC_COLOR,[Yr]:i.ONE_MINUS_SRC_ALPHA,[Oc]:i.ONE_MINUS_DST_COLOR,[Nc]:i.ONE_MINUS_DST_ALPHA,[Bc]:i.CONSTANT_COLOR,[kc]:i.ONE_MINUS_CONSTANT_COLOR,[Hc]:i.CONSTANT_ALPHA,[Gc]:i.ONE_MINUS_CONSTANT_ALPHA};function L(N,ve,q,Q,Se,ge,He,mt,At,it){if(N===Bn){y===!0&&(U(i.BLEND),y=!1);return}if(y===!1&&(Me(i.BLEND),y=!0),N!==Ec){if(N!==m||it!==w){if((u!==Qn||v!==Qn)&&(i.blendEquation(i.FUNC_ADD),u=Qn,v=Qn),it)switch(N){case En:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nr:i.blendFunc(i.ONE,i.ONE);break;case co:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ho:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case En:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nr:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case co:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ho:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}_=null,x=null,T=null,E=null,R.set(0,0,0),C=0,m=N,w=it}return}Se=Se||ve,ge=ge||q,He=He||Q,(ve!==u||Se!==v)&&(i.blendEquationSeparate(J[ve],J[Se]),u=ve,v=Se),(q!==_||Q!==x||ge!==T||He!==E)&&(i.blendFuncSeparate(se[q],se[Q],se[ge],se[He]),_=q,x=Q,T=ge,E=He),(mt.equals(R)===!1||At!==C)&&(i.blendColor(mt.r,mt.g,mt.b,At),R.copy(mt),C=At),m=N,w=!1}function Re(N,ve){N.side===Je?U(i.CULL_FACE):Me(i.CULL_FACE);let q=N.side===Bt;ve&&(q=!q),$(q),N.blending===En&&N.transparent===!1?L(Bn):L(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),r.setMask(N.colorWrite);const Q=N.stencilWrite;o.setTest(Q),Q&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Be(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Me(i.SAMPLE_ALPHA_TO_COVERAGE):U(i.SAMPLE_ALPHA_TO_COVERAGE)}function $(N){S!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),S=N)}function ue(N){N!==wc?(Me(i.CULL_FACE),N!==D&&(N===lo?i.cullFace(i.BACK):N===bc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):U(i.CULL_FACE),D=N}function _e(N){N!==B&&(K&&i.lineWidth(N),B=N)}function Be(N,ve,q){N?(Me(i.POLYGON_OFFSET_FILL),(H!==ve||Y!==q)&&(i.polygonOffset(ve,q),H=ve,Y=q)):U(i.POLYGON_OFFSET_FILL)}function de(N){N?Me(i.SCISSOR_TEST):U(i.SCISSOR_TEST)}function A(N){N===void 0&&(N=i.TEXTURE0+re-1),me!==N&&(i.activeTexture(N),me=N)}function M(N,ve,q){q===void 0&&(me===null?q=i.TEXTURE0+re-1:q=me);let Q=be[q];Q===void 0&&(Q={type:void 0,texture:void 0},be[q]=Q),(Q.type!==N||Q.texture!==ve)&&(me!==q&&(i.activeTexture(q),me=q),i.bindTexture(N,ve||Pe[N]),Q.type=N,Q.texture=ve)}function z(){const N=be[me];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function X(){try{i.compressedTexImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ce(){try{i.texSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function fe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ee(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ke(){try{i.texStorage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ae(){try{i.texStorage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Te(){try{i.texImage2D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Fe(){try{i.texImage3D.apply(i,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ze(N){nt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),nt.copy(N))}function Ae(N){ee.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),ee.copy(N))}function Ze(N,ve){let q=c.get(ve);q===void 0&&(q=new WeakMap,c.set(ve,q));let Q=q.get(N);Q===void 0&&(Q=i.getUniformBlockIndex(ve,N.name),q.set(N,Q))}function Ve(N,ve){const Q=c.get(ve).get(N);l.get(ve)!==Q&&(i.uniformBlockBinding(ve,Q,N.__bindingPointIndex),l.set(ve,Q))}function rt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},me=null,be={},d={},f=new WeakMap,p=[],g=null,y=!1,m=null,u=null,_=null,x=null,v=null,T=null,E=null,R=new Ge(0,0,0),C=0,w=!1,S=null,D=null,B=null,H=null,Y=null,nt.set(0,0,i.canvas.width,i.canvas.height),ee.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:Me,disable:U,bindFramebuffer:k,drawBuffers:te,useProgram:ce,setBlending:L,setMaterial:Re,setFlipSided:$,setCullFace:ue,setLineWidth:_e,setPolygonOffset:Be,setScissorTest:de,activeTexture:A,bindTexture:M,unbindTexture:z,compressedTexImage2D:X,compressedTexImage3D:ne,texImage2D:Te,texImage3D:Fe,updateUBOMapping:Ze,uniformBlockBinding:Ve,texStorage2D:Ke,texStorage3D:ae,texSubImage2D:j,texSubImage3D:Ce,compressedTexSubImage2D:fe,compressedTexSubImage3D:Ee,scissor:ze,viewport:Ae,reset:rt}}function sl(i,e,t,n){const s=dm(n);switch(t){case El:return i*e;case Al:return i*e;case Cl:return i*e*2;case Rl:return i*e/s.components*s.byteLength;case Va:return i*e/s.components*s.byteLength;case Pl:return i*e*2/s.components*s.byteLength;case Wa:return i*e*2/s.components*s.byteLength;case Tl:return i*e*3/s.components*s.byteLength;case sn:return i*e*4/s.components*s.byteLength;case Xa:return i*e*4/s.components*s.byteLength;case Zs:case Ks:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Js:case js:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case oa:case ca:return Math.max(i,16)*Math.max(e,8)/4;case aa:case la:return Math.max(i,8)*Math.max(e,8)/2;case ha:case ua:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case da:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case fa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case pa:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case ma:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case _a:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case ga:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case va:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case xa:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ya:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Ma:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Sa:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case wa:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case ba:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Ea:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Ta:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Qs:case Aa:case Ca:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Ll:case Ra:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Pa:case La:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function dm(i){switch(i){case Cn:case Sl:return{byteLength:1,components:1};case hs:case wl:case ms:return{byteLength:2,components:1};case Ha:case Ga:return{byteLength:2,components:4};case ii:case ka:case Sn:return{byteLength:4,components:1};case bl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function fm(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new pe,h=new WeakMap;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,M){return p?new OffscreenCanvas(A,M):us("canvas")}function y(A,M,z){let X=1;const ne=de(A);if((ne.width>z||ne.height>z)&&(X=z/Math.max(ne.width,ne.height)),X<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const j=Math.floor(X*ne.width),Ce=Math.floor(X*ne.height);d===void 0&&(d=g(j,Ce));const fe=M?g(j,Ce):d;return fe.width=j,fe.height=Ce,fe.getContext("2d").drawImage(A,0,0,j,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+j+"x"+Ce+")."),fe}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),A;return A}function m(A){return A.generateMipmaps}function u(A){i.generateMipmap(A)}function _(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(A,M,z,X,ne=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let j=M;if(M===i.RED&&(z===i.FLOAT&&(j=i.R32F),z===i.HALF_FLOAT&&(j=i.R16F),z===i.UNSIGNED_BYTE&&(j=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.R8UI),z===i.UNSIGNED_SHORT&&(j=i.R16UI),z===i.UNSIGNED_INT&&(j=i.R32UI),z===i.BYTE&&(j=i.R8I),z===i.SHORT&&(j=i.R16I),z===i.INT&&(j=i.R32I)),M===i.RG&&(z===i.FLOAT&&(j=i.RG32F),z===i.HALF_FLOAT&&(j=i.RG16F),z===i.UNSIGNED_BYTE&&(j=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RG8UI),z===i.UNSIGNED_SHORT&&(j=i.RG16UI),z===i.UNSIGNED_INT&&(j=i.RG32UI),z===i.BYTE&&(j=i.RG8I),z===i.SHORT&&(j=i.RG16I),z===i.INT&&(j=i.RG32I)),M===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGB8UI),z===i.UNSIGNED_SHORT&&(j=i.RGB16UI),z===i.UNSIGNED_INT&&(j=i.RGB32UI),z===i.BYTE&&(j=i.RGB8I),z===i.SHORT&&(j=i.RGB16I),z===i.INT&&(j=i.RGB32I)),M===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),z===i.UNSIGNED_INT&&(j=i.RGBA32UI),z===i.BYTE&&(j=i.RGBA8I),z===i.SHORT&&(j=i.RGBA16I),z===i.INT&&(j=i.RGBA32I)),M===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),M===i.RGBA){const Ce=ne?ar:et.getTransfer(X);z===i.FLOAT&&(j=i.RGBA32F),z===i.HALF_FLOAT&&(j=i.RGBA16F),z===i.UNSIGNED_BYTE&&(j=Ce===lt?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function v(A,M){let z;return A?M===null||M===ii||M===Ni?z=i.DEPTH24_STENCIL8:M===Sn?z=i.DEPTH32F_STENCIL8:M===hs&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===ii||M===Ni?z=i.DEPTH_COMPONENT24:M===Sn?z=i.DEPTH_COMPONENT32F:M===hs&&(z=i.DEPTH_COMPONENT16),z}function T(A,M){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==rn&&A.minFilter!==gt?Math.log2(Math.max(M.width,M.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?M.mipmaps.length:1}function E(A){const M=A.target;M.removeEventListener("dispose",E),C(M),M.isVideoTexture&&h.delete(M)}function R(A){const M=A.target;M.removeEventListener("dispose",R),S(M)}function C(A){const M=n.get(A);if(M.__webglInit===void 0)return;const z=A.source,X=f.get(z);if(X){const ne=X[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&w(A),Object.keys(X).length===0&&f.delete(z)}n.remove(A)}function w(A){const M=n.get(A);i.deleteTexture(M.__webglTexture);const z=A.source,X=f.get(z);delete X[M.__cacheKey],a.memory.textures--}function S(A){const M=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(M.__webglFramebuffer[X]))for(let ne=0;ne<M.__webglFramebuffer[X].length;ne++)i.deleteFramebuffer(M.__webglFramebuffer[X][ne]);else i.deleteFramebuffer(M.__webglFramebuffer[X]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[X])}else{if(Array.isArray(M.__webglFramebuffer))for(let X=0;X<M.__webglFramebuffer.length;X++)i.deleteFramebuffer(M.__webglFramebuffer[X]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let X=0;X<M.__webglColorRenderbuffer.length;X++)M.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[X]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=A.textures;for(let X=0,ne=z.length;X<ne;X++){const j=n.get(z[X]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(z[X])}n.remove(A)}let D=0;function B(){D=0}function H(){const A=D;return A>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),D+=1,A}function Y(A){const M=[];return M.push(A.wrapS),M.push(A.wrapT),M.push(A.wrapR||0),M.push(A.magFilter),M.push(A.minFilter),M.push(A.anisotropy),M.push(A.internalFormat),M.push(A.format),M.push(A.type),M.push(A.generateMipmaps),M.push(A.premultiplyAlpha),M.push(A.flipY),M.push(A.unpackAlignment),M.push(A.colorSpace),M.join()}function re(A,M){const z=n.get(A);if(A.isVideoTexture&&_e(A),A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){const X=A.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(z,A,M);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function K(A,M){const z=n.get(A);if(A.version>0&&z.__version!==A.version){ee(z,A,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function le(A,M){const z=n.get(A);if(A.version>0&&z.__version!==A.version){ee(z,A,M);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function Z(A,M){const z=n.get(A);if(A.version>0&&z.__version!==A.version){oe(z,A,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const me={[sa]:i.REPEAT,[Mn]:i.CLAMP_TO_EDGE,[ra]:i.MIRRORED_REPEAT},be={[rn]:i.NEAREST,[jc]:i.NEAREST_MIPMAP_NEAREST,[xs]:i.NEAREST_MIPMAP_LINEAR,[gt]:i.LINEAR,[hr]:i.LINEAR_MIPMAP_NEAREST,[ti]:i.LINEAR_MIPMAP_LINEAR},Le={[nh]:i.NEVER,[lh]:i.ALWAYS,[ih]:i.LESS,[Dl]:i.LEQUAL,[sh]:i.EQUAL,[oh]:i.GEQUAL,[rh]:i.GREATER,[ah]:i.NOTEQUAL};function qe(A,M){if(M.type===Sn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===gt||M.magFilter===hr||M.magFilter===xs||M.magFilter===ti||M.minFilter===gt||M.minFilter===hr||M.minFilter===xs||M.minFilter===ti)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,me[M.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,me[M.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,me[M.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,be[M.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,be[M.minFilter]),M.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,Le[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===rn||M.minFilter!==xs&&M.minFilter!==ti||M.type===Sn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function nt(A,M){let z=!1;A.__webglInit===void 0&&(A.__webglInit=!0,M.addEventListener("dispose",E));const X=M.source;let ne=f.get(X);ne===void 0&&(ne={},f.set(X,ne));const j=Y(M);if(j!==A.__cacheKey){ne[j]===void 0&&(ne[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),ne[j].usedTimes++;const Ce=ne[A.__cacheKey];Ce!==void 0&&(ne[A.__cacheKey].usedTimes--,Ce.usedTimes===0&&w(M)),A.__cacheKey=j,A.__webglTexture=ne[j].texture}return z}function ee(A,M,z){let X=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(X=i.TEXTURE_3D);const ne=nt(A,M),j=M.source;t.bindTexture(X,A.__webglTexture,i.TEXTURE0+z);const Ce=n.get(j);if(j.version!==Ce.__version||ne===!0){t.activeTexture(i.TEXTURE0+z);const fe=et.getPrimaries(et.workingColorSpace),Ee=M.colorSpace===zn?null:et.getPrimaries(M.colorSpace),Ke=M.colorSpace===zn||fe===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);let ae=y(M.image,!1,s.maxTextureSize);ae=Be(M,ae);const Te=r.convert(M.format,M.colorSpace),Fe=r.convert(M.type);let ze=x(M.internalFormat,Te,Fe,M.colorSpace,M.isVideoTexture);qe(X,M);let Ae;const Ze=M.mipmaps,Ve=M.isVideoTexture!==!0,rt=Ce.__version===void 0||ne===!0,N=j.dataReady,ve=T(M,ae);if(M.isDepthTexture)ze=v(M.format===Fi,M.type),rt&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,ze,ae.width,ae.height):t.texImage2D(i.TEXTURE_2D,0,ze,ae.width,ae.height,0,Te,Fe,null));else if(M.isDataTexture)if(Ze.length>0){Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,Ze[0].width,Ze[0].height);for(let q=0,Q=Ze.length;q<Q;q++)Ae=Ze[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Fe,Ae.data):t.texImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Te,Fe,Ae.data);M.generateMipmaps=!1}else Ve?(rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,ae.width,ae.height),N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae.width,ae.height,Te,Fe,ae.data)):t.texImage2D(i.TEXTURE_2D,0,ze,ae.width,ae.height,0,Te,Fe,ae.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ve&&rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,ze,Ze[0].width,Ze[0].height,ae.depth);for(let q=0,Q=Ze.length;q<Q;q++)if(Ae=Ze[q],M.format!==sn)if(Te!==null)if(Ve){if(N)if(M.layerUpdates.size>0){const Se=sl(Ae.width,Ae.height,M.format,M.type);for(const ge of M.layerUpdates){const He=Ae.data.subarray(ge*Se/Ae.data.BYTES_PER_ELEMENT,(ge+1)*Se/Ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,ge,Ae.width,Ae.height,1,Te,He)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Ae.width,Ae.height,ae.depth,Te,Ae.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,ze,Ae.width,Ae.height,ae.depth,0,Ae.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,Ae.width,Ae.height,ae.depth,Te,Fe,Ae.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,ze,Ae.width,Ae.height,ae.depth,0,Te,Fe,Ae.data)}else{Ve&&rt&&t.texStorage2D(i.TEXTURE_2D,ve,ze,Ze[0].width,Ze[0].height);for(let q=0,Q=Ze.length;q<Q;q++)Ae=Ze[q],M.format!==sn?Te!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Ae.data):t.compressedTexImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Ae.width,Ae.height,Te,Fe,Ae.data):t.texImage2D(i.TEXTURE_2D,q,ze,Ae.width,Ae.height,0,Te,Fe,Ae.data)}else if(M.isDataArrayTexture)if(Ve){if(rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ve,ze,ae.width,ae.height,ae.depth),N)if(M.layerUpdates.size>0){const q=sl(ae.width,ae.height,M.format,M.type);for(const Q of M.layerUpdates){const Se=ae.data.subarray(Q*q/ae.data.BYTES_PER_ELEMENT,(Q+1)*q/ae.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,ae.width,ae.height,1,Te,Fe,Se)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ae.width,ae.height,ae.depth,Te,Fe,ae.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ze,ae.width,ae.height,ae.depth,0,Te,Fe,ae.data);else if(M.isData3DTexture)Ve?(rt&&t.texStorage3D(i.TEXTURE_3D,ve,ze,ae.width,ae.height,ae.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ae.width,ae.height,ae.depth,Te,Fe,ae.data)):t.texImage3D(i.TEXTURE_3D,0,ze,ae.width,ae.height,ae.depth,0,Te,Fe,ae.data);else if(M.isFramebufferTexture){if(rt)if(Ve)t.texStorage2D(i.TEXTURE_2D,ve,ze,ae.width,ae.height);else{let q=ae.width,Q=ae.height;for(let Se=0;Se<ve;Se++)t.texImage2D(i.TEXTURE_2D,Se,ze,q,Q,0,Te,Fe,null),q>>=1,Q>>=1}}else if(Ze.length>0){if(Ve&&rt){const q=de(Ze[0]);t.texStorage2D(i.TEXTURE_2D,ve,ze,q.width,q.height)}for(let q=0,Q=Ze.length;q<Q;q++)Ae=Ze[q],Ve?N&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,Te,Fe,Ae):t.texImage2D(i.TEXTURE_2D,q,ze,Te,Fe,Ae);M.generateMipmaps=!1}else if(Ve){if(rt){const q=de(ae);t.texStorage2D(i.TEXTURE_2D,ve,ze,q.width,q.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Te,Fe,ae)}else t.texImage2D(i.TEXTURE_2D,0,ze,Te,Fe,ae);m(M)&&u(X),Ce.__version=j.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function oe(A,M,z){if(M.image.length!==6)return;const X=nt(A,M),ne=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+z);const j=n.get(ne);if(ne.version!==j.__version||X===!0){t.activeTexture(i.TEXTURE0+z);const Ce=et.getPrimaries(et.workingColorSpace),fe=M.colorSpace===zn?null:et.getPrimaries(M.colorSpace),Ee=M.colorSpace===zn||Ce===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Ke=M.isCompressedTexture||M.image[0].isCompressedTexture,ae=M.image[0]&&M.image[0].isDataTexture,Te=[];for(let Q=0;Q<6;Q++)!Ke&&!ae?Te[Q]=y(M.image[Q],!0,s.maxCubemapSize):Te[Q]=ae?M.image[Q].image:M.image[Q],Te[Q]=Be(M,Te[Q]);const Fe=Te[0],ze=r.convert(M.format,M.colorSpace),Ae=r.convert(M.type),Ze=x(M.internalFormat,ze,Ae,M.colorSpace),Ve=M.isVideoTexture!==!0,rt=j.__version===void 0||X===!0,N=ne.dataReady;let ve=T(M,Fe);qe(i.TEXTURE_CUBE_MAP,M);let q;if(Ke){Ve&&rt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ze,Fe.width,Fe.height);for(let Q=0;Q<6;Q++){q=Te[Q].mipmaps;for(let Se=0;Se<q.length;Se++){const ge=q[Se];M.format!==sn?ze!==null?Ve?N&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Ze,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,Ae,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Ze,ge.width,ge.height,0,ze,Ae,ge.data)}}}else{if(q=M.mipmaps,Ve&&rt){q.length>0&&ve++;const Q=de(Te[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ve,Ze,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ae){Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Te[Q].width,Te[Q].height,ze,Ae,Te[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ze,Te[Q].width,Te[Q].height,0,ze,Ae,Te[Q].data);for(let Se=0;Se<q.length;Se++){const He=q[Se].image[Q].image;Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,He.width,He.height,ze,Ae,He.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Ze,He.width,He.height,0,ze,Ae,He.data)}}else{Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ze,Ae,Te[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ze,ze,Ae,Te[Q]);for(let Se=0;Se<q.length;Se++){const ge=q[Se];Ve?N&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,ze,Ae,ge.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Ze,ze,Ae,ge.image[Q])}}}m(M)&&u(i.TEXTURE_CUBE_MAP),j.__version=ne.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function Pe(A,M,z,X,ne,j){const Ce=r.convert(z.format,z.colorSpace),fe=r.convert(z.type),Ee=x(z.internalFormat,Ce,fe,z.colorSpace),Ke=n.get(M),ae=n.get(z);if(ae.__renderTarget=M,!Ke.__hasExternalTextures){const Te=Math.max(1,M.width>>j),Fe=Math.max(1,M.height>>j);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,j,Ee,Te,Fe,M.depth,0,Ce,fe,null):t.texImage2D(ne,j,Ee,Te,Fe,0,Ce,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),ue(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,ne,ae.__webglTexture,0,$(M)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,ne,ae.__webglTexture,j),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Me(A,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,A),M.depthBuffer){const X=M.depthTexture,ne=X&&X.isDepthTexture?X.type:null,j=v(M.stencilBuffer,ne),Ce=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=$(M);ue(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe,j,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,j,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,j,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ce,i.RENDERBUFFER,A)}else{const X=M.textures;for(let ne=0;ne<X.length;ne++){const j=X[ne],Ce=r.convert(j.format,j.colorSpace),fe=r.convert(j.type),Ee=x(j.internalFormat,Ce,fe,j.colorSpace),Ke=$(M);z&&ue(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ke,Ee,M.width,M.height):ue(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ke,Ee,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function U(A,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(M.depthTexture);X.__renderTarget=M,(!X.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),re(M.depthTexture,0);const ne=X.__webglTexture,j=$(M);if(M.depthTexture.format===Pi)ue(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(M.depthTexture.format===Fi)ue(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function k(A){const M=n.get(A),z=A.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==A.depthTexture){const X=A.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),X){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,X.removeEventListener("dispose",ne)};X.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=X}if(A.depthTexture&&!M.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");U(M.__webglFramebuffer,A)}else if(z){M.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[X]),M.__webglDepthbuffer[X]===void 0)M.__webglDepthbuffer[X]=i.createRenderbuffer(),Me(M.__webglDepthbuffer[X],A,!1);else{const ne=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=M.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,j)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),Me(M.__webglDepthbuffer,A,!1);else{const X=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,ne)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function te(A,M,z){const X=n.get(A);M!==void 0&&Pe(X.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&k(A)}function ce(A){const M=A.texture,z=n.get(A),X=n.get(M);A.addEventListener("dispose",R);const ne=A.textures,j=A.isWebGLCubeRenderTarget===!0,Ce=ne.length>1;if(Ce||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=M.version,a.memory.textures++),j){z.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[fe]=[];for(let Ee=0;Ee<M.mipmaps.length;Ee++)z.__webglFramebuffer[fe][Ee]=i.createFramebuffer()}else z.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)z.__webglFramebuffer[fe]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Ce)for(let fe=0,Ee=ne.length;fe<Ee;fe++){const Ke=n.get(ne[fe]);Ke.__webglTexture===void 0&&(Ke.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&ue(A)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let fe=0;fe<ne.length;fe++){const Ee=ne[fe];z.__webglColorRenderbuffer[fe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[fe]);const Ke=r.convert(Ee.format,Ee.colorSpace),ae=r.convert(Ee.type),Te=x(Ee.internalFormat,Ke,ae,Ee.colorSpace,A.isXRRenderTarget===!0),Fe=$(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Fe,Te,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,z.__webglColorRenderbuffer[fe])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),Me(z.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),qe(i.TEXTURE_CUBE_MAP,M);for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ee=0;Ee<M.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[fe][Ee],A,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Ee);else Pe(z.__webglFramebuffer[fe],A,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);m(M)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let fe=0,Ee=ne.length;fe<Ee;fe++){const Ke=ne[fe],ae=n.get(Ke);t.bindTexture(i.TEXTURE_2D,ae.__webglTexture),qe(i.TEXTURE_2D,Ke),Pe(z.__webglFramebuffer,A,Ke,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,0),m(Ke)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(fe=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(fe,X.__webglTexture),qe(fe,M),M.mipmaps&&M.mipmaps.length>0)for(let Ee=0;Ee<M.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[Ee],A,M,i.COLOR_ATTACHMENT0,fe,Ee);else Pe(z.__webglFramebuffer,A,M,i.COLOR_ATTACHMENT0,fe,0);m(M)&&u(fe),t.unbindTexture()}A.depthBuffer&&k(A)}function J(A){const M=A.textures;for(let z=0,X=M.length;z<X;z++){const ne=M[z];if(m(ne)){const j=_(A),Ce=n.get(ne).__webglTexture;t.bindTexture(j,Ce),u(j),t.unbindTexture()}}}const se=[],L=[];function Re(A){if(A.samples>0){if(ue(A)===!1){const M=A.textures,z=A.width,X=A.height;let ne=i.COLOR_BUFFER_BIT;const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ce=n.get(A),fe=M.length>1;if(fe)for(let Ee=0;Ee<M.length;Ee++)t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ee=0;Ee<M.length;Ee++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),fe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const Ke=n.get(M[Ee]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ke,0)}i.blitFramebuffer(0,0,z,X,0,0,z,X,ne,i.NEAREST),l===!0&&(se.length=0,L.length=0,se.push(i.COLOR_ATTACHMENT0+Ee),A.depthBuffer&&A.resolveDepthBuffer===!1&&(se.push(j),L.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,L)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),fe)for(let Ee=0;Ee<M.length;Ee++){t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const Ke=n.get(M[Ee]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,Ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const M=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function $(A){return Math.min(s.maxSamples,A.samples)}function ue(A){const M=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function _e(A){const M=a.render.frame;h.get(A)!==M&&(h.set(A,M),A.update())}function Be(A,M){const z=A.colorSpace,X=A.format,ne=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||z!==zi&&z!==zn&&(et.getTransfer(z)===lt?(X!==sn||ne!==Cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),M}function de(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=B,this.setTexture2D=re,this.setTexture2DArray=K,this.setTexture3D=le,this.setTextureCube=Z,this.rebindTextures=te,this.setupRenderTarget=ce,this.updateRenderTargetMipmap=J,this.updateMultisampleRenderTarget=Re,this.setupDepthRenderbuffer=k,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=ue}function pm(i,e){function t(n,s=zn){let r;const a=et.getTransfer(s);if(n===Cn)return i.UNSIGNED_BYTE;if(n===Ha)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ga)return i.UNSIGNED_SHORT_5_5_5_1;if(n===bl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Sl)return i.BYTE;if(n===wl)return i.SHORT;if(n===hs)return i.UNSIGNED_SHORT;if(n===ka)return i.INT;if(n===ii)return i.UNSIGNED_INT;if(n===Sn)return i.FLOAT;if(n===ms)return i.HALF_FLOAT;if(n===El)return i.ALPHA;if(n===Tl)return i.RGB;if(n===sn)return i.RGBA;if(n===Al)return i.LUMINANCE;if(n===Cl)return i.LUMINANCE_ALPHA;if(n===Pi)return i.DEPTH_COMPONENT;if(n===Fi)return i.DEPTH_STENCIL;if(n===Rl)return i.RED;if(n===Va)return i.RED_INTEGER;if(n===Pl)return i.RG;if(n===Wa)return i.RG_INTEGER;if(n===Xa)return i.RGBA_INTEGER;if(n===Zs||n===Ks||n===Js||n===js)if(a===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Zs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Zs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===aa||n===oa||n===la||n===ca)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===aa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===la)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ha||n===ua||n===da)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ha||n===ua)return a===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===da)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===fa||n===pa||n===ma||n===_a||n===ga||n===va||n===xa||n===ya||n===Ma||n===Sa||n===wa||n===ba||n===Ea||n===Ta)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===fa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===pa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ma)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===_a)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ga)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===va)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ya)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ma)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Sa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===wa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ba)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ea)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ta)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Qs||n===Aa||n===Ca)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Qs)return a===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Aa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ca)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ll||n===Ra||n===Pa||n===La)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Qs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ra)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Pa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===La)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ni?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class mm extends Xt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ni extends wt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const _m={type:"move"};class Br{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ni,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ni,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ni,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const y of e.hand.values()){const m=t.getJointPose(y,n),u=this._getHandJoint(c,y);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=h.position.distanceTo(d.position),p=.02,g=.005;c.inputState.pinching&&f>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(_m)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ni;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const gm=`
void main() {
...
---
\`sig:${$}\` | *UNPLUG: Elemental Survivor*`,Be=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(ue)}&body=${encodeURIComponent(_e)}&labels=record`;window.open(Be,"_blank")}),(Me=document.getElementById("retry-btn"))==null||Me.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",P=new is,t=!0,me=!1,e.enemyMeshes.forEach(U=>e.scene.remove(U)),e.enemyMeshes=[],e.orbMeshes.forEach(U=>e.scene.remove(U)),e.orbMeshes=[],e.bulletMeshes.forEach(U=>e.scene.remove(U)),e.bulletMeshes=[]}),window._restartGame=()=>{P=new is,t=!0,me=!1,e.enemyMeshes.forEach(U=>e.scene.remove(U)),e.enemyMeshes=[],e.orbMeshes.forEach(U=>e.scene.remove(U)),e.orbMeshes=[],e.bulletMeshes.forEach(U=>e.scene.remove(U)),e.bulletMeshes=[]};const a={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",U=>{const k=a[U.code]||U.key.toLowerCase();if(U.code==="Space"&&U.preventDefault(),U.code==="Space"&&!P.level_up_pending()&&!P.is_paused()&&P.player_dash_cooldown()<=0&&je.playDash(),U.code==="Escape"){P.toggle_pause();const te=P.is_paused();document.getElementById("pause-menu").style.display=te?"flex":"none",te&&R();return}if(U.code==="Tab"){U.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(P.on_key_down(k),P.level_up_pending()){const te=P.player_class_tier();if(k==="1"){const ce=Qi(P.level_up_choice(0));P.choose_upgrade(0),P.player_class_tier()>te?D(P.player_class_tier()):S(ce),w()}if(k==="2"){const ce=Qi(P.level_up_choice(1));P.choose_upgrade(1),P.player_class_tier()>te?D(P.player_class_tier()):S(ce),w()}if(k==="3"){const ce=Qi(P.level_up_choice(2));P.choose_upgrade(2),P.player_class_tier()>te?D(P.player_class_tier()):S(ce),w()}}}),document.addEventListener("keyup",U=>{const k=a[U.code]||U.key.toLowerCase();P.on_key_up(k)});const o=document.getElementById("game-canvas");o.addEventListener("contextmenu",U=>U.preventDefault()),document.addEventListener("contextmenu",U=>{t&&U.preventDefault()}),o.addEventListener("selectstart",U=>U.preventDefault());let l=null,c=!1,h=null,d=[],f=null,p=null;o.addEventListener("mousedown",U=>{if(!(!t||!P))if(U.preventDefault(),U.button===0){if(l={x:U.clientX,y:U.clientY,button:0},d=[{x:U.clientX,y:U.clientY}],c=!1,ji.clear(),ji.addPoint(U.clientX,U.clientY),_(),document.body.style.cursor="crosshair",!document.getElementById("gesture-desaturate")){const k=document.createElement("div");k.id="gesture-desaturate",k.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.15);pointer-events:none;z-index:990;transition:opacity 0.1s",document.body.appendChild(k)}}else U.button===2&&P.player_class_tier()>=2&&(l={x:U.clientX,y:U.clientY,button:2},d=[{x:U.clientX,y:U.clientY}],c=!1,_())}),document.addEventListener("mousemove",U=>{if(window._lastMouseX=U.clientX,window._lastMouseY=U.clientY,!l)return;const k=U.clientX-l.x,te=U.clientY-l.y,ce=Math.sqrt(k*k+te*te);if(d.push({x:U.clientX,y:U.clientY}),v(d),ce>20){c=!0;const J=g(d,l);if(!p){const de=document.createElement("canvas");de.width=window.innerWidth,de.height=window.innerHeight,de.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(de),p=de}const se=p.getContext("2d");if(se.clearRect(0,0,p.width,p.height),d.length>2){const de=xt(),A={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};se.strokeStyle=A[de]||A[0],se.lineWidth=3,se.lineCap="round",se.beginPath(),se.moveTo(d[0].x,d[0].y);for(let M=1;M<d.length;M++)se.lineTo(d[M].x,d[M].y);se.stroke(),J==="circle"&&(se.strokeStyle="rgba(255,200,0,0.7)",se.lineWidth=5,se.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),f||(f=document.createElement("div"),f.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(f));const L=Math.min(50+ce*.4,100),Re=xt(),$=l.button===2,_e=($?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[Re]||($?"#ccaaff":"#8888ff");h.style.width=L+"px",h.style.height=L+"px",h.style.borderColor=_e,h.style.boxShadow=`0 0 ${L/4}px ${_e}, inset 0 0 ${L/6}px ${_e}`;const Be={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=Be[J]||"...",e&&e.camera){const de=e.projectToScreen(P.player_x(),.5,P.player_z());if(h.style.left=de.x-L/2+"px",h.style.top=de.y-L/2+"px",J==="outward"){const A=Math.atan2(te,k),M=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let z=Math.round(A/(Math.PI/4));z<0&&(z+=8),z=z%8,f.textContent=M[z],f.style.fontSize="32px";const X=50;f.style.left=de.x+Math.cos(A)*X-16+"px",f.style.top=de.y+Math.sin(A)*X-16+"px",f.style.opacity="1"}else J==="inward"?(f.textContent="🛡️",f.style.fontSize="28px",f.style.left=de.x-14+"px",f.style.top=de.y-14+"px",f.style.opacity="1"):J==="circle"?(f.textContent="🌀",f.style.left=de.x-14+"px",f.style.top=de.y-40+"px",f.style.opacity="1"):(f.style.opacity="0.3",f.textContent="?")}}}),document.addEventListener("mouseup",U=>{if(!l||!P){l=null;return}const k=U.clientX-l.x,te=U.clientY-l.y,ce=Math.sqrt(k*k+te*te),J=l.button;document.body.style.cursor="";const se=document.getElementById("gesture-desaturate");if(se&&se.remove(),T(),h&&(h.remove(),h=null),f&&(f.remove(),f=null),p&&(p.remove(),p=null),x(),J===0&&P.player_class_tier()>0)if(c&&ce>30){const L=g(d,l),Re=Math.atan2(-te,k);if(L==="outward"){if(P.player_class_tier()>0&&!m(20)){l=null,c=!1,d=[];return}P.use_directional_skill(Re);const $=xt(),ue=document.createElement("div"),_e={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};ue.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${_e[$]||_e[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(ue),setTimeout(()=>ue.remove(),150),e.spawnDirectionalEffect(P.player_x(),P.player_z(),Re,$,7),e.hitStop(.04),e.shake(.3,.1),e.zoomPunch(1,.12),window._onboardingActive&&s(),$===1?je.playElementFire():$===2?je.playElementIce():$===3?je.playElementThunder():$===4?je.playElementPoison():je.playHit(),E("outward")}else if(L==="inward")P.use_shield_skill(),je.playShield(),e.spawnShieldEffect(P.player_x(),P.player_z(),xt()),e.shake(.15,.05),E("inward");else if(L==="circle"){if(P.player_class_tier()>0&&!m(50)){l=null,c=!1,d=[];return}P.use_ultimate_skill(),je.playUltimate(xt());const $=xt();e.spawnUltimateEffect(P.player_x(),P.player_z(),$,10),e.hitStop(.12),e.shake(.8,.25),E("circle");const ue={0:"rgba(255,255,255,0.15)",1:"rgba(255,80,0,0.12)",2:"rgba(50,180,255,0.12)",3:"rgba(255,200,0,0.12)",4:"rgba(150,50,255,0.12)"},_e=document.createElement("div");_e.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ue[$]||ue[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(_e),setTimeout(()=>_e.remove(),400);const Be=document.createElement("div");Be.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(Be),setTimeout(()=>Be.remove(),600),window._onboardingActive&&s()}else if(L==="zigzag"){if(P.player_class_tier()>0&&!m(35)){l=null,c=!1,d=[];return}const $=xt();for(let ue=-1;ue<=1;ue++){const _e=Math.atan2(-te,k)+ue*.4;setTimeout(()=>{P.use_directional_skill(_e),e.spawnDirectionalEffect(P.player_x(),P.player_z(),_e,$,5)},ue*80+80)}e.hitStop(.06),e.shake(.4,.15),je.playElementThunder(),E("zigzag")}else if(L==="vshape"){if(P.player_class_tier()>0&&!m(25)){l=null,c=!1,d=[];return}P.use_shield_skill();const $=xt();e.spawnShieldEffect(P.player_x(),P.player_z(),$),setTimeout(()=>{const ue=Math.atan2(-te,k);P.use_directional_skill(ue),e.spawnDirectionalEffect(P.player_x(),P.player_z(),ue,$,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),je.playShield(),E("vshape")}else if(L==="upstroke"){if(P.player_class_tier()>0&&!m(30)){l=null,c=!1,d=[];return}const $=Math.atan2(-te,k);P.use_directional_skill($);const ue=xt();e.spawnDirectionalEffect(P.player_x(),P.player_z(),$,ue,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),ue===1?je.playElementFire():ue===2?je.playElementIce():ue===3?je.playElementThunder():je.playHit(),E("upstroke")}else P.use_directional_skill(Math.atan2(-te,k)),e.shake(.1,.05)}else c||P.use_active_skill();else if(J===2&&P.player_class_tier()>=2)if(c&&ce>30){const L=g(d,l),Re=Math.atan2(-te,k);if(L==="outward"){if(!m(20)){l=null,c=!1,d=[];return}P.use_directional_skill(Re);const $=xt();e.spawnAdvancedDirectionalEffect(P.player_x(),P.player_z(),Re,$,9),je.playAdvancedSkill($),e.shake(.55,.15),E("outward")}else if(L==="circle"){if(!m(50)){l=null,c=!1,d=[];return}const $=xt();P.use_ultimate_skill(),je.playAdvancedUltimate($),e.spawnAdvancedUltimateEffect(P.player_x(),P.player_z(),$,12),e.shake(.9,.3),E("circle");const ue=document.createElement("div");ue.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",ue.style.background=$===1?"rgba(255,100,0,0.3)":$===2?"rgba(100,200,255,0.3)":$===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(ue),setTimeout(()=>ue.remove(),400),e.shake(.7,.25),E("circle")}else P.use_active_skill(),e.shake(.3,.1),E("outward")}else c||(P.use_active_skill(),e.spawnSkillEffect(P.player_x(),P.player_z(),xt(),4),e.shake(.25,.08));l=null,c=!1,d=[]});function g(U,k){if(U.length<5)return"unknown";const te=U[U.length-1],ce=te.x-k.x,J=te.y-k.y,se=Math.sqrt(ce*ce+J*J);if(U.length>30){let L=0;for(let $=2;$<U.length;$++){const ue=U[$-1].x-U[$-2].x,_e=U[$-1].y-U[$-2].y,Be=U[$].x-U[$-1].x,de=U[$].y-U[$-1].y,A=ue*de-_e*Be,M=ue*Be+_e*de;L+=Math.atan2(A,M)}const Re=Math.sqrt((te.x-k.x)**2+(te.y-k.y)**2);if(Math.abs(L)>Math.PI*1.9&&Re<120)return"circle"}if(U.length>15){let L=0,Re=0;for(let $=3;$<U.length;$+=3){const ue=U[$].x-U[$-3].x;Re!==0&&Math.sign(ue)!==Math.sign(Re)&&Math.abs(ue)>10&&L++,Math.abs(ue)>10&&(Re=ue)}if(L>=3&&se<200)return"zigzag"}if(U.length>10){let L=0;for(let $=1;$<U.length;$++)U[$].y>U[L].y&&(L=$);const Re=L/U.length;if(Re>.25&&Re<.75){const $=U[L].y-k.y,ue=U[L].y-te.y;if($>40&&ue>40&&se<150)return"vshape"}}if(se>60&&J<-50&&Math.abs(ce)<Math.abs(J)*.5)return"upstroke";if(e&&e.camera){const L=e.projectToScreen(P.player_x(),.5,P.player_z()),Re=Math.sqrt((k.x-L.x)**2+(k.y-L.y)**2),$=Math.sqrt((te.x-L.x)**2+(te.y-L.y)**2);if($<Re-20)return"inward";if($>Re+20)return"outward"}return se>40?"outward":"unknown"}function y(){const U=document.getElementById("stamina-bar-bg");if(!U)return;U.style.border="2px solid #ff4444";const k=document.createElement("div");k.textContent="Not enough mana",k.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(k),setTimeout(()=>{k.remove(),U.style.border="1px solid #2a4a2a"},1e3)}function m(U){return P.player_stamina()<U?(y(),!1):!0}let u=null;function _(){u||(u=document.createElement("div"),u.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",u.innerHTML=`
        ...
        `,document.body.appendChild(u))}function x(){u&&(u.remove(),u=null)}function v(U){ji.setStyle(P.player_class_tier(),xt());const k=U[U.length-1];k&&ji.addPoint(k.x,k.y)}function T(){const U=d.length>5?g(d,l||{x:0,y:0}):"unknown";ji.release(U)}function E(U){const k=P.learned_skill_count();if(k===0)return;let te="",ce="#fff";if(U==="outward"){for(let se=0;se<k;se++)if(P.learned_skill_type(se)===0){te=P.learned_skill_name(se);break}ce="#ff8844"}else if(U==="inward"){for(let se=0;se<k;se++)if(P.learned_skill_type(se)===1){te=P.learned_skill_name(se);break}te||(te="Shield"),ce="#44ff88"}else if(U==="circle"){for(let se=0;se<k;se++)if(P.learned_skill_type(se)===2){te=P.learned_skill_name(se);break}te||(te="Ultimate"),ce="#ffcc00"}else U==="zigzag"?(te="Chain Strike",ce="#ffdd44"):U==="vshape"?(te="Parry Counter",ce="#88ffaa"):U==="upstroke"&&(te="Pierce",ce="#ff66aa");te||(te="Skill");const J=document.createElement("div");J.textContent=U==="circle"?`✨ ${te} ✨`:te,J.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${ce};font-size:${U==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${ce},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(J),setTimeout(()=>J.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{P.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function R(){let U="<b>📜 Status</b><br><br>";const k=P.fire_level(),te=P.ice_level(),ce=P.thunder_level(),J=P.poison_level();U+="<b>⚗️ Element Orbs</b><br>",k>0&&(U+=`  🔥 Fire: ${k}<br>`),te>0&&(U+=`  ❄️ Ice: ${te}<br>`),ce>0&&(U+=`  ⚡ Thunder: ${ce}<br>`),J>0&&(U+=`  ☠️ Poison: ${J}<br>`),k+te+ce+J===0&&(U+='  <span style="color:#666">None</span><br>');const se=P.player_class_tier();if(se>0){U+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[se]||""} ${P.player_class_name()}</b> (Tier ${se})<br>`;const Re=P.learned_skill_count();if(Re>0){U+="<br><b>🗡️ Class Skills</b><br>";for(let $=0;$<Re;$++){const ue=P.learned_skill_name($),_e=P.learned_skill_level($);U+=`  📈 ${ue} <span style="color:#ffcc00">Lv.${_e}</span><br>`}}}else U+='<br><span style="color:#666">Reach Lv.2 for first promotion</span><br>',U+='<span style="color:#555;font-size:10px">Collect element orbs to meet requirements</span>';if(se===0||se===1||se===2){const L=se===0?10:se===1?25:45;P.player_level()<L&&(U+=`<br><br><span style="color:#888;font-size:10px">Next promotion: Lv.${L}</span>`)}document.getElementById("pause-skills").innerHTML=U}for(let U=0;U<3;U++)document.getElementById(`choice-${U}`).addEventListener("click",()=>{const k=P.level_up_choice(U),te=Qi(k),ce=P.player_class_tier();P.choose_upgrade(U);const J=P.player_class_tier();if(J>ce)D(J);else{S(te);const se=P.player_x(),L=P.player_z();if(k>=50&&k<=53){const Re=k-49;e.spawnDirectionalEffect(se,L,0,Re,4),e.spawnGroundDecal(se,L,Re),e.zoomPunch(.8,.1)}else k>=60&&e.spawnDeathParticles(se,L,xt())}w()});function C(){const U=document.getElementById("levelup");U.style.display="block",U.classList.add("shown");for(let te=0;te<3;te++){const ce=P.level_up_choice(te),J=Qi(ce),se=M0(ce);let L="";if(ce>=50&&ce<=53){const $=ce-50+1,ue=[0,P.fire_level(),P.ice_level(),P.thunder_level(),P.poison_level()][$],_e=P.player_class_tier()===0?1:4,Be=Math.max(0,_e-ue-1);Be===0?L='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':L=`<span style="color:#555;font-size:10px">→ ${Be} more to promote</span>`}else ce>=100&&(L=`<span style="color:#daa520;font-size:10px">${Wt.star(10)} Class change!</span>`);const Re=ce>=50&&ce<=53?$r(ce-49,18):ce>=100?Wt.star(18):"";document.getElementById(`choice-${te}`).innerHTML=`
          ...
          `}let k=document.getElementById("levelup-hint");k||(k=document.createElement("div"),k.id="levelup-hint",k.style.cssText="color:#daa520;font-size:11px;margin-top:10px;text-align:center;opacity:0.8",U.appendChild(k)),P.player_class_tier()===0&&P.player_level()<=4?(k.textContent="Choose element orbs to unlock class promotion",k.style.display="block"):k.style.display="none"}function w(){const U=document.getElementById("levelup");U.style.display="none",U.classList.remove("shown"),Y=!1,je.playPickup()}function S(U){const k=xt(),ce={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[k]||"#daa520",J=document.createElement("div");J.style.cssText="position:fixed;top:18%;left:50%;transform:translateX(-50%) scale(0.8);z-index:9998;pointer-events:none;text-align:center;opacity:0;transition:all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",J.innerHTML=`<div style="font-size:14px;color:#fff;text-shadow:0 0 8px ${ce};background:rgba(0,0,0,0.8);padding:8px 20px;border-radius:20px;border:1px solid ${ce}44;font-family:'Inter',sans-serif">${$r(k,14)} ${U}</div>`,document.body.appendChild(J),requestAnimationFrame(()=>{J.style.opacity="1",J.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{J.style.opacity="0",J.style.transform="translateX(-50%) scale(0.9) translateY(-10px)"},1400),setTimeout(()=>J.remove(),1800);const se=document.createElement("div");se.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ce}11;pointer-events:none;z-index:990;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(se),setTimeout(()=>se.remove(),400)}function D(U){const k=xt(),te=P.player_class_name()||"",J={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"}[k]||"#daa520";e.hitStop(.3);const se=document.createElement("div");se.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:9998;
          ...
          pointer-events:none;z-index:9997;transition:all 0.6s ease-out`,document.body.appendChild(L),requestAnimationFrame(()=>{L.style.width="300px",L.style.height="300px"}),setTimeout(()=>{const Re=["","CLASS PROMOTION","ADVANCED CLASS","MASTER CLASS"],$=document.createElement("div");$.style.cssText=`position:fixed;top:38%;left:50%;transform:translate(-50%,-50%) scale(0.5);
            ...
            <div style="font-size:14px;color:#aaa;margin-top:12px;opacity:0.8">${$r(k,16)} New abilities unlocked</div>
          `,document.body.appendChild($),requestAnimationFrame(()=>{$.style.opacity="1",$.style.transform="translate(-50%,-50%) scale(1)"}),setTimeout(()=>{$.style.opacity="0",$.style.transform="translate(-50%,-50%) scale(1.1)"},1800),setTimeout(()=>$.remove(),2300)},400),setTimeout(()=>{const Re=document.createElement("div");Re.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${J}55;
            pointer-events:none;z-index:9999;animation:flash-fade 0.5s ease-out forwards`,document.body.appendChild(Re),setTimeout(()=>Re.remove(),500),e.shake(.6,.25),e.zoomPunch(3,.2),je.playLevelUp(),setTimeout(()=>je.playShield(),100)},800),setTimeout(()=>{k===1?P.use_ultimate_skill():k===2?P.use_shield_skill():k===3||k===4?P.use_ultimate_skill():P.use_directional_skill(0),e.spawnUltimateEffect(P.player_x(),P.player_z(),k,12),e.shake(.3,.15)},1200),setTimeout(()=>{se.style.boxShadow="inset 0 0 0 0 rgba(0,0,0,0)",L.style.opacity="0",setTimeout(()=>{se.remove(),L.remove()},500)},2e3)}const B=[];let H="",Y=!1;function re(){const U=P.player_promoted(),k=U?P.player_class_name():"",te={1:"⭐",2:"🌟",3:"👑"},ce=P.player_class_tier(),J=te[ce]||"";document.getElementById("level").textContent=P.player_level()+(k?` ${J}${k}`:"");const se=xt(),L=document.getElementById("portrait"),Re={0:Wt.sword(24),1:Wt.fire(24),2:Wt.ice(24),3:Wt.thunder(24),4:Wt.poison(24)},$={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"};L.innerHTML=Re[se]||Wt.sword(24),L.style.borderColor=$[se]||"#555",U?L.style.boxShadow=`0 0 10px ${$[se]}`:L.style.boxShadow="none";const ue=Math.max(0,P.player_hp()/P.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=ue+"%";const _e=Math.max(0,P.player_shield()/P.player_max_hp()*100),Be=document.getElementById("shield-bar-fill");Be.style.width=_e+"%",Be.style.left=ue+"%";const de=P.player_xp()/P.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=de+"%";const A=document.getElementById("stat-panel"),M=P.player_class_tier(),z=P.fire_level(),X=P.ice_level(),ne=P.thunder_level(),j=P.poison_level(),Ce=P.element_total();let fe=document.getElementById("promo-hud");if(fe||(fe=document.createElement("div"),fe.id="promo-hud",fe.style.cssText="margin-top:6px;font-size:11px;color:#8a8680;line-height:1.5;background:rgba(8,6,12,0.85);padding:4px 8px;border-radius:4px;border:1px solid rgba(218,165,32,0.15);max-width:170px;backdrop-filter:blur(4px)",document.getElementById("stats").appendChild(fe)),M<3){const Oe=M===0?1:M===1?4:7,st=M===0?2:M===1?4:7,Ut=P.player_level()>=st,yt=P.promotion_available_count()>0;let St;yt?St="⭐ PROMOTION READY! (Level up to choose)":Ut?St=`Need ${Oe} of same element (${Ce} total)`:St=`Next: Lv${st} + ${Oe} orbs (${Ce}/${Oe})`,fe.innerHTML=`<span style="color:${z>0?"#ff4400":"#333"}">${Wt.fire(12,z>0?"#ff4400":"#333")}${z}</span> <span style="color:${X>0?"#44ccff":"#333"}">${Wt.ice(12,X>0?"#44ccff":"#333")}${X}</span> <span style="color:${ne>0?"#ffcc00":"#333"}">${Wt.thunder(12,ne>0?"#ffcc00":"#333")}${ne}</span> <span style="color:${j>0?"#9933ff":"#333"}">${Wt.poison(12,j>0?"#9933ff":"#333")}${j}</span><br><span style="color:${yt?"#daa520":"#666"};font-size:10px">${St}</span>`,fe.style.display="block"}else fe.style.display="none";A&&(A.style.display=window._showDetailStats?"block":"none",window._showDetailStats&&(A.innerHTML=`ATK <span style="color:#ff8844">${Math.round(P.player_damage())}</span><br>SPD <span style="color:#44ccff">${P.player_atk_speed().toFixed(1)}/s</span><br>RNG <span style="color:#88ff44">${P.player_range().toFixed(1)}</span><br>CRT <span style="color:#ff4488">${Math.round(P.player_crit()*100)}%</span><br>PRC <span style="color:#ffcc44">${P.player_pierce()}</span> ×<span style="color:#44ffcc">${P.player_multi()}</span><br>STEAL <span style="color:#ff44ff">${Math.round(P.player_lifesteal()*100)}%</span>`));const Ee={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},Ke={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},ae={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},Te=P.skill_slot_count(),Fe=P.learned_skill_count();let ze="";for(let Oe=0;Oe<Te;Oe++)ze+=P.skill_slot_id(Oe)+":"+P.skill_slot_level(Oe)+",";ze+="|"+Fe;for(let Oe=0;Oe<Fe;Oe++)ze+=P.learned_skill_id(Oe)+":"+P.learned_skill_level(Oe)+",";if(ze!==H){H=ze;let Oe="";for(let st=0;st<Te;st++){const Ut=P.skill_slot_id(st),yt=P.skill_slot_level(st),St=Ee[Ut]||"⭐",Lt=Ke[Ut]||"#888",oi=ae[Ut]||"Skill";Oe+=`<div class="skill-icon" style="background:${Lt}22;border-color:${Lt}">
              ${St}<span class="sk-lvl">${yt}</span>
              <div class="sk-tooltip"><b style="color:${Lt}">${oi} Lv.${yt}</b></div>
            </div>`}if(Fe>0){Oe+='<div style="width:2px;height:28px;background:#333;margin:0 4px"></div>';for(let st=0;st<Fe;st++){const Ut=P.learned_skill_name(st),yt=P.learned_skill_level(st),St=P.learned_skill_desc(st),Lt=P.learned_skill_type(st),oi=Lt===0?"⚔️":Lt===1?"🛡️":"💫",li=Lt===0?"AUTO":Lt===1?"PASSIVE":"ULT",Wn=Lt===0?"#44ccff":Lt===1?"#44ff44":"#ffcc00";Oe+=`<div class="skill-icon class-skill" data-skill-idx="${st}" style="background:${Wn}15;border-color:${Wn}">
              ...
              </div>`}}document.getElementById("skill-slots").innerHTML=Oe,document.querySelectorAll(".skill-icon").forEach(st=>{st.addEventListener("click",Ut=>{const yt=st.classList.contains("active-tip");document.querySelectorAll(".skill-icon").forEach(St=>St.classList.remove("active-tip")),yt||st.classList.add("active-tip"),Ut.stopPropagation()})})}document.querySelectorAll(".class-skill").forEach(Oe=>{const st=parseInt(Oe.dataset.skillIdx);if(isNaN(st))return;const Ut=P.learned_skill_cd(st),yt=P.learned_skill_max_cd(st),St=Oe.querySelector(".sk-cd-overlay");if(St)if(Ut>0){const Lt=Ut/yt;St.style.background=`conic-gradient(rgba(0,0,0,0.7) ${Lt*360}deg, transparent ${Lt*360}deg)`,St.style.display="block"}else St.style.display="none"});const Ae=Math.floor(P.game_time()),Ze=Math.floor(Ae/60),Ve=Ae%60;document.getElementById("timer").textContent=`${Ze}:${Ve.toString().padStart(2,"0")}`;const rt=P.wave_number(),N=rt>0&&rt%10===0;if(document.getElementById("kills").textContent=N?`⚠️ WAVE 0 — BOSS ⚠️ | ${P.kills()} kills`:`Wave ${rt} | ${P.kills()} kills`,N&&!window._bossShown){window._bossShown=!0;const Oe=document.createElement("div");Oe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,0,0,0.4);pointer-events:none;z-index:9999;transition:opacity 1s",document.body.appendChild(Oe),setTimeout(()=>{Oe.style.opacity="0"},200),setTimeout(()=>Oe.remove(),1200);const st=document.createElement("div");st.style.cssText="position:fixed;top:40%;left:50%;transform:translate(-50%,-50%);z-index:9999;pointer-events:none;text-align:center;animation:promo-pop 2s ease-out forwards",st.innerHTML='<div style="font-size:42px;color:#ff2200;text-shadow:0 0 30px #ff0000,0 0 60px #880000;font-weight:bold">💀 BOSS 💀</div><div style="font-size:18px;color:#ffaa00;margin-top:8px">ALL ENEMIES CLEARED — DUEL!</div>',document.body.appendChild(st),setTimeout(()=>st.remove(),2500),e.shake(.8,.3),e.hitStop(.2),je.playUltimate(1)}else N||(window._bossShown=!1);if(P.boss_active()){let Oe=document.getElementById("boss-bar");Oe||(Oe=document.createElement("div"),Oe.id="boss-bar",Oe.style.cssText="position:fixed;top:50px;left:50%;transform:translateX(-50%);width:300px;text-align:center;z-index:100",Oe.innerHTML='<div style="color:#ff4444;font-size:12px;margin-bottom:4px">💀 BOSS</div><div style="width:100%;height:10px;background:#333;border-radius:5px;border:1px solid #ff4444"><div id="boss-hp-fill" style="height:100%;background:linear-gradient(90deg,#ff2222,#ff6644);border-radius:4px;transition:width 0.1s"></div></div>',document.body.appendChild(Oe)),document.getElementById("boss-hp-fill").style.width=P.boss_hp_pct()*100+"%"}else{const Oe=document.getElementById("boss-bar");Oe&&Oe.remove()}P.level_up_pending()&&!Y&&(C(),Y=!0,je.playLevelUp()),P.wave_event_pending()&&!P.level_up_pending()&&!window._waveEventShown&&(window._waveEventShown=!0,g0(P)),P.wave_event_pending()||(window._waveEventShown=!1),v0(P);let ve;for(;(ve=P.pop_log())!==void 0;)B.push(ve),B.length>4&&B.shift();document.getElementById("log").textContent=B.join(`
`);const q=P.player_dash_cooldown(),Q=document.getElementById("dash-bar"),Se=document.getElementById("dash-cd-text"),ge=P.player_dash_type(),He={1:"🔥 BLINK",2:"❄️ SKATE",3:"⚡ DASH×3",4:"☠️ SMOKE",5:"💨 DASH"},mt={1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#44ff44",5:"#44ccff"},it={1:3,2:0,3:.8,4:4,5:2}[ge]||2;if(document.querySelector("#dash-ui span").textContent=He[ge]||"💨 DASH",ge===2)Q.style.width="100%",Q.style.background="#44ccff",Se.textContent="+40% SPD";else if(ge===3){const Oe=P.player_dash_charges();Q.style.width=Oe/3*100+"%",Q.style.background=Oe>0?"#ffcc00":"#333",Se.textContent=`⚡${Oe}/3`}else q>0?(Q.style.width=Math.max(0,(1-q/it)*100)+"%",Q.style.background="#666",Se.textContent=q.toFixed(1)+"s"):(Q.style.width="100%",Q.style.background=mt[ge]||"#44ccff",Se.textContent="READY");const kt=document.getElementById("stamina-bar-bg");if(P.player_class_tier()>0){kt.style.display="block";const Oe=P.player_stamina()/P.player_max_stamina()*100;document.getElementById("stamina-bar-fill").style.width=Oe+"%"}}function K(U,k,te,ce){const J=document.createElement("div");J.className="dmg-popup"+(ce?" crit":""),J.textContent=Math.round(te);const se=ce?18:13,L=Math.min(12,Math.floor(te/30));if(J.style.fontSize=se+L+"px",document.getElementById("game-canvas"),e&&e.camera){const Re=e.projectToScreen(U,1.8,k);J.style.left=Re.x+"px",J.style.top=Re.y-20+"px"}else J.style.left=window.innerWidth/2+"px",J.style.top=window.innerHeight/2-50+"px";document.body.appendChild(J),setTimeout(()=>J.remove(),900)}function le(U){m0(U)}let Z=0,me=!1,be=0,Le=0;function qe(U){let k=document.getElementById("combo-display");k||(k=document.createElement("div"),k.id="combo-display",k.style.cssText="position:fixed;top:45%;right:20px;pointer-events:none;z-index:999;text-align:right;transition:opacity 0.3s,transform 0.2s",document.body.appendChild(k));const te=Math.min(20+U*.8,40),ce=U>=30?"#ff44ff":U>=20?"#ffcc00":U>=10?"#ff8844":"#44ff88";let J="";U===5?J='<div style="font-size:10px;color:#888;margin-top:2px">♪ rhythm up</div>':U===10?J='<div style="font-size:10px;color:#ffcc00;margin-top:2px">✦ XP range +</div>':U===20?J='<div style="font-size:10px;color:#ff8844;margin-top:2px">✦ mana regen</div>':U===30&&(J='<div style="font-size:10px;color:#ff44ff;margin-top:2px">✦✦ ELEMENTAL BURST</div>'),k.innerHTML=`<div style="font-size:${te}px;color:${ce};font-weight:bold;text-shadow:0 0 6px ${ce};font-family:monospace;line-height:1">${U}</div><div style="font-size:10px;color:#666;letter-spacing:1px">COMBO</div>${J}`,k.style.opacity="1",k.style.transform="scale(1.1)",setTimeout(()=>{k.style.transform="scale(1)"},100),clearTimeout(k._fadeTimer),k._fadeTimer=setTimeout(()=>{k.style.opacity="0"},2e3)}function nt(U){const k=Z?(U-Z)/1e3:.016;if(Z=U,!t){requestAnimationFrame(nt);return}if(Le>0&&(Le-=k,Le<=0&&(be=0)),!P.player_alive()&&!me&&(me=!0,le(P)),c&&l)window._gestureFrameSkip||(window._gestureFrameSkip=0),window._gestureFrameSkip++,window._gestureFrameSkip%3!==0||P.update(U);else{if(window._gestureFrameSkip=0,window._lastMouseX!==void 0&&P.set_aim){const $=(window._lastMouseX-window.innerWidth/2)*.02,ue=window._lastMouseY!==void 0?(window._lastMouseY-window.innerHeight/2)*.02:0;P.set_aim($,ue)}P.update(U)}const te=[],ce=P.enemy_count();for(let $=0;$<ce;$++)te.push({x:P.enemy_x($),z:P.enemy_z($),type:P.enemy_type($),hit:P.enemy_hit($)});const J=[],se=P.bullet_count();for(let $=0;$<se;$++)J.push({x:P.bullet_x($),z:P.bullet_z($)});const L=[],Re=P.orb_count();for(let $=0;$<Re;$++)L.push({x:P.orb_x($),z:P.orb_z($),type:P.orb_type($)});if(!P.level_up_pending()){const $=P.damage_event_count(),ue=P.player_x(),_e=P.player_z(),Be=P.player_damage(),de=xt();let A=!1;for(let X=0;X<$;X++){const ne=P.damage_event_x(X),j=P.damage_event_z(X),Ce=P.damage_event_crit(X);Ce&&(A=!0),K(ne,j,P.damage_event_amount(X),Ce),e.spawnSlash(ue,_e,ne,j,Ce,Be,de),X===0&&(Ce?je.playCrit():de===1?je.playElementFire():de===2?je.playElementIce():de===3?je.playElementThunder():de===4?je.playElementPoison():je.playHit())}A?(e.shake(.07,.065),e.hitStop(.03)):$>=3?e.shake(.06,.06):$>0&&e.shake(.04,.055);const M=P.death_event_count();for(let X=0;X<M;X++)if(e.spawnDeathParticles(P.death_event_x(X),P.death_event_z(X),xt()),e.spawnGroundDecal(P.death_event_x(X),P.death_event_z(X),xt()),X===0)je.playDeath();else if(X<4)try{je.playDeath()}catch{}if(M>0){const X=Math.min(.03+M*.015,.1);if(e.hitStop(X),e.shake(Math.min(.15+M*.08,.5),Math.min(.08+M*.01,.15)),be+=M,Le=2,be>=5&&qe(be),M>=3){const ne=document.createElement("div");ne.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.08);pointer-events:none;z-index:997;animation:flash-fade 0.2s ease-out forwards",document.body.appendChild(ne),setTimeout(()=>ne.remove(),200)}}const z=P.skill_event_count();for(let X=0;X<z;X++)e.spawnSkillEffect(P.skill_event_x(X),P.skill_event_z(X),P.skill_event_element(X),P.skill_event_range(X))}e._shieldRing&&P.player_shield()<=0?(e.scene.remove(e._shieldRing.mesh),e._shieldOuter&&e.scene.remove(e._shieldOuter.mesh),e._shieldRing=null,e._shieldOuter=null):e.updateShield&&e.updateShield(P.player_x(),P.player_z(),k/1e3),e.update({playerX:P.player_x(),playerZ:P.player_z(),playerMoving:P.player_moving(),playerSpeed:P.player_move_speed?P.player_move_speed():5,playerDirX:P.player_dir_x(),playerDirZ:P.player_dir_z(),playerHit:P.player_hit(),playerAttacking:P.player_attacking(),playerCasting:c,playerDashing:P.player_dashing(),dashType:P.player_dash_type(),hp:P.player_hp(),maxHp:P.player_max_hp(),nearestEnemyDirX:P.nearest_enemy_dir_x(),mouseWorldX:P.player_x()+(window._lastMouseX!==void 0?(window._lastMouseX-window.innerWidth/2)*.02:0),element:xt(),elementLevel:P.active_element_level(),fireLv:P.fire_level(),iceLv:P.ice_level(),thunderLv:P.thunder_level(),poisonLv:P.poison_level(),bossActive:P.boss_active(),bossX:P.boss_x(),bossZ:P.boss_z(),bossHpPct:P.boss_hp_pct(),promoted:P.player_promoted(),enemies:te,bullets:J,orbs:L},k),re(),requestAnimationFrame(nt)}requestAnimationFrame(nt)}S0().catch(i=>{document.body.innerHTML=`<pre style="color:red;padding:20px">FATAL: ${i}
${i.stack||""}</pre>`});
