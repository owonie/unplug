...
}`;function Up(i,e,t){let n=new Ea;const s=new ye,r=new ye,a=new nt,o=new Pp({depthPacking:wc}),l=new Lp,c={},h=t.maxTextureSize,u={[En]:Pt,[Pt]:En,[ut]:ut},d=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ye},radius:{value:4}},vertexShader:Dp,fragmentShader:Ip}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Et;_.setAttribute("position",new Kt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new fe(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ko;let f=this.type;this.render=function(w,A,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const b=i.getRenderTarget(),S=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),X=i.state;X.setBlending(Mn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const G=f!==an&&this.type===an,$=f===an&&this.type!==an;for(let te=0,R=w.length;te<R;te++){const H=w[te],U=H.shadow;if(U===void 0){console.warn("THREE.WebGLShadowMap:",H,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;s.copy(U.mapSize);const Q=U.getFrameExtents();if(s.multiply(Q),r.copy(U.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Q.x),s.x=r.x*Q.x,U.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Q.y),s.y=r.y*Q.y,U.mapSize.y=r.y)),U.map===null||G===!0||$===!0){const Y=this.type!==an?{minFilter:Tt,magFilter:Tt}:{};U.map!==null&&U.map.dispose(),U.map=new Vn(s.x,s.y,Y),U.map.texture.name=H.name+".shadowMap",U.camera.updateProjectionMatrix()}i.setRenderTarget(U.map),i.clear();const q=U.getViewportCount();for(let Y=0;Y<q;Y++){const ce=U.getViewport(Y);a.set(r.x*ce.x,r.y*ce.y,r.x*ce.z,r.y*ce.w),X.viewport(a),U.updateMatrices(H,Y),n=U.getFrustum(),g(A,P,U.camera,H,this.type)}U.isPointLightShadow!==!0&&this.type===an&&v(U,P),U.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(b,S,D)};function v(w,A){const P=e.update(x);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Vn(s.x,s.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(A,null,P,d,x,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(A,null,P,p,x,null)}function y(w,A,P,b){let S=null;const D=P.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(D!==void 0)S=D;else if(S=P.isPointLight===!0?l:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const X=S.uuid,G=A.uuid;let $=c[X];$===void 0&&($={},c[X]=$);let te=$[G];te===void 0&&(te=S.clone(),$[G]=te,A.addEventListener("dispose",C)),S=te}if(S.visible=A.visible,S.wireframe=A.wireframe,b===an?S.side=A.shadowSide!==null?A.shadowSide:A.side:S.side=A.shadowSide!==null?A.shadowSide:u[A.side],S.alphaMap=A.alphaMap,S.alphaTest=A.alphaTest,S.map=A.map,S.clipShadows=A.clipShadows,S.clippingPlanes=A.clippingPlanes,S.clipIntersection=A.clipIntersection,S.displacementMap=A.displacementMap,S.displacementScale=A.displacementScale,S.displacementBias=A.displacementBias,S.wireframeLinewidth=A.wireframeLinewidth,S.linewidth=A.linewidth,P.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const X=i.properties.get(S);X.light=P}return S}function g(w,A,P,b,S){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&S===an)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,w.matrixWorld);const G=e.update(w),$=w.material;if(Array.isArray($)){const te=G.groups;for(let R=0,H=te.length;R<H;R++){const U=te[R],Q=$[U.materialIndex];if(Q&&Q.visible){const q=y(w,Q,b,S);w.onBeforeShadow(i,w,A,P,G,q,U),i.renderBufferDirect(P,null,G,q,w,U),w.onAfterShadow(i,w,A,P,G,q,U)}}}else if($.visible){const te=y(w,$,b,S);w.onBeforeShadow(i,w,A,P,G,te,null),i.renderBufferDirect(P,null,G,te,w,null),w.onAfterShadow(i,w,A,P,G,te,null)}}const X=w.children;for(let G=0,$=X.length;G<$;G++)g(X[G],A,P,b,S)}function C(w){w.target.removeEventListener("dispose",C);for(const P in c){const b=c[P],S=w.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}const Np={[Tr]:Ar,[Cr]:Lr,[Rr]:Dr,[di]:Pr,[Ar]:Tr,[Lr]:Cr,[Dr]:Rr,[Pr]:di};function Fp(i,e){function t(){let F=!1;const _e=new nt;let K=null;const ee=new nt(0,0,0,0);return{setMask:function(xe){K!==xe&&!F&&(i.colorMask(xe,xe,xe,xe),K=xe)},setLocked:function(xe){F=xe},setClear:function(xe,ge,ze,ht,yt){yt===!0&&(xe*=ht,ge*=ht,ze*=ht),_e.set(xe,ge,ze,ht),ee.equals(_e)===!1&&(i.clearColor(xe,ge,ze,ht),ee.copy(_e))},reset:function(){F=!1,K=null,ee.set(-1,0,0,0)}}}function n(){let F=!1,_e=!1,K=null,ee=null,xe=null;return{setReversed:function(ge){if(_e!==ge){const ze=e.get("EXT_clip_control");_e?ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.ZERO_TO_ONE_EXT):ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.NEGATIVE_ONE_TO_ONE_EXT);const ht=xe;xe=null,this.setClear(ht)}_e=ge},getReversed:function(){return _e},setTest:function(ge){ge?ae(i.DEPTH_TEST):he(i.DEPTH_TEST)},setMask:function(ge){K!==ge&&!F&&(i.depthMask(ge),K=ge)},setFunc:function(ge){if(_e&&(ge=Np[ge]),ee!==ge){switch(ge){case Tr:i.depthFunc(i.NEVER);break;case Ar:i.depthFunc(i.ALWAYS);break;case Cr:i.depthFunc(i.LESS);break;case di:i.depthFunc(i.LEQUAL);break;case Rr:i.depthFunc(i.EQUAL);break;case Pr:i.depthFunc(i.GEQUAL);break;case Lr:i.depthFunc(i.GREATER);break;case Dr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ee=ge}},setLocked:function(ge){F=ge},setClear:function(ge){xe!==ge&&(_e&&(ge=1-ge),i.clearDepth(ge),xe=ge)},reset:function(){F=!1,K=null,ee=null,xe=null,_e=!1}}}function s(){let F=!1,_e=null,K=null,ee=null,xe=null,ge=null,ze=null,ht=null,yt=null;return{setTest:function(je){F||(je?ae(i.STENCIL_TEST):he(i.STENCIL_TEST))},setMask:function(je){_e!==je&&!F&&(i.stencilMask(je),_e=je)},setFunc:function(je,Bt,jt){(K!==je||ee!==Bt||xe!==jt)&&(i.stencilFunc(je,Bt,jt),K=je,ee=Bt,xe=jt)},setOp:function(je,Bt,jt){(ge!==je||ze!==Bt||ht!==jt)&&(i.stencilOp(je,Bt,jt),ge=je,ze=Bt,ht=jt)},setLocked:function(je){F=je},setClear:function(je){yt!==je&&(i.clearStencil(je),yt=je)},reset:function(){F=!1,_e=null,K=null,ee=null,xe=null,ge=null,ze=null,ht=null,yt=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,v=null,y=null,g=null,C=null,w=null,A=new Ve(0,0,0),P=0,b=!1,S=null,D=null,X=null,G=null,$=null;const te=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let R=!1,H=0;const U=i.getParameter(i.VERSION);U.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(U)[1]),R=H>=1):U.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(U)[1]),R=H>=2);let Q=null,q={};const Y=i.getParameter(i.SCISSOR_BOX),ce=i.getParameter(i.VIEWPORT),le=new nt().fromArray(Y),k=new nt().fromArray(ce);function ie(F,_e,K,ee){const xe=new Uint8Array(4),ge=i.createTexture();i.bindTexture(F,ge),i.texParameteri(F,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(F,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ze=0;ze<K;ze++)F===i.TEXTURE_3D||F===i.TEXTURE_2D_ARRAY?i.texImage3D(_e,0,i.RGBA,1,1,ee,0,i.RGBA,i.UNSIGNED_BYTE,xe):i.texImage2D(_e+ze,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,xe);return ge}const me={};me[i.TEXTURE_2D]=ie(i.TEXTURE_2D,i.TEXTURE_2D,1),me[i.TEXTURE_CUBE_MAP]=ie(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[i.TEXTURE_2D_ARRAY]=ie(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),me[i.TEXTURE_3D]=ie(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(i.DEPTH_TEST),a.setFunc(di),We(!1),Xe(Ha),ae(i.CULL_FACE),N(Mn);function ae(F){h[F]!==!0&&(i.enable(F),h[F]=!0)}function he(F){h[F]!==!1&&(i.disable(F),h[F]=!1)}function be(F,_e){return u[F]!==_e?(i.bindFramebuffer(F,_e),u[F]=_e,F===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=_e),F===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=_e),!0):!1}function Ue(F,_e){let K=p,ee=!1;if(F){K=d.get(_e),K===void 0&&(K=[],d.set(_e,K));const xe=F.textures;if(K.length!==xe.length||K[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,ze=xe.length;ge<ze;ge++)K[ge]=i.COLOR_ATTACHMENT0+ge;K.length=xe.length,ee=!0}}else K[0]!==i.BACK&&(K[0]=i.BACK,ee=!0);ee&&i.drawBuffers(K)}function De(F){return _!==F?(i.useProgram(F),_=F,!0):!1}const Be={[Fn]:i.FUNC_ADD,[Zl]:i.FUNC_SUBTRACT,[jl]:i.FUNC_REVERSE_SUBTRACT};Be[Ql]=i.MIN,Be[ec]=i.MAX;const it={[tc]:i.ZERO,[nc]:i.ONE,[ic]:i.SRC_COLOR,[br]:i.SRC_ALPHA,[cc]:i.SRC_ALPHA_SATURATE,[oc]:i.DST_COLOR,[rc]:i.DST_ALPHA,[sc]:i.ONE_MINUS_SRC_COLOR,[wr]:i.ONE_MINUS_SRC_ALPHA,[lc]:i.ONE_MINUS_DST_COLOR,[ac]:i.ONE_MINUS_DST_ALPHA,[hc]:i.CONSTANT_COLOR,[uc]:i.ONE_MINUS_CONSTANT_COLOR,[fc]:i.CONSTANT_ALPHA,[dc]:i.ONE_MINUS_CONSTANT_ALPHA};function N(F,_e,K,ee,xe,ge,ze,ht,yt,je){if(F===Mn){x===!0&&(he(i.BLEND),x=!1);return}if(x===!1&&(ae(i.BLEND),x=!0),F!==Jl){if(F!==m||je!==b){if((f!==Fn||g!==Fn)&&(i.blendEquation(i.FUNC_ADD),f=Fn,g=Fn),je)switch(F){case hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFunc(i.ONE,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}v=null,y=null,C=null,w=null,A.set(0,0,0),P=0,m=F,b=je}return}xe=xe||_e,ge=ge||K,ze=ze||ee,(_e!==f||xe!==g)&&(i.blendEquationSeparate(Be[_e],Be[xe]),f=_e,g=xe),(K!==v||ee!==y||ge!==C||ze!==w)&&(i.blendFuncSeparate(it[K],it[ee],it[ge],it[ze]),v=K,y=ee,C=ge,w=ze),(ht.equals(A)===!1||yt!==P)&&(i.blendColor(ht.r,ht.g,ht.b,yt),A.copy(ht),P=yt),m=F,b=!1}function mt(F,_e){F.side===ut?he(i.CULL_FACE):ae(i.CULL_FACE);let K=F.side===Pt;_e&&(K=!K),We(K),F.blending===hi&&F.transparent===!1?N(Mn):N(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),r.setMask(F.colorWrite);const ee=F.stencilWrite;o.setTest(ee),ee&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),et(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?ae(i.SAMPLE_ALPHA_TO_COVERAGE):he(i.SAMPLE_ALPHA_TO_COVERAGE)}function We(F){S!==F&&(F?i.frontFace(i.CW):i.frontFace(i.CCW),S=F)}function Xe(F){F!==$l?(ae(i.CULL_FACE),F!==D&&(F===Ha?i.cullFace(i.BACK):F===Kl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):he(i.CULL_FACE),D=F}function Ie(F){F!==X&&(R&&i.lineWidth(F),X=F)}function et(F,_e,K){F?(ae(i.POLYGON_OFFSET_FILL),(G!==_e||$!==K)&&(i.polygonOffset(_e,K),G=_e,$=K)):he(i.POLYGON_OFFSET_FILL)}function Pe(F){F?ae(i.SCISSOR_TEST):he(i.SCISSOR_TEST)}function T(F){F===void 0&&(F=i.TEXTURE0+te-1),Q!==F&&(i.activeTexture(F),Q=F)}function M(F,_e,K){K===void 0&&(Q===null?K=i.TEXTURE0+te-1:K=Q);let ee=q[K];ee===void 0&&(ee={type:void 0,texture:void 0},q[K]=ee),(ee.type!==F||ee.texture!==_e)&&(Q!==K&&(i.activeTexture(K),Q=K),i.bindTexture(F,_e||me[F]),ee.type=F,ee.texture=_e)}function z(){const F=q[Q];F!==void 0&&F.type!==void 0&&(i.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function j(){try{i.compressedTexImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Z(){try{i.texSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function we(){try{i.texSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function se(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Le(){try{i.texStorage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function re(){try{i.texStorage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function pe(){try{i.texImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Se(){try{i.texImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ee(F){le.equals(F)===!1&&(i.scissor(F.x,F.y,F.z,F.w),le.copy(F))}function Me(F){k.equals(F)===!1&&(i.viewport(F.x,F.y,F.z,F.w),k.copy(F))}function qe(F,_e){let K=c.get(_e);K===void 0&&(K=new WeakMap,c.set(_e,K));let ee=K.get(F);ee===void 0&&(ee=i.getUniformBlockIndex(_e,F.name),K.set(F,ee))}function Fe(F,_e){const ee=c.get(_e).get(F);l.get(_e)!==ee&&(i.uniformBlockBinding(_e,ee,F.__bindingPointIndex),l.set(_e,ee))}function st(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},Q=null,q={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,v=null,y=null,g=null,C=null,w=null,A=new Ve(0,0,0),P=0,b=!1,S=null,D=null,X=null,G=null,$=null,le.set(0,0,i.canvas.width,i.canvas.height),k.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ae,disable:he,bindFramebuffer:be,drawBuffers:Ue,useProgram:De,setBlending:N,setMaterial:mt,setFlipSided:We,setCullFace:Xe,setLineWidth:Ie,setPolygonOffset:et,setScissorTest:Pe,activeTexture:T,bindTexture:M,unbindTexture:z,compressedTexImage2D:j,compressedTexImage3D:ne,texImage2D:pe,texImage3D:Se,updateUBOMapping:qe,uniformBlockBinding:Fe,texStorage2D:Le,texStorage3D:re,texSubImage2D:Z,texSubImage3D:we,compressedTexSubImage2D:de,compressedTexSubImage3D:se,scissor:Ee,viewport:Me,reset:st}}function zo(i,e,t,n){const s=Op(n);switch(t){case nl:return i*e;case sl:return i*e;case rl:return i*e*2;case al:return i*e/s.components*s.byteLength;case xa:return i*e/s.components*s.byteLength;case ol:return i*e*2/s.components*s.byteLength;case ya:return i*e*2/s.components*s.byteLength;case il:return i*e*3/s.components*s.byteLength;case Wt:return i*e*4/s.components*s.byteLength;case Ma:return i*e*4/s.components*s.byteLength;case Es:case bs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case ws:case Ts:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Br:case kr:return Math.max(i,16)*Math.max(e,8)/4;case Or:case zr:return Math.max(i,8)*Math.max(e,8)/2;case Hr:case Gr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Vr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Wr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Xr:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case qr:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Yr:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case $r:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Kr:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Jr:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Zr:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case jr:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Qr:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case ea:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case ta:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case na:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ia:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case As:case sa:case ra:return Math.ceil(i/4)*Math.ceil(e/4)*16;case ll:case aa:return Math.ceil(i/4)*Math.ceil(e/4)*8;case oa:case la:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Op(i){switch(i){case un:case Qo:return{byteLength:1,components:1};case ki:case el:case Xi:return{byteLength:2,components:1};case ga:case va:return{byteLength:2,components:4};case Gn:case _a:case ln:return{byteLength:4,components:1};case tl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Bp(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ye,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,M){return p?new OffscreenCanvas(T,M):Hi("canvas")}function x(T,M,z){let j=1;const ne=Pe(T);if((ne.width>z||ne.height>z)&&(j=z/Math.max(ne.width,ne.height)),j<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const Z=Math.floor(j*ne.width),we=Math.floor(j*ne.height);u===void 0&&(u=_(Z,we));const de=M?_(Z,we):u;return de.width=Z,de.height=we,de.getContext("2d").drawImage(T,0,0,Z,we),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+Z+"x"+we+")."),de}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),T;return T}function m(T){return T.generateMipmaps}function f(T){i.generateMipmap(T)}function v(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(T,M,z,j,ne=!1){if(T!==null){if(i[T]!==void 0)return i[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let Z=M;if(M===i.RED&&(z===i.FLOAT&&(Z=i.R32F),z===i.HALF_FLOAT&&(Z=i.R16F),z===i.UNSIGNED_BYTE&&(Z=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.R8UI),z===i.UNSIGNED_SHORT&&(Z=i.R16UI),z===i.UNSIGNED_INT&&(Z=i.R32UI),z===i.BYTE&&(Z=i.R8I),z===i.SHORT&&(Z=i.R16I),z===i.INT&&(Z=i.R32I)),M===i.RG&&(z===i.FLOAT&&(Z=i.RG32F),z===i.HALF_FLOAT&&(Z=i.RG16F),z===i.UNSIGNED_BYTE&&(Z=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RG8UI),z===i.UNSIGNED_SHORT&&(Z=i.RG16UI),z===i.UNSIGNED_INT&&(Z=i.RG32UI),z===i.BYTE&&(Z=i.RG8I),z===i.SHORT&&(Z=i.RG16I),z===i.INT&&(Z=i.RG32I)),M===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RGB8UI),z===i.UNSIGNED_SHORT&&(Z=i.RGB16UI),z===i.UNSIGNED_INT&&(Z=i.RGB32UI),z===i.BYTE&&(Z=i.RGB8I),z===i.SHORT&&(Z=i.RGB16I),z===i.INT&&(Z=i.RGB32I)),M===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(Z=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(Z=i.RGBA16UI),z===i.UNSIGNED_INT&&(Z=i.RGBA32UI),z===i.BYTE&&(Z=i.RGBA8I),z===i.SHORT&&(Z=i.RGBA16I),z===i.INT&&(Z=i.RGBA32I)),M===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(Z=i.RGB9_E5),M===i.RGBA){const we=ne?Ns:$e.getTransfer(j);z===i.FLOAT&&(Z=i.RGBA32F),z===i.HALF_FLOAT&&(Z=i.RGBA16F),z===i.UNSIGNED_BYTE&&(Z=we===tt?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(Z=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(Z=i.RGB5_A1)}return(Z===i.R16F||Z===i.R32F||Z===i.RG16F||Z===i.RG32F||Z===i.RGBA16F||Z===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function g(T,M){let z;return T?M===null||M===Gn||M===_i?z=i.DEPTH24_STENCIL8:M===ln?z=i.DEPTH32F_STENCIL8:M===ki&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Gn||M===_i?z=i.DEPTH_COMPONENT24:M===ln?z=i.DEPTH_COMPONENT32F:M===ki&&(z=i.DEPTH_COMPONENT16),z}function C(T,M){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Tt&&T.minFilter!==$t?Math.log2(Math.max(M.width,M.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?M.mipmaps.length:1}function w(T){const M=T.target;M.removeEventListener("dispose",w),P(M),M.isVideoTexture&&h.delete(M)}function A(T){const M=T.target;M.removeEventListener("dispose",A),S(M)}function P(T){const M=n.get(T);if(M.__webglInit===void 0)return;const z=T.source,j=d.get(z);if(j){const ne=j[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&b(T),Object.keys(j).length===0&&d.delete(z)}n.remove(T)}function b(T){const M=n.get(T);i.deleteTexture(M.__webglTexture);const z=T.source,j=d.get(z);delete j[M.__cacheKey],a.memory.textures--}function S(T){const M=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(M.__webglFramebuffer[j]))for(let ne=0;ne<M.__webglFramebuffer[j].length;ne++)i.deleteFramebuffer(M.__webglFramebuffer[j][ne]);else i.deleteFramebuffer(M.__webglFramebuffer[j]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[j])}else{if(Array.isArray(M.__webglFramebuffer))for(let j=0;j<M.__webglFramebuffer.length;j++)i.deleteFramebuffer(M.__webglFramebuffer[j]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let j=0;j<M.__webglColorRenderbuffer.length;j++)M.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[j]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=T.textures;for(let j=0,ne=z.length;j<ne;j++){const Z=n.get(z[j]);Z.__webglTexture&&(i.deleteTexture(Z.__webglTexture),a.memory.textures--),n.remove(z[j])}n.remove(T)}let D=0;function X(){D=0}function G(){const T=D;return T>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),D+=1,T}function $(T){const M=[];return M.push(T.wrapS),M.push(T.wrapT),M.push(T.wrapR||0),M.push(T.magFilter),M.push(T.minFilter),M.push(T.anisotropy),M.push(T.internalFormat),M.push(T.format),M.push(T.type),M.push(T.generateMipmaps),M.push(T.premultiplyAlpha),M.push(T.flipY),M.push(T.unpackAlignment),M.push(T.colorSpace),M.join()}function te(T,M){const z=n.get(T);if(T.isVideoTexture&&Ie(T),T.isRenderTargetTexture===!1&&T.version>0&&z.__version!==T.version){const j=T.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{k(z,T,M);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function R(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){k(z,T,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function H(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){k(z,T,M);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function U(T,M){const z=n.get(T);if(T.version>0&&z.__version!==T.version){ie(z,T,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const Q={[Nr]:i.REPEAT,[Bn]:i.CLAMP_TO_EDGE,[Fr]:i.MIRRORED_REPEAT},q={[Tt]:i.NEAREST,[Ec]:i.NEAREST_MIPMAP_NEAREST,[Zi]:i.NEAREST_MIPMAP_LINEAR,[$t]:i.LINEAR,[Gs]:i.LINEAR_MIPMAP_NEAREST,[zn]:i.LINEAR_MIPMAP_LINEAR},Y={[Ac]:i.NEVER,[Ic]:i.ALWAYS,[Cc]:i.LESS,[hl]:i.LEQUAL,[Rc]:i.EQUAL,[Dc]:i.GEQUAL,[Pc]:i.GREATER,[Lc]:i.NOTEQUAL};function ce(T,M){if(M.type===ln&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===$t||M.magFilter===Gs||M.magFilter===Zi||M.magFilter===zn||M.minFilter===$t||M.minFilter===Gs||M.minFilter===Zi||M.minFilter===zn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,Q[M.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,Q[M.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,Q[M.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,q[M.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,q[M.minFilter]),M.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Y[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Tt||M.minFilter!==Zi&&M.minFilter!==zn||M.type===ln&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function le(T,M){let z=!1;T.__webglInit===void 0&&(T.__webglInit=!0,M.addEventListener("dispose",w));const j=M.source;let ne=d.get(j);ne===void 0&&(ne={},d.set(j,ne));const Z=$(M);if(Z!==T.__cacheKey){ne[Z]===void 0&&(ne[Z]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),ne[Z].usedTimes++;const we=ne[T.__cacheKey];we!==void 0&&(ne[T.__cacheKey].usedTimes--,we.usedTimes===0&&b(M)),T.__cacheKey=Z,T.__webglTexture=ne[Z].texture}return z}function k(T,M,z){let j=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(j=i.TEXTURE_3D);const ne=le(T,M),Z=M.source;t.bindTexture(j,T.__webglTexture,i.TEXTURE0+z);const we=n.get(Z);if(Z.version!==we.__version||ne===!0){t.activeTexture(i.TEXTURE0+z);const de=$e.getPrimaries($e.workingColorSpace),se=M.colorSpace===yn?null:$e.getPrimaries(M.colorSpace),Le=M.colorSpace===yn||de===se?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le);let re=x(M.image,!1,s.maxTextureSize);re=et(M,re);const pe=r.convert(M.format,M.colorSpace),Se=r.convert(M.type);let Ee=y(M.internalFormat,pe,Se,M.colorSpace,M.isVideoTexture);ce(j,M);let Me;const qe=M.mipmaps,Fe=M.isVideoTexture!==!0,st=we.__version===void 0||ne===!0,F=Z.dataReady,_e=C(M,re);if(M.isDepthTexture)Ee=g(M.format===gi,M.type),st&&(Fe?t.texStorage2D(i.TEXTURE_2D,1,Ee,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,Ee,re.width,re.height,0,pe,Se,null));else if(M.isDataTexture)if(qe.length>0){Fe&&st&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,qe[0].width,qe[0].height);for(let K=0,ee=qe.length;K<ee;K++)Me=qe[K],Fe?F&&t.texSubImage2D(i.TEXTURE_2D,K,0,0,Me.width,Me.height,pe,Se,Me.data):t.texImage2D(i.TEXTURE_2D,K,Ee,Me.width,Me.height,0,pe,Se,Me.data);M.generateMipmaps=!1}else Fe?(st&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,re.width,re.height),F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re.width,re.height,pe,Se,re.data)):t.texImage2D(i.TEXTURE_2D,0,Ee,re.width,re.height,0,pe,Se,re.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Fe&&st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,Ee,qe[0].width,qe[0].height,re.depth);for(let K=0,ee=qe.length;K<ee;K++)if(Me=qe[K],M.format!==Wt)if(pe!==null)if(Fe){if(F)if(M.layerUpdates.size>0){const xe=zo(Me.width,Me.height,M.format,M.type);for(const ge of M.layerUpdates){const ze=Me.data.subarray(ge*xe/Me.data.BYTES_PER_ELEMENT,(ge+1)*xe/Me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,ge,Me.width,Me.height,1,pe,ze)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,Me.width,Me.height,re.depth,pe,Me.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,K,Ee,Me.width,Me.height,re.depth,0,Me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?F&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,Me.width,Me.height,re.depth,pe,Se,Me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,K,Ee,Me.width,Me.height,re.depth,0,pe,Se,Me.data)}else{Fe&&st&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,qe[0].width,qe[0].height);for(let K=0,ee=qe.length;K<ee;K++)Me=qe[K],M.format!==Wt?pe!==null?Fe?F&&t.compressedTexSubImage2D(i.TEXTURE_2D,K,0,0,Me.width,Me.height,pe,Me.data):t.compressedTexImage2D(i.TEXTURE_2D,K,Ee,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?F&&t.texSubImage2D(i.TEXTURE_2D,K,0,0,Me.width,Me.height,pe,Se,Me.data):t.texImage2D(i.TEXTURE_2D,K,Ee,Me.width,Me.height,0,pe,Se,Me.data)}else if(M.isDataArrayTexture)if(Fe){if(st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,Ee,re.width,re.height,re.depth),F)if(M.layerUpdates.size>0){const K=zo(re.width,re.height,M.format,M.type);for(const ee of M.layerUpdates){const xe=re.data.subarray(ee*K/re.data.BYTES_PER_ELEMENT,(ee+1)*K/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ee,re.width,re.height,1,pe,Se,xe)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,pe,Se,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ee,re.width,re.height,re.depth,0,pe,Se,re.data);else if(M.isData3DTexture)Fe?(st&&t.texStorage3D(i.TEXTURE_3D,_e,Ee,re.width,re.height,re.depth),F&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,pe,Se,re.data)):t.texImage3D(i.TEXTURE_3D,0,Ee,re.width,re.height,re.depth,0,pe,Se,re.data);else if(M.isFramebufferTexture){if(st)if(Fe)t.texStorage2D(i.TEXTURE_2D,_e,Ee,re.width,re.height);else{let K=re.width,ee=re.height;for(let xe=0;xe<_e;xe++)t.texImage2D(i.TEXTURE_2D,xe,Ee,K,ee,0,pe,Se,null),K>>=1,ee>>=1}}else if(qe.length>0){if(Fe&&st){const K=Pe(qe[0]);t.texStorage2D(i.TEXTURE_2D,_e,Ee,K.width,K.height)}for(let K=0,ee=qe.length;K<ee;K++)Me=qe[K],Fe?F&&t.texSubImage2D(i.TEXTURE_2D,K,0,0,pe,Se,Me):t.texImage2D(i.TEXTURE_2D,K,Ee,pe,Se,Me);M.generateMipmaps=!1}else if(Fe){if(st){const K=Pe(re);t.texStorage2D(i.TEXTURE_2D,_e,Ee,K.width,K.height)}F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,Se,re)}else t.texImage2D(i.TEXTURE_2D,0,Ee,pe,Se,re);m(M)&&f(j),we.__version=Z.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function ie(T,M,z){if(M.image.length!==6)return;const j=le(T,M),ne=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+z);const Z=n.get(ne);if(ne.version!==Z.__version||j===!0){t.activeTexture(i.TEXTURE0+z);const we=$e.getPrimaries($e.workingColorSpace),de=M.colorSpace===yn?null:$e.getPrimaries(M.colorSpace),se=M.colorSpace===yn||we===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const Le=M.isCompressedTexture||M.image[0].isCompressedTexture,re=M.image[0]&&M.image[0].isDataTexture,pe=[];for(let ee=0;ee<6;ee++)!Le&&!re?pe[ee]=x(M.image[ee],!0,s.maxCubemapSize):pe[ee]=re?M.image[ee].image:M.image[ee],pe[ee]=et(M,pe[ee]);const Se=pe[0],Ee=r.convert(M.format,M.colorSpace),Me=r.convert(M.type),qe=y(M.internalFormat,Ee,Me,M.colorSpace),Fe=M.isVideoTexture!==!0,st=Z.__version===void 0||j===!0,F=ne.dataReady;let _e=C(M,Se);ce(i.TEXTURE_CUBE_MAP,M);let K;if(Le){Fe&&st&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,qe,Se.width,Se.height);for(let ee=0;ee<6;ee++){K=pe[ee].mipmaps;for(let xe=0;xe<K.length;xe++){const ge=K[xe];M.format!==Wt?Ee!==null?Fe?F&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,0,0,ge.width,ge.height,Ee,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,qe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Fe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,0,0,ge.width,ge.height,Ee,Me,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,qe,ge.width,ge.height,0,Ee,Me,ge.data)}}}else{if(K=M.mipmaps,Fe&&st){K.length>0&&_e++;const ee=Pe(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,qe,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(re){Fe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,pe[ee].width,pe[ee].height,Ee,Me,pe[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,qe,pe[ee].width,pe[ee].height,0,Ee,Me,pe[ee].data);for(let xe=0;xe<K.length;xe++){const ze=K[xe].image[ee].image;Fe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,0,0,ze.width,ze.height,Ee,Me,ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,qe,ze.width,ze.height,0,Ee,Me,ze.data)}}else{Fe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ee,Me,pe[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,qe,Ee,Me,pe[ee]);for(let xe=0;xe<K.length;xe++){const ge=K[xe];Fe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,0,0,Ee,Me,ge.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,qe,Ee,Me,ge.image[ee])}}}m(M)&&f(i.TEXTURE_CUBE_MAP),Z.__version=ne.version,M.onUpdate&&M.onUpdate(M)}T.__version=M.version}function me(T,M,z,j,ne,Z){const we=r.convert(z.format,z.colorSpace),de=r.convert(z.type),se=y(z.internalFormat,we,de,z.colorSpace),Le=n.get(M),re=n.get(z);if(re.__renderTarget=M,!Le.__hasExternalTextures){const pe=Math.max(1,M.width>>Z),Se=Math.max(1,M.height>>Z);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,Z,se,pe,Se,M.depth,0,we,de,null):t.texImage2D(ne,Z,se,pe,Se,0,we,de,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),Xe(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,ne,re.__webglTexture,0,We(M)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,ne,re.__webglTexture,Z),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ae(T,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,T),M.depthBuffer){const j=M.depthTexture,ne=j&&j.isDepthTexture?j.type:null,Z=g(M.stencilBuffer,ne),we=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=We(M);Xe(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,Z,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,Z,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Z,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,we,i.RENDERBUFFER,T)}else{const j=M.textures;for(let ne=0;ne<j.length;ne++){const Z=j[ne],we=r.convert(Z.format,Z.colorSpace),de=r.convert(Z.type),se=y(Z.internalFormat,we,de,Z.colorSpace),Le=We(M);z&&Xe(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Le,se,M.width,M.height):Xe(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Le,se,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,se,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function he(T,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(M.depthTexture);j.__renderTarget=M,(!j.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),te(M.depthTexture,0);const ne=j.__webglTexture,Z=We(M);if(M.depthTexture.format===ui)Xe(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(M.depthTexture.format===gi)Xe(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function be(T){const M=n.get(T),z=T.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==T.depthTexture){const j=T.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),j){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,j.removeEventListener("dispose",ne)};j.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=j}if(T.depthTexture&&!M.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");he(M.__webglFramebuffer,T)}else if(z){M.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[j]),M.__webglDepthbuffer[j]===void 0)M.__webglDepthbuffer[j]=i.createRenderbuffer(),ae(M.__webglDepthbuffer[j],T,!1);else{const ne=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=M.__webglDepthbuffer[j];i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,Z)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),ae(M.__webglDepthbuffer,T,!1);else{const j=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,ne)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(T,M,z){const j=n.get(T);M!==void 0&&me(j.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&be(T)}function De(T){const M=T.texture,z=n.get(T),j=n.get(M);T.addEventListener("dispose",A);const ne=T.textures,Z=T.isWebGLCubeRenderTarget===!0,we=ne.length>1;if(we||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=M.version,a.memory.textures++),Z){z.__webglFramebuffer=[];for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[de]=[];for(let se=0;se<M.mipmaps.length;se++)z.__webglFramebuffer[de][se]=i.createFramebuffer()}else z.__webglFramebuffer[de]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let de=0;de<M.mipmaps.length;de++)z.__webglFramebuffer[de]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(we)for(let de=0,se=ne.length;de<se;de++){const Le=n.get(ne[de]);Le.__webglTexture===void 0&&(Le.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&Xe(T)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let de=0;de<ne.length;de++){const se=ne[de];z.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[de]);const Le=r.convert(se.format,se.colorSpace),re=r.convert(se.type),pe=y(se.internalFormat,Le,re,se.colorSpace,T.isXRRenderTarget===!0),Se=We(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Se,pe,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,z.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),ae(z.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Z){t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),ce(i.TEXTURE_CUBE_MAP,M);for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0)for(let se=0;se<M.mipmaps.length;se++)me(z.__webglFramebuffer[de][se],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,se);else me(z.__webglFramebuffer[de],T,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);m(M)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(we){for(let de=0,se=ne.length;de<se;de++){const Le=ne[de],re=n.get(Le);t.bindTexture(i.TEXTURE_2D,re.__webglTexture),ce(i.TEXTURE_2D,Le),me(z.__webglFramebuffer,T,Le,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),m(Le)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let de=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(de=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,j.__webglTexture),ce(de,M),M.mipmaps&&M.mipmaps.length>0)for(let se=0;se<M.mipmaps.length;se++)me(z.__webglFramebuffer[se],T,M,i.COLOR_ATTACHMENT0,de,se);else me(z.__webglFramebuffer,T,M,i.COLOR_ATTACHMENT0,de,0);m(M)&&f(de),t.unbindTexture()}T.depthBuffer&&be(T)}function Be(T){const M=T.textures;for(let z=0,j=M.length;z<j;z++){const ne=M[z];if(m(ne)){const Z=v(T),we=n.get(ne).__webglTexture;t.bindTexture(Z,we),f(Z),t.unbindTexture()}}}const it=[],N=[];function mt(T){if(T.samples>0){if(Xe(T)===!1){const M=T.textures,z=T.width,j=T.height;let ne=i.COLOR_BUFFER_BIT;const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,we=n.get(T),de=M.length>1;if(de)for(let se=0;se<M.length;se++)t.bindFramebuffer(i.FRAMEBUFFER,we.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,we.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let se=0;se<M.length;se++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),de){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,we.__webglColorRenderbuffer[se]);const Le=n.get(M[se]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Le,0)}i.blitFramebuffer(0,0,z,j,0,0,z,j,ne,i.NEAREST),l===!0&&(it.length=0,N.length=0,it.push(i.COLOR_ATTACHMENT0+se),T.depthBuffer&&T.resolveDepthBuffer===!1&&(it.push(Z),N.push(Z),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,N)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,it))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let se=0;se<M.length;se++){t.bindFramebuffer(i.FRAMEBUFFER,we.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,we.__webglColorRenderbuffer[se]);const Le=n.get(M[se]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,we.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.TEXTURE_2D,Le,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const M=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function We(T){return Math.min(s.maxSamples,T.samples)}function Xe(T){const M=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ie(T){const M=a.render.frame;h.get(T)!==M&&(h.set(T,M),T.update())}function et(T,M){const z=T.colorSpace,j=T.format,ne=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||z!==xi&&z!==yn&&($e.getTransfer(z)===tt?(j!==Wt||ne!==un)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),M}function Pe(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=X,this.setTexture2D=te,this.setTexture2DArray=R,this.setTexture3D=H,this.setTextureCube=U,this.rebindTextures=Ue,this.setupRenderTarget=De,this.updateRenderTargetMipmap=Be,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=be,this.setupFrameBufferTexture=me,this.useMultisampledRTT=Xe}function zp(i,e){function t(n,s=yn){let r;const a=$e.getTransfer(s);if(n===un)return i.UNSIGNED_BYTE;if(n===ga)return i.UNSIGNED_SHORT_4_4_4_4;if(n===va)return i.UNSIGNED_SHORT_5_5_5_1;if(n===tl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Qo)return i.BYTE;if(n===el)return i.SHORT;if(n===ki)return i.UNSIGNED_SHORT;if(n===_a)return i.INT;if(n===Gn)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Xi)return i.HALF_FLOAT;if(n===nl)return i.ALPHA;if(n===il)return i.RGB;if(n===Wt)return i.RGBA;if(n===sl)return i.LUMINANCE;if(n===rl)return i.LUMINANCE_ALPHA;if(n===ui)return i.DEPTH_COMPONENT;if(n===gi)return i.DEPTH_STENCIL;if(n===al)return i.RED;if(n===xa)return i.RED_INTEGER;if(n===ol)return i.RG;if(n===ya)return i.RG_INTEGER;if(n===Ma)return i.RGBA_INTEGER;if(n===Es||n===bs||n===ws||n===Ts)if(a===tt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Es)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ws)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ts)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Es)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ws)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ts)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Or||n===Br||n===zr||n===kr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Or)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Br)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===zr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===kr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Hr||n===Gr||n===Vr)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Hr||n===Gr)return a===tt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Vr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Wr||n===Xr||n===qr||n===Yr||n===$r||n===Kr||n===Jr||n===Zr||n===jr||n===Qr||n===ea||n===ta||n===na||n===ia)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Xr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Yr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===$r)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Kr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Jr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Zr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===jr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qr)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ea)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ta)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===na)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ia)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===As||n===sa||n===ra)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===As)return a===tt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===sa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ra)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ll||n===aa||n===oa||n===la)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===As)return r.COMPRESSED_RED_RGTC1_EXT;if(n===aa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===oa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===la)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===_i?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class kp extends Nt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class kn extends xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Hp={type:"move"};class gr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new kn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new kn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new kn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const x of e.hand.values()){const m=t.getJointPose(x,n),f=this._getHandJoint(c,x);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,_=.005;c.inputState.pinching&&d>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Hp)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new kn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Gp=`
void main() {
...
---
\`sig:${k}\` | *UNPLUG: Elemental Survivor*`,ae=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(ie)}&body=${encodeURIComponent(me)}&labels=record`;window.open(ae,"_blank")}),document.getElementById("retry-btn").addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",I=new Rs,t=!0,$=!1,e.enemyMeshes.forEach(R=>e.scene.remove(R)),e.enemyMeshes=[],e.orbMeshes.forEach(R=>e.scene.remove(R)),e.orbMeshes=[],e.bulletMeshes.forEach(R=>e.scene.remove(R)),e.bulletMeshes=[]});const r={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",R=>{const H=r[R.code]||R.key.toLowerCase();if(R.code==="Space"&&R.preventDefault(),R.code==="Escape"){I.toggle_pause();const U=I.is_paused();document.getElementById("pause-menu").style.display=U?"flex":"none",U&&g();return}I.on_key_down(H),I.level_up_pending()&&(H==="1"&&(I.choose_upgrade(0),w()),H==="2"&&(I.choose_upgrade(1),w()),H==="3"&&(I.choose_upgrade(2),w()))}),document.addEventListener("keyup",R=>{const H=r[R.code]||R.key.toLowerCase();I.on_key_up(H)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",R=>R.preventDefault()),document.addEventListener("contextmenu",R=>{t&&R.preventDefault()}),a.addEventListener("selectstart",R=>R.preventDefault());let o=null,l=!1,c=null,h=[],u=null,d=null;a.addEventListener("mousedown",R=>{!t||!I||(R.preventDefault(),R.button===0&&I.player_class_tier()>0?(o={x:R.clientX,y:R.clientY,button:0},h=[{x:R.clientX,y:R.clientY}],l=!1,f()):R.button===2&&I.player_class_tier()>=2&&(o={x:R.clientX,y:R.clientY,button:2},h=[{x:R.clientX,y:R.clientY}],l=!1,f()))}),document.addEventListener("mousemove",R=>{if(!o)return;const H=R.clientX-o.x,U=R.clientY-o.y,Q=Math.sqrt(H*H+U*U);if(h.push({x:R.clientX,y:R.clientY}),Q>20){l=!0;const q=p(h,o);if(!d){const he=document.createElement("canvas");he.width=window.innerWidth,he.height=window.innerHeight,he.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(he),d=he}const Y=d.getContext("2d");if(Y.clearRect(0,0,d.width,d.height),h.length>2){const he=I.player_class_element()||I.active_element(),be={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};Y.strokeStyle=be[he]||be[0],Y.lineWidth=3,Y.lineCap="round",Y.beginPath(),Y.moveTo(h[0].x,h[0].y);for(let Ue=1;Ue<h.length;Ue++)Y.lineTo(h[Ue].x,h[Ue].y);Y.stroke(),q==="circle"&&(Y.strokeStyle="rgba(255,200,0,0.7)",Y.lineWidth=5,Y.stroke())}c||(c=document.createElement("div"),c.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(c)),u||(u=document.createElement("div"),u.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(u));const ce=Math.min(50+Q*.4,100),le=I.player_class_element()||I.active_element(),k=o.button===2,me=(k?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[le]||(k?"#ccaaff":"#8888ff");c.style.width=ce+"px",c.style.height=ce+"px",c.style.borderColor=me,c.style.boxShadow=`0 0 ${ce/4}px ${me}, inset 0 0 ${ce/6}px ${me}`;const ae={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(c.textContent=ae[q]||"...",e&&e.camera){const he=e.projectToScreen(I.player_x(),.5,I.player_z());if(c.style.left=he.x-ce/2+"px",c.style.top=he.y-ce/2+"px",q==="outward"){const be=Math.atan2(U,H),Ue=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let De=Math.round(be/(Math.PI/4));De<0&&(De+=8),De=De%8,u.textContent=Ue[De],u.style.fontSize="32px";const Be=50;u.style.left=he.x+Math.cos(be)*Be-16+"px",u.style.top=he.y+Math.sin(be)*Be-16+"px",u.style.opacity="1"}else q==="inward"?(u.textContent="🛡️",u.style.fontSize="28px",u.style.left=he.x-14+"px",u.style.top=he.y-14+"px",u.style.opacity="1"):q==="circle"?(u.textContent="🌀",u.style.left=he.x-14+"px",u.style.top=he.y-40+"px",u.style.opacity="1"):(u.style.opacity="0.3",u.textContent="?")}}}),document.addEventListener("mouseup",R=>{if(!o||!I){o=null;return}const H=R.clientX-o.x,U=R.clientY-o.y,Q=Math.sqrt(H*H+U*U),q=o.button;if(c&&(c.remove(),c=null),u&&(u.remove(),u=null),d&&(d.remove(),d=null),v(),q===0&&I.player_class_tier()>0)if(l&&Q>30){const Y=p(h,o),ce=Math.atan2(-U,H);if(Y==="outward"){if(!x(20)){o=null,l=!1,h=[];return}I.use_directional_skill(ce),e.spawnDirectionalEffect(I.player_x(),I.player_z(),ce,I.player_class_element()||I.active_element(),5),e.shake(.35,.1),y("outward")}else if(Y==="inward")I.use_shield_skill(),gt.playShield(),e.spawnShieldEffect(I.player_x(),I.player_z(),I.player_class_element()||I.active_element()),e.shake(.15,.05),y("inward");else if(Y==="circle"){if(!x(50)){o=null,l=!1,h=[];return}I.use_ultimate_skill(),gt.playUltimate(I.player_class_element()||I.active_element()),e.spawnUltimateEffect(I.player_x(),I.player_z(),I.player_class_element()||I.active_element(),8),e.shake(.6,.2),y("circle");const le=document.createElement("div");le.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(255,255,255,0.3);pointer-events:none;z-index:999;animation:flash-fade 0.3s ease-out forwards",document.body.appendChild(le),setTimeout(()=>le.remove(),300)}}else l||(I.use_active_skill(),e.shake(.2,.08));else if(q===2&&I.player_class_tier()>=2)if(l&&Q>30){const Y=p(h,o),ce=Math.atan2(-U,H);if(Y==="outward"){if(!x(20)){o=null,l=!1,h=[];return}I.use_directional_skill(ce);const le=I.player_class_element()||I.active_element();e.spawnAdvancedDirectionalEffect(I.player_x(),I.player_z(),ce,le,9),gt.playAdvancedSkill(le),e.shake(.55,.15),y("outward")}else if(Y==="circle"){if(!x(50)){o=null,l=!1,h=[];return}I.use_ultimate_skill(),gt.playUltimate(I.player_class_element()||I.active_element()),e.spawnUltimateEffect(I.player_x(),I.player_z(),I.player_class_element()||I.active_element(),10),e.shake(.7,.25),y("circle")}else I.use_active_skill(),e.shake(.3,.1),y("outward")}else l||(I.use_active_skill(),e.spawnSkillEffect(I.player_x(),I.player_z(),I.active_element(),4),e.shake(.25,.08));o=null,l=!1,h=[]});function p(R,H){if(R.length<5)return"unknown";const U=R[R.length-1],Q=U.x-H.x,q=U.y-H.y,Y=Math.sqrt(Q*Q+q*q);if(R.length>30){let ce=0;for(let k=2;k<R.length;k++){const ie=R[k-1].x-R[k-2].x,me=R[k-1].y-R[k-2].y,ae=R[k].x-R[k-1].x,he=R[k].y-R[k-1].y,be=ie*he-me*ae,Ue=ie*ae+me*he;ce+=Math.atan2(be,Ue)}const le=Math.sqrt((U.x-H.x)**2+(U.y-H.y)**2);if(Math.abs(ce)>Math.PI*1.9&&le<120)return"circle"}if(e&&e.camera){const ce=e.projectToScreen(I.player_x(),.5,I.player_z()),le=Math.sqrt((H.x-ce.x)**2+(H.y-ce.y)**2),k=Math.sqrt((U.x-ce.x)**2+(U.y-ce.y)**2);if(k<le-20)return"inward";if(k>le+20)return"outward"}return Y>40?"outward":"unknown"}function _(){const R=document.getElementById("stamina-bar-bg");if(!R)return;R.style.border="2px solid #ff4444";const H=document.createElement("div");H.textContent="⚠️ Mana 부족!",H.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(H),setTimeout(()=>{H.remove(),R.style.border="1px solid #2a4a2a"},1e3)}function x(R){return I.player_stamina()<R?(_(),!1):!0}let m=null;function f(){m||(m=document.createElement("div"),m.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",m.innerHTML=`
