...
`)+`
`+f);const y=g+m+o,v=g+f+a,C=ol(i,i.VERTEX_SHADER,y),T=ol(i,i.FRAGMENT_SHADER,v);i.attachShader(x,C),i.attachShader(x,T),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function R(P){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(x).trim(),F=i.getShaderInfoLog(C).trim(),q=i.getShaderInfoLog(T).trim();let se=!0,j=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(se=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,C,T);else{const oe=cl(i,C,"vertex"),V=cl(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
}`;function d0(s,e,t){let n=new ec;const i=new _e,r=new _e,o=new ct,a=new c0({depthPacking:Vu}),c=new l0,l={},h=t.maxTextureSize,u={[Vn]:$t,[$t]:Vn,[qe]:qe},d=new Wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new _e},radius:{value:4}},vertexShader:h0,fragmentShader:u0}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Et;_.setAttribute("position",new Gt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new J(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Yl;let f=this.type;this.render=function(T,R,A){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;const M=s.getRenderTarget(),w=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),k=s.state;k.setBlending(ni),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const F=f!==Fn&&this.type===Fn,q=f===Fn&&this.type!==Fn;for(let se=0,j=T.length;se<j;se++){const oe=T[se],V=oe.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",oe,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;i.copy(V.mapSize);const de=V.getFrameExtents();if(i.multiply(de),r.copy(V.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/de.x),i.x=r.x*de.x,V.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/de.y),i.y=r.y*de.y,V.mapSize.y=r.y)),V.map===null||F===!0||q===!0){const Ie=this.type!==Fn?{minFilter:Vt,magFilter:Vt}:{};V.map!==null&&V.map.dispose(),V.map=new xi(i.x,i.y,Ie),V.map.texture.name=oe.name+".shadowMap",V.camera.updateProjectionMatrix()}s.setRenderTarget(V.map),s.clear();const ve=V.getViewportCount();for(let Ie=0;Ie<ve;Ie++){const je=V.getViewport(Ie);o.set(r.x*je.x,r.y*je.y,r.x*je.z,r.y*je.w),k.viewport(o),V.updateMatrices(oe,Ie),n=V.getFrustum(),v(R,A,V.camera,oe,this.type)}V.isPointLightShadow!==!0&&this.type===Fn&&g(V,A),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(M,w,P)};function g(T,R){const A=e.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new xi(i.x,i.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(R,null,A,d,x,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(R,null,A,p,x,null)}function y(T,R,A,M){let w=null;const P=A.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)w=P;else if(w=A.isPointLight===!0?c:a,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const k=w.uuid,F=R.uuid;let q=l[k];q===void 0&&(q={},l[k]=q);let se=q[F];se===void 0&&(se=w.clone(),q[F]=se,R.addEventListener("dispose",C)),w=se}if(w.visible=R.visible,w.wireframe=R.wireframe,M===Fn?w.side=R.shadowSide!==null?R.shadowSide:R.side:w.side=R.shadowSide!==null?R.shadowSide:u[R.side],w.alphaMap=R.alphaMap,w.alphaTest=R.alphaTest,w.map=R.map,w.clipShadows=R.clipShadows,w.clippingPlanes=R.clippingPlanes,w.clipIntersection=R.clipIntersection,w.displacementMap=R.displacementMap,w.displacementScale=R.displacementScale,w.displacementBias=R.displacementBias,w.wireframeLinewidth=R.wireframeLinewidth,w.linewidth=R.linewidth,A.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const k=s.properties.get(w);k.light=A}return w}function v(T,R,A,M,w){if(T.visible===!1)return;if(T.layers.test(R.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&w===Fn)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(A.matrixWorldInverse,T.matrixWorld);const F=e.update(T),q=T.material;if(Array.isArray(q)){const se=F.groups;for(let j=0,oe=se.length;j<oe;j++){const V=se[j],de=q[V.materialIndex];if(de&&de.visible){const ve=y(T,de,M,w);T.onBeforeShadow(s,T,R,A,F,ve,V),s.renderBufferDirect(A,null,F,ve,T,V),T.onAfterShadow(s,T,R,A,F,ve,V)}}}else if(q.visible){const se=y(T,q,M,w);T.onBeforeShadow(s,T,R,A,F,se,null),s.renderBufferDirect(A,null,F,se,T,null),T.onAfterShadow(s,T,R,A,F,se,null)}}const k=T.children;for(let F=0,q=k.length;F<q;F++)v(k[F],R,A,M,w)}function C(T){T.target.removeEventListener("dispose",C);for(const A in l){const M=l[A],w=T.target.uuid;w in M&&(M[w].dispose(),delete M[w])}}}const f0={[Ko]:Zo,[Jo]:ta,[Qo]:na,[Qi]:ea,[Zo]:Ko,[ta]:Jo,[na]:Qo,[ea]:Qi};function p0(s,e){function t(){let U=!1;const xe=new ct;let Y=null;const Q=new ct(0,0,0,0);return{setMask:function(Se){Y!==Se&&!U&&(s.colorMask(Se,Se,Se,Se),Y=Se)},setLocked:function(Se){U=Se},setClear:function(Se,ge,Ve,xt,Dt){Dt===!0&&(Se*=xt,ge*=xt,Ve*=xt),xe.set(Se,ge,Ve,xt),Q.equals(xe)===!1&&(s.clearColor(Se,ge,Ve,xt),Q.copy(xe))},reset:function(){U=!1,Y=null,Q.set(-1,0,0,0)}}}function n(){let U=!1,xe=!1,Y=null,Q=null,Se=null;return{setReversed:function(ge){if(xe!==ge){const Ve=e.get("EXT_clip_control");xe?Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.ZERO_TO_ONE_EXT):Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.NEGATIVE_ONE_TO_ONE_EXT);const xt=Se;Se=null,this.setClear(xt)}xe=ge},getReversed:function(){return xe},setTest:function(ge){ge?Me(s.DEPTH_TEST):N(s.DEPTH_TEST)},setMask:function(ge){Y!==ge&&!U&&(s.depthMask(ge),Y=ge)},setFunc:function(ge){if(xe&&(ge=f0[ge]),Q!==ge){switch(ge){case Ko:s.depthFunc(s.NEVER);break;case Zo:s.depthFunc(s.ALWAYS);break;case Jo:s.depthFunc(s.LESS);break;case Qi:s.depthFunc(s.LEQUAL);break;case Qo:s.depthFunc(s.EQUAL);break;case ea:s.depthFunc(s.GEQUAL);break;case ta:s.depthFunc(s.GREATER);break;case na:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Q=ge}},setLocked:function(ge){U=ge},setClear:function(ge){Se!==ge&&(xe&&(ge=1-ge),s.clearDepth(ge),Se=ge)},reset:function(){U=!1,Y=null,Q=null,Se=null,xe=!1}}}function i(){let U=!1,xe=null,Y=null,Q=null,Se=null,ge=null,Ve=null,xt=null,Dt=null;return{setTest:function(rt){U||(rt?Me(s.STENCIL_TEST):N(s.STENCIL_TEST))},setMask:function(rt){xe!==rt&&!U&&(s.stencilMask(rt),xe=rt)},setFunc:function(rt,qt,ke){(Y!==rt||Q!==qt||Se!==ke)&&(s.stencilFunc(rt,qt,ke),Y=rt,Q=qt,Se=ke)},setOp:function(rt,qt,ke){(ge!==rt||Ve!==qt||xt!==ke)&&(s.stencilOp(rt,qt,ke),ge=rt,Ve=qt,xt=ke)},setLocked:function(rt){U=rt},setClear:function(rt){Dt!==rt&&(s.clearStencil(rt),Dt=rt)},reset:function(){U=!1,xe=null,Y=null,Q=null,Se=null,ge=null,Ve=null,xt=null,Dt=null}}}const r=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let h={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,g=null,y=null,v=null,C=null,T=null,R=new Fe(0,0,0),A=0,M=!1,w=null,P=null,k=null,F=null,q=null;const se=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,oe=0;const V=s.getParameter(s.VERSION);V.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(V)[1]),j=oe>=1):V.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),j=oe>=2);let de=null,ve={};const Ie=s.getParameter(s.SCISSOR_BOX),je=s.getParameter(s.VIEWPORT),st=new ct().fromArray(Ie),ee=new ct().fromArray(je);function ue(U,xe,Y,Q){const Se=new Uint8Array(4),ge=s.createTexture();s.bindTexture(U,ge),s.texParameteri(U,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(U,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ve=0;Ve<Y;Ve++)U===s.TEXTURE_3D||U===s.TEXTURE_2D_ARRAY?s.texImage3D(xe,0,s.RGBA,1,1,Q,0,s.RGBA,s.UNSIGNED_BYTE,Se):s.texImage2D(xe+Ve,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Se);return ge}const Pe={};Pe[s.TEXTURE_2D]=ue(s.TEXTURE_2D,s.TEXTURE_2D,1),Pe[s.TEXTURE_CUBE_MAP]=ue(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Pe[s.TEXTURE_2D_ARRAY]=ue(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Pe[s.TEXTURE_3D]=ue(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Me(s.DEPTH_TEST),o.setFunc(Qi),ne(!1),he(xc),Me(s.CULL_FACE),D(ni);function Me(U){h[U]!==!0&&(s.enable(U),h[U]=!0)}function N(U){h[U]!==!1&&(s.disable(U),h[U]=!1)}function H(U,xe){return u[U]!==xe?(s.bindFramebuffer(U,xe),u[U]=xe,U===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=xe),U===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=xe),!0):!1}function te(U,xe){let Y=p,Q=!1;if(U){Y=d.get(xe),Y===void 0&&(Y=[],d.set(xe,Y));const Se=U.textures;if(Y.length!==Se.length||Y[0]!==s.COLOR_ATTACHMENT0){for(let ge=0,Ve=Se.length;ge<Ve;ge++)Y[ge]=s.COLOR_ATTACHMENT0+ge;Y.length=Se.length,Q=!0}}else Y[0]!==s.BACK&&(Y[0]=s.BACK,Q=!0);Q&&s.drawBuffers(Y)}function ae(U){return _!==U?(s.useProgram(U),_=U,!0):!1}const K={[_i]:s.FUNC_ADD,[uu]:s.FUNC_SUBTRACT,[du]:s.FUNC_REVERSE_SUBTRACT};K[fu]=s.MIN,K[pu]=s.MAX;const re={[mu]:s.ZERO,[_u]:s.ONE,[gu]:s.SRC_COLOR,[Yo]:s.SRC_ALPHA,[wu]:s.SRC_ALPHA_SATURATE,[Mu]:s.DST_COLOR,[xu]:s.DST_ALPHA,[vu]:s.ONE_MINUS_SRC_COLOR,[jo]:s.ONE_MINUS_SRC_ALPHA,[Su]:s.ONE_MINUS_DST_COLOR,[yu]:s.ONE_MINUS_DST_ALPHA,[bu]:s.CONSTANT_COLOR,[Tu]:s.ONE_MINUS_CONSTANT_COLOR,[Eu]:s.CONSTANT_ALPHA,[Au]:s.ONE_MINUS_CONSTANT_ALPHA};function D(U,xe,Y,Q,Se,ge,Ve,xt,Dt,rt){if(U===ni){x===!0&&(N(s.BLEND),x=!1);return}if(x===!1&&(Me(s.BLEND),x=!0),U!==hu){if(U!==m||rt!==M){if((f!==_i||v!==_i)&&(s.blendEquation(s.FUNC_ADD),f=_i,v=_i),rt)switch(U){case dn:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case $r:s.blendFunc(s.ONE,s.ONE);break;case yc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Mc:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case dn:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case $r:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case yc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Mc:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}g=null,y=null,C=null,T=null,R.set(0,0,0),A=0,m=U,M=rt}return}Se=Se||xe,ge=ge||Y,Ve=Ve||Q,(xe!==f||Se!==v)&&(s.blendEquationSeparate(K[xe],K[Se]),f=xe,v=Se),(Y!==g||Q!==y||ge!==C||Ve!==T)&&(s.blendFuncSeparate(re[Y],re[Q],re[ge],re[Ve]),g=Y,y=Q,C=ge,T=Ve),(xt.equals(R)===!1||Dt!==A)&&(s.blendColor(xt.r,xt.g,xt.b,Dt),R.copy(xt),A=Dt),m=U,M=!1}function be(U,xe){U.side===qe?N(s.CULL_FACE):Me(s.CULL_FACE);let Y=U.side===$t;xe&&(Y=!Y),ne(Y),U.blending===dn&&U.transparent===!1?D(ni):D(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),r.setMask(U.colorWrite);const Q=U.stencilWrite;a.setTest(Q),Q&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Be(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Me(s.SAMPLE_ALPHA_TO_COVERAGE):N(s.SAMPLE_ALPHA_TO_COVERAGE)}function ne(U){w!==U&&(U?s.frontFace(s.CW):s.frontFace(s.CCW),w=U)}function he(U){U!==cu?(Me(s.CULL_FACE),U!==P&&(U===xc?s.cullFace(s.BACK):U===lu?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):N(s.CULL_FACE),P=U}function ce(U){U!==k&&(j&&s.lineWidth(U),k=U)}function Be(U,xe,Y){U?(Me(s.POLYGON_OFFSET_FILL),(F!==xe||q!==Y)&&(s.polygonOffset(xe,Y),F=xe,q=Y)):N(s.POLYGON_OFFSET_FILL)}function we(U){U?Me(s.SCISSOR_TEST):N(s.SCISSOR_TEST)}function E(U){U===void 0&&(U=s.TEXTURE0+se-1),de!==U&&(s.activeTexture(U),de=U)}function S(U,xe,Y){Y===void 0&&(de===null?Y=s.TEXTURE0+se-1:Y=de);let Q=ve[Y];Q===void 0&&(Q={type:void 0,texture:void 0},ve[Y]=Q),(Q.type!==U||Q.texture!==xe)&&(de!==Y&&(s.activeTexture(Y),de=Y),s.bindTexture(U,xe||Pe[U]),Q.type=U,Q.texture=xe)}function z(){const U=ve[de];U!==void 0&&U.type!==void 0&&(s.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function G(){try{s.compressedTexImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ie(){try{s.compressedTexImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Z(){try{s.texSubImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ce(){try{s.texSubImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function me(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ee(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function et(){try{s.texStorage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function le(){try{s.texStorage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ae(){try{s.texImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Oe(){try{s.texImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ze(U){st.equals(U)===!1&&(s.scissor(U.x,U.y,U.z,U.w),st.copy(U))}function Re(U){ee.equals(U)===!1&&(s.viewport(U.x,U.y,U.z,U.w),ee.copy(U))}function Je(U,xe){let Y=l.get(xe);Y===void 0&&(Y=new WeakMap,l.set(xe,Y));let Q=Y.get(U);Q===void 0&&(Q=s.getUniformBlockIndex(xe,U.name),Y.set(U,Q))}function We(U,xe){const Q=l.get(xe).get(U);c.get(xe)!==Q&&(s.uniformBlockBinding(xe,Q,U.__bindingPointIndex),c.set(xe,Q))}function lt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},de=null,ve={},u={},d=new WeakMap,p=[],_=null,x=!1,m=null,f=null,g=null,y=null,v=null,C=null,T=null,R=new Fe(0,0,0),A=0,M=!1,w=null,P=null,k=null,F=null,q=null,st.set(0,0,s.canvas.width,s.canvas.height),ee.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:Me,disable:N,bindFramebuffer:H,drawBuffers:te,useProgram:ae,setBlending:D,setMaterial:be,setFlipSided:ne,setCullFace:he,setLineWidth:ce,setPolygonOffset:Be,setScissorTest:we,activeTexture:E,bindTexture:S,unbindTexture:z,compressedTexImage2D:G,compressedTexImage3D:ie,texImage2D:Ae,texImage3D:Oe,updateUBOMapping:Je,uniformBlockBinding:We,texStorage2D:et,texStorage3D:le,texSubImage2D:Z,texSubImage3D:Ce,compressedTexSubImage2D:me,compressedTexSubImage3D:Ee,scissor:ze,viewport:Re,reset:lt}}function _l(s,e,t,n){const i=m0(n);switch(t){case nh:return s*e;case sh:return s*e;case rh:return s*e*2;case Ya:return s*e/i.components*i.byteLength;case ja:return s*e/i.components*i.byteLength;case oh:return s*e*2/i.components*i.byteLength;case Ka:return s*e*2/i.components*i.byteLength;case ih:return s*e*3/i.components*i.byteLength;case sn:return s*e*4/i.components*i.byteLength;case Za:return s*e*4/i.components*i.byteLength;case kr:case zr:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case Hr:case Vr:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case oa:case ca:return Math.max(s,16)*Math.max(e,8)/4;case ra:case aa:return Math.max(s,8)*Math.max(e,8)/2;case la:case ha:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case ua:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case da:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case fa:return Math.floor((s+4)/5)*Math.floor((e+3)/4)*16;case pa:return Math.floor((s+4)/5)*Math.floor((e+4)/5)*16;case ma:return Math.floor((s+5)/6)*Math.floor((e+4)/5)*16;case _a:return Math.floor((s+5)/6)*Math.floor((e+5)/6)*16;case ga:return Math.floor((s+7)/8)*Math.floor((e+4)/5)*16;case va:return Math.floor((s+7)/8)*Math.floor((e+5)/6)*16;case xa:return Math.floor((s+7)/8)*Math.floor((e+7)/8)*16;case ya:return Math.floor((s+9)/10)*Math.floor((e+4)/5)*16;case Ma:return Math.floor((s+9)/10)*Math.floor((e+5)/6)*16;case Sa:return Math.floor((s+9)/10)*Math.floor((e+7)/8)*16;case wa:return Math.floor((s+9)/10)*Math.floor((e+9)/10)*16;case ba:return Math.floor((s+11)/12)*Math.floor((e+9)/10)*16;case Ta:return Math.floor((s+11)/12)*Math.floor((e+11)/12)*16;case Gr:case Ea:case Aa:return Math.ceil(s/4)*Math.ceil(e/4)*16;case ah:case Ra:return Math.ceil(s/4)*Math.ceil(e/4)*8;case Ca:case Pa:return Math.ceil(s/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function m0(s){switch(s){case Gn:case Ql:return{byteLength:1,components:1};case $s:case eh:case er:return{byteLength:2,components:1};case $a:case qa:return{byteLength:2,components:4};case vi:case Xa:case pn:return{byteLength:4,components:1};case th:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${s}.`)}function _0(s,e,t,n,i,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new _e,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,S){return p?new OffscreenCanvas(E,S):js("canvas")}function x(E,S,z){let G=1;const ie=we(E);if((ie.width>z||ie.height>z)&&(G=z/Math.max(ie.width,ie.height)),G<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const Z=Math.floor(G*ie.width),Ce=Math.floor(G*ie.height);u===void 0&&(u=_(Z,Ce));const me=S?_(Z,Ce):u;return me.width=Z,me.height=Ce,me.getContext("2d").drawImage(E,0,0,Z,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+Z+"x"+Ce+")."),me}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),E;return E}function m(E){return E.generateMipmaps}function f(E){s.generateMipmap(E)}function g(E){return E.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?s.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function y(E,S,z,G,ie=!1){if(E!==null){if(s[E]!==void 0)return s[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Z=S;if(S===s.RED&&(z===s.FLOAT&&(Z=s.R32F),z===s.HALF_FLOAT&&(Z=s.R16F),z===s.UNSIGNED_BYTE&&(Z=s.R8)),S===s.RED_INTEGER&&(z===s.UNSIGNED_BYTE&&(Z=s.R8UI),z===s.UNSIGNED_SHORT&&(Z=s.R16UI),z===s.UNSIGNED_INT&&(Z=s.R32UI),z===s.BYTE&&(Z=s.R8I),z===s.SHORT&&(Z=s.R16I),z===s.INT&&(Z=s.R32I)),S===s.RG&&(z===s.FLOAT&&(Z=s.RG32F),z===s.HALF_FLOAT&&(Z=s.RG16F),z===s.UNSIGNED_BYTE&&(Z=s.RG8)),S===s.RG_INTEGER&&(z===s.UNSIGNED_BYTE&&(Z=s.RG8UI),z===s.UNSIGNED_SHORT&&(Z=s.RG16UI),z===s.UNSIGNED_INT&&(Z=s.RG32UI),z===s.BYTE&&(Z=s.RG8I),z===s.SHORT&&(Z=s.RG16I),z===s.INT&&(Z=s.RG32I)),S===s.RGB_INTEGER&&(z===s.UNSIGNED_BYTE&&(Z=s.RGB8UI),z===s.UNSIGNED_SHORT&&(Z=s.RGB16UI),z===s.UNSIGNED_INT&&(Z=s.RGB32UI),z===s.BYTE&&(Z=s.RGB8I),z===s.SHORT&&(Z=s.RGB16I),z===s.INT&&(Z=s.RGB32I)),S===s.RGBA_INTEGER&&(z===s.UNSIGNED_BYTE&&(Z=s.RGBA8UI),z===s.UNSIGNED_SHORT&&(Z=s.RGBA16UI),z===s.UNSIGNED_INT&&(Z=s.RGBA32UI),z===s.BYTE&&(Z=s.RGBA8I),z===s.SHORT&&(Z=s.RGBA16I),z===s.INT&&(Z=s.RGBA32I)),S===s.RGB&&z===s.UNSIGNED_INT_5_9_9_9_REV&&(Z=s.RGB9_E5),S===s.RGBA){const Ce=ie?eo:tt.getTransfer(G);z===s.FLOAT&&(Z=s.RGBA32F),z===s.HALF_FLOAT&&(Z=s.RGBA16F),z===s.UNSIGNED_BYTE&&(Z=Ce===pt?s.SRGB8_ALPHA8:s.RGBA8),z===s.UNSIGNED_SHORT_4_4_4_4&&(Z=s.RGBA4),z===s.UNSIGNED_SHORT_5_5_5_1&&(Z=s.RGB5_A1)}return(Z===s.R16F||Z===s.R32F||Z===s.RG16F||Z===s.RG32F||Z===s.RGBA16F||Z===s.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function v(E,S){let z;return E?S===null||S===vi||S===is?z=s.DEPTH24_STENCIL8:S===pn?z=s.DEPTH32F_STENCIL8:S===$s&&(z=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===vi||S===is?z=s.DEPTH_COMPONENT24:S===pn?z=s.DEPTH_COMPONENT32F:S===$s&&(z=s.DEPTH_COMPONENT16),z}function C(E,S){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==Vt&&E.minFilter!==at?Math.log2(Math.max(S.width,S.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?S.mipmaps.length:1}function T(E){const S=E.target;S.removeEventListener("dispose",T),A(S),S.isVideoTexture&&h.delete(S)}function R(E){const S=E.target;S.removeEventListener("dispose",R),w(S)}function A(E){const S=n.get(E);if(S.__webglInit===void 0)return;const z=E.source,G=d.get(z);if(G){const ie=G[S.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&M(E),Object.keys(G).length===0&&d.delete(z)}n.remove(E)}function M(E){const S=n.get(E);s.deleteTexture(S.__webglTexture);const z=E.source,G=d.get(z);delete G[S.__cacheKey],o.memory.textures--}function w(E){const S=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(S.__webglFramebuffer[G]))for(let ie=0;ie<S.__webglFramebuffer[G].length;ie++)s.deleteFramebuffer(S.__webglFramebuffer[G][ie]);else s.deleteFramebuffer(S.__webglFramebuffer[G]);S.__webglDepthbuffer&&s.deleteRenderbuffer(S.__webglDepthbuffer[G])}else{if(Array.isArray(S.__webglFramebuffer))for(let G=0;G<S.__webglFramebuffer.length;G++)s.deleteFramebuffer(S.__webglFramebuffer[G]);else s.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&s.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&s.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let G=0;G<S.__webglColorRenderbuffer.length;G++)S.__webglColorRenderbuffer[G]&&s.deleteRenderbuffer(S.__webglColorRenderbuffer[G]);S.__webglDepthRenderbuffer&&s.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=E.textures;for(let G=0,ie=z.length;G<ie;G++){const Z=n.get(z[G]);Z.__webglTexture&&(s.deleteTexture(Z.__webglTexture),o.memory.textures--),n.remove(z[G])}n.remove(E)}let P=0;function k(){P=0}function F(){const E=P;return E>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+i.maxTextures),P+=1,E}function q(E){const S=[];return S.push(E.wrapS),S.push(E.wrapT),S.push(E.wrapR||0),S.push(E.magFilter),S.push(E.minFilter),S.push(E.anisotropy),S.push(E.internalFormat),S.push(E.format),S.push(E.type),S.push(E.generateMipmaps),S.push(E.premultiplyAlpha),S.push(E.flipY),S.push(E.unpackAlignment),S.push(E.colorSpace),S.join()}function se(E,S){const z=n.get(E);if(E.isVideoTexture&&ce(E),E.isRenderTargetTexture===!1&&E.version>0&&z.__version!==E.version){const G=E.image;if(G===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(z,E,S);return}}t.bindTexture(s.TEXTURE_2D,z.__webglTexture,s.TEXTURE0+S)}function j(E,S){const z=n.get(E);if(E.version>0&&z.__version!==E.version){ee(z,E,S);return}t.bindTexture(s.TEXTURE_2D_ARRAY,z.__webglTexture,s.TEXTURE0+S)}function oe(E,S){const z=n.get(E);if(E.version>0&&z.__version!==E.version){ee(z,E,S);return}t.bindTexture(s.TEXTURE_3D,z.__webglTexture,s.TEXTURE0+S)}function V(E,S){const z=n.get(E);if(E.version>0&&z.__version!==E.version){ue(z,E,S);return}t.bindTexture(s.TEXTURE_CUBE_MAP,z.__webglTexture,s.TEXTURE0+S)}const de={[ns]:s.REPEAT,[yn]:s.CLAMP_TO_EDGE,[qr]:s.MIRRORED_REPEAT},ve={[Vt]:s.NEAREST,[Jl]:s.NEAREST_MIPMAP_NEAREST,[Is]:s.NEAREST_MIPMAP_LINEAR,[at]:s.LINEAR,[Br]:s.LINEAR_MIPMAP_NEAREST,[kn]:s.LINEAR_MIPMAP_LINEAR},Ie={[Wu]:s.NEVER,[Ku]:s.ALWAYS,[Xu]:s.LESS,[hh]:s.LEQUAL,[$u]:s.EQUAL,[ju]:s.GEQUAL,[qu]:s.GREATER,[Yu]:s.NOTEQUAL};function je(E,S){if(S.type===pn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===at||S.magFilter===Br||S.magFilter===Is||S.magFilter===kn||S.minFilter===at||S.minFilter===Br||S.minFilter===Is||S.minFilter===kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(E,s.TEXTURE_WRAP_S,de[S.wrapS]),s.texParameteri(E,s.TEXTURE_WRAP_T,de[S.wrapT]),(E===s.TEXTURE_3D||E===s.TEXTURE_2D_ARRAY)&&s.texParameteri(E,s.TEXTURE_WRAP_R,de[S.wrapR]),s.texParameteri(E,s.TEXTURE_MAG_FILTER,ve[S.magFilter]),s.texParameteri(E,s.TEXTURE_MIN_FILTER,ve[S.minFilter]),S.compareFunction&&(s.texParameteri(E,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(E,s.TEXTURE_COMPARE_FUNC,Ie[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Vt||S.minFilter!==Is&&S.minFilter!==kn||S.type===pn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");s.texParameterf(E,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function st(E,S){let z=!1;E.__webglInit===void 0&&(E.__webglInit=!0,S.addEventListener("dispose",T));const G=S.source;let ie=d.get(G);ie===void 0&&(ie={},d.set(G,ie));const Z=q(S);if(Z!==E.__cacheKey){ie[Z]===void 0&&(ie[Z]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ie[Z].usedTimes++;const Ce=ie[E.__cacheKey];Ce!==void 0&&(ie[E.__cacheKey].usedTimes--,Ce.usedTimes===0&&M(S)),E.__cacheKey=Z,E.__webglTexture=ie[Z].texture}return z}function ee(E,S,z){let G=s.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(G=s.TEXTURE_2D_ARRAY),S.isData3DTexture&&(G=s.TEXTURE_3D);const ie=st(E,S),Z=S.source;t.bindTexture(G,E.__webglTexture,s.TEXTURE0+z);const Ce=n.get(Z);if(Z.version!==Ce.__version||ie===!0){t.activeTexture(s.TEXTURE0+z);const me=tt.getPrimaries(tt.workingColorSpace),Ee=S.colorSpace===ei?null:tt.getPrimaries(S.colorSpace),et=S.colorSpace===ei||me===Ee?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,S.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,S.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let le=x(S.image,!1,i.maxTextureSize);le=Be(S,le);const Ae=r.convert(S.format,S.colorSpace),Oe=r.convert(S.type);let ze=y(S.internalFormat,Ae,Oe,S.colorSpace,S.isVideoTexture);je(G,S);let Re;const Je=S.mipmaps,We=S.isVideoTexture!==!0,lt=Ce.__version===void 0||ie===!0,U=Z.dataReady,xe=C(S,le);if(S.isDepthTexture)ze=v(S.format===ss,S.type),lt&&(We?t.texStorage2D(s.TEXTURE_2D,1,ze,le.width,le.height):t.texImage2D(s.TEXTURE_2D,0,ze,le.width,le.height,0,Ae,Oe,null));else if(S.isDataTexture)if(Je.length>0){We&&lt&&t.texStorage2D(s.TEXTURE_2D,xe,ze,Je[0].width,Je[0].height);for(let Y=0,Q=Je.length;Y<Q;Y++)Re=Je[Y],We?U&&t.texSubImage2D(s.TEXTURE_2D,Y,0,0,Re.width,Re.height,Ae,Oe,Re.data):t.texImage2D(s.TEXTURE_2D,Y,ze,Re.width,Re.height,0,Ae,Oe,Re.data);S.generateMipmaps=!1}else We?(lt&&t.texStorage2D(s.TEXTURE_2D,xe,ze,le.width,le.height),U&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,le.width,le.height,Ae,Oe,le.data)):t.texImage2D(s.TEXTURE_2D,0,ze,le.width,le.height,0,Ae,Oe,le.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){We&&lt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,xe,ze,Je[0].width,Je[0].height,le.depth);for(let Y=0,Q=Je.length;Y<Q;Y++)if(Re=Je[Y],S.format!==sn)if(Ae!==null)if(We){if(U)if(S.layerUpdates.size>0){const Se=_l(Re.width,Re.height,S.format,S.type);for(const ge of S.layerUpdates){const Ve=Re.data.subarray(ge*Se/Re.data.BYTES_PER_ELEMENT,(ge+1)*Se/Re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Y,0,0,ge,Re.width,Re.height,1,Ae,Ve)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Y,0,0,0,Re.width,Re.height,le.depth,Ae,Re.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Y,ze,Re.width,Re.height,le.depth,0,Re.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else We?U&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Y,0,0,0,Re.width,Re.height,le.depth,Ae,Oe,Re.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Y,ze,Re.width,Re.height,le.depth,0,Ae,Oe,Re.data)}else{We&&lt&&t.texStorage2D(s.TEXTURE_2D,xe,ze,Je[0].width,Je[0].height);for(let Y=0,Q=Je.length;Y<Q;Y++)Re=Je[Y],S.format!==sn?Ae!==null?We?U&&t.compressedTexSubImage2D(s.TEXTURE_2D,Y,0,0,Re.width,Re.height,Ae,Re.data):t.compressedTexImage2D(s.TEXTURE_2D,Y,ze,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):We?U&&t.texSubImage2D(s.TEXTURE_2D,Y,0,0,Re.width,Re.height,Ae,Oe,Re.data):t.texImage2D(s.TEXTURE_2D,Y,ze,Re.width,Re.height,0,Ae,Oe,Re.data)}else if(S.isDataArrayTexture)if(We){if(lt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,xe,ze,le.width,le.height,le.depth),U)if(S.layerUpdates.size>0){const Y=_l(le.width,le.height,S.format,S.type);for(const Q of S.layerUpdates){const Se=le.data.subarray(Q*Y/le.data.BYTES_PER_ELEMENT,(Q+1)*Y/le.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Q,le.width,le.height,1,Ae,Oe,Se)}S.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,Ae,Oe,le.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,ze,le.width,le.height,le.depth,0,Ae,Oe,le.data);else if(S.isData3DTexture)We?(lt&&t.texStorage3D(s.TEXTURE_3D,xe,ze,le.width,le.height,le.depth),U&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,Ae,Oe,le.data)):t.texImage3D(s.TEXTURE_3D,0,ze,le.width,le.height,le.depth,0,Ae,Oe,le.data);else if(S.isFramebufferTexture){if(lt)if(We)t.texStorage2D(s.TEXTURE_2D,xe,ze,le.width,le.height);else{let Y=le.width,Q=le.height;for(let Se=0;Se<xe;Se++)t.texImage2D(s.TEXTURE_2D,Se,ze,Y,Q,0,Ae,Oe,null),Y>>=1,Q>>=1}}else if(Je.length>0){if(We&&lt){const Y=we(Je[0]);t.texStorage2D(s.TEXTURE_2D,xe,ze,Y.width,Y.height)}for(let Y=0,Q=Je.length;Y<Q;Y++)Re=Je[Y],We?U&&t.texSubImage2D(s.TEXTURE_2D,Y,0,0,Ae,Oe,Re):t.texImage2D(s.TEXTURE_2D,Y,ze,Ae,Oe,Re);S.generateMipmaps=!1}else if(We){if(lt){const Y=we(le);t.texStorage2D(s.TEXTURE_2D,xe,ze,Y.width,Y.height)}U&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,Ae,Oe,le)}else t.texImage2D(s.TEXTURE_2D,0,ze,Ae,Oe,le);m(S)&&f(G),Ce.__version=Z.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function ue(E,S,z){if(S.image.length!==6)return;const G=st(E,S),ie=S.source;t.bindTexture(s.TEXTURE_CUBE_MAP,E.__webglTexture,s.TEXTURE0+z);const Z=n.get(ie);if(ie.version!==Z.__version||G===!0){t.activeTexture(s.TEXTURE0+z);const Ce=tt.getPrimaries(tt.workingColorSpace),me=S.colorSpace===ei?null:tt.getPrimaries(S.colorSpace),Ee=S.colorSpace===ei||Ce===me?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,S.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,S.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const et=S.isCompressedTexture||S.image[0].isCompressedTexture,le=S.image[0]&&S.image[0].isDataTexture,Ae=[];for(let Q=0;Q<6;Q++)!et&&!le?Ae[Q]=x(S.image[Q],!0,i.maxCubemapSize):Ae[Q]=le?S.image[Q].image:S.image[Q],Ae[Q]=Be(S,Ae[Q]);const Oe=Ae[0],ze=r.convert(S.format,S.colorSpace),Re=r.convert(S.type),Je=y(S.internalFormat,ze,Re,S.colorSpace),We=S.isVideoTexture!==!0,lt=Z.__version===void 0||G===!0,U=ie.dataReady;let xe=C(S,Oe);je(s.TEXTURE_CUBE_MAP,S);let Y;if(et){We&&lt&&t.texStorage2D(s.TEXTURE_CUBE_MAP,xe,Je,Oe.width,Oe.height);for(let Q=0;Q<6;Q++){Y=Ae[Q].mipmaps;for(let Se=0;Se<Y.length;Se++){const ge=Y[Se];S.format!==sn?ze!==null?We?U&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,ge.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Je,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):We?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,0,0,ge.width,ge.height,ze,Re,ge.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se,Je,ge.width,ge.height,0,ze,Re,ge.data)}}}else{if(Y=S.mipmaps,We&&lt){Y.length>0&&xe++;const Q=we(Ae[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,xe,Je,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(le){We?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ae[Q].width,Ae[Q].height,ze,Re,Ae[Q].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Je,Ae[Q].width,Ae[Q].height,0,ze,Re,Ae[Q].data);for(let Se=0;Se<Y.length;Se++){const Ve=Y[Se].image[Q].image;We?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,Ve.width,Ve.height,ze,Re,Ve.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Je,Ve.width,Ve.height,0,ze,Re,Ve.data)}}else{We?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ze,Re,Ae[Q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Je,ze,Re,Ae[Q]);for(let Se=0;Se<Y.length;Se++){const ge=Y[Se];We?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,0,0,ze,Re,ge.image[Q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Se+1,Je,ze,Re,ge.image[Q])}}}m(S)&&f(s.TEXTURE_CUBE_MAP),Z.__version=ie.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function Pe(E,S,z,G,ie,Z){const Ce=r.convert(z.format,z.colorSpace),me=r.convert(z.type),Ee=y(z.internalFormat,Ce,me,z.colorSpace),et=n.get(S),le=n.get(z);if(le.__renderTarget=S,!et.__hasExternalTextures){const Ae=Math.max(1,S.width>>Z),Oe=Math.max(1,S.height>>Z);ie===s.TEXTURE_3D||ie===s.TEXTURE_2D_ARRAY?t.texImage3D(ie,Z,Ee,Ae,Oe,S.depth,0,Ce,me,null):t.texImage2D(ie,Z,Ee,Ae,Oe,0,Ce,me,null)}t.bindFramebuffer(s.FRAMEBUFFER,E),he(S)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,G,ie,le.__webglTexture,0,ne(S)):(ie===s.TEXTURE_2D||ie>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,G,ie,le.__webglTexture,Z),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Me(E,S,z){if(s.bindRenderbuffer(s.RENDERBUFFER,E),S.depthBuffer){const G=S.depthTexture,ie=G&&G.isDepthTexture?G.type:null,Z=v(S.stencilBuffer,ie),Ce=S.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,me=ne(S);he(S)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,me,Z,S.width,S.height):z?s.renderbufferStorageMultisample(s.RENDERBUFFER,me,Z,S.width,S.height):s.renderbufferStorage(s.RENDERBUFFER,Z,S.width,S.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Ce,s.RENDERBUFFER,E)}else{const G=S.textures;for(let ie=0;ie<G.length;ie++){const Z=G[ie],Ce=r.convert(Z.format,Z.colorSpace),me=r.convert(Z.type),Ee=y(Z.internalFormat,Ce,me,Z.colorSpace),et=ne(S);z&&he(S)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,et,Ee,S.width,S.height):he(S)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,et,Ee,S.width,S.height):s.renderbufferStorage(s.RENDERBUFFER,Ee,S.width,S.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function N(E,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,E),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const G=n.get(S.depthTexture);G.__renderTarget=S,(!G.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),se(S.depthTexture,0);const ie=G.__webglTexture,Z=ne(S);if(S.depthTexture.format===Ki)he(S)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ie,0,Z):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ie,0);else if(S.depthTexture.format===ss)he(S)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ie,0,Z):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function H(E){const S=n.get(E),z=E.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==E.depthTexture){const G=E.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),G){const ie=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,G.removeEventListener("dispose",ie)};G.addEventListener("dispose",ie),S.__depthDisposeCallback=ie}S.__boundDepthTexture=G}if(E.depthTexture&&!S.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");N(S.__webglFramebuffer,E)}else if(z){S.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(s.FRAMEBUFFER,S.__webglFramebuffer[G]),S.__webglDepthbuffer[G]===void 0)S.__webglDepthbuffer[G]=s.createRenderbuffer(),Me(S.__webglDepthbuffer[G],E,!1);else{const ie=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Z=S.__webglDepthbuffer[G];s.bindRenderbuffer(s.RENDERBUFFER,Z),s.framebufferRenderbuffer(s.FRAMEBUFFER,ie,s.RENDERBUFFER,Z)}}else if(t.bindFramebuffer(s.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=s.createRenderbuffer(),Me(S.__webglDepthbuffer,E,!1);else{const G=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ie=S.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ie),s.framebufferRenderbuffer(s.FRAMEBUFFER,G,s.RENDERBUFFER,ie)}t.bindFramebuffer(s.FRAMEBUFFER,null)}function te(E,S,z){const G=n.get(E);S!==void 0&&Pe(G.__webglFramebuffer,E,E.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),z!==void 0&&H(E)}function ae(E){const S=E.texture,z=n.get(E),G=n.get(S);E.addEventListener("dispose",R);const ie=E.textures,Z=E.isWebGLCubeRenderTarget===!0,Ce=ie.length>1;if(Ce||(G.__webglTexture===void 0&&(G.__webglTexture=s.createTexture()),G.__version=S.version,o.memory.textures++),Z){z.__webglFramebuffer=[];for(let me=0;me<6;me++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[me]=[];for(let Ee=0;Ee<S.mipmaps.length;Ee++)z.__webglFramebuffer[me][Ee]=s.createFramebuffer()}else z.__webglFramebuffer[me]=s.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let me=0;me<S.mipmaps.length;me++)z.__webglFramebuffer[me]=s.createFramebuffer()}else z.__webglFramebuffer=s.createFramebuffer();if(Ce)for(let me=0,Ee=ie.length;me<Ee;me++){const et=n.get(ie[me]);et.__webglTexture===void 0&&(et.__webglTexture=s.createTexture(),o.memory.textures++)}if(E.samples>0&&he(E)===!1){z.__webglMultisampledFramebuffer=s.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let me=0;me<ie.length;me++){const Ee=ie[me];z.__webglColorRenderbuffer[me]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,z.__webglColorRenderbuffer[me]);const et=r.convert(Ee.format,Ee.colorSpace),le=r.convert(Ee.type),Ae=y(Ee.internalFormat,et,le,Ee.colorSpace,E.isXRRenderTarget===!0),Oe=ne(E);s.renderbufferStorageMultisample(s.RENDERBUFFER,Oe,Ae,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+me,s.RENDERBUFFER,z.__webglColorRenderbuffer[me])}s.bindRenderbuffer(s.RENDERBUFFER,null),E.depthBuffer&&(z.__webglDepthRenderbuffer=s.createRenderbuffer(),Me(z.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(Z){t.bindTexture(s.TEXTURE_CUBE_MAP,G.__webglTexture),je(s.TEXTURE_CUBE_MAP,S);for(let me=0;me<6;me++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[me][Ee],E,S,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ee);else Pe(z.__webglFramebuffer[me],E,S,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+me,0);m(S)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let me=0,Ee=ie.length;me<Ee;me++){const et=ie[me],le=n.get(et);t.bindTexture(s.TEXTURE_2D,le.__webglTexture),je(s.TEXTURE_2D,et),Pe(z.__webglFramebuffer,E,et,s.COLOR_ATTACHMENT0+me,s.TEXTURE_2D,0),m(et)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let me=s.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(me=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(me,G.__webglTexture),je(me,S),S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)Pe(z.__webglFramebuffer[Ee],E,S,s.COLOR_ATTACHMENT0,me,Ee);else Pe(z.__webglFramebuffer,E,S,s.COLOR_ATTACHMENT0,me,0);m(S)&&f(me),t.unbindTexture()}E.depthBuffer&&H(E)}function K(E){const S=E.textures;for(let z=0,G=S.length;z<G;z++){const ie=S[z];if(m(ie)){const Z=g(E),Ce=n.get(ie).__webglTexture;t.bindTexture(Z,Ce),f(Z),t.unbindTexture()}}}const re=[],D=[];function be(E){if(E.samples>0){if(he(E)===!1){const S=E.textures,z=E.width,G=E.height;let ie=s.COLOR_BUFFER_BIT;const Z=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ce=n.get(E),me=S.length>1;if(me)for(let Ee=0;Ee<S.length;Ee++)t.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ee=0;Ee<S.length;Ee++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(ie|=s.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(ie|=s.STENCIL_BUFFER_BIT)),me){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const et=n.get(S[Ee]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,et,0)}s.blitFramebuffer(0,0,z,G,0,0,z,G,ie,s.NEAREST),c===!0&&(re.length=0,D.length=0,re.push(s.COLOR_ATTACHMENT0+Ee),E.depthBuffer&&E.resolveDepthBuffer===!1&&(re.push(Z),D.push(Z),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,D)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,re))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),me)for(let Ee=0;Ee<S.length;Ee++){t.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ee]);const et=n.get(S[Ee]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.TEXTURE_2D,et,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const S=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[S])}}}function ne(E){return Math.min(i.maxSamples,E.samples)}function he(E){const S=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function ce(E){const S=o.render.frame;h.get(E)!==S&&(h.set(E,S),E.update())}function Be(E,S){const z=E.colorSpace,G=E.format,ie=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||z!==Wt&&z!==ei&&(tt.getTransfer(z)===pt?(G!==sn||ie!==Gn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),S}function we(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=k,this.setTexture2D=se,this.setTexture2DArray=j,this.setTexture3D=oe,this.setTextureCube=V,this.rebindTextures=te,this.setupRenderTarget=ae,this.updateRenderTargetMipmap=K,this.updateMultisampleRenderTarget=be,this.setupDepthRenderbuffer=H,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=he}function g0(s,e){function t(n,i=ei){let r;const o=tt.getTransfer(i);if(n===Gn)return s.UNSIGNED_BYTE;if(n===$a)return s.UNSIGNED_SHORT_4_4_4_4;if(n===qa)return s.UNSIGNED_SHORT_5_5_5_1;if(n===th)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Ql)return s.BYTE;if(n===eh)return s.SHORT;if(n===$s)return s.UNSIGNED_SHORT;if(n===Xa)return s.INT;if(n===vi)return s.UNSIGNED_INT;if(n===pn)return s.FLOAT;if(n===er)return s.HALF_FLOAT;if(n===nh)return s.ALPHA;if(n===ih)return s.RGB;if(n===sn)return s.RGBA;if(n===sh)return s.LUMINANCE;if(n===rh)return s.LUMINANCE_ALPHA;if(n===Ki)return s.DEPTH_COMPONENT;if(n===ss)return s.DEPTH_STENCIL;if(n===Ya)return s.RED;if(n===ja)return s.RED_INTEGER;if(n===oh)return s.RG;if(n===Ka)return s.RG_INTEGER;if(n===Za)return s.RGBA_INTEGER;if(n===kr||n===zr||n===Hr||n===Vr)if(o===pt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===kr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===zr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Hr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===kr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===zr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Hr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Vr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ra||n===oa||n===aa||n===ca)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ra)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===aa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===la||n===ha||n===ua)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===la||n===ha)return o===pt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ua)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===da||n===fa||n===pa||n===ma||n===_a||n===ga||n===va||n===xa||n===ya||n===Ma||n===Sa||n===wa||n===ba||n===Ta)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===da)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===fa)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===pa)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ma)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===_a)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ga)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===va)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===xa)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ya)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ma)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Sa)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===wa)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ba)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ta)return o===pt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Gr||n===Ea||n===Aa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Gr)return o===pt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ea)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Aa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ah||n===Ra||n===Ca||n===Pa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Gr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ra)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ca)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Pa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===is?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}class v0 extends Ht{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Mn extends mt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const x0={type:"move"};class No{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Mn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Mn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Mn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const x of e.hand.values()){const m=t.getJointPose(x,n),f=this._getHandJoint(l,x);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,_=.005;l.inputState.pinching&&d>p+_?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=p-_&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(x0)))}return a!==null&&(a.visible=i!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Mn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const y0=`
void main() {
...
---
\`sig:${ne}\` | *UNPLUG: Elemental Survivor*`,Be=`https://github.com/owonie/unplug/issues/new?title=${encodeURIComponent(he)}&body=${encodeURIComponent(ce)}&labels=record`;window.open(Be,"_blank")}),(Me=document.getElementById("retry-btn"))==null||Me.addEventListener("click",()=>{document.getElementById("gameover-screen").style.display="none",I=new Fs,t=!0,de=!1,e.enemyMeshes.forEach(N=>e.scene.remove(N)),e.enemyMeshes=[],e.orbMeshes.forEach(N=>e.scene.remove(N)),e.orbMeshes=[],e.bulletMeshes.forEach(N=>e.scene.remove(N)),e.bulletMeshes=[]}),window._restartGame=()=>{I=new Fs,t=!0,de=!1,e.enemyMeshes.forEach(N=>e.scene.remove(N)),e.enemyMeshes=[],e.orbMeshes.forEach(N=>e.scene.remove(N)),e.orbMeshes=[],e.bulletMeshes.forEach(N=>e.scene.remove(N)),e.bulletMeshes=[]};const o={KeyW:"w",KeyA:"a",KeyS:"s",KeyD:"d",ArrowUp:"w",ArrowDown:"s",ArrowLeft:"a",ArrowRight:"d",Digit1:"1",Digit2:"2",Digit3:"3"};document.addEventListener("keydown",N=>{const H=o[N.code]||N.key.toLowerCase();if(N.code==="Space"&&N.preventDefault(),N.code==="Space"&&!I.level_up_pending()&&!I.is_paused()&&I.player_dash_cooldown()<=0&&nt.playDash(),N.code==="Escape"){I.toggle_pause();const te=I.is_paused();document.getElementById("pause-menu").style.display=te?"flex":"none",te&&R();return}if(N.code==="Tab"){N.preventDefault(),window._showDetailStats=!window._showDetailStats;return}if(I.on_key_down(H),I.level_up_pending()){const te=I.player_class_tier();if(H==="1"){const ae=Cs(I.level_up_choice(0));I.choose_upgrade(0),I.player_class_tier()>te?P(I.player_class_tier()):w(ae),M()}if(H==="2"){const ae=Cs(I.level_up_choice(1));I.choose_upgrade(1),I.player_class_tier()>te?P(I.player_class_tier()):w(ae),M()}if(H==="3"){const ae=Cs(I.level_up_choice(2));I.choose_upgrade(2),I.player_class_tier()>te?P(I.player_class_tier()):w(ae),M()}}}),document.addEventListener("keyup",N=>{const H=o[N.code]||N.key.toLowerCase();I.on_key_up(H)});const a=document.getElementById("game-canvas");a.addEventListener("contextmenu",N=>N.preventDefault()),document.addEventListener("contextmenu",N=>{t&&N.preventDefault()}),a.addEventListener("selectstart",N=>N.preventDefault());let c=null,l=!1,h=null,u=[],d=null,p=null;a.addEventListener("mousedown",N=>{if(!(!t||!I))if(N.preventDefault(),N.button===0){if(c={x:N.clientX,y:N.clientY,button:0},u=[{x:N.clientX,y:N.clientY}],l=!1,Rs.clear(),Rs.addPoint(N.clientX,N.clientY),g(),document.body.style.cursor="crosshair",window._gestureStartTime=performance.now(),window._gestureTimeLimit=2500,!document.getElementById("gesture-timer-hud")){const H=document.createElement("div");H.id="gesture-timer-hud",H.innerHTML=`<svg width="220" height="120" viewBox="0 0 220 120" style="filter:drop-shadow(0 0 12px rgba(100,180,255,0.5))">
            ...
            </svg>`,H.style.cssText="position:fixed;top:12%;right:8%;pointer-events:none;z-index:995;opacity:0;transition:opacity 0.25s",document.body.appendChild(H),requestAnimationFrame(()=>H.style.opacity="1")}if(window._gestureTimerRAF=requestAnimationFrame(function H(){const te=performance.now()-window._gestureStartTime,ae=Math.min(1,te/window._gestureTimeLimit),K=document.getElementById("gesture-arc");if(K&&(K.style.strokeDasharray=220,K.style.strokeDashoffset=220*ae,ae>.7&&K.setAttribute("stroke",`rgba(255,${Math.floor(180*(1-ae))},50,0.8)`)),ae>=1&&c){document.dispatchEvent(new MouseEvent("mouseup",{clientX:c.x,clientY:c.y,button:0}));return}c&&(window._gestureTimerRAF=requestAnimationFrame(H))}),!document.getElementById("gesture-desaturate")){const H=document.createElement("div");H.id="gesture-desaturate",H.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:990;opacity:0;transition:opacity 0.3s ease-in;background:radial-gradient(circle 280px at var(--gx, 50%) var(--gy, 50%), rgba(0,0,0,0.0) 0%, rgba(0,0,0,0.05) 40%, rgba(0,0,0,0.22) 100%)",document.body.appendChild(H),requestAnimationFrame(()=>H.style.opacity="1"),document.body.appendChild(H)}}else N.button===2&&I.player_class_tier()>=2&&(c={x:N.clientX,y:N.clientY,button:2},u=[{x:N.clientX,y:N.clientY}],l=!1,g())}),document.addEventListener("mousemove",N=>{if(window._lastMouseX=N.clientX,window._lastMouseY=N.clientY,!c)return;const H=N.clientX-c.x,te=N.clientY-c.y,ae=Math.sqrt(H*H+te*te);u.push({x:N.clientX,y:N.clientY});const K=document.getElementById("gesture-desaturate");if(K&&(K.style.setProperty("--gx",N.clientX+"px"),K.style.setProperty("--gy",N.clientY+"px")),v(u),ae>20){l=!0;const re=_(u,c);if(!p){const E=document.createElement("canvas");E.width=window.innerWidth,E.height=window.innerHeight,E.style.cssText="position:fixed;top:0;left:0;pointer-events:none;z-index:899",document.body.appendChild(E),p=E}const D=p.getContext("2d");if(D.clearRect(0,0,p.width,p.height),u.length>2){const E=wt(),S={1:"rgba(255,100,0,0.5)",2:"rgba(100,150,200,0.4)",3:"rgba(255,220,50,0.5)",4:"rgba(120,50,180,0.4)",0:"rgba(150,150,255,0.4)"};D.strokeStyle=S[E]||S[0],D.lineWidth=3,D.lineCap="round",D.beginPath(),D.moveTo(u[0].x,u[0].y);for(let z=1;z<u.length;z++)D.lineTo(u[z].x,u[z].y);D.stroke(),re==="circle"&&(D.strokeStyle="rgba(255,200,0,0.7)",D.lineWidth=5,D.stroke())}h||(h=document.createElement("div"),h.style.cssText="position:fixed;pointer-events:none;z-index:900;border-radius:50%;border:2px solid;animation:magic-spin 1s linear infinite;box-shadow:0 0 15px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;font-weight:bold;text-shadow:0 0 5px rgba(0,0,0,0.8)",document.body.appendChild(h)),d||(d=document.createElement("div"),d.style.cssText="position:fixed;pointer-events:none;z-index:901;font-size:28px;text-shadow:0 0 8px rgba(255,255,255,0.5)",document.body.appendChild(d));const be=Math.min(50+ae*.4,100),ne=wt(),he=c.button===2,Be=(he?{1:"#ff88cc",2:"#88ffcc",3:"#ccff88",4:"#cc88ff",0:"#ccaaff"}:{1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff",0:"#8888ff"})[ne]||(he?"#ccaaff":"#8888ff");h.style.width=be+"px",h.style.height=be+"px",h.style.borderColor=Be,h.style.boxShadow=`0 0 ${be/4}px ${Be}, inset 0 0 ${be/6}px ${Be}`;const we={outward:"⚔️ ATK",inward:"🛡️ DEF",circle:"💫 ULT"};if(h.textContent=we[re]||"...",e&&e.camera){const E=e.projectToScreen(I.player_x(),.5,I.player_z());if(h.style.left=E.x-be/2+"px",h.style.top=E.y-be/2+"px",re==="outward"){const S=Math.atan2(te,H),z=["➡️","↘️","⬇️","↙️","⬅️","↖️","⬆️","↗️"];let G=Math.round(S/(Math.PI/4));G<0&&(G+=8),G=G%8,d.textContent=z[G],d.style.fontSize="32px";const ie=50;d.style.left=E.x+Math.cos(S)*ie-16+"px",d.style.top=E.y+Math.sin(S)*ie-16+"px",d.style.opacity="1"}else re==="inward"?(d.textContent="🛡️",d.style.fontSize="28px",d.style.left=E.x-14+"px",d.style.top=E.y-14+"px",d.style.opacity="1"):re==="circle"?(d.textContent="🌀",d.style.left=E.x-14+"px",d.style.top=E.y-40+"px",d.style.opacity="1"):(d.style.opacity="0.3",d.textContent="?")}}}),document.addEventListener("mouseup",N=>{if(!c||!I){c=null;return}const H=N.clientX-c.x,te=N.clientY-c.y,ae=Math.sqrt(H*H+te*te),K=c.button;document.body.style.cursor="";const re=document.getElementById("gesture-desaturate");re&&re.remove();const D=document.getElementById("gesture-timer-hud");if(D&&D.remove(),window._gestureTimerRAF&&cancelAnimationFrame(window._gestureTimerRAF),C(),h&&(h.remove(),h=null),d&&(d.remove(),d=null),p&&(p.remove(),p=null),y(),K===0&&I.player_class_tier()>0)if(l&&ae>30){const be=_(u,c),ne=Math.atan2(-te,H);if(be==="outward"){if(I.player_class_tier()>0&&!m(20)){c=null,l=!1,u=[];return}I.use_directional_skill(ne);const he=wt(),ce=document.createElement("div"),Be={0:"rgba(255,255,255,0.15)",1:"rgba(255,100,0,0.2)",2:"rgba(50,200,255,0.2)",3:"rgba(255,220,0,0.2)",4:"rgba(150,50,255,0.2)"};ce.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${Be[he]||Be[0]};pointer-events:none;z-index:998;animation:flash-fade 0.15s ease-out forwards`,document.body.appendChild(ce),setTimeout(()=>ce.remove(),150);const we=I.player_class_tier()>0?8:6;e.spawnDirectionalEffect(I.player_x(),I.player_z(),ne,he,we),e.hitStop(.04),e.shake(.3,.1),e.zoomPunch(1,.12),window._onboardingActive&&i(),he===1?nt.playElementFire():he===2?nt.playElementIce():he===3?nt.playElementThunder():he===4?nt.playElementPoison():nt.playHit(),T("outward")}else if(be==="inward")I.use_shield_skill(),nt.playShield(),e.spawnShieldEffect(I.player_x(),I.player_z(),wt()),e.shake(.15,.05),T("inward");else if(be==="circle"){if(I.player_class_tier()>0&&!m(50)){c=null,l=!1,u=[];return}I.use_ultimate_skill(),nt.playUltimate(wt());const he=wt();e.spawnUltimateEffect(I.player_x(),I.player_z(),he,10),e.hitStop(.12),e.shake(.8,.25),T("circle");const ce={0:"rgba(255,255,255,0.15)",1:"rgba(255,80,0,0.12)",2:"rgba(50,180,255,0.12)",3:"rgba(255,200,0,0.12)",4:"rgba(150,50,255,0.12)"},Be=document.createElement("div");Be.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${ce[he]||ce[0]};pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards`,document.body.appendChild(Be),setTimeout(()=>Be.remove(),400);const we=document.createElement("div");we.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:998;box-shadow:inset 0 0 80px 30px rgba(0,0,0,0.6);animation:flash-fade 0.6s ease-out forwards",document.body.appendChild(we),setTimeout(()=>we.remove(),600),window._onboardingActive&&i()}else if(be==="zigzag"){if(I.player_class_tier()>0&&!m(35)){c=null,l=!1,u=[];return}const he=wt();for(let ce=-1;ce<=1;ce++){const Be=Math.atan2(-te,H)+ce*.4;setTimeout(()=>{I.use_directional_skill(Be),e.spawnDirectionalEffect(I.player_x(),I.player_z(),Be,he,5)},ce*80+80)}e.hitStop(.06),e.shake(.4,.15),nt.playElementThunder(),T("zigzag")}else if(be==="vshape"){if(I.player_class_tier()>0&&!m(25)){c=null,l=!1,u=[];return}I.use_shield_skill();const he=wt();e.spawnShieldEffect(I.player_x(),I.player_z(),he),setTimeout(()=>{const ce=Math.atan2(-te,H);I.use_directional_skill(ce),e.spawnDirectionalEffect(I.player_x(),I.player_z(),ce,he,5),e.shake(.35,.1)},200),e.hitStop(.04),e.shake(.2,.08),nt.playShield(),T("vshape")}else if(be==="upstroke"){if(I.player_class_tier()>0&&!m(30)){c=null,l=!1,u=[];return}const he=Math.atan2(-te,H);I.use_directional_skill(he);const ce=wt();e.spawnDirectionalEffect(I.player_x(),I.player_z(),he,ce,10),e.hitStop(.07),e.shake(.6,.15),e.zoomPunch(2,.18),ce===1?nt.playElementFire():ce===2?nt.playElementIce():ce===3?nt.playElementThunder():nt.playHit(),T("upstroke")}else I.use_directional_skill(Math.atan2(-te,H)),e.shake(.1,.05)}else l||I.use_active_skill();else if(K===2&&I.player_class_tier()>=2)if(l&&ae>30){const be=_(u,c),ne=Math.atan2(-te,H);if(be==="outward"){if(!m(20)){c=null,l=!1,u=[];return}I.use_directional_skill(ne);const he=wt();e.spawnAdvancedDirectionalEffect(I.player_x(),I.player_z(),ne,he,9),nt.playAdvancedSkill(he),e.shake(.55,.15),T("outward")}else if(be==="circle"){if(!m(50)){c=null,l=!1,u=[];return}const he=wt();I.use_ultimate_skill(),nt.playAdvancedUltimate(he),e.spawnAdvancedUltimateEffect(I.player_x(),I.player_z(),he,12),e.shake(.9,.3),T("circle");const ce=document.createElement("div");ce.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:999;animation:flash-fade 0.4s ease-out forwards",ce.style.background=he===1?"rgba(255,100,0,0.3)":he===2?"rgba(100,200,255,0.3)":he===3?"rgba(255,255,0,0.3)":"rgba(150,50,255,0.3)",document.body.appendChild(ce),setTimeout(()=>ce.remove(),400),e.shake(.7,.25),T("circle")}else I.use_active_skill(),e.shake(.3,.1),T("outward")}else l||(I.use_active_skill(),e.spawnSkillEffect(I.player_x(),I.player_z(),wt(),4),e.shake(.25,.08));c=null,l=!1,u=[]});function _(N,H){if(N.length<5)return"unknown";const te=N[N.length-1],ae=te.x-H.x,K=te.y-H.y,re=Math.sqrt(ae*ae+K*K);if(N.length>30){let D=0;for(let ne=2;ne<N.length;ne++){const he=N[ne-1].x-N[ne-2].x,ce=N[ne-1].y-N[ne-2].y,Be=N[ne].x-N[ne-1].x,we=N[ne].y-N[ne-1].y,E=he*we-ce*Be,S=he*Be+ce*we;D+=Math.atan2(E,S)}const be=Math.sqrt((te.x-H.x)**2+(te.y-H.y)**2);if(Math.abs(D)>Math.PI*1.9&&be<120)return"circle"}if(N.length>15){let D=0,be=0;for(let ne=3;ne<N.length;ne+=3){const he=N[ne].x-N[ne-3].x;be!==0&&Math.sign(he)!==Math.sign(be)&&Math.abs(he)>10&&D++,Math.abs(he)>10&&(be=he)}if(D>=3&&re<200)return"zigzag"}if(N.length>10){let D=0;for(let ne=1;ne<N.length;ne++)N[ne].y>N[D].y&&(D=ne);const be=D/N.length;if(be>.25&&be<.75){const ne=N[D].y-H.y,he=N[D].y-te.y;if(ne>40&&he>40&&re<150)return"vshape"}}if(re>60&&K<-50&&Math.abs(ae)<Math.abs(K)*.5)return"upstroke";if(e&&e.camera){const D=e.projectToScreen(I.player_x(),.5,I.player_z()),be=Math.sqrt((H.x-D.x)**2+(H.y-D.y)**2),ne=Math.sqrt((te.x-D.x)**2+(te.y-D.y)**2);if(ne<be-20)return"inward";if(ne>be+20)return"outward"}return re>40?"outward":"unknown"}function x(){const N=document.getElementById("stamina-bar-bg");if(!N)return;N.style.border="2px solid #ff4444";const H=document.createElement("div");H.textContent="Not enough mana",H.style.cssText="position:fixed;top:45%;left:50%;transform:translateX(-50%);color:#ff4444;font-size:16px;font-weight:bold;pointer-events:none;z-index:960;text-shadow:0 0 8px rgba(255,0,0,0.5);animation:skill-name-fade 1s ease-out forwards",document.body.appendChild(H),setTimeout(()=>{H.remove(),N.style.border="1px solid #2a4a2a"},1e3)}function m(N){return I.player_stamina()<N?(x(),!1):!0}let f=null;function g(){f||(f=document.createElement("div"),f.style.cssText="position:fixed;top:80px;right:16px;background:rgba(0,0,0,0.85);border:1px solid #444;border-radius:8px;padding:10px 14px;pointer-events:none;z-index:950;font-size:11px;color:#ccc;line-height:2;min-width:140px",f.innerHTML=`
        ...
        `,document.body.appendChild(f))}function y(){f&&(f.remove(),f=null)}function v(N){Rs.setStyle(I.player_class_tier(),wt());const H=N[N.length-1];H&&Rs.addPoint(H.x,H.y)}function C(){const N=u.length>5?_(u,c||{x:0,y:0}):"unknown";Rs.release(N)}function T(N){const H=I.learned_skill_count();if(H===0)return;let te="",ae="#fff";if(N==="outward"){for(let re=0;re<H;re++)if(I.learned_skill_type(re)===0){te=I.learned_skill_name(re);break}ae="#ff8844"}else if(N==="inward"){for(let re=0;re<H;re++)if(I.learned_skill_type(re)===1){te=I.learned_skill_name(re);break}te||(te="Shield"),ae="#44ff88"}else if(N==="circle"){for(let re=0;re<H;re++)if(I.learned_skill_type(re)===2){te=I.learned_skill_name(re);break}te||(te="Ultimate"),ae="#ffcc00"}else N==="zigzag"?(te="Chain Strike",ae="#ffdd44"):N==="vshape"?(te="Parry Counter",ae="#88ffaa"):N==="upstroke"&&(te="Pierce",ae="#ff66aa");te||(te="Skill");const K=document.createElement("div");K.textContent=N==="circle"?`✨ ${te} ✨`:te,K.style.cssText=`position:fixed;top:38%;left:50%;transform:translateX(-50%);color:${ae};font-size:${N==="circle"?"28px":"20px"};font-weight:bold;pointer-events:none;z-index:950;text-shadow:0 0 12px ${ae},0 2px 4px rgba(0,0,0,0.8);animation:skill-name-fade 1.2s ease-out forwards`,document.body.appendChild(K),setTimeout(()=>K.remove(),1200)}document.getElementById("resume-btn").addEventListener("click",()=>{I.toggle_pause(),document.getElementById("pause-menu").style.display="none"});function R(){let N="<b>📜 Status</b><br><br>";const H=I.fire_level(),te=I.ice_level(),ae=I.thunder_level(),K=I.poison_level();N+="<b>⚗️ Element Orbs</b><br>",H>0&&(N+=`  🔥 Fire: ${H}<br>`),te>0&&(N+=`  ❄️ Ice: ${te}<br>`),ae>0&&(N+=`  ⚡ Thunder: ${ae}<br>`),K>0&&(N+=`  ☠️ Poison: ${K}<br>`),H+te+ae+K===0&&(N+='  <span style="color:#666">None</span><br>');const re=I.player_class_tier();if(re>0){N+=`<br><b>${{1:"⭐",2:"🌟",3:"👑"}[re]||""} ${I.player_class_name()}</b> (Tier ${re})<br>`;const be=I.learned_skill_count();if(be>0){N+="<br><b>🗡️ Class Skills</b><br>";for(let ne=0;ne<be;ne++){const he=I.learned_skill_name(ne),ce=I.learned_skill_level(ne);N+=`  📈 ${he} <span style="color:#ffcc00">Lv.${ce}</span><br>`}}}else N+='<br><span style="color:#666">Reach Lv.2 for first promotion</span><br>',N+='<span style="color:#555;font-size:10px">Collect element orbs to meet requirements</span>';if(re===0||re===1||re===2){const D=re===0?10:re===1?25:45;I.player_level()<D&&(N+=`<br><br><span style="color:#888;font-size:10px">Next promotion: Lv.${D}</span>`)}document.getElementById("pause-skills").innerHTML=N}for(let N=0;N<3;N++)document.getElementById(`choice-${N}`).addEventListener("click",()=>{const H=I.level_up_choice(N),te=Cs(H),ae=I.player_class_tier();I.choose_upgrade(N);const K=I.player_class_tier();if(K>ae)P(K);else{w(te);const re=I.player_x(),D=I.player_z();if(H>=50&&H<=53){const be=H-49;e.spawnDirectionalEffect(re,D,0,be,4),e.spawnGroundDecal(re,D,be),e.zoomPunch(.8,.1)}else H>=60&&e.spawnDeathParticles(re,D,wt())}M()});function A(){const N=document.getElementById("levelup");N.style.display="block",N.classList.add("shown");for(let te=0;te<3;te++){const ae=I.level_up_choice(te),K=Cs(ae),re=Fv(ae);let D="";if(ae>=50&&ae<=53){const ne=ae-50+1,he=[0,I.fire_level(),I.ice_level(),I.thunder_level(),I.poison_level()][ne],ce=I.player_class_tier()===0?1:4,Be=Math.max(0,ce-he-1);Be===0?D='<span style="color:#daa520;font-size:10px">→ PROMOTION READY after this!</span>':D=`<span style="color:#555;font-size:10px">→ ${Be} more to promote</span>`}else ae>=100&&(D=`<span style="color:#daa520;font-size:10px">${Zt.star(10)} Class change!</span>`);const be=ae>=50&&ae<=53?qo(ae-49,18):ae>=100?Zt.star(18):"";document.getElementById(`choice-${te}`).innerHTML=`
          ...
          `,document.body.appendChild(ne),requestAnimationFrame(()=>{ne.style.opacity="1",ne.style.transform="translate(-50%,-50%) scale(1)"}),setTimeout(()=>{ne.style.opacity="0",ne.style.transform="translate(-50%,-50%) scale(1.1)"},1800),setTimeout(()=>ne.remove(),2300)},400),setTimeout(()=>{const be=document.createElement("div");be.style.cssText=`position:fixed;top:0;left:0;right:0;bottom:0;background:${K}55;
            pointer-events:none;z-index:9999;animation:flash-fade 0.5s ease-out forwards`,document.body.appendChild(be),setTimeout(()=>be.remove(),500),e.shake(.6,.25),e.zoomPunch(3,.2),nt.playLevelUp(),setTimeout(()=>nt.playShield(),100)},800),setTimeout(()=>{H===1?I.use_ultimate_skill():H===2?I.use_shield_skill():H===3||H===4?I.use_ultimate_skill():I.use_directional_skill(0),e.spawnUltimateEffect(I.player_x(),I.player_z(),H,12),e.shake(.3,.15)},1200),setTimeout(()=>{re.style.boxShadow="inset 0 0 0 0 rgba(0,0,0,0)",D.style.opacity="0",setTimeout(()=>{re.remove(),D.remove()},500)},2e3)}const k=[];let F="",q=!1;function se(){const N=I.player_promoted(),H=N?I.player_class_name():"",te={1:"⭐",2:"🌟",3:"👑"},ae=I.player_class_tier(),K=te[ae]||"";document.getElementById("level").textContent=I.player_level()+(H?` ${K}${H}`:"");const re=wt(),D=document.getElementById("portrait"),be={0:Zt.sword(24),1:Zt.fire(24),2:Zt.ice(24),3:Zt.thunder(24),4:Zt.poison(24)},ne={0:"#555",1:"#ff4400",2:"#44ccff",3:"#ffcc00",4:"#9933ff"};D.innerHTML=be[re]||Zt.sword(24),D.style.borderColor=ne[re]||"#555",N?D.style.boxShadow=`0 0 10px ${ne[re]}`:D.style.boxShadow="none";const he=Math.max(0,I.player_hp()/I.player_max_hp()*100);document.getElementById("hp-bar-fill").style.width=he+"%";const ce=Math.max(0,I.player_shield()/I.player_max_hp()*100),Be=document.getElementById("shield-bar-fill");Be.style.width=ce+"%",Be.style.left=he+"%";const we=I.player_xp()/I.player_xp_max()*100;document.getElementById("xp-bar-fill").style.width=we+"%";const E=document.getElementById("stat-panel"),S=I.player_class_tier(),z=I.fire_level(),G=I.ice_level(),ie=I.thunder_level(),Z=I.poison_level(),Ce=I.element_total();let me=document.getElementById("promo-hud");if(me||(me=document.createElement("div"),me.id="promo-hud",me.style.cssText="margin-top:6px;font-size:11px;color:#8a8680;line-height:1.5;background:rgba(8,6,12,0.85);padding:4px 8px;border-radius:4px;border:1px solid rgba(218,165,32,0.15);max-width:170px;backdrop-filter:blur(4px)",document.getElementById("stats").appendChild(me)),S<3){const ke=S===0?1:S===1?4:7,ot=S===0?2:S===1?4:7,Ot=I.player_level()>=ot,bt=I.promotion_available_count()>0;let At;bt?At="⭐ PROMOTION READY! (Level up to choose)":Ot?At=`Need ${ke} of same element (${Ce} total)`:At=`Next: Lv${ot} + ${ke} orbs (${Ce}/${ke})`,me.innerHTML=`<span style="color:${z>0?"#ff4400":"#333"}">${Zt.fire(12,z>0?"#ff4400":"#333")}${z}</span> <span style="color:${G>0?"#44ccff":"#333"}">${Zt.ice(12,G>0?"#44ccff":"#333")}${G}</span> <span style="color:${ie>0?"#ffcc00":"#333"}">${Zt.thunder(12,ie>0?"#ffcc00":"#333")}${ie}</span> <span style="color:${Z>0?"#9933ff":"#333"}">${Zt.poison(12,Z>0?"#9933ff":"#333")}${Z}</span><br><span style="color:${bt?"#daa520":"#666"};font-size:10px">${At}</span>`,me.style.display="block"}else me.style.display="none";E&&(E.style.display=window._showDetailStats?"block":"none",window._showDetailStats&&(E.innerHTML=`ATK <span style="color:#ff8844">${Math.round(I.player_damage())}</span><br>SPD <span style="color:#44ccff">${I.player_atk_speed().toFixed(1)}/s</span><br>RNG <span style="color:#88ff44">${I.player_range().toFixed(1)}</span><br>CRT <span style="color:#ff4488">${Math.round(I.player_crit()*100)}%</span><br>PRC <span style="color:#ffcc44">${I.player_pierce()}</span> ×<span style="color:#44ffcc">${I.player_multi()}</span><br>STEAL <span style="color:#ff44ff">${Math.round(I.player_lifesteal()*100)}%</span>`));const Ee={0:"🔥",4:"❄️",2:"⚡",7:"☠️"},et={0:"#ff4400",4:"#44ccff",2:"#ffcc00",7:"#44ff44"},le={0:"Fire Blade",4:"Frost Blade",2:"Thunder Blade",7:"Poison Blade"},Ae=I.skill_slot_count(),Oe=I.learned_skill_count();let ze="";for(let ke=0;ke<Ae;ke++)ze+=I.skill_slot_id(ke)+":"+I.skill_slot_level(ke)+",";ze+="|"+Oe;for(let ke=0;ke<Oe;ke++)ze+=I.learned_skill_id(ke)+":"+I.learned_skill_level(ke)+",";if(ze!==F){F=ze;let ke="";for(let ot=0;ot<Ae;ot++){const Ot=I.skill_slot_id(ot),bt=I.skill_slot_level(ot),At=Ee[Ot]||"⭐",Nt=et[Ot]||"#888",wi=le[Ot]||"Skill";ke+=`<div class="skill-icon" style="background:${Nt}22;border-color:${Nt}">
              ${At}<span class="sk-lvl">${bt}</span>
              <div class="sk-tooltip"><b style="color:${Nt}">${wi} Lv.${bt}</b></div>
            </div>`}if(Oe>0){ke+='<div style="width:2px;height:28px;background:#333;margin:0 4px"></div>';for(let ot=0;ot<Oe;ot++){const Ot=I.learned_skill_name(ot),bt=I.learned_skill_level(ot),At=I.learned_skill_desc(ot),Nt=I.learned_skill_type(ot),wi=Nt===0?"⚔️":Nt===1?"🛡️":"💫",bi=Nt===0?"AUTO":Nt===1?"PASSIVE":"ULT",oi=Nt===0?"#44ccff":Nt===1?"#44ff44":"#ffcc00";ke+=`<div class="skill-icon class-skill" data-skill-idx="${ot}" style="background:${oi}15;border-color:${oi}">
